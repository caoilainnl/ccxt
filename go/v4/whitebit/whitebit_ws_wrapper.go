...
func NewWhitebitWs(userConfig map[string]interface{}) WhitebitWs {
   p := &whitebitWs{}
   p.Init(userConfig)
   return WhitebitWs{
       whitebitWs: p,
...
func (this *WhitebitWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *WhitebitWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *WhitebitWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *WhitebitWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *WhitebitWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *WhitebitWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *WhitebitWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *WhitebitWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
