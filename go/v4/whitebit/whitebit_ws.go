...
type whitebitWs struct {
	whitebit
	base whitebit
}

func NewWhitebitWsCore() whitebitWs {
   p := whitebitWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *whitebitWs) Describe() interface{}  {
 ...
 */
func  (this *whitebitWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *whitebitWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    // {
 ...
 */
func  (this *whitebitWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // {
    //     "method":"depth_update",
    //     "params":[
...
func  (this *whitebitWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *whitebitWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *whitebitWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *whitebitWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes2968 := (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, nil))
...
func  (this *whitebitWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    //   {
 ...
 */
func  (this *whitebitWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) HandleTrades(client interface{}, message interface{})  {
    //
    //    {
 ...
 */
func  (this *whitebitWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) HandleMyTrades(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    //   {
    //       "method": "deals_update",
    //       "params": [
...
func  (this *whitebitWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //   [
    //         1894994106, // id
 ...
 */
func  (this *whitebitWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) HandleOrder(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    // {
...
func  (this *whitebitWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //   {
    //         "id": 96433622651,
    //         "market": "LTC_USDT",
...
func  (this *whitebitWs) ParseWsOrderType(status interface{}) interface{}  {
 ...
 */
func  (this *whitebitWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp405111 := this.HandleMarketTypeAndParams("watchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp405111, 0)
            params = ccxt.GetValue(__tmp405111, 1)
...
func  (this *whitebitWs) HandleBalance(client interface{}, message interface{})  {
    //
    //   {
...
func  (this *whitebitWs) WatchPublic(messageHash interface{}, method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) WatchMultipleSubscription(messageHash interface{}, method interface{}, symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) WatchPrivate(messageHash interface{}, method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *whitebitWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                {		 func(this *whitebitWs) (ret_ interface{}) {
                		defer func() {
                			if e := recover(); e != nil {
                                if e == "break" {
                				    return
                			    }
                				ret_ = func(this *whitebitWs) interface{} {
                					// catch block:
                ...
                retRes88015 :=  <-future.(<-chan interface{})
...
func  (this *whitebitWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    //
    //     { error: null, result: { status: "success" }, id: 1656084550 }
    //
    var future interface{} = ccxt.GetValue(client.(*ccxt.Client).Futures, "authenticated")
    future.(*ccxt.Future).Resolve(1)
    return message
}
func  (this *whitebitWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    ...
    {		ret__ := func(this *whitebitWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
...
func  (this *whitebitWs) HandleMessage(client interface{}, message interface{})  {
    //
    // auth
    //    { error: null, result: { status: "success" }, id: 1656084550 }
    //
...
func  (this *whitebitWs) HandleSubscriptionStatus(client interface{}, message interface{}, id interface{})  {
...
func  (this *whitebitWs) HandlePong(client interface{}, message interface{}) interface{}  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
    return message
}
func  (this *whitebitWs) Ping(client interface{}) interface{}  {
...
func (this *whitebitWs) Init(userConfig map[string]interface{}) {
    this.whitebit.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
