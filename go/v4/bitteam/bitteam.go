    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "400002": ccxt.BadSymbol,
                "401000": ccxt.AuthenticationError,
                "403002": ccxt.BadRequest,
                "404200": ccxt.BadSymbol,
            },
            "broad": map[string]interface{} {
                "is not allowed": ccxt.BadRequest,
                "Insufficient funds": ccxt.InsufficientFunds,
                "Invalid request params input": ccxt.BadRequest,
                "must be a number": ccxt.BadRequest,
                "must be a string": ccxt.BadRequest,
                "must be of type": ccxt.BadRequest,
                "must be one of": ccxt.BadRequest,
                "ccxt.Order not found": ccxt.OrderNotFound,
                "Pair with pair name": ccxt.BadSymbol,
                "pairName": ccxt.BadSymbol,
                "Service Unavailable": ccxt.ExchangeNotAvailable,
                "Symbol ": ccxt.BadSymbol,
            },
        },
    })
}
...
func  (this *bitteam) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(statusesResponse)
            //
            //     {
            //         "ZNX": {
            //             "name": "ZeNeX Coin",
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencies)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(blockChain, nil))) && ccxt.IsTrue((!ccxt.IsEqual(blockChain, "")))) {
                    fee = this.ParseNumber(withdrawCommissionFixed)
                    ccxt.AddElementToObject(feesByNetworkId, blockChain, fee)
                } else {
                ...
                var networkIds interface{} = ccxt.ObjectKeys(feesByNetworkId)
...
func  (this *bitteam) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "pairName": ccxt.GetValue(market, "id"),
...
func  (this *bitteam) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes105615)
                ch <- retRes105615
                return nil
...
func  (this *bitteam) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pairId": ccxt.ToString(ccxt.GetValue(market, "numericId")),
                "type": typeVar,
                "side": side,
...
func  (this *bitteam) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ccxt.AddElementToObject(request, "pairId", ccxt.ToString(ccxt.GetValue(market, "numericId")))
            } else {
                ccxt.AddElementToObject(request, "pairId", "0") // '0' for all markets
            }
...
func  (this *bitteam) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(createdAt, nil)) {
    ...
    var fee interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(feeRaw, nil)) {
...
func  (this *bitteam) ParseValueToPricision(valueObject interface{}, valueKey interface{}, preciseObject interface{}, precisionKey interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(valueRawString, nil)) || ccxt.IsTrue(ccxt.IsEqual(precisionRawString, nil))) {
        return nil
    }
...
func  (this *bitteam) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                var rawTicker interface{} = ccxt.GetValue(response, i)
...
func  (this *bitteam) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(bids, nil))) && ccxt.IsTrue((ccxt.IsArray(bids)))) && ccxt.IsTrue((!ccxt.IsEqual(asks, nil)))) && ccxt.IsTrue((ccxt.IsArray(asks)))) {
...
func  (this *bitteam) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ccxt.AddElementToObject(request, "pairId", ccxt.GetValue(market, "numericId"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit)
            }
...
func  (this *bitteam) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(takerOrMaker, nil)) {
        timestamp = ccxt.Precise.StringMul(timestamp, "1000")
    }
    ...
    } else if ccxt.IsTrue(ccxt.IsEqual(takerOrMaker, "taker")) {
...
func  (this *bitteam) ParseBalance(response interface{}) interface{}  {
    ...
    var rawCurrencyIds interface{} = ccxt.ObjectKeys(balanceByCurrencies)
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(rawCurrencyIds)); i++ {
        var rawCurrencyId interface{} = ccxt.GetValue(rawCurrencyIds, i)
        ...
        var currencyCode interface{} = this.SafeCurrencyCode(ccxt.ToLower(rawCurrencyId))
        ccxt.AddElementToObject(balance, currencyCode, map[string]interface{} {
    "free": free,
    "used": used,
    "total": total,
})
...
func  (this *bitteam) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes21798)
            var currency interface{} = nil
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                currency = this.Currency(code)
                ccxt.AddElementToObject(request, "currency", ccxt.GetValue(currency, "numericId"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit)
            }
...
func  (this *bitteam) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var signature interface{} = ccxt.Add("Basic ", auth64)
...
func  (this *bitteam) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(code, 200)) {
        if ccxt.IsTrue(ccxt.IsEqual(code, 404)) {
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(url, "/ccxt/order/"), 0))) && ccxt.IsTrue((ccxt.IsEqual(method, "GET")))) {
                var parts interface{} = ccxt.Split(url, "/order/")
                var orderId interface{} = this.SafeString(parts, 1)
                panic(ccxt.OrderNotFound(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " order "), orderId), " not found")))
            }
            if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(url, "/cmc/orderbook/"), 0)) {
                var parts interface{} = ccxt.Split(url, "/cmc/orderbook/")
                var symbolId interface{} = this.SafeString(parts, 1)
                panic(ccxt.BadSymbol(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " symbolId "), symbolId), " not found")))
            }
        }
