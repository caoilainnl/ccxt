 ...
 */
func (this *Cryptomus) FetchMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 */
func (this *Cryptomus) FetchCurrencies(params ...interface{}) (ccxt.Currencies, error) {
 ...
 */
func (this *Cryptomus) FetchTickers(options ...ccxt.FetchTickersOptions) (ccxt.Tickers, error) {
 ...
 */
func (this *Cryptomus) FetchOrderBook(symbol string, options ...ccxt.FetchOrderBookOptions) (ccxt.OrderBook, error) {
 ...
 */
func (this *Cryptomus) FetchTrades(symbol string, options ...ccxt.FetchTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Cryptomus) FetchBalance(params ...interface{}) (ccxt.Balances, error) {
 ...
 */
func (this *Cryptomus) CreateOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Cryptomus) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (map[string]interface{}, error) {
...
func (this *Cryptomus) FetchCanceledAndClosedOrders(options ...ccxt.FetchCanceledAndClosedOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Cryptomus) FetchOpenOrders(options ...ccxt.FetchOpenOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Cryptomus) FetchTradingFees(params ...interface{}) (ccxt.TradingFees, error) {
