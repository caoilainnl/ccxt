...
func NewGeminiWs(userConfig map[string]interface{}) GeminiWs {
   p := &geminiWs{}
   p.Init(userConfig)
   return GeminiWs{
       geminiWs: p,
...
func (this *GeminiWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *GeminiWs) WatchTradesForSymbols(symbols []string, options ...ccxt.WatchTradesForSymbolsOptions) ([]ccxt.Trade, error) {
...
func (this *GeminiWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *GeminiWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *GeminiWs) WatchOrderBookForSymbols(symbols []string, options ...ccxt.WatchOrderBookForSymbolsOptions) (ccxt.IOrderBook, error) {
...
func (this *GeminiWs) WatchBidsAsks(options ...ccxt.WatchBidsAsksOptions) (ccxt.Tickers, error) {
...
func (this *GeminiWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
