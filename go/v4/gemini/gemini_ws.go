...
type geminiWs struct {
	gemini
	base gemini
}

func NewGeminiWsCore() geminiWs {
   p := geminiWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *geminiWs) Describe() interface{}  {
 ...
 */
func  (this *geminiWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *geminiWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *geminiWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // regular v2 trade
    //
    //     {
...
func  (this *geminiWs) HandleTrade(client interface{}, message interface{})  {
    //
    //     {
    //         "type": "trade",
    //         "symbol": "BTCUSD",
...
func  (this *geminiWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "type": "l2_updates",
    //         "symbol": "BTCUSD",
...
func  (this *geminiWs) HandleTradesForMultidata(client interface{}, trades interface{}, timestamp interface{})  {
    if ccxt.IsTrue(!ccxt.IsEqual(trades, nil)) {
        var tradesLimit interface{} = this.SafeInteger(this.Options, "tradesLimit", 1000)
 ...
 */
func  (this *geminiWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *geminiWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    //     {
 ...
 */
func  (this *geminiWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *geminiWs) HandleOrderBook(client interface{}, message interface{})  {
    var changes interface{} = this.SafeValue(message, "changes", []interface{}{})
    var marketId interface{} = this.SafeStringLower(message, "symbol")
    var market interface{} = this.SafeMarket(marketId)
    var symbol interface{} = ccxt.GetValue(market, "symbol")
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *geminiWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *geminiWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *geminiWs) HandleBidsAsksForMultidata(client interface{}, rawBidAskChanges interface{}, timestamp interface{}, nonce interface{})  {
    //
    // {
    ...
    client.(ccxt.ClientInterface).Resolve(currentBidAsk, messageHash)
}
func  (this *geminiWs) HelperForWatchMultipleConstruct(itemHashName interface{}, symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(itemHashName, "orderbook")) {
                ...
                retRes53115 :=  (<-this.WatchMultiple(url, messageHashes, nil, nil, nil))
...
func  (this *geminiWs) HandleOrderBookForMultidata(client interface{}, rawOrderBookChanges interface{}, timestamp interface{}, nonce interface{})  {
    //
    // rawOrderBookChanges
    //
    // [
...
func  (this *geminiWs) HandleL2Updates(client interface{}, message interface{})  {
    //
    //     {
    //         "type": "l2_updates",
    //         "symbol": "BTCUSD",
 ...
 */
func  (this *geminiWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes6418 := (<-this.Authenticate(authParams))
...
func  (this *geminiWs) HandleHeartbeat(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "type": "heartbeat",
...
func  (this *geminiWs) HandleSubscription(client interface{}, message interface{}) interface{}  {
    //
    //     {
...
func  (this *geminiWs) HandleOrder(client interface{}, message interface{})  {
    //
    //     [
    //         {
    //             "type": "accepted",
...
func  (this *geminiWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "type": "accepted",
    //         "order_id": "134150423884",
...
func  (this *geminiWs) ParseWsOrderStatus(status interface{}) interface{}  {
...
func  (this *geminiWs) ParseWsOrderType(typeVar interface{}) interface{}  {
...
func  (this *geminiWs) HandleError(client interface{}, message interface{})  {
    panic(ccxt.ExchangeError(this.Json(message)))
}
func  (this *geminiWs) HandleMessage(client interface{}, message interface{})  {
    //
    //  public
    //     {
    //         "type": "trade",
...
func  (this *geminiWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func (this *geminiWs) Init(userConfig map[string]interface{}) {
    this.gemini.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
