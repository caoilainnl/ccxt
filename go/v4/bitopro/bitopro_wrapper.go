 ...
 */
func (this *Bitopro) CancelOrders(ids interface{}, options ...ccxt.CancelOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Bitopro) FetchWithdrawal(id string, options ...ccxt.FetchWithdrawalOptions) (ccxt.Transaction, error) {
