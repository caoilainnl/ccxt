    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "ccxt.Market not found": ccxt.BadRequest,
                "Insufficient funds": ccxt.InsufficientFunds,
                "ccxt.Order not found": ccxt.BadRequest,
            },
        },
...
func  (this *tradeogre) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                var rawMarket interface{} = ccxt.GetValue(response, i)
                var keys interface{} = ccxt.ObjectKeys(rawMarket)
                var id interface{} = this.SafeString(keys, 0)
                var keyParts interface{} = ccxt.Split(id, "-")
...
func  (this *tradeogre) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                var marketIdArray interface{} = ccxt.ObjectKeys(entry)
                var marketId interface{} = this.SafeString(marketIdArray, 0)
                var market interface{} = this.SafeMarket(marketId)
                var data interface{} = ccxt.GetValue(entry, marketId)
...
func  (this *tradeogre) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ...
                ccxt.AddElementToObject(request, "timestamp", this.ParseToInt(ccxt.Divide(until, 1000)))
...
func  (this *tradeogre) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(response, "s"))
...
func  (this *tradeogre) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(currency, nil)) {
                ...
                ccxt.AddElementToObject(singleCurrencyresult, code, account)
...
func  (this *tradeogre) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " createOrder does not support market orders")))
            }
            if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder requires a price parameter")))
            }
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
...
func  (this *tradeogre) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        headers = map[string]interface{} {
            ...
            "Referer": "CCXT",
            "authorization": ccxt.Add("Basic ", this.StringToBase64(ccxt.Add(ccxt.Add(this.ApiKey, ":"), this.Secret))),
        }
        if ccxt.IsTrue(!ccxt.IsEqual(method, "GET")) {
...
func  (this *tradeogre) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(successString, "true")) {
        return nil
    }
