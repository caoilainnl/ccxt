...
func NewBybitWsCore() bybitWs {
   p := bybitWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bybitWs) Describe() interface{}  {
...
func  (this *bybitWs) RequestId() interface{}  {
...
func  (this *bybitWs) GetUrlByMarketType(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                __tmp60674 := this.HandleMarketTypeAndParams(method, nil, params)
                typeVar = ccxt.GetValue(__tmp60674, 0)
                params = ccxt.GetValue(__tmp60674, 1)
            ...
            if ccxt.IsTrue(isPrivate) {
                ...
                if ccxt.IsTrue(isSpot) {
                    ...
                    __tmp421895 := this.HandleSubTypeAndParams(method, market, params, "linear")
                    subType = ccxt.GetValue(__tmp421895, 0)
                    params = ccxt.GetValue(__tmp421895, 1)
...
func  (this *bybitWs) CleanParams(params interface{}) interface{}  {
 ...
 */
func  (this *bybitWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes2488 := (<-this.Authenticate(url))
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes26115 :=  (<-this.Watch(url, requestId, request, requestId, true))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bybitWs) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes2938 := (<-this.Authenticate(url))
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes30615 :=  (<-this.Watch(url, requestId, request, requestId, true))
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bybitWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes3268 := (<-this.Authenticate(url))
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes34215 :=  (<-this.Watch(url, requestId, request, requestId, true))
 ...
 */
func  (this *bybitWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var topics interface{} = []interface{}{topic}
                ...
                retRes36915 :=  (<-this.WatchTopics(url, []interface{}{messageHash}, topics, params))
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bybitWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bybitWs) UnWatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(url)
                ...
                retRes43315 :=  (<-this.UnWatchTopics(url, "ticker", symbols, messageHashes, subMessageHashes, topics, params))
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bybitWs) UnWatchTicker(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(retRes4478)
                ...
                retRes44815 :=  (<-this.UnWatchTickers([]interface{}{symbols}, params))
...
func  (this *bybitWs) HandleTicker(client interface{}, message interface{})  {
    //
    // linear
    //     {
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bybitWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bybitWs) ParseWsBidAsk(orderbook interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *bybitWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bybitWs) WatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(this.NewUpdates) {
                limit = stored.(ccxt.GetsLimit).GetLimit(symbol, limit)
            }
 ...
 * @returns {object} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *bybitWs) UnWatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var subExtension interface{} = map[string]interface{} {
                ...
                retRes73415 :=  (<-this.UnWatchTopics(url, "ohlcv", symbols, messageHashes, subMessageHashes, rawHashes, params, subExtension))
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *bybitWs) UnWatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.AddElementToObject(params, "callerMethodName", "watchOHLCV")
                ...
                retRes75015 :=  (<-this.UnWatchOHLCVForSymbols([]interface{}{[]interface{}{symbol, timeframe}}, params))
...
func  (this *bybitWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    ...
    var marketId interface{} = this.SafeString(topicParts, ccxt.Subtract(topicLength, 1))
    var isSpot interface{} = ccxt.IsGreaterThan(ccxt.GetIndexOf(client.(*ccxt.Client).Url, "spot"), ccxt.OpNeg(1))
...
func  (this *bybitWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "start": 1670363160000,
    //         "end": 1670363219999,
 ...
 */
func  (this *bybitWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes84315 :=  (<-this.WatchOrderBookForSymbols([]interface{}{symbol}, limit, params))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *bybitWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                ...
                if !ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                    if ccxt.IsTrue(ccxt.GetValue(market, "option")) {
                        if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(limit, 25))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 100)))) {
                            panic(ccxt.BadRequest(ccxt.Add(this.Id, " watchOrderBookForSymbols() can only use limit 25 and 100 for option markets.")))
                        }
                    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(limit, 1))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 50)))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 200)))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 500)))) {
                        panic(ccxt.BadRequest(ccxt.Add(this.Id, " watchOrderBookForSymbols() can only use limit 1, 50, 200 and 500 for swap and future markets.")))
                    }
                } else {
                    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(limit, 1))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 50)))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 200)))) {
                        panic(ccxt.BadRequest(ccxt.Add(this.Id, " watchOrderBookForSymbols() can only use limit 1,50, and 200 for spot markets.")))
                    }
                }
            }
            var topics interface{} = []interface{}{}
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *bybitWs) UnWatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(url)
                ...
                retRes93615 :=  (<-this.UnWatchTopics(url, "orderbook", symbols, messageHashes, subMessageHashes, topics, params))
                ccxt.PanicOnError(retRes93615)
                ch <- retRes93615
                return nil
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *bybitWs) UnWatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(retRes9508)
                ...
                retRes95115 :=  (<-this.UnWatchOrderBookForSymbols([]interface{}{symbol}, params))
...
func  (this *bybitWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    ...
    var isSpot interface{} = ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(client.(*ccxt.Client).Url, "spot"), 0)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(limit, "1")) {
        var bidask interface{} = this.ParseWsBidAsk(ccxt.GetValue(this.Orderbooks, symbol), market)
...
func  (this *bybitWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, 0, 1)
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *bybitWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *bybitWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes104915 :=  (<-this.WatchTradesForSymbols([]interface{}{symbol}, since, limit, params))
 ...
 */
func  (this *bybitWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bybitWs) UnWatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
                ...
                retRes111615 :=  (<-this.UnWatchTopics(url, "trades", symbols, messageHashes, subMessageHashes, topics, params))
 ...
 * @returns {any} status of the unwatch request
 */
func  (this *bybitWs) UnWatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(retRes11298)
                ...
                retRes113015 :=  (<-this.UnWatchTradesForSymbols([]interface{}{symbol}, params))
...
func  (this *bybitWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *bybitWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // public
    //    {
    //         "T": 1672304486865,
...
func  (this *bybitWs) GetPrivateType(url interface{}) interface{}  {
 ...
 */
func  (this *bybitWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes12788 := (<-this.Authenticate(url))
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bybitWs) UnWatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes13118 := (<-this.Authenticate(url))
            ...
            var topic interface{} = this.SafeValue(topicByMarket, this.GetPrivateType(url))
                ...
                retRes131815 :=  (<-this.UnWatchTopics(url, "myTrades", []interface{}{}, []interface{}{messageHash}, []interface{}{subHash}, []interface{}{topic}, params))
...
func  (this *bybitWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    // spot
    //    {
    //        "type": "snapshot",
 ...
 */
func  (this *bybitWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes14478 := (<-this.Authenticate(url))
...
func  (this *bybitWs) SetPositionsCache(client interface{}, optionalArgs ...interface{})  {
    symbols := ccxt.GetArg(optionalArgs, 0, nil)
    _ = symbols
...
func  (this *bybitWs) LoadPositionsSnapshot(client interface{}, messageHash interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bybitWs) HandlePositions(client interface{}, message interface{})  {
    //
    //    {
    //        topic: 'position',
 ...
 */
func  (this *bybitWs) WatchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp145188 := this.HandleOptionAndParams(params, "watchLiquidations", "method", "liquidation")
            method = ccxt.GetValue(__tmp145188, 0)
            params = ccxt.GetValue(__tmp145188, 1)
...
func  (this *bybitWs) HandleLiquidation(client interface{}, message interface{})  {
    //
    //     {
    //         "data": {
    //             "price": "0.03803",
...
func  (this *bybitWs) ParseWsLiquidation(liquidation interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "price": "0.03803",
    //         "side": "Buy",
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bybitWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes17318 := (<-this.Authenticate(url))
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bybitWs) UnWatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes17648 := (<-this.Authenticate(url))
            ...
            var topics interface{} = this.SafeValue(topicsByMarket, this.GetPrivateType(url))
                ...
                retRes177115 :=  (<-this.UnWatchTopics(url, "orders", []interface{}{}, []interface{}{messageHash}, []interface{}{subHash}, topics, params))
                ccxt.PanicOnError(retRes177115)
                ch <- retRes177115
                return nil
...
func  (this *bybitWs) HandleOrderWs(client interface{}, message interface{})  {
    //
    //    {
    //        "reqId":"1",
    //        "retCode":0,
...
func  (this *bybitWs) HandleOrder(client interface{}, message interface{})  {
    //
    //     spot
    //     {
    //         "type": "snapshot",
 ...
 */
func  (this *bybitWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp950455 := this.HandleMarketTypeAndParams("watchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp950455, 0)
            params = ccxt.GetValue(__tmp950455, 1)
            var subType interface{} = nil
            __tmp828348 := this.HandleSubTypeAndParams("watchBalance", nil, params)
            subType = ccxt.GetValue(__tmp828348, 0)
            params = ccxt.GetValue(__tmp828348, 1)
            ...
            retRes19388 := (<-this.Authenticate(url))
            ...
            var topics interface{} = []interface{}{this.SafeValue(topicByMarket, this.GetPrivateType(url))}
                ...
                retRes197215 :=  (<-this.WatchTopics(url, []interface{}{messageHash}, topics, params))
...
func  (this *bybitWs) HandleBalance(client interface{}, message interface{})  {
    //
    // spot
    //    {
    //        "type": "snapshot",
...
func  (this *bybitWs) ParseWsBalance(balance interface{}, optionalArgs ...interface{})  {
    //
    // spot
    //    {
    //        "a": "USDT",
...
func  (this *bybitWs) WatchTopics(url interface{}, messageHashes interface{}, topics interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes221815 :=  (<-this.WatchMultiple(url, messageHashes, message, messageHashes, nil))
                ccxt.PanicOnError(retRes221815)
                ch <- retRes221815
                return nil
...
func  (this *bybitWs) UnWatchTopics(url interface{}, topic interface{}, symbols interface{}, messageHashes interface{}, subMessageHashes interface{}, topics interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes223615 :=  (<-this.WatchMultiple(url, messageHashes, message, messageHashes, this.Extend(subscription, subExtension)))
                ccxt.PanicOnError(retRes223615)
                ch <- retRes223615
                return nil
...
func  (this *bybitWs) Authenticate(url interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes226015 :=  <-future.(<-chan interface{})
                ccxt.PanicOnError(retRes226015)
                ch <- retRes226015
                return nil
...
func  (this *bybitWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //   {
    //       "success": false,
    ...
    {		ret__ := func(this *bybitWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *bybitWs) interface{} {
    					// catch block:
...
func  (this *bybitWs) HandleMessage(client interface{}, message interface{})  {
    if ccxt.IsTrue(this.HandleErrorMessage(client, message)) {
        return
    }
    // contract pong
    var ret_msg interface{} = this.SafeString(message, "ret_msg")
    if ccxt.IsTrue(ccxt.IsEqual(ret_msg, "pong")) {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(event, "sub")) {
...
func  (this *bybitWs) Ping(client interface{}) interface{}  {
    return map[string]interface{} {
        "req_id": this.RequestId(),
        "op": "ping",
    }
}
func  (this *bybitWs) HandlePong(client interface{}, message interface{}) interface{}  {
    //
    //   {
    //       "success": true,
    //       "ret_msg": "pong",
    ...
    //   { pong: 1653296711335 }
    //
    client.(*ccxt.Client).LastPong = this.SafeInteger(message, "pong")
    return message
}
func  (this *bybitWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "success": true,
    //        "ret_msg": '',
    ...
    if ccxt.IsTrue(ccxt.IsTrue(success) || ccxt.IsTrue(ccxt.IsEqual(code, 0))) {
        ...
        err := ccxt.AuthenticationError(ccxt.Add(ccxt.Add(this.Id, " "), this.Json(message)))
...
func  (this *bybitWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "topic": "kline",
    //        "event": "sub",
...
func  (this *bybitWs) HandleUnSubscribe(client interface{}, message interface{}) interface{}  {
    //
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
        ...
        if ccxt.IsTrue(ccxt.StartsWith(messageHash, "unsubscribe")) {
            ...
            for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(messageHashes)); j++ {
                ...
                var usePrefix interface{} = ccxt.IsTrue((ccxt.IsEqual(subHash, "orders"))) || ccxt.IsTrue((ccxt.IsEqual(subHash, "myTrades")))
...
func (this *bybitWs) Init(userConfig map[string]interface{}) {
