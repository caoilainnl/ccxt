...
type hashkeyWs struct {
	hashkey
	base hashkey
}

func NewHashkeyWsCore() hashkeyWs {
   p := hashkeyWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *hashkeyWs) Describe() interface{}  {
...
func  (this *hashkeyWs) WathPublic(market interface{}, topic interface{}, messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *hashkeyWs) WatchPrivate(messageHash interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) GetPrivateUrl(listenKey interface{}) interface{}  {
 ...
 */
func  (this *hashkeyWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "symbol": "DOGEUSDT",
    //         "symbolName": "DOGEUSDT",
...
func  (this *hashkeyWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "t": 1722861660000,
    //         "s": "DOGEUSDT",
 ...
 */
func  (this *hashkeyWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "symbol": "ETHUSDT",
    //         "symbolName": "ETHUSDT",
 ...
 */
func  (this *hashkeyWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "symbol": "ETHUSDT",
    //         "symbolName": "ETHUSDT",
 ...
 */
func  (this *hashkeyWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "symbol": "ETHUSDT",
    //         "symbolName": "ETHUSDT",
 ...
 */
func  (this *hashkeyWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleOrder(client interface{}, message interface{})  {
    //
    // swap
    //     {
...
func  (this *hashkeyWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    ...
    __tmp803966 := this.ParseOrderSideAndReduceOnly(side)
    side = ccxt.GetValue(__tmp803966, 0)
    reduceOnly = ccxt.GetValue(__tmp803966, 1)
    var typeVar interface{} = this.ParseOrderType(this.SafeString(order, "o"))
    var timeInForce interface{} = this.SafeString(order, "f")
    var postOnly interface{} = nil
    __tmp879932 := this.ParseOrderTypeTimeInForceAndPostOnly(typeVar, timeInForce)
    typeVar = ccxt.GetValue(__tmp879932, 0)
    timeInForce = ccxt.GetValue(__tmp879932, 1)
    postOnly = ccxt.GetValue(__tmp879932, 2)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
 */
func  (this *hashkeyWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleMyTrade(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    //     {
    //         "e": "ticketInfo",
    //         "E": "1723037391156",
...
func  (this *hashkeyWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // watchTrades
    //     {
    //         "v": "1745922896272048129",
 ...
 */
func  (this *hashkeyWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            positions:= (<-this.WatchMultiple(url, messageHashes, nil, messageHashes, nil))
...
func  (this *hashkeyWs) HandlePosition(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *hashkeyWs) ParseWsPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
 ...
 */
func  (this *hashkeyWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp513483 := this.HandleMarketTypeAndParams("watchBalance", nil, params, typeVar)
            typeVar = ccxt.GetValue(__tmp513483, 0)
            params = ccxt.GetValue(__tmp513483, 1)
            ...
            __tmp423665 := this.HandleOptionAndParams(this.Options, "watchBalance", "fetchBalanceSnapshot", true)
            fetchBalanceSnapshot = ccxt.GetValue(__tmp423665, 0)
            params = ccxt.GetValue(__tmp423665, 1)
            __tmp890554 := this.HandleOptionAndParams(this.Options, "watchBalance", "awaitBalanceSnapshot", false)
            awaitBalanceSnapshot = ccxt.GetValue(__tmp890554, 0)
            params = ccxt.GetValue(__tmp890554, 1)
...
func  (this *hashkeyWs) SetBalanceCache(client interface{}, typeVar interface{}, subscribeHash interface{})  {
...
func  (this *hashkeyWs) LoadBalanceSnapshot(client interface{}, messageHash interface{}, typeVar interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *hashkeyWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hashkeyWs) KeepAliveListenKey(listenKey interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *hashkeyWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *hashkeyWs) interface{} {
            					// catch block:
                                        var url interface{} = this.GetPrivateUrl(listenKey)
                    var client interface{} = this.Client(url)
...
func  (this *hashkeyWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *hashkeyWs) Init(userConfig map[string]interface{}) {
    this.hashkey.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
