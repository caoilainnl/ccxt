...
func NewHashkeyWs(userConfig map[string]interface{}) HashkeyWs {
   p := &hashkeyWs{}
   p.Init(userConfig)
   return HashkeyWs{
       hashkeyWs: p,
...
func (this *HashkeyWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *HashkeyWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *HashkeyWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *HashkeyWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *HashkeyWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *HashkeyWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *HashkeyWs) WatchPositions(options ...ccxt.WatchPositionsOptions) ([]ccxt.Position, error) {
...
func (this *HashkeyWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
