 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Woofipro) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (map[string]interface{}, error) {
 ...
 * @returns {object} an list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Woofipro) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) ([]map[string]interface{}, error) {
 ...
 */
func (this *Woofipro) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
