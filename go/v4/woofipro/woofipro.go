...
func  (this *woofipro) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            tokenResponsechainResponseVariable := (<-ccxt.PromiseAll([]interface{}{tokenPromise, chainPromise}));
            tokenResponse := ccxt.GetValue(tokenResponsechainResponseVariable,0);
            chainResponse := ccxt.GetValue(tokenResponsechainResponseVariable,1)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp708033 := this.HandleOptionAndParams(params, "fetchFundingRateHistory", "paginate")
            paginate = ccxt.GetValue(__tmp708033, 0)
            params = ccxt.GetValue(__tmp708033, 1)
            if ccxt.IsTrue(paginate) {
                    ...
                    ccxt.PanicOnError(retRes100919)
                    ch <- retRes100919
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            __tmp966970 := this.HandleUntilOption("end_t", request, params, 0.001)
            request = ccxt.GetValue(__tmp966970, 0)
            params = ccxt.GetValue(__tmp966970, 1)
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp828860 := this.HandleOptionAndParams(params, "fetchOrders", "paginate")
            paginate = ccxt.GetValue(__tmp828860, 0)
            params = ccxt.GetValue(__tmp828860, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes194019 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    ccxt.PanicOnError(retRes194019)
                    ch <- retRes194019
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            __tmp270959 := this.HandleUntilOption("end_t", request, params)
            request = ccxt.GetValue(__tmp270959, 0)
            params = ccxt.GetValue(__tmp270959, 1)
            var response interface{} = nil
            if ccxt.IsTrue(isTrigger) {
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes202615)
                ch <- retRes202615
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes204915)
                ch <- retRes204915
                return nil
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes21148)
            var paginate interface{} = false
            __tmp971054 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp971054, 0)
            params = ccxt.GetValue(__tmp971054, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes211819 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    ccxt.PanicOnError(retRes211819)
                    ch <- retRes211819
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            __tmp91668 := this.HandleUntilOption("end_t", request, params)
            request = ccxt.GetValue(__tmp91668, 0)
            params = ccxt.GetValue(__tmp91668, 1)
...
func  (this *woofipro) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
        ...
        ccxt.AddElementToObject(account, "frozen", this.SafeString(balance, "frozen"))
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes237715)
                ch <- retRes237715
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes239515)
                ch <- retRes239515
                return nil
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes26068)
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsLessThan(leverage, 1))) || ccxt.IsTrue((ccxt.IsGreaterThan(leverage, 50)))) {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes261315)
                ch <- retRes261315
                return nil
...
func  (this *woofipro) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(access, "public")) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(method, "POST")) || ccxt.IsTrue(ccxt.IsEqual(method, "PUT")))) && ccxt.IsTrue((ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(path, "algo/order")) || ccxt.IsTrue(ccxt.IsEqual(path, "order"))) || ccxt.IsTrue(ccxt.IsEqual(path, "batch-order"))))) {
