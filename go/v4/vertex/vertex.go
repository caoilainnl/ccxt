...
func  (this *vertex) ConvertToX18(num interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsString(num)) {
        return ccxt.Precise.StringMul(num, "1000000000000000000")
    }
    var numStr interface{} = this.NumberToString(num)
    return ccxt.Precise.StringMul(numStr, "1000000000000000000")
}
func  (this *vertex) ConvertFromX18(num interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsString(num)) {
        return ccxt.Precise.StringDiv(num, "1000000000000000000")
    }
    var numStr interface{} = this.NumberToString(num)
    return ccxt.Precise.StringDiv(numStr, "1000000000000000000")
}
/**
 * @method
...
func  (this *vertex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(tickerId, nil))) && ccxt.IsTrue((ccxt.IsGreaterThan(ccxt.GetIndexOf(tickerId, "PERP"), 0)))) {
                    continue
                }
...
func  (this *vertex) ParseMarket(market interface{}) interface{}  {
    ...
    var contract interface{} =     !ccxt.IsTrue(spot)
    var swap interface{} =     !ccxt.IsTrue(spot)
    if ccxt.IsTrue(swap) {
        var splitSymbol interface{} = ccxt.Split(base, "-")
        symbol = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.GetValue(splitSymbol, 0), "/"), quote), ":"), settle)
    }
    ...
    var isInverse interface{} = ccxt.Ternary(ccxt.IsTrue((spot)), nil, false)
    var isLinear interface{} = ccxt.Ternary(ccxt.IsTrue((spot)), nil, true)
    var contractSize interface{} = ccxt.Ternary(ccxt.IsTrue((spot)), nil, this.ParseNumber("1"))
    return map[string]interface{} {
        "id": this.SafeString(market, "product_id"),
        "symbol": symbol,
        "base": base,
        "quote": quote,
        "settle": ccxt.Ternary(ccxt.IsTrue((spot)), nil, settle),
        "baseId": baseId,
        "quoteId": quoteId,
        "settleId": ccxt.Ternary(ccxt.IsTrue((spot)), nil, settleId),
...
func  (this *vertex) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(timestamp, nil)) {
        ...
        if ccxt.IsTrue(ccxt.InOp(baseBalance, "perp")) {
        ...
        var splitTickerId interface{} = ccxt.Split(tickerId, "_")
        var splitSymbol interface{} = ccxt.Split(ccxt.GetValue(splitTickerId, 0), "-")
        var marketId interface{} = ccxt.Add(ccxt.GetValue(splitSymbol, 0), ccxt.GetValue(splitTickerId, 1))
...
func  (this *vertex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketId interface{} = ccxt.Add(ccxt.GetValue(market, "baseId"), "_USDC")
            var request interface{} = map[string]interface{} {
                "ticker_id": marketId,
            }
...
func  (this *vertex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes8648)
            var userAddress interface{} = nil
            __tmp307195 := this.HandlePublicAddress("fetchMyTrades", params)
            userAddress = ccxt.GetValue(__tmp307195, 0)
            params = ccxt.GetValue(__tmp307195, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                ccxt.AddElementToObject(matchesRequest, "product_ids", []interface{}{this.ParseToNumeric(ccxt.GetValue(market, "id"))})
            }
            var until interface{} = this.SafeInteger(params, "until")
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                params = this.Omit(params, "until")
                ccxt.AddElementToObject(matchesRequest, "max_time", until)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(matchesRequest, "limit", limit)
            }
            var request interface{} = map[string]interface{} {
...
func  (this *vertex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var userAddress interface{} = nil
            __tmp371483 := this.HandlePublicAddress("fetchTradingFees", params)
            userAddress = ccxt.GetValue(__tmp371483, 0)
            params = ccxt.GetValue(__tmp371483, 1)
            var request interface{} = map[string]interface{} {
                "type": "fee_rates",
            ...
            var result interface{} = map[string]interface{} {}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(taker)); i++ {
                var market interface{} = this.SafeMarket(this.NumberToString(i))
                if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(market, "id"), nil)) {
                    continue
                }
                var symbol interface{} = ccxt.GetValue(market, "symbol")
            ...
            "info": response,
            "symbol": symbol,
            "maker": this.ParseNumber(this.ConvertFromX18(ccxt.GetValue(maker, i))),
            "taker": this.ParseNumber(this.ConvertFromX18(ccxt.GetValue(taker, i))),
            "percentage": true,
            "tierBased": false,
        })
            }
...
func  (this *vertex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var ohlcvRequest interface{} = map[string]interface{} {
                "product_id": this.ParseToInt(ccxt.GetValue(market, "id")),
                "granularity": this.SafeInteger(this.Timeframes, timeframe),
            }
            var until interface{} = this.SafeInteger(params, "until")
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                params = this.Omit(params, "until")
                ccxt.AddElementToObject(ohlcvRequest, "max_time", until)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(ohlcvRequest, "limit", ccxt.MathMin(limit, 1000))
            }
            var request interface{} = map[string]interface{} {
...
func  (this *vertex) ParseFundingRate(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(fundingRate, nil)) {
...
func  (this *vertex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                var tickerId interface{} = ccxt.GetValue(keys, i)
                var parsedTickerId interface{} = ccxt.Split(tickerId, "-")
                var data interface{} = ccxt.GetValue(response, tickerId)
                var marketId interface{} = ccxt.Add(ccxt.GetValue(parsedTickerId, 0), "/USDC:USDC")
                var market interface{} = this.Market(marketId)
                var ticker interface{} = this.ParseFundingRate(data, market)
                var symbol interface{} = ccxt.GetValue(ticker, "symbol")
                ccxt.AddElementToObject(fundingRates, symbol, ticker)
            }
...
func  (this *vertex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) {
                symbols = []interface{}{}
                for y := 0; ccxt.IsLessThan(y, ccxt.GetArrayLength(markets)); y++ {
                    var tickerId interface{} = ccxt.GetValue(markets, y)
                    var parsedTickerId interface{} = ccxt.Split(tickerId, "-")
                    var currentSymbol interface{} = ccxt.Add(ccxt.GetValue(parsedTickerId, 0), "/USDC:USDC")
                    if !ccxt.IsTrue(this.InArray(currentSymbol, symbols)) {
                        ccxt.AppendToArray(&symbols, currentSymbol)
                    }
                }
            }
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(symbols)); j++ {
                    var market interface{} = this.Market(ccxt.GetValue(symbols, j))
                    var tickerId interface{} = ccxt.Add(ccxt.GetValue(market, "base"), "_USDC")
                    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(marketInner, "marketId"), tickerId)) {
                        ccxt.AppendToArray(&parsedSymbols, ccxt.GetValue(market, "symbol"))
                        ccxt.AppendToArray(&results, this.ParseOpenInterest(openInterest, market))
                    }
                }
            }
...
func  (this *vertex) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var marketId interface{} = ccxt.Add(ccxt.Add(base, "/"), quote)
    if ccxt.IsTrue(ccxt.IsGreaterThan(ccxt.GetIndexOf(base, "PERP"), 0)) {
        marketId = ccxt.Add(ccxt.Replace(marketId, "-PERP", ""), ":USDC")
    }
    market = this.SafeMarket(marketId, market)
...
func  (this *vertex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            // }
            //
            var tickers interface{} = ccxt.ObjectValues(response)
...
func  (this *vertex) QueryContracts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(cachedContracts, nil)) {
            ...
            ccxt.PanicOnError(response)
            var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
            ccxt.AddElementToObject(this.Options, "v1contracts", data)
...
func  (this *vertex) BuildSig(chainId interface{}, messageTypes interface{}, message interface{}, optionalArgs ...interface{}) interface{}  {
    verifyingContractAddress := ccxt.GetArg(optionalArgs, 0, "")
...
func  (this *vertex) ConvertAddressToSender(address interface{}) interface{}  {
    var sender interface{} = ccxt.Add(address, "64656661756c74")
    return ccxt.PadEnd(sender, 66, "0")
}
func  (this *vertex) GetNonce(now interface{}, expiration interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsEqual(now, nil)) {
        now = this.Nonce()
    }
    // nonce = ((now + expiration) << 20) + 1000
    // 1 << 20 = 1048576
    return ccxt.Precise.StringAdd(ccxt.Precise.StringMul(ccxt.Precise.StringAdd(this.NumberToString(now), this.NumberToString(expiration)), "1048576"), "1000")
}
func  (this *vertex) GetExpiration(now interface{}, timeInForce interface{}, postOnly interface{}, reduceOnly interface{}) interface{}  {
    var expiration interface{} = ccxt.Precise.StringAdd(this.NumberToString(now), "86400")
    if ccxt.IsTrue(ccxt.IsEqual(timeInForce, "ioc")) {
        // 1 << 62 = 4611686018427387904
        expiration = ccxt.Precise.StringOr(expiration, "4611686018427387904")
    } else if ccxt.IsTrue(ccxt.IsEqual(timeInForce, "fok")) {
        // 2 << 62 = 9223372036854775808
        expiration = ccxt.Precise.StringOr(expiration, "9223372036854775808")
    } else if ccxt.IsTrue(postOnly) {
        // 3 << 62 = 13835058055282163712
        expiration = ccxt.Precise.StringOr(expiration, "13835058055282163712")
    }
    if ccxt.IsTrue(reduceOnly) {
        // 1 << 61 = 2305843009213693952
        expiration = ccxt.Precise.StringOr(expiration, "2305843009213693952")
    }
    return expiration
}
func  (this *vertex) GetAmount(amount interface{}, side interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(side, "sell")) {
        ...
        if ccxt.IsTrue(ccxt.IsLessThan(amount, 0)) {
            // amount *= -1;
            amountString = ccxt.Precise.StringMul(amountString, "-1")
        }
    }
...
func  (this *vertex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketType interface{} = ccxt.ToLower(typeVar)
            var isMarketOrder interface{} = ccxt.IsEqual(marketType, "market")
            if ccxt.IsTrue(ccxt.IsTrue(isMarketOrder) && ccxt.IsTrue(ccxt.IsEqual(price, nil))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() requires a price argument for market order")))
            }
        
            retRes18198 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes18198)
            var market interface{} = this.Market(symbol)
            var marketId interface{} = this.ParseToInt(ccxt.GetValue(market, "id"))
            ...
            var defaultTimeInForce interface{} = ccxt.Ternary(ccxt.IsTrue((isMarketOrder)), "fok", nil)
            ...
            if ccxt.IsTrue(ccxt.IsTrue(postOnly) && ccxt.IsTrue(reduceOnly)) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " reduceOnly not supported when postOnly is enabled")))
            }
            var expiration interface{} = this.GetExpiration(now, timeInForce, postOnly, reduceOnly)
            if ccxt.IsTrue(isTrigger) {
                // 1 << 63 = 9223372036854775808
                nonce = ccxt.Precise.StringOr(nonce, "9223372036854775808")
            }
            ...
            var request interface{} = map[string]interface{} {
                "place_order": map[string]interface{} {
                    ...
                    "order": map[string]interface{} {
                        "sender": ccxt.GetValue(order, "sender"),
                        "priceX18": ccxt.GetValue(order, "priceX18"),
                        "amount": ccxt.GetValue(order, "amount"),
                        "expiration": this.NumberToString(ccxt.GetValue(order, "expiration")),
                        "nonce": ccxt.GetValue(order, "nonce"),
                    },
            ...
            if ccxt.IsTrue(isTrigger) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(stopLossPrice, nil)) {
                    ccxt.AddElementToObject(trigger, "last_price_below", this.ConvertToX18(stopLossPrice))
                } else if ccxt.IsTrue(!ccxt.IsEqual(takeProfitPrice, nil)) {
                    ccxt.AddElementToObject(trigger, "last_price_above", this.ConvertToX18(takeProfitPrice))
                }
                ccxt.AddElementToObject(ccxt.GetValue(request, "place_order"), "trigger", trigger)
...
func  (this *vertex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var isMarketOrder interface{} = ccxt.IsEqual(marketType, "market")
            if ccxt.IsTrue(ccxt.IsTrue(isMarketOrder) && ccxt.IsTrue(ccxt.IsEqual(price, nil))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " editOrder() requires a price argument for market order")))
            }
            ...
            if ccxt.IsTrue(isTrigger) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " editOrder() not supported for trigger order")))
            }
            var expiration interface{} = this.GetExpiration(now, timeInForce, postOnly, reduceOnly)
            var amountString interface{} = this.GetAmount(amount, side)
            var order interface{} = map[string]interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "cancel_and_place": map[string]interface{} {
                    "cancel_tx": map[string]interface{} {
                        "sender": ccxt.GetValue(cancels, "sender"),
                        "productIds": ccxt.GetValue(cancels, "productIds"),
                        "digests": ccxt.GetValue(cancels, "digests"),
                        "nonce": this.NumberToString(ccxt.GetValue(cancels, "nonce")),
                    },
...
func  (this *vertex) ParseOrderStatus(status interface{}) interface{}  {
    if ccxt.IsTrue(!ccxt.IsEqual(status, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsString(status)) {
            return this.SafeString(statuses, status, status)
        }
        var statusCancelled interface{} = this.SafeDict(status, "cancelled")
        if ccxt.IsTrue(!ccxt.IsEqual(statusCancelled, nil)) {
            return "canceled"
        }
        ...
        if ccxt.IsTrue(ccxt.IsEqual(triggeredStatus, "success")) {
            return "closed"
        }
        return "canceled"
    }
...
func  (this *vertex) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var side interface{} = nil
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(amountNum, nil)) && ccxt.IsTrue(!ccxt.IsEqual(remainingNum, nil))) {
        side = ccxt.Ternary(ccxt.IsTrue((ccxt.IsTrue(ccxt.IsLessThan(amountNum, 0)) || ccxt.IsTrue(ccxt.IsLessThan(remainingNum, 0)))), "sell", "buy")
    }
    var tif interface{} = this.ParseTimeInForce(this.SafeString(order, "order_type"))
    var isPostOnly interface{} =     (ccxt.IsEqual(tif, "PO"))
...
func  (this *vertex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes21938)
            var userAddress interface{} = nil
            __tmp436572 := this.HandlePublicAddress("fetchOpenOrders", params)
            userAddress = ccxt.GetValue(__tmp436572, 0)
            params = ccxt.GetValue(__tmp436572, 1)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ccxt.AddElementToObject(request, "product_id", this.ParseToNumeric(ccxt.GetValue(market, "id")))
            }
            var response interface{} = nil
            if ccxt.IsTrue(trigger) {
                ...
                var tx interface{} = map[string]interface{} {
                    "sender": this.ConvertAddressToSender(userAddress),
                    "recvTime": ccxt.Add(this.Nonce(), 90000),
                }
                ccxt.AddElementToObject(request, "signature", this.BuildListTriggerTxSig(tx, chainId, verifyingContractAddress))
                ccxt.AddElementToObject(request, "tx", map[string]interface{} {
            "sender": ccxt.GetValue(tx, "sender"),
            "recvTime": this.NumberToString(ccxt.GetValue(tx, "recvTime")),
        })
                ccxt.AddElementToObject(request, "type", "list_trigger_orders")
                ccxt.AddElementToObject(request, "pending", true)
                var until interface{} = this.SafeInteger(params, "until")
                params = this.Omit(params, "until")
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ccxt.AddElementToObject(request, "max_update_time", until)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "limit", limit)
                }
                ...
                ccxt.AddElementToObject(request, "type", "subaccount_orders")
                ccxt.AddElementToObject(request, "sender", this.ConvertAddressToSender(userAddress))
...
func  (this *vertex) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"stop", "trigger"})
            if !ccxt.IsTrue(trigger) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOrders only support trigger orders")))
            }
            var userAddress interface{} = nil
            __tmp628382 := this.HandlePublicAddress("fetchOrders", params)
            userAddress = ccxt.GetValue(__tmp628382, 0)
            params = ccxt.GetValue(__tmp628382, 1)
        
            retRes23178 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes23178)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *vertex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes247815)
                ch <- retRes247815
                return nil
...
func  (this *vertex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var userAddress interface{} = nil
            __tmp162173 := this.HandlePublicAddress("fetchBalance", params)
            userAddress = ccxt.GetValue(__tmp162173, 0)
            params = ccxt.GetValue(__tmp162173, 1)
            var request interface{} = map[string]interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
                ...
                var isUsdcMarketId interface{} = ccxt.IsEqual(marketId, "0")
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(market, "id"), nil)) && !ccxt.IsTrue(isUsdcMarketId)) {
                    continue
                }
                var baseId interface{} = ccxt.Ternary(ccxt.IsTrue((isUsdcMarketId)), "USDC", this.SafeString(market, "baseId"))
...
func  (this *vertex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var userAddress interface{} = nil
            __tmp870705 := this.HandlePublicAddress("fetchPositions", params)
            userAddress = ccxt.GetValue(__tmp870705, 0)
            params = ccxt.GetValue(__tmp870705, 1)
            var request interface{} = map[string]interface{} {
                "type": "subaccount_info",
                "subaccount": this.ConvertAddressToSender(userAddress),
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(positions)); i++ {
                var position interface{} = this.Extend(this.ParsePosition(ccxt.GetValue(positions, i), nil), params)
                if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(position, "contractSize"), 0)) {
                    continue
                }
...
func  (this *vertex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "withdraw_collateral": map[string]interface{} {
                    "tx": map[string]interface{} {
                        "sender": ccxt.GetValue(withdraw, "sender"),
                        "productId": ccxt.GetValue(withdraw, "productId"),
                        "amount": ccxt.GetValue(withdraw, "amount"),
                        "nonce": this.NumberToString(ccxt.GetValue(withdraw, "nonce")),
                    },
...
func  (this *vertex) HandlePublicAddress(methodName interface{}, params interface{}) interface{}  {
    ...
    __tmp709029 := this.HandleOptionAndParams(params, methodName, "user")
    userAux = ccxt.GetValue(__tmp709029, 0)
    params = ccxt.GetValue(__tmp709029, 1)
    var user interface{} = userAux
    __tmp397423 := this.HandleOptionAndParams(params, methodName, "address", userAux)
    user = ccxt.GetValue(__tmp397423, 0)
    params = ccxt.GetValue(__tmp397423, 1)
...
func  (this *vertex) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(status, "failure")) {
...
func  (this *vertex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var url interface{} = this.ImplodeHostname(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), version), typeVar))
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(version, "v1")) || ccxt.IsTrue(!ccxt.IsEqual(typeVar, "archive"))) {
        url = ccxt.Add(ccxt.Add(url, "/"), path)
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(path, "execute")) {
        // required encoding for public methods
        if ccxt.IsTrue(!ccxt.IsEqual(headers, nil)) {
            ccxt.AddElementToObject(headers, "Accept-Encoding", "gzip")
        } else {
            headers = map[string]interface{} {
