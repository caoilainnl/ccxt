...
type deriveWs struct {
	derive
	base derive
}

func NewDeriveWsCore() deriveWs {
   p := deriveWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *deriveWs) Describe() interface{}  {
...
func  (this *deriveWs) RequestId(url interface{}) interface{}  {
...
func  (this *deriveWs) WatchPublic(messageHash interface{}, message interface{}, subscription interface{}) <- chan interface{} {
 ...
 */
func  (this *deriveWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deriveWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // {
    //     method: 'subscription',
    //     params: {
 ...
 */
func  (this *deriveWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deriveWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    // {
    //     method: 'subscription',
    //     params: {
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *deriveWs) UnWatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *deriveWs) UnWatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deriveWs) UnWatchPublic(messageHash interface{}, message interface{}, subscription interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deriveWs) HandleOrderBookUnSubscription(client interface{}, topic interface{})  {
    ...
    client.(ccxt.ClientInterface).Reject(err, topic)
    client.(ccxt.ClientInterface).Resolve(err, ccxt.Add("unwatch", topic))
}
func  (this *deriveWs) HandleTradesUnSubscription(client interface{}, topic interface{})  {
    var parsedTopic interface{} = ccxt.Split(topic, ".")
    var marketId interface{} = this.SafeString(parsedTopic, 1)
    var market interface{} = this.SafeMarket(marketId)
    var symbol interface{} = ccxt.GetValue(market, "symbol")
...
func  (this *deriveWs) HandleUnSubscribe(client interface{}, message interface{}) interface{}  {
    //
    // {
    //     id: 1,
    //     result: {
 ...
 */
func  (this *deriveWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deriveWs) HandleTrade(client interface{}, message interface{})  {
    //
    //
    var params interface{} = this.SafeDict(message, "params")
    var data interface{} = this.SafeDict(params, "data")
...
func  (this *deriveWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes46315 :=  <-future.(<-chan interface{})
...
func  (this *deriveWs) WatchPrivate(messageHash interface{}, message interface{}, subscription interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *deriveWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp597432 := this.HandleDeriveSubaccountId("watchOrders", params)
            subaccountId = ccxt.GetValue(__tmp597432, 0)
            params = ccxt.GetValue(__tmp597432, 1)
...
func  (this *deriveWs) HandleOrder(client interface{}, message interface{})  {
    //
    // {
    //     method: 'subscription',
    //     params: {
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
 */
func  (this *deriveWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var subaccountId interface{} = nil
            __tmp158073 := this.HandleDeriveSubaccountId("watchMyTrades", params)
            subaccountId = ccxt.GetValue(__tmp158073, 0)
            params = ccxt.GetValue(__tmp158073, 1)
...
func  (this *deriveWs) HandleMyTrade(client interface{}, message interface{})  {
    //
    //
...
func  (this *deriveWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    // {
    ...
    {		ret__ := func(this *deriveWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *deriveWs) interface{} {
    					// catch block:
...
func  (this *deriveWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *deriveWs) HandleAuth(client interface{}, message interface{})  {
    //
    // {
    //     id: 1,
    //     result: [ 130837 ]
...
func (this *deriveWs) Init(userConfig map[string]interface{}) {
    this.derive.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
