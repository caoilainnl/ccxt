...
func (this *Derive) FetchSpotMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
...
func (this *Derive) FetchSwapMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
...
func (this *Derive) FetchOptionMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Derive) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Derive) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Derive) FetchCanceledOrders(options ...ccxt.FetchCanceledOrdersOptions) ([]ccxt.Order, error) {
