...
func  (this *coinone) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencies)); i++ {
                ...
                var isWithdrawEnabled interface{} = ccxt.IsEqual(this.SafeString(entry, "withdraw_status", ""), "normal")
                var isDepositEnabled interface{} = ccxt.IsEqual(this.SafeString(entry, "deposit_status", ""), "normal")
                var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(code, "KRW"))), "crypto", "fiat")
...
func  (this *coinone) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencyIds)); i++ {
        ...
        ccxt.AddElementToObject(account, "free", this.SafeString(balance, "avail"))
...
func  (this *coinone) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", limit) // only support 5, 10, 15, 16
            }
            ...
            ch <- this.ParseOrderBook(response, ccxt.GetValue(market, "symbol"), timestamp, "bids", "asks", "price", "qty")
            return nil
...
func  (this *coinone) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                ccxt.AddElementToObject(request, "quote_currency", ccxt.GetValue(market, "quote"))
                ccxt.AddElementToObject(request, "target_currency", ccxt.GetValue(market, "base"))
...
func  (this *coinone) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeCostString, nil)) {
        ...
        var feeCurrencyCode interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "sell"))), ccxt.GetValue(market, "quote"), ccxt.GetValue(market, "base"))
...
func  (this *coinone) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", ccxt.MathMin(limit, 200))
            }
...
func  (this *coinone) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "price": price,
                "currency": ccxt.GetValue(market, "id"),
                "qty": amount,
            }
            var method interface{} = ccxt.Add(ccxt.Add("privatePostOrder", this.Capitalize(typeVar)), this.Capitalize(side))
...
func  (this *coinone) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(status, "live")) {
        if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(remainingString, nil))) && ccxt.IsTrue((!ccxt.IsEqual(amountString, nil)))) {
            var isLessThan interface{} = ccxt.Precise.StringLt(remainingString, amountString)
            if ccxt.IsTrue(isLessThan) {
                status = "canceled"
            }
        }
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeCostString, nil)) {
        var feeCurrencyCode interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "sell"))), quote, base)
        fee = map[string]interface{} {
            "cost": feeCostString,
...
func  (this *coinone) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " fetchOpenOrders() allows fetching closed orders with a specific symbol")))
            }
...
func  (this *coinone) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " cancelOrder() requires a symbol argument. To cancel the order, pass a symbol argument and {\\'price\\': 12345, \\'qty\\': 1.2345, \\'is_ask\\': 0} in the params argument of cancelOrder.")))
            }
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(price, nil))) || ccxt.IsTrue((ccxt.IsEqual(qty, nil)))) || ccxt.IsTrue((ccxt.IsEqual(isAsk, nil)))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " cancelOrder() requires {\\'price\\': 12345, \\'qty\\': 1.2345, \\'is_ask\\': 0} in the params argument.")))
            }
...
func  (this *coinone) FetchDepositAddresses(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var keys interface{} = ccxt.ObjectKeys(walletAddress)
            var result interface{} = map[string]interface{} {}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                var key interface{} = ccxt.GetValue(keys, i)
                var value interface{} = ccxt.GetValue(walletAddress, key)
                if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsTrue(value))) || ccxt.IsTrue((ccxt.IsEqual(value, "-1")))) {
                    continue
                }
                ...
                ccxt.AddElementToObject(depositAddress, "address", address)
                ccxt.AddElementToObject(depositAddress, "info", address)
                if ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(secondPart, "tag")) || ccxt.IsTrue(ccxt.IsEqual(secondPart, "memo")))) {
                    ccxt.AddElementToObject(depositAddress, "tag", value)
                    ccxt.AddElementToObject(depositAddress, "info", []interface{}{address, value})
                }
                ccxt.AddElementToObject(result, code, depositAddress)
            }
...
func  (this *coinone) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "v2Public")) {
        url = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "v2Public"), "/")
        api = "public"
    } else if ccxt.IsTrue(ccxt.IsEqual(api, "v2Private")) {
        url = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "v2Private"), "/")
    } else if ccxt.IsTrue(ccxt.IsEqual(api, "v2_1Private")) {
        url = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "v2_1Private"), "/")
    }
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        body = payload
        var secret interface{} = ccxt.ToUpper(this.Secret)
        var signature interface{} = this.Hmac(this.Encode(payload), this.Encode(secret), ccxt.Sha512)
