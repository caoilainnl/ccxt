...
func NewCoinoneWsCore() coinoneWs {
   p := coinoneWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *coinoneWs) Describe() interface{}  {
 ...
 */
func  (this *coinoneWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *coinoneWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "response_type": "DATA",
    //         "channel": "ORDERBOOK",
    ...
    if ccxt.IsTrue(ccxt.IsEqual(orderbook, nil)) {
        ...
        orderbook.(ccxt.OrderBookInterface).Reset(nil)
    }
...
func  (this *coinoneWs) HandleDelta(bookside interface{}, delta interface{})  {
 ...
 */
func  (this *coinoneWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinoneWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "response_type": "DATA",
    //         "channel": "TICKER",
...
func  (this *coinoneWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "quote_currency": "KRW",
    //         "target_currency": "BTC",
 ...
 */
func  (this *coinoneWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinoneWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "response_type": "DATA",
    //         "channel": "TRADE",
...
func  (this *coinoneWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "quote_currency": "KRW",
    //         "target_currency": "BTC",
...
func  (this *coinoneWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "response_type": "ERROR",
    //         "error_code": 160012,
...
func  (this *coinoneWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *coinoneWs) Ping(client interface{}) interface{}  {
    return map[string]interface{} {
        "request_type": "PING",
    }
}
func  (this *coinoneWs) HandlePong(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "response_type":"PONG"
    //     }
...
func (this *coinoneWs) Init(userConfig map[string]interface{}) {
    this.coinone.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
