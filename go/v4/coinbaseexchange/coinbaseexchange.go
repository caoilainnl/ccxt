    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            ...
            "broad": map[string]interface{} {
                "ccxt.Order already done": ccxt.OrderNotFound,
                ...
                "ccxt.Cancel only mode": ccxt.OnMaintenance,
            },
        },
    })
}
...
func  (this *coinbaseexchange) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(supportedNetworks)); j++ {
                    var network interface{} = ccxt.GetValue(supportedNetworks, j)
            ...
            "network": networkCode,
            "active": ccxt.IsEqual(this.SafeString(network, "status"), "online"),
            "withdraw": nil,
            "deposit": nil,
            "fee": nil,
            "precision": nil,
            ...
            "name": name,
            "active": ccxt.IsEqual(this.SafeString(currency, "status"), "online"),
            "deposit": nil,
            "withdraw": nil,
            "fee": nil,
...
func  (this *coinbaseexchange) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                ccxt.AppendToArray(&result, this.Extend(ccxt.GetValue(this.Fees, "trading"), map[string]interface{} {
                    "id": id,
                    ...
                    "future": false,
                    "option": false,
                    "active": (ccxt.IsEqual(status, "online")),
                    "contract": false,
                    "linear": nil,
                    "inverse": nil,
                    "contractSize": nil,
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(response, "sequence"))
...
func  (this *coinbaseexchange) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var symbol interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(market, nil))), nil, ccxt.GetValue(market, "symbol"))
    if ccxt.IsTrue(ccxt.IsArray(ticker)) {
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketIds)); i++ {
                ...
                ccxt.AddElementToObject(result, symbol, this.ParseTicker(first, market))
            }
...
func  (this *coinbaseexchange) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeCurrencyId, nil)) {
        var costField interface{} = ccxt.Add(feeCurrencyId, "_value")
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(liquidity, nil)) {
            takerOrMaker = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(liquidity, "T"))), "taker", "maker")
    ...
    var side interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(trade, "side"), "buy"))), "sell", "buy")
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(orderId, nil))) || ccxt.IsTrue((ccxt.IsTrue((!ccxt.IsEqual(makerOrderId, nil))) && ccxt.IsTrue((!ccxt.IsEqual(takerOrderId, nil)))))) {
        side = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(trade, "side"), "buy"))), "buy", "sell")
    }
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp868808 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp868808, 0)
            params = ccxt.GetValue(__tmp868808, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes107019 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    ccxt.PanicOnError(retRes107019)
                    ch <- retRes107019
                    return nil
            }
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes11988)
            var paginate interface{} = false
            __tmp826772 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate", false)
            paginate = ccxt.GetValue(__tmp826772, 0)
            params = ccxt.GetValue(__tmp826772, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes120219 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    ccxt.PanicOnError(retRes120219)
                    ch <- retRes120219
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                    ...
                    limit = ccxt.MathMin(300, limit)
                }
                if ccxt.IsTrue(ccxt.IsEqual(until, nil)) {
                    var parsedTimeframeMilliseconds interface{} = ccxt.Multiply(parsedTimeframe, 1000)
                    if ccxt.IsTrue(this.IsRoundNumber(ccxt.Mod(since, parsedTimeframeMilliseconds))) {
                        ccxt.AddElementToObject(request, "end", this.Iso8601(this.Sum(ccxt.Multiply((ccxt.Subtract(limit, 1)), parsedTimeframeMilliseconds), since)))
                    } else {
                        ccxt.AddElementToObject(request, "end", this.Iso8601(this.Sum(ccxt.Multiply(limit, parsedTimeframeMilliseconds), since)))
                    }
                } else {
                    ccxt.AddElementToObject(request, "end", this.Iso8601(until))
                }
            }
...
func  (this *coinbaseexchange) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(status, "closed"))) && ccxt.IsTrue((ccxt.IsEqual(doneReason, "canceled")))) {
        status = "canceled"
    }
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                ...
                ccxt.AddElementToObject(request, "client_oid", clientOrderId)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes141815)
                ch <- retRes141815
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp122597 := this.HandleOptionAndParams(params, "fetchOpenOrders", "paginate")
            paginate = ccxt.GetValue(__tmp122597, 0)
            params = ccxt.GetValue(__tmp122597, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes143919 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    ccxt.PanicOnError(retRes143919)
                    ch <- retRes143919
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes147815)
                ch <- retRes147815
                return nil
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(cost, nil)) {
                    if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
                        cost = ccxt.Multiply(amount, price)
                    }
                } else {
                    params = this.Omit(params, []interface{}{"cost", "funds"})
                }
                if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
                    ccxt.AddElementToObject(request, "funds", this.CostToPrecision(symbol, cost))
                } else {
                    ccxt.AddElementToObject(request, "size", this.AmountToPrecision(symbol, amount))
                }
            }
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ccxt.AddElementToObject(request, "product_id", ccxt.GetValue(market, "symbol")) // the request will be more performant if you include it
            }
        
                retRes160515 :=  (<-this.CallDynamically(method, this.Extend(request, params)))
                ccxt.PanicOnError(retRes160515)
                ch <- retRes160515
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                ccxt.PanicOnError(retRes162515)
                ch <- retRes162515
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes162915)
                ch <- retRes162915
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp566637 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp566637, 0)
            params = ccxt.GetValue(__tmp566637, 1)
            ...
            if ccxt.IsTrue(ccxt.InOp(params, "payment_method_id")) {
                method = ccxt.Add(method, "PaymentMethod")
            } else if ccxt.IsTrue(ccxt.InOp(params, "coinbase_account_id")) {
                method = ccxt.Add(method, "CoinbaseAccount")
            } else {
                method = ccxt.Add(method, "Crypto")
                ccxt.AddElementToObject(request, "crypto_address", address)
            ...
            if !ccxt.IsTrue(response) {
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " withdraw() error: "), this.Json(response))))
            }
...
func  (this *coinbaseexchange) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var beforeString interface{} = ccxt.Precise.StringSub(afterString, amountString)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, "transfer")) {
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchLedger() requires a code param")))
            }
        
            retRes17748 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes17748)
            ...
            ccxt.PanicOnError(response)
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ccxt.AddElementToObject(ccxt.GetValue(response, i), "currency", code)
            }
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(id, nil)) {
                if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                    ...
                    var account interface{} = this.SafeValue(accountsByCurrencyCode, code)
                    if ccxt.IsTrue(ccxt.IsEqual(account, nil)) {
                        panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " fetchDepositsWithdrawals() could not find account id for "), code)))
                    }
                    id = ccxt.GetValue(account, "id")
                }
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(id, nil)) {
                ...
                //
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                    var account_id interface{} = this.SafeString(ccxt.GetValue(response, i), "account_id")
                    var account interface{} = this.SafeValue(this.AccountsById, account_id)
                    var codeInner interface{} = this.SafeString(account, "code")
                    ccxt.AddElementToObject(ccxt.GetValue(response, i), "currency", codeInner)
                }
            } else {
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes193015)
                ch <- retRes193015
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes194615)
                ch <- retRes194615
                return nil
...
func  (this *coinbaseexchange) ParseTransactionStatus(transaction interface{}) interface{}  {
    ...
    if ccxt.IsTrue(completed) {
        return "ok"
    } else if ccxt.IsTrue(ccxt.IsTrue(processed) && !ccxt.IsTrue(completed)) {
        return "failed"
    } else {
        return "pending"
    }
    ...
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, "withdraw")) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(feeCost, nil)) {
            if ccxt.IsTrue(!ccxt.IsEqual(amount, nil)) {
                amount = ccxt.Subtract(amount, feeCost)
            }
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(accounts, nil)) {
                accounts = (<-this.PrivateGetCoinbaseAccounts())
                ccxt.AddElementToObject(this.Options, "coinbaseAccounts", accounts) // cache it
                ccxt.AddElementToObject(this.Options, "coinbaseAccountsByCurrencyId", this.IndexBy(accounts, "currency"))
            }
            var currencyId interface{} = ccxt.GetValue(currency, "id")
            var account interface{} = this.SafeValue(ccxt.GetValue(this.Options, "coinbaseAccountsByCurrencyId"), currencyId)
            if ccxt.IsTrue(ccxt.IsEqual(account, nil)) {
                panic(ccxt.InvalidAddress(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createDepositAddress() could not find currency code "), code), " with id = "), currencyId), " in this.options[\\'coinbaseAccountsByCurrencyId\\']")))
            }
            var request interface{} = map[string]interface{} {
                "id": ccxt.GetValue(account, "id"),
            }
...
func  (this *coinbaseexchange) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(method, "GET")) {
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            request = ccxt.Add(request, ccxt.Add("?", this.Urlencode(query)))
        }
    }
    var url interface{} = ccxt.Add(this.ImplodeHostname(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), api)), request)
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var what interface{} = ccxt.Add(ccxt.Add(ccxt.Add(nonce, method), request), payload)
        		...
        		defer func() {
        			if e := recover(); e != nil {
        				...
        				ret_ = func(this *coinbaseexchange) interface{} {
        					// catch block:
                                        panic(ccxt.AuthenticationError(ccxt.Add(this.Id, " sign() invalid base64 secret")))
                            return nil
        				}(this)
        			}
        		}()
        ...
        var signature interface{} = this.Hmac(this.Encode(what), secret, ccxt.Sha256, "base64")
...
func  (this *coinbaseexchange) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(code, 400))) || ccxt.IsTrue((ccxt.IsEqual(code, 404)))) {
...
func  (this *coinbaseexchange) Request(path interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsString(response)) {
                if ccxt.IsTrue(ccxt.InOp(response, "message")) {
