 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinbaseexchange) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Coinbaseexchange) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) (map[string]interface{}, error) {
