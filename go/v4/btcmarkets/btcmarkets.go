...
func  (this *btcmarkets) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes33015 :=  (<-this.FetchTransactionsWithMethod("privateGetTransfers", code, since, limit, params))
...
func  (this *btcmarkets) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes34515 :=  (<-this.FetchTransactionsWithMethod("privateGetDeposits", code, since, limit, params))
...
func  (this *btcmarkets) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes36015 :=  (<-this.FetchTransactionsWithMethod("privateGetWithdrawals", code, since, limit, params))
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Market-Data-APIs/paths/~1v3~1markets/get
 * @param {object} [params] extra parameters specific to the exchange API endpoint
...
func  (this *btcmarkets) ParseMarket(market interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(quote, "AUD")) {
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Account-APIs/paths/~1v3~1accounts~1me~1balances/get
 * @param {object} [params] extra parameters specific to the exchange API endpoint
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Market-Data-APIs/paths/~1v3~1markets~1{marketId}~1candles/get
...
func  (this *btcmarkets) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", ccxt.MathMin(limit, 200)) // default is 10, max 200
            }
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Market-Data-APIs/paths/~1v3~1markets~1{marketId}~1orderbook/get
...
func  (this *btcmarkets) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(response, "snapshotId"))
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Market-Data-APIs/paths/~1v3~1markets~1{marketId}~1ticker/get
...
func  (this *btcmarkets) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    market = this.SafeMarket(marketId, market, "-")
    var feeCurrencyCode interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(market, "quote"), "AUD"))), ccxt.GetValue(market, "quote"), ccxt.GetValue(market, "base"))
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Market-Data-APIs/paths/~1v3~1markets~1{marketId}~1trades/get
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/ccxt.Order-Placement-APIs/paths/~1v3~1orders/post
...
func  (this *btcmarkets) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                "side": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), "Bid", "Ask"),
            }
            ...
            var orderTypes interface{} = this.SafeValue(this.Options, "orderTypes", map[string]interface{} {
                ...
                "market": "ccxt.Market",
                "stop": "Stop",
                "stop limit": "Stop ccxt.Limit",
                "take profit": "Take Profit",
            })
            ccxt.AddElementToObject(request, "type", this.SafeString(orderTypes, lowercaseType, typeVar))
            var priceIsRequired interface{} = false
            var triggerPriceIsRequired interface{} = false
            if ccxt.IsTrue(ccxt.IsEqual(lowercaseType, "limit")) {
                priceIsRequired = true
            } else if ccxt.IsTrue(ccxt.IsEqual(lowercaseType, "stop limit")) {
                triggerPriceIsRequired = true
                priceIsRequired = true
            } else if ccxt.IsTrue(ccxt.IsEqual(lowercaseType, "take profit")) {
                triggerPriceIsRequired = true
            } else if ccxt.IsTrue(ccxt.IsEqual(lowercaseType, "stop")) {
                triggerPriceIsRequired = true
            }
            ...
            if ccxt.IsTrue(triggerPriceIsRequired) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(triggerPrice, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() requires a triggerPrice parameter for a "), typeVar), "order")))
                } else {
 ...
 * @see https://docs.btcmarkets.net/v3/#tag/Batch-ccxt.Order-APIs/paths/~1v3~1batchorders~1{ids}/delete
...
func  (this *btcmarkets) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ccxt.AddElementToObject(ids, i, ccxt.ParseInt(ccxt.GetValue(ids, i)))
            }
            var request interface{} = map[string]interface{} {
                "ids": ids,
            }
...
func  (this *btcmarkets) CalculateFee(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(market, "quote"), "AUD")) {
        currency = ccxt.GetValue(market, "quote")
        var amountString interface{} = this.NumberToString(amount)
        var priceString interface{} = this.NumberToString(price)
        var otherUnitsAmount interface{} = ccxt.Precise.StringMul(amountString, priceString)
    ...
    var rate interface{} = ccxt.GetValue(market, takerOrMaker)
    var rateCost interface{} = ccxt.Precise.StringMul(this.NumberToString(rate), cost)
    return map[string]interface{} {
        "type": takerOrMaker,
        "currency": currency,
        "rate": rate,
        "cost": ccxt.ParseFloat(this.FeeToPrecision(symbol, rateCost)),
    }
}
...
func  (this *btcmarkets) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes126315 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *btcmarkets) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp2220 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp2220, 0)
            params = ccxt.GetValue(__tmp2220, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(code, "AUD")) {
                this.CheckAddress(address)
                ccxt.AddElementToObject(request, "toAddress", address)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                ccxt.AddElementToObject(request, "toAddress", ccxt.Add(ccxt.Add(address, "?dt="), tag))
            }
...
func  (this *btcmarkets) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var auth interface{} = ccxt.Add(ccxt.Add(method, request), nonce)
        ...
        var signature interface{} = this.Hmac(this.Encode(auth), secret, ccxt.Sha512, "base64")
