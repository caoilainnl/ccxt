 ...
 */
func (this *Coinmetro) FetchCurrencies(params ...interface{}) (ccxt.Currencies, error) {
 ...
 */
func (this *Coinmetro) FetchMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 */
func (this *Coinmetro) FetchOHLCV(symbol string, options ...ccxt.FetchOHLCVOptions) ([]ccxt.OHLCV, error) {
 ...
 */
func (this *Coinmetro) FetchTrades(symbol string, options ...ccxt.FetchTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Coinmetro) FetchMyTrades(options ...ccxt.FetchMyTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Coinmetro) FetchOrderBook(symbol string, options ...ccxt.FetchOrderBookOptions) (ccxt.OrderBook, error) {
 ...
 */
func (this *Coinmetro) FetchTickers(options ...ccxt.FetchTickersOptions) (ccxt.Tickers, error) {
 ...
 * @returns {object} a dictionary of [ticker structures]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func (this *Coinmetro) FetchBidsAsks(options ...ccxt.FetchBidsAsksOptions) (ccxt.Tickers, error) {
 ...
 */
func (this *Coinmetro) FetchBalance(params ...interface{}) (ccxt.Balances, error) {
 ...
 */
func (this *Coinmetro) FetchLedger(options ...ccxt.FetchLedgerOptions) ([]ccxt.LedgerEntry, error) {
 ...
 */
func (this *Coinmetro) CreateOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinmetro) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Coinmetro) FetchOpenOrders(options ...ccxt.FetchOpenOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinmetro) FetchCanceledAndClosedOrders(options ...ccxt.FetchCanceledAndClosedOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinmetro) FetchOrder(id string, options ...ccxt.FetchOrderOptions) (ccxt.Order, error) {
