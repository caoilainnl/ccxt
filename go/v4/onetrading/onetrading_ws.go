...
func NewOnetradingWsCore() onetradingWs {
   p := onetradingWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *onetradingWs) Describe() interface{}  {
 ...
 */
func  (this *onetradingWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *onetradingWs) HandleBalanceSnapshot(client interface{}, message interface{})  {
    //
    // snapshot
    //     {
 ...
 */
func  (this *onetradingWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *onetradingWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *onetradingWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "ticker_updates": [{
    //             "instrument": "ETH_BTC",
...
func  (this *onetradingWs) ParseWSTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "instrument": "ETH_BTC",
    //         "last_price": "0.053752",
 ...
 */
func  (this *onetradingWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *onetradingWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *onetradingWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //  snapshot
    //     {
...
func  (this *onetradingWs) HandleDelta(orderbook interface{}, delta interface{})  {
    //
    //   [ 'BUY', "0.053595", "0" ]
    //
...
func  (this *onetradingWs) HandleDeltas(orderbook interface{}, deltas interface{})  {
    //
    //    [
    //       [ 'BUY', "0.053593", "0" ],
    //       [ 'SELL', "0.053698", "0" ]
 ...
 */
func  (this *onetradingWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *onetradingWs) HandleTrading(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *onetradingWs) ParseTradingOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "order_book_sequence": 892925263,
    //         "side": "BUY",
...
func  (this *onetradingWs) ParseTradingOrderStatus(status interface{}) interface{}  {
...
func  (this *onetradingWs) HandleOrders(client interface{}, message interface{})  {
    //
    //  snapshot
    //     {
...
func  (this *onetradingWs) HandleAccountUpdate(client interface{}, message interface{})  {
    //
    // order created
    //     {
...
func  (this *onetradingWs) ParseWsOrderStatus(status interface{}) interface{}  {
    var statuses interface{} = map[string]interface{} {
...
func  (this *onetradingWs) UpdateBalance(balance interface{})  {
    //
    //     {
    //         "currency_code": "EUR",
    //         "amount": "0.0",
 ...
 */
func  (this *onetradingWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *onetradingWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //  snapshot
    //     {
    //         "instrument_code": "BTC_EUR",
...
func  (this *onetradingWs) FindTimeframe(timeframe interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *onetradingWs) HandleSubscriptions(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "channels": [{
...
func  (this *onetradingWs) HandleHeartbeat(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "subscription": "SYSTEM",
    //         "channel_name": "SYSTEM",
...
func  (this *onetradingWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " "), this.Json(message))))
}
func  (this *onetradingWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *onetradingWs) HandlePricePointUpdates(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "channel_name": "MARKET_TICKER",
...
func  (this *onetradingWs) HandleAuthenticationMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "channel_name": "SYSTEM",
    //        "type": "AUTHENTICATED",
...
func  (this *onetradingWs) WatchMany(messageHash interface{}, request interface{}, subscriptionHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *onetradingWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes136415 :=  <-future.(<-chan interface{})
...
func (this *onetradingWs) Init(userConfig map[string]interface{}) {
