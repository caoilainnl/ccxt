...
func  (this *onetrading) ParseMarket(market interface{}) interface{}  {
    ...
    var id interface{} = ccxt.Add(ccxt.Add(baseId, "_"), quoteId)
...
func  (this *onetrading) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "fetchPrivateTradingFees")) {
                    ...
                    retRes53319 :=  (<-this.FetchPrivateTradingFees(params))
                    ccxt.PanicOnError(retRes53319)
                    ch <- retRes53319
                    return nil
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "fetchPublicTradingFees")) {
        
                    retRes53519 :=  (<-this.FetchPublicTradingFees(params))
                    ccxt.PanicOnError(retRes53519)
                    ch <- retRes53519
                    return nil
            } else {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchTradingFees() does not support "), method), ", fetchPrivateTradingFees and fetchPublicTradingFees are supported")))
            }
                return nil
            }()
            return ch
...
func  (this *onetrading) ParseFeeTiers(feeTiers interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(feeTiers)); i++ {
        ...
        ccxt.AppendToArray(&makerFees, []interface{}{volume, this.ParseNumber(maker)})
        ccxt.AppendToArray(&takerFees, []interface{}{volume, this.ParseNumber(taker)})
    }
    return map[string]interface{} {
        "maker": makerFees,
        "taker": takerFees,
...
func  (this *onetrading) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "instrument_code": ccxt.GetValue(market, "id"),
            }
...
func  (this *onetrading) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseOrderBook(response, ccxt.GetValue(market, "symbol"), timestamp, "bids", "asks", "price", "amount")
            return nil
...
func  (this *onetrading) ParseOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var timeframe interface{} = ccxt.Add(period, lowercaseUnit)
    var durationInSeconds interface{} = this.ParseTimeframe(timeframe)
    var duration interface{} = ccxt.Multiply(durationInSeconds, 1000)
    var timestamp interface{} = this.Parse8601(this.SafeString(ohlcv, "time"))
    var alignedTimestamp interface{} = ccxt.Multiply(duration, this.ParseToInt(ccxt.Divide(timestamp, duration)))
...
func  (this *onetrading) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            periodunitVariable := ccxt.Split(periodUnit, "/");
            period := ccxt.GetValue(periodunitVariable,0);
            unit := ccxt.GetValue(periodunitVariable,1)
            var durationInSeconds interface{} = this.ParseTimeframe(timeframe)
            var duration interface{} = ccxt.Multiply(durationInSeconds, 1000)
            if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                limit = 1500
            ...
            if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                ...
                ccxt.AddElementToObject(request, "to", this.Iso8601(now))
                ccxt.AddElementToObject(request, "from", this.Iso8601(ccxt.Subtract(now, ccxt.Multiply(limit, duration))))
            } else {
                ccxt.AddElementToObject(request, "from", this.Iso8601(since))
                ccxt.AddElementToObject(request, "to", this.Iso8601(this.Sum(since, ccxt.Multiply(limit, duration))))
            }
...
func  (this *onetrading) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(uppercaseType, "LIMIT")) || ccxt.IsTrue(ccxt.IsEqual(uppercaseType, "STOP"))) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(uppercaseType, "MARKET")) {
                    panic(ccxt.BadRequest(ccxt.Add(this.Id, " createOrder() cannot place stop market orders, only stop limit")))
                }
                ...
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() requires a triggerPrice param for "), typeVar), " orders")))
            }
...
func  (this *onetrading) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "privateDeleteAccountOrdersOrderId")) {
...
func  (this *onetrading) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                var market interface{} = this.Market(symbol)
                ccxt.AddElementToObject(request, "instrument_code", ccxt.GetValue(market, "id"))
            }
...
func  (this *onetrading) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(to, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOpenOrders() requires a \"to\" iso8601 string param with the since argument is specified, max range is 100 days")))
                }
                ccxt.AddElementToObject(request, "from", this.Iso8601(since))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "max_page_size", limit)
            }
...
func  (this *onetrading) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes158115 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *onetrading) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                var to interface{} = this.SafeString(params, "to")
                if ccxt.IsTrue(ccxt.IsEqual(to, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchMyTrades() requires a \"to\" iso8601 string param with the since argument is specified, max range is 100 days")))
                }
                ccxt.AddElementToObject(request, "from", this.Iso8601(since))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
...
func  (this *onetrading) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        headers = map[string]interface{} {
            ...
            "Authorization": ccxt.Add("Bearer ", this.ApiKey),
        }
