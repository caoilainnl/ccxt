...
func NewXtWs(userConfig map[string]interface{}) XtWs {
   p := &xtWs{}
   p.Init(userConfig)
   return XtWs{
       xtWs: p,
...
func (this *XtWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *XtWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *XtWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *XtWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *XtWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *XtWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *XtWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *XtWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
...
func (this *XtWs) WatchPositions(options ...ccxt.WatchPositionsOptions) ([]ccxt.Position, error) {
