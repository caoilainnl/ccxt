...
func NewXtWsCore() xtWs {
   p := xtWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *xtWs) Describe() interface{}  {
 ...
 */
func  (this *xtWs) GetListenKey(isContract interface{}) <- chan interface{} {
...
func  (this *xtWs) GetCacheIndex(orderbook interface{}, cache interface{}) interface{}  {
...
func  (this *xtWs) HandleDelta(orderbook interface{}, delta interface{})  {
 ...
 */
func  (this *xtWs) Subscribe(name interface{}, access interface{}, methodName interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp910565 := this.HandleMarketTypeAndParams(methodName, market, params)
            typeVar = ccxt.GetValue(__tmp910565, 0)
            params = ccxt.GetValue(__tmp910565, 1)
 ...
 */
func  (this *xtWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/en/latest/manual.html#ticker-structure}
 */
func  (this *xtWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *xtWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *xtWs) SetPositionsCache(client interface{})  {
...
func  (this *xtWs) LoadPositionsSnapshot(client interface{}, messageHash interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *xtWs) HandlePosition(client interface{}, message interface{})  {
    //
    //    {
    //      topic: 'position',
    //      event: 'position',
...
func  (this *xtWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleTickers(client interface{}, message interface{}) interface{}  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleTrade(client interface{}, message interface{}) interface{}  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) ParseWsOrderTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "s": "btc_usdt",                         // symbol
...
func  (this *xtWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleOrder(client interface{}, message interface{}) interface{}  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleBalance(client interface{}, message interface{})  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    // spot
    //
    //    {
...
func  (this *xtWs) HandleMessage(client interface{}, message interface{})  {
    var event interface{} = this.SafeString(message, "event")
...
func  (this *xtWs) Ping(client interface{}) interface{}  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
    return "ping"
}
func  (this *xtWs) HandleErrorMessage(client interface{}, message interface{})  {
    //
    //    {
    //        "id": "123",
    //        "code": 401,
...
func (this *xtWs) Init(userConfig map[string]interface{}) {
    this.xt.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
