    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "System abnormality": ccxt.ExchangeError,
                ...
                "ccxt.Market is closed.": ccxt.ExchangeNotAvailable,
                "Too many requests. Please try again later.": ccxt.DDoSProtection,
                ...
                "-1016": ccxt.ExchangeNotAvailable,
                ...
                "-1160": ccxt.InvalidOrder,
                "-1156": ccxt.InvalidOrder,
                ...
                "-3005": ccxt.InsufficientFunds,
                "-3006": ccxt.InsufficientFunds,
                "-3008": ccxt.InsufficientFunds,
                "-3010": ccxt.ExchangeError,
                "-3015": ccxt.ExchangeError,
                "-3022": ccxt.AccountSuspended,
                "-4028": ccxt.BadRequest,
                "-3020": ccxt.InsufficientFunds,
                "-3041": ccxt.InsufficientFunds,
                "-5013": ccxt.InsufficientFunds,
                "-11008": ccxt.InsufficientFunds,
                "-4051": ccxt.InsufficientFunds,
            },
            "broad": map[string]interface{} {
                "Insufficient account balance": ccxt.InsufficientFunds,
...
func  (this *bitrue) FetchStatus(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var formattedStatus interface{} = ccxt.Ternary(ccxt.IsTrue(keysLength), "maintenance", "ok")
...
func  (this *bitrue) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(coins)); i++ {
                var currency interface{} = ccxt.GetValue(coins, i)
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(networkDetails)); j++ {
                    var entry interface{} = ccxt.GetValue(networkDetails, j)
...
func  (this *bitrue) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(fetchMarkets)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                    ccxt.AppendToArray(&promisesRaw, this.SpotV1PublicGetExchangeInfo(params))
                } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "linear")) {
                    ccxt.AppendToArray(&promisesRaw, this.FapiV1PublicGetContracts(params))
                } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "inverse")) {
                    ccxt.AppendToArray(&promisesRaw, this.DapiV1PublicGetContracts(params))
                } else {
            ...
            if ccxt.IsTrue(ccxt.GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes92212 := (<-this.LoadTimeDifference())
...
func  (this *bitrue) ParseMarket(market interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(side, nil)) {
        ...
        typeVar = "swap"
        isLinear = (ccxt.IsEqual(side, 1))
        isInverse = (ccxt.IsEqual(side, 0))
    }
    ...
    if ccxt.IsTrue(isContract) {
        var symbolSplit interface{} = ccxt.Split(id, "-")
    ...
    return map[string]interface{} {
        ...
        "settleId": settleId,
        "type": typeVar,
        "spot": (ccxt.IsEqual(typeVar, "spot")),
        "margin": false,
        "swap": isContract,
        "future": false,
        "option": false,
        ...
        "linear": isLinear,
        "inverse": isInverse,
        "contractSize": this.ParseNumber(ccxt.Precise.StringAbs(multiplier)),
        "expiry": nil,
        "expiryDatetime": nil,
        "strike": nil,
        "optionType": nil,
...
func  (this *bitrue) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
        ...
        ccxt.AddElementToObject(account, "free", this.SafeString2(balance, "free", "accountNormal"))
        ccxt.AddElementToObject(account, "used", this.SafeString2(balance, "locked", "accountLock"))
 ...
 * @see https://www.bitrue.com/api-docs#account-information-v2-user_data-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#account-information-v2-user_data-hmac-ccxt.Sha256
 * @param {object} [params] extra parameters specific to the exchange API endpoint
...
func  (this *bitrue) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var typeVar interface{} = nil
            __tmp879373 := this.HandleMarketTypeAndParams("fetchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp879373, 0)
            params = ccxt.GetValue(__tmp879373, 1)
            var subType interface{} = nil
            __tmp150521 := this.HandleSubTypeAndParams("fetchBalance", nil, params)
            subType = ccxt.GetValue(__tmp150521, 0)
            params = ccxt.GetValue(__tmp150521, 1)
            var response interface{} = nil
            var result interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "swap")) {
                if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(subType, nil)) && ccxt.IsTrue(ccxt.IsEqual(subType, "inverse"))) {
...
func  (this *bitrue) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                var request interface{} = map[string]interface{} {
                    "contractName": ccxt.GetValue(market, "id"),
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    if ccxt.IsTrue(ccxt.IsGreaterThan(limit, 100)) {
                        limit = 100
                    }
                    ccxt.AddElementToObject(request, "limit", limit) // default 100, max 100, see https://www.bitrue.com/api-docs#order-book
                }
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ...
                    ccxt.AddElementToObject(request, "limit", limit) // default 100, max 1000, see https://github.com/Bitrue-exchange/bitrue-official-api-docs#order-book
                }
                response = (<-this.SpotV1PublicGetDepth(this.Extend(request, params)))
            } else {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOrderBook only support spot & swap markets")))
            }
            //
            // spot
            //
...
func  (this *bitrue) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
        percentage = ccxt.Precise.StringMul(this.SafeString(ticker, "rose"), "100")
    } else {
...
func  (this *bitrue) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTicker only support spot & swap markets")))
            }
...
func  (this *bitrue) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ...
                    ccxt.AddElementToObject(request, "fromIdx", until)
                }
                response = (<-this.SpotV1PublicGetMarketKline(this.Extend(request, params)))
                data = this.SafeList(response, "data", []interface{}{})
            } else {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOHLCV only support spot & swap markets")))
            }
...
func  (this *bitrue) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchBidsAsks only support spot & swap markets")))
            }
            //
            // spot
            //
            ...
            ccxt.AddElementToObject(data, ccxt.GetValue(market, "id"), response)
...
func  (this *bitrue) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                var market interface{} = this.Market(first)
                if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTickers does not support swap markets, please use fetchTicker instead")))
                } else if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                    response = (<-this.SpotV1PublicGetTicker24hr(this.Extend(request, params)))
                    data = response
                } else {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTickers only support spot & swap markets")))
                }
            } else {
                __tmp312843 := this.HandleMarketTypeAndParams("fetchTickers", nil, params)
                typeVar = ccxt.GetValue(__tmp312843, 0)
                params = ccxt.GetValue(__tmp312843, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(typeVar, "spot")) {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTickers only support spot when symbols are not proved")))
                }
                response = (<-this.SpotV1PublicGetTicker24hr(this.Extend(request, params)))
                data = response
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                ccxt.AddElementToObject(tickers, ccxt.GetValue(market, "id"), ticker)
            }
...
func  (this *bitrue) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(isBuyer, nil)) {
        side = ccxt.Ternary(ccxt.IsTrue(isBuyer), "buy", "sell") // this is a true side
    }
...
func  (this *bitrue) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTrades only support spot markets")))
            }
...
func  (this *bitrue) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(order, "time")) {
        timestamp = this.SafeInteger(order, "time")
    } else if ccxt.IsTrue(ccxt.InOp(order, "transactTime")) {
        timestamp = this.SafeInteger(order, "transactTime")
    } else if ccxt.IsTrue(ccxt.InOp(order, "updateTime")) {
    ...
    var postOnly interface{} = ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "limit_maker"))) || ccxt.IsTrue((ccxt.IsEqual(timeInForce, "GTX")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "post_only")))
 ...
 * @see https://www.bitrue.com/api-docs#new-order-trade-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#new-order-trade-hmac-ccxt.Sha256
...
func  (this *bitrue) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " createMarketBuyOrderWithCost() supports swap orders only")))
            }
            ccxt.AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
        
                retRes200015 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                ccxt.PanicOnError(retRes200015)
                ch <- retRes200015
                return nil
 ...
 * @see https://www.bitrue.com/api_docs_includes_file/futures/index.html#new-order-trade-hmac-ccxt.Sha256
 * @param {string} symbol unified symbol of the market to create an order in
...
func  (this *bitrue) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(uppercaseType, "LIMIT")) {
                if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                    panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createOrder() requires a price argument")))
                }
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                ccxt.AddElementToObject(request, "contractName", ccxt.GetValue(market, "id"))
                var createMarketBuyOrderRequiresPrice interface{} = true
                __tmp270401 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp270401, 0)
                params = ccxt.GetValue(__tmp270401, 1)
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(isMarket) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))) && ccxt.IsTrue(createMarketBuyOrderRequiresPrice)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(price, nil)) && ccxt.IsTrue(ccxt.IsEqual(cost, nil))) {
                        panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createOrder() requires the price argument with swap market buy orders to calculate total order cost (amount to spend), where cost = amount * price. Supply a price argument to createOrder() call if you want the cost to be calculated for you from price and amount, or, alternatively, add .options[\"createMarketBuyOrderRequiresPrice\"] = false to supply the cost in the amount argument (the exchange-specific behaviour)")))
                    } else {
                        var amountString interface{} = this.NumberToString(amount)
                        var priceString interface{} = this.NumberToString(price)
                        var quoteAmount interface{} = ccxt.Precise.StringMul(amountString, priceString)
                        var requestAmount interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(cost, nil))), cost, quoteAmount)
                        ccxt.AddElementToObject(request, "amount", this.CostToPrecision(symbol, requestAmount))
                        ccxt.AddElementToObject(request, "volume", this.CostToPrecision(symbol, requestAmount))
                    }
                } else {
                    ccxt.AddElementToObject(request, "amount", this.ParseToNumeric(amount))
                    ccxt.AddElementToObject(request, "volume", this.ParseToNumeric(amount))
                }
                ccxt.AddElementToObject(request, "positionType", 1)
                var reduceOnly interface{} = this.SafeValue2(params, "reduceOnly", "reduce_only")
                ccxt.AddElementToObject(request, "open", ccxt.Ternary(ccxt.IsTrue(reduceOnly), "CLOSE", "OPEN"))
                var leverage interface{} = this.SafeString(params, "leverage", "1")
                ccxt.AddElementToObject(request, "leverage", this.ParseToNumeric(leverage))
                ...
                var validOrderTypes interface{} = this.SafeValue(ccxt.GetValue(market, "info"), "orderTypes")
                if !ccxt.IsTrue(this.InArray(uppercaseType, validOrderTypes)) {
                    panic(ccxt.InvalidOrder(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), typeVar), " is not a valid order type in market "), symbol)))
                }
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrder only support spot & swap markets")))
            }
 ...
 * @see https://www.bitrue.com/api_docs_includes_file/futures/index.html#query-order-user_data-hmac-ccxt.Sha256
...
func  (this *bitrue) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var data interface{} = nil
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(ccxt.IsEqual(origClientOrderId, nil)) {
                ccxt.AddElementToObject(request, "orderId", id)
            } else {
                if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                    ccxt.AddElementToObject(request, "clientOrderId", origClientOrderId)
                } else {
                    ccxt.AddElementToObject(request, "origClientOrderId", origClientOrderId)
                }
            }
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ccxt.AddElementToObject(request, "contractName", ccxt.GetValue(market, "id"))
                ...
                ccxt.AddElementToObject(request, "orderId", id) // spot market id is mandatory
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                response = (<-this.SpotV1PrivateGetOrder(this.Extend(request, params)))
                data = response
            } else {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOrder only support spot & swap markets")))
            }
...
func  (this *bitrue) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchClosedOrders only support spot markets")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            }
 ...
 * @see https://www.bitrue.com/api_docs_includes_file/futures/index.html#cancel-all-open-orders-trade-hmac-ccxt.Sha256
...
func  (this *bitrue) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOpenOrders only support spot & swap markets")))
            }
 ...
 * @see https://www.bitrue.com/api-docs#cancel-order-trade-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#cancel-order-trade-hmac-ccxt.Sha256
...
func  (this *bitrue) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " cancelOrder only support spot & swap markets")))
            }
 ...
 * @see https://www.bitrue.com/api-docs#cancel-all-open-orders-trade-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#cancel-all-open-orders-trade-hmac-ccxt.Sha256
...
func  (this *bitrue) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " cancelAllOrders only support future markets")))
            }
 ...
 * @see https://www.bitrue.com/api_docs_includes_file/futures/index.html#account-trade-list-user_data-hmac-ccxt.Sha256
 * @param {string} symbol unified market symbol
...
func  (this *bitrue) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchMyTrades only support spot & swap markets")))
            }
...
func  (this *bitrue) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchDeposits() requires a code argument")))
            }
...
func  (this *bitrue) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchWithdrawals() requires a code argument")))
            }
        
            retRes26668 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes26668)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": ccxt.GetValue(currency, "id"),
                "status": 5,
...
func  (this *bitrue) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(tagType, nil)) {
        if ccxt.IsTrue(!ccxt.IsEqual(addressTo, nil)) {
            var parts interface{} = ccxt.Split(addressTo, "_")
            addressTo = this.SafeString(parts, 0)
            tagTo = this.SafeString(parts, 1)
        }
        if ccxt.IsTrue(!ccxt.IsEqual(addressFrom, nil)) {
            var parts interface{} = ccxt.Split(addressFrom, "_")
    ...
    var payAmount interface{} =     (ccxt.InOp(transaction, "payAmount"))
    var ctime interface{} =     (ccxt.InOp(transaction, "ctime"))
    var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsTrue(payAmount) || ccxt.IsTrue(ctime))), "withdrawal", "deposit")
...
func  (this *bitrue) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp80084 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp80084, 0)
            params = ccxt.GetValue(__tmp80084, 1)
            ...
            __tmp44482 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp44482, 0)
            params = ccxt.GetValue(__tmp44482, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
                ccxt.AddElementToObject(request, "chainName", this.NetworkCodeToId(networkCode))
            }
...
func  (this *bitrue) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var chainDetailLength interface{} =     ccxt.GetArrayLength(chainDetails)
    var result interface{} = map[string]interface{} {
        "info": fee,
        "withdraw": map[string]interface{} {
            "fee": nil,
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(chainDetailLength, 0)) {
        for i := 0; ccxt.IsLessThan(i, chainDetailLength); i++ {
            var chainDetail interface{} = ccxt.GetValue(chainDetails, i)
    ...
    "withdraw": map[string]interface{} {
        ...
        "percentage": false,
            ...
            if ccxt.IsTrue(ccxt.IsEqual(chainDetailLength, 1)) {
                ccxt.AddElementToObject(ccxt.GetValue(result, "withdraw"), "fee", this.SafeNumber(chainDetail, "withdrawFee"))
...
func  (this *bitrue) ParseTransfer(transfer interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(transferType, nil)) {
        var accountSplit interface{} = ccxt.Split(transferType, "_to_")
 ...
 * @see https://www.bitrue.com/api-docs#get-future-account-transfer-history-list-user_data-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#get-future-account-transfer-history-list-user_data-hmac-ccxt.Sha256
...
func  (this *bitrue) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                ...
                ccxt.AddElementToObject(request, "coinSymbol", ccxt.GetValue(currency, "id"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
 ...
 * @see https://www.bitrue.com/api-docs#new-future-account-transfer-user_data-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#user-commission-rate-user_data-hmac-ccxt.Sha256
 * @param {string} code unified currency code
...
func  (this *bitrue) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "coinSymbol": ccxt.GetValue(currency, "id"),
                "amount": this.CurrencyToPrecision(code, amount),
                "transferType": ccxt.Add(ccxt.Add(fromId, "_to_"), toId),
            }
 ...
 * @see https://www.bitrue.com/api-docs#change-initial-leverage-trade-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#change-initial-leverage-trade-hmac-ccxt.Sha256
...
func  (this *bitrue) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " setLeverage only support swap markets")))
            }
            if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
 ...
 * @see https://www.bitrue.com/api-docs#modify-isolated-position-margin-trade-hmac-ccxt.Sha256
 * @see https://www.bitrue.com/api_docs_includes_file/delivery.html#modify-isolated-position-margin-trade-hmac-ccxt.Sha256
...
func  (this *bitrue) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(typeVar, "api")) && ccxt.IsTrue(ccxt.IsEqual(version, "kline")))) || ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(typeVar, "open")) && ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(path, "listenKey"), 0))))) {
        url = ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), typeVar)
    } else {
        url = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), typeVar), "/"), version)
    }
    url = ccxt.Add(ccxt.Add(url, "/"), this.ImplodeParams(path, params))
    ...
    if ccxt.IsTrue(ccxt.IsEqual(access, "private")) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(typeVar, "spot")) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "open"))) {
            var query interface{} = this.Urlencode(this.Extend(map[string]interface{} {
                "timestamp": this.Nonce(),
                "recvWindow": recvWindow,
            }, params))
            var signature interface{} = this.Hmac(this.Encode(query), this.Encode(this.Secret), ccxt.Sha256)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "fapi")) {
                signPath = "/fapi"
            } else if ccxt.IsTrue(ccxt.IsEqual(typeVar, "dapi")) {
                signPath = "/dapi"
            }
            signPath = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(signPath, "/"), version), "/"), path)
            var signMessage interface{} = ccxt.Add(ccxt.Add(timestamp, method), signPath)
            if ccxt.IsTrue(ccxt.IsEqual(method, "GET")) {
                var keys interface{} = ccxt.ObjectKeys(params)
                var keysLength interface{} =                 ccxt.GetArrayLength(keys)
                if ccxt.IsTrue(ccxt.IsGreaterThan(keysLength, 0)) {
                    signMessage = ccxt.Add(signMessage, ccxt.Add("?", this.Urlencode(params)))
                }
                var signature interface{} = this.Hmac(this.Encode(signMessage), this.Encode(this.Secret), ccxt.Sha256)
                headers = map[string]interface{} {
                ...
                signMessage = ccxt.Add(signMessage, body)
                var signature interface{} = this.Hmac(this.Encode(signMessage), this.Encode(this.Secret), ccxt.Sha256)
                headers = map[string]interface{} {
...
func  (this *bitrue) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(code, 400)) {
        ...
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(body, "PRICE_FILTER"), 0)) {
            panic(ccxt.InvalidOrder(ccxt.Add(ccxt.Add(this.Id, " order price is invalid, i.e. exceeds allowed price precision, exceeds min price or max price limits or is invalid float value in general, use this.priceToPrecision (symbol, amount) "), body)))
        }
    }
    ...
    if !ccxt.IsTrue(success) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(messageInner, nil)) {
            
            {		 func(this *bitrue) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            		...
            		// try block:
                                    parsedMessage = ccxt.JsonParse(messageInner)
            		return nil
            	}(this)
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(err, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(err, "-2015"))) && ccxt.IsTrue(ccxt.GetValue(this.Options, "hasAlreadyAuthenticatedSuccessfully"))) {
            panic(ccxt.DDoSProtection(ccxt.Add(ccxt.Add(this.Id, " temporary banned: "), body)))
        }
...
func  (this *bitrue) CalculateRateLimiterCost(api interface{}, method interface{}, path interface{}, params interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = config
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.InOp(config, "noSymbol"))) && !ccxt.IsTrue((ccxt.InOp(params, "symbol")))) {
