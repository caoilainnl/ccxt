...
func NewBitrueWsCore() bitrueWs {
   p := bitrueWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bitrueWs) Describe() interface{}  {
 ...
 */
func  (this *bitrueWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *bitrueWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "BALANCE",
...
func  (this *bitrueWs) ParseWSBalances(balances interface{})  {
    //
    //    [{
    //         "a": "btc",
    //         "F": "0.0006000000000000",
 ...
 */
func  (this *bitrueWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitrueWs) HandleOrder(client interface{}, message interface{})  {
    //
    //    {
    //        "e": "ORDER",
    //        "i": 16122802798,
...
func  (this *bitrueWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "e": "ORDER",
    //        "i": 16122802798,
...
func  (this *bitrueWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitrueWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *bitrueWs) ParseWsOrderType(typeId interface{}) interface{}  {
...
func  (this *bitrueWs) ParseWsOrderStatus(status interface{}) interface{}  {
...
func  (this *bitrueWs) HandlePing(client interface{}, message interface{})  {
    this.Spawn(this.Pong, client, message)
}
func  (this *bitrueWs) Pong(client interface{}, message interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            //     }
            //
            var timestamp interface{} = this.SafeInteger(message, "ping")
...
func  (this *bitrueWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *bitrueWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitrueWs) KeepAliveListenKey(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *bitrueWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *bitrueWs) interface{} {
            					// catch block:
...
func (this *bitrueWs) Init(userConfig map[string]interface{}) {
    this.bitrue.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
