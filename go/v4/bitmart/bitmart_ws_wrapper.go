...
func NewBitmartWs(userConfig map[string]interface{}) BitmartWs {
   p := &bitmartWs{}
   p.Init(userConfig)
   return BitmartWs{
       bitmartWs: p,
...
func (this *BitmartWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
...
func (this *BitmartWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *BitmartWs) WatchTradesForSymbols(symbols []string, options ...ccxt.WatchTradesForSymbolsOptions) ([]ccxt.Trade, error) {
...
func (this *BitmartWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *BitmartWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *BitmartWs) WatchBidsAsks(options ...ccxt.WatchBidsAsksOptions) (ccxt.Tickers, error) {
...
func (this *BitmartWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *BitmartWs) WatchPositions(options ...ccxt.WatchPositionsOptions) ([]ccxt.Position, error) {
...
func (this *BitmartWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *BitmartWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *BitmartWs) WatchOrderBookForSymbols(symbols []string, options ...ccxt.WatchOrderBookForSymbolsOptions) (ccxt.IOrderBook, error) {
