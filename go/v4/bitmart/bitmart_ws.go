...
func NewBitmartWsCore() bitmartWs {
   p := bitmartWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bitmartWs) Describe() interface{}  {
...
func  (this *bitmartWs) Subscribe(channel interface{}, symbol interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *bitmartWs) SubscribeMultiple(channel interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.AddElementToObject(request, actionType, "subscribe")
                ...
                retRes14415 :=  (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), rawSubscriptions, nil))
 ...
 */
func  (this *bitmartWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp844662 := this.HandleMarketTypeAndParams("watchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp844662, 0)
            params = ccxt.GetValue(__tmp844662, 1)
            ...
            __tmp727349 := this.HandleOptionAndParams(this.Options, "watchBalance", "fetchBalanceSnapshot", true)
            fetchBalanceSnapshot = ccxt.GetValue(__tmp727349, 0)
            params = ccxt.GetValue(__tmp727349, 1)
            __tmp231276 := this.HandleOptionAndParams(this.Options, "watchBalance", "awaitBalanceSnapshot", false)
            awaitBalanceSnapshot = ccxt.GetValue(__tmp231276, 0)
            params = ccxt.GetValue(__tmp231276, 1)
...
func  (this *bitmartWs) SetBalanceCache(client interface{}, typeVar interface{}, subscribeHash interface{})  {
...
func  (this *bitmartWs) LoadBalanceSnapshot(client interface{}, messageHash interface{}, typeVar interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmartWs) HandleBalance(client interface{}, message interface{})  {
    //
    // spot
    //    {
    //        "data":[
 ...
 */
func  (this *bitmartWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *bitmartWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp348750 := this.GetParamsForMultipleSub("watchTradesForSymbols", symbols, limit, params)
            symbols = ccxt.GetValue(__tmp348750, 0)
            marketType = ccxt.GetValue(__tmp348750, 1)
            params = ccxt.GetValue(__tmp348750, 2)
...
func  (this *bitmartWs) GetParamsForMultipleSub(methodName interface{}, symbols interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var marketType interface{} = nil
    __tmp605600 := this.HandleMarketTypeAndParams(methodName, market, params)
    marketType = ccxt.GetValue(__tmp605600, 0)
    params = ccxt.GetValue(__tmp605600, 1)
 ...
 */
func  (this *bitmartWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bitmartWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp82091 := this.HandleMarketTypeAndParams("watchTickers", market, params)
            marketType = ccxt.GetValue(__tmp82091, 0)
            params = ccxt.GetValue(__tmp82091, 1)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bitmartWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp206417 := this.HandleMarketTypeAndParams("watchBidsAsks", firstMarket, params)
            marketType = ccxt.GetValue(__tmp206417, 0)
            params = ccxt.GetValue(__tmp206417, 1)
            ...
            newTickers:= (<-this.WatchMultiple(url, messageHashes, request, rawSubscriptions, nil))
...
func  (this *bitmartWs) HandleBidAsk(client interface{}, message interface{})  {
...
func  (this *bitmartWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *bitmartWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = "spot"
            __tmp417015 := this.HandleMarketTypeAndParams("watchOrders", market, params)
            typeVar = ccxt.GetValue(__tmp417015, 0)
            params = ccxt.GetValue(__tmp417015, 1)
...
func  (this *bitmartWs) HandleOrders(client interface{}, message interface{})  {
    //
    // spot
    //    {
    //        "data":[
...
func  (this *bitmartWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //    {
    //        "symbol": "LTC_USDT",
...
func  (this *bitmartWs) ParseWsOrderStatus(statusId interface{}) interface{}  {
...
func  (this *bitmartWs) ParseWsOrderSide(sideId interface{}) interface{}  {
 ...
 */
func  (this *bitmartWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmartWs) HandlePositions(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *bitmartWs) ParseWsPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //       "symbol":"LTCUSDT",
    //       "hold_volume":"6",
...
func  (this *bitmartWs) HandleTrade(client interface{}, message interface{})  {
    //
    // spot
    //    {
    //        "table": "spot/trade",
...
func  (this *bitmartWs) HandleTradeLoop(entry interface{}) interface{}  {
...
func  (this *bitmartWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //     {
    //         "ms_t": 1740320841473,
...
func  (this *bitmartWs) HandleTicker(client interface{}, message interface{})  {
    //
    //    {
    //        "data": [
    //            {
...
func  (this *bitmartWs) ParseWsSwapTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "symbol": "ETHUSDT",
    //         "last_price": "2807.73",
 ...
 */
func  (this *bitmartWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = "spot"
            __tmp677641 := this.HandleMarketTypeAndParams("watchOrderBook", market, params)
            typeVar = ccxt.GetValue(__tmp677641, 0)
            params = ccxt.GetValue(__tmp677641, 1)
...
func  (this *bitmartWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //    {
    //        "data": [
    //            {
 ...
 */
func  (this *bitmartWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = "spot"
            __tmp689921 := this.HandleMarketTypeAndParams("watchOrderBook", market, params)
            typeVar = ccxt.GetValue(__tmp689921, 0)
            params = ccxt.GetValue(__tmp689921, 1)
...
func  (this *bitmartWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *bitmartWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *bitmartWs) HandleOrderBookMessage(client interface{}, message interface{}, orderbook interface{}) interface{}  {
    //
    //     {
    //         "asks": [
    //             [ '46828.38', "0.21847" ],
...
func  (this *bitmartWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // spot depth-all
    //
    //    {
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *bitmartWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp147934 := this.GetParamsForMultipleSub("watchOrderBookForSymbols", symbols, limit, params)
            symbols = ccxt.GetValue(__tmp147934, 0)
            typeVar = ccxt.GetValue(__tmp147934, 1)
            params = ccxt.GetValue(__tmp147934, 2)
            var channel interface{} = nil
            __tmp219169 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "depth", "depth/increase100")
            channel = ccxt.GetValue(__tmp219169, 0)
            params = ccxt.GetValue(__tmp219169, 1)
...
func  (this *bitmartWs) Authenticate(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes155715 :=  <-future.(<-chan interface{})
...
func  (this *bitmartWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //    {"event":"subscribe","channel":"spot/depth:BTC-USDT"}
    //
    return message
}
func  (this *bitmartWs) HandleAuthenticate(client interface{}, message interface{})  {
    //
    // spot
    //    { event: "login" }
    // swap
...
func  (this *bitmartWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    ...
    {		ret__ := func(this *bitmartWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *bitmartWs) interface{} {
    					// catch block:
    		...
    		// try block:
                    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(errorCode, nil)) || ccxt.IsTrue(!ccxt.IsEqual(err, nil))) {
                ...
                var messageString interface{} = this.SafeValue(message, "message", err)
...
func  (this *bitmartWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *bitmartWs) Init(userConfig map[string]interface{}) {
    this.bitmart.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
