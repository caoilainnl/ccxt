...
func NewHitbtcWsCore() hitbtcWs {
   p := hitbtcWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *hitbtcWs) Describe() interface{}  {
 ...
 */
func  (this *hitbtcWs) Authenticate() <- chan interface{} {
 ...
 */
func  (this *hitbtcWs) SubscribePublic(name interface{}, messageHashPrefix interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var request interface{} = this.Extend(subscribe, params)
                ...
                retRes15515 :=  (<-this.WatchMultiple(url, messageHashes, request, messageHashes, nil))
 ...
 * @param {object} [params] extra parameters specific to the hitbtc api
 */
func  (this *hitbtcWs) SubscribePrivate(name interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @param {object} [params] extra parameters specific to the hitbtc api
 */
func  (this *hitbtcWs) TradeRequest(name interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *hitbtcWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hitbtcWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *hitbtcWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *hitbtcWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *hitbtcWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *hitbtcWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hitbtcWs) HandleTicker(client interface{}, message interface{})  {
    //
    //    {
    //        "ch": "ticker/1s",
    //        "data": {
...
func  (this *hitbtcWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "t": 1614815872000,             // Timestamp in milliseconds
    //        "a": "0.031175",                // Best ask
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *hitbtcWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hitbtcWs) HandleBidAsk(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *hitbtcWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var timestamp interface{} = this.SafeInteger(ticker, "t")
    return this.SafeTicker(map[string]interface{} {
 ...
 */
func  (this *hitbtcWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hitbtcWs) HandleTrades(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "result": {
    //            "ch": "trades",                           // Channel
...
func  (this *hitbtcWs) ParseWsTrades(trades interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *hitbtcWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
 ...
 */
func  (this *hitbtcWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hitbtcWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    //    {
...
func  (this *hitbtcWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "t": 1626860340000,             // Message timestamp
    //        "o": "30881.95",                // Open price
 ...
 */
func  (this *hitbtcWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp783730 := this.HandleMarketTypeAndParams("watchOrders", market, params)
            marketType = ccxt.GetValue(__tmp783730, 0)
            params = ccxt.GetValue(__tmp783730, 1)
...
func  (this *hitbtcWs) HandleOrder(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "jsonrpc": "2.0",
    ...
    if ccxt.IsTrue(ccxt.IsEqual(this.Orders, nil)) {
        var limit interface{} = this.SafeInteger(this.Options, "orderbooks.(ccxt.GetsLimit).Limit")
...
func  (this *hitbtcWs) HandleOrderHelper(client interface{}, message interface{}, order interface{})  {
...
func  (this *hitbtcWs) ParseWsOrderTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "id": 584244931496,
    //        "client_order_id": "b5acd79c0a854b01b558665bcf379456",
...
func  (this *hitbtcWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "id": 584244931496,
    //        "client_order_id": "b5acd79c0a854b01b558665bcf379456",
 ...
 */
func  (this *hitbtcWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp817959 := this.HandleMarketTypeAndParams("watchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp817959, 0)
            params = ccxt.GetValue(__tmp817959, 1)
 ...
 */
func  (this *hitbtcWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp433983 := this.HandleMarketTypeAndParams("createOrder", market, params)
            marketType = ccxt.GetValue(__tmp433983, 0)
            params = ccxt.GetValue(__tmp433983, 1)
            var marginMode interface{} = nil
            __tmp938559 := this.HandleMarginModeAndParams("createOrder", params)
            marginMode = ccxt.GetValue(__tmp938559, 0)
            params = ccxt.GetValue(__tmp938559, 1)
            __tmp405884 := this.CreateOrderRequest(market, marketType, typeVar, side, amount, price, marginMode, params)
            request = ccxt.GetValue(__tmp405884, 0)
            params = ccxt.GetValue(__tmp405884, 1)
 ...
 */
func  (this *hitbtcWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp811768 := this.HandleMarketTypeAndParams("cancelOrderWs", market, params)
            marketType = ccxt.GetValue(__tmp811768, 0)
            params = ccxt.GetValue(__tmp811768, 1)
 ...
 */
func  (this *hitbtcWs) CancelAllOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp616474 := this.HandleMarketTypeAndParams("cancelAllOrdersWs", market, params)
            marketType = ccxt.GetValue(__tmp616474, 0)
            params = ccxt.GetValue(__tmp616474, 1)
            var marginMode interface{} = nil
            __tmp240644 := this.HandleMarginModeAndParams("cancelAllOrdersWs", params)
            marginMode = ccxt.GetValue(__tmp240644, 0)
            params = ccxt.GetValue(__tmp240644, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
 ...
 */
func  (this *hitbtcWs) FetchOpenOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp990681 := this.HandleMarketTypeAndParams("fetchOpenOrdersWs", market, params)
            marketType = ccxt.GetValue(__tmp990681, 0)
            params = ccxt.GetValue(__tmp990681, 1)
            var marginMode interface{} = nil
            __tmp891947 := this.HandleMarginModeAndParams("fetchOpenOrdersWs", params)
            marginMode = ccxt.GetValue(__tmp891947, 0)
            params = ccxt.GetValue(__tmp891947, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
...
func  (this *hitbtcWs) HandleBalance(client interface{}, message interface{})  {
    //
    //    {
    //        "jsonrpc": "2.0",
...
func  (this *hitbtcWs) HandleNotification(client interface{}, message interface{}) interface{}  {
    //
    //     { jsonrpc: "2.0", result: true, id: null }
    //
    return message
}
func  (this *hitbtcWs) HandleOrderRequest(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *hitbtcWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *hitbtcWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "jsonrpc": "2.0",
    //        "result": true
...
func  (this *hitbtcWs) HandleError(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        jsonrpc: '2.0',
    //        error: {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(err, nil)) {
        ...
        {		 func(this *hitbtcWs) (ret_ interface{}) {
        		defer func() {
        			if e := recover(); e != nil {
                        if e == "break" {
        				    return
        			    }
        				ret_ = func(this *hitbtcWs) interface{} {
        					// catch block:
        		...
        		// try block:
                            var code interface{} = this.SafeValue(err, "code")
                    var errorMessage interface{} = this.SafeString(err, "message")
                    var description interface{} = this.SafeString(err, "description")
...
func (this *hitbtcWs) Init(userConfig map[string]interface{}) {
