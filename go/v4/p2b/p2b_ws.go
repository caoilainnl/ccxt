...
func NewP2bWsCore() p2bWs {
   p := p2bWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *p2bWs) Describe() interface{}  {
 ...
 */
func  (this *p2bWs) Subscribe(name interface{}, messageHash interface{}, request interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 */
func  (this *p2bWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *p2bWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp89640 := this.HandleOptionAndParams(params, "method", "name", name)
            name = ccxt.GetValue(__tmp89640, 0)
            params = ccxt.GetValue(__tmp89640, 1)
            var market interface{} = this.Market(symbol)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *p2bWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var watchTickerOptions interface{} = this.SafeDict(this.Options, "watchTicker")
            var name interface{} = this.SafeString(watchTickerOptions, "name", "state") // or price
            __tmp948376 := this.HandleOptionAndParams(params, "method", "name", name)
            name = ccxt.GetValue(__tmp948376, 0)
            params = ccxt.GetValue(__tmp948376, 1)
            ...
            retRes1718 := (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, nil))
 ...
 */
func  (this *p2bWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *p2bWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            trades:= (<-this.WatchMultiple(url, messageHashes, query, messageHashes, nil))
 ...
 */
func  (this *p2bWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *p2bWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "method": "kline.update",
    //        "params": [
...
func  (this *p2bWs) HandleTrade(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "method": "deals.update",
    //        "params": [
...
func  (this *p2bWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    // state
    //
    //    {
...
func  (this *p2bWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //    {
    //        "method": "depth.update",
    //        "params": [
...
func  (this *p2bWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *p2bWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    var err interface{} = this.SafeString(message, "error")
    if ccxt.IsTrue(!ccxt.IsEqual(err, nil)) {
        panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " error: "), this.Json(err))))
    }
    return false
}
func  (this *p2bWs) Ping(client interface{}) interface{}  {
    /**
...
func  (this *p2bWs) HandlePong(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        error: null,
    //        result: 'pong',
    ...
    //    }
    //
    client.(*ccxt.Client).LastPong = this.SafeInteger(message, "id")
    return message
}
func  (this *p2bWs) OnError(client interface{}, error interface{})  {
    ccxt.AddElementToObject(this.Options, "tickerSubs", this.CreateSafeDictionary())
    this.base.OnError(client, error)
}
func  (this *p2bWs) OnClose(client interface{}, error interface{})  {
    ccxt.AddElementToObject(this.Options, "tickerSubs", this.CreateSafeDictionary())
    this.base.OnClose(client, error)
}


func (this *p2bWs) Init(userConfig map[string]interface{}) {
    this.p2b.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
