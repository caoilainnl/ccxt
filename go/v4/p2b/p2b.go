...
func  (this *p2b) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            ...
            "1007": ccxt.AuthenticationError,
            "1008": ccxt.AuthenticationError,
            "1009": ccxt.AuthenticationError,
            "1010": ccxt.AuthenticationError,
            "1011": ccxt.AuthenticationError,
            "1012": ccxt.AuthenticationError,
            "1013": ccxt.AuthenticationError,
            "1014": ccxt.AuthenticationError,
            "1015": ccxt.AuthenticationError,
            "1016": ccxt.AuthenticationError,
            "2010": ccxt.BadRequest,
            "2020": ccxt.BadRequest,
            "2021": ccxt.BadRequest,
            "2030": ccxt.BadRequest,
            "2040": ccxt.InsufficientFunds,
            "2050": ccxt.BadRequest,
            "2051": ccxt.BadRequest,
            "2052": ccxt.BadRequest,
            "2060": ccxt.BadRequest,
            "2061": ccxt.BadRequest,
            "2062": ccxt.BadRequest,
            "2070": ccxt.BadRequest,
            "3001": ccxt.BadRequest,
            "3020": ccxt.BadRequest,
            "3030": ccxt.BadRequest,
            "3040": ccxt.BadRequest,
            "3050": ccxt.BadRequest,
            "3060": ccxt.BadRequest,
            "3070": ccxt.BadRequest,
            "3080": ccxt.BadRequest,
            "3090": ccxt.BadRequest,
            "3100": ccxt.BadRequest,
            "3110": ccxt.BadRequest,
...
func  (this *p2b) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(ticker, "ticker")) {
...
func  (this *p2b) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseOrderBook(result, ccxt.GetValue(market, "symbol"), timestamp, "bids", "asks", 0, 1)
            return nil
...
func  (this *p2b) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(lastId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchTrades () requires an extra parameter params[\"lastId\"]")))
            }
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
...
func  (this *p2b) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(takerOrMaker, "1")) {
        takerOrMaker = "maker"
    } else if ccxt.IsTrue(ccxt.IsEqual(takerOrMaker, "2")) {
        takerOrMaker = "taker"
    }
...
func  (this *p2b) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
        ...
        var balance interface{} = ccxt.GetValue(response, currencyId)
...
func  (this *p2b) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " createOrder () can only accept orders with type \"limit\"")))
            }
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
            ...
            //        "message": "",
            //        "result": {
            //            "orderId": 171906478744,          // ccxt.Order id
            //            "market": "ETH_BTC",              // ccxt.Market name
            //            "price": "0.04348",               // Price
            //            "side": "buy",                    // Side
            //            "type": "limit",                  // ccxt.Order type
            //            "timestamp": 1698484861.746517,   // ccxt.Order creation time
...
func  (this *p2b) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOpenOrders () requires the symbol argument")))
            }
...
func  (this *p2b) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(until, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                    ...
                    until = ccxt.Add(since, 86400000)
                }
            }
            if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                since = ccxt.Subtract(until, 86400000)
            }
            if ccxt.IsTrue(ccxt.IsGreaterThan((ccxt.Subtract(until, since)), 86400000)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchMyTrades () the time between since and params[\"until\"] cannot be greater than 24 hours")))
            }
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
                "startTime": this.ParseToInt(ccxt.Divide(since, 1000)),
                "endTime": this.ParseToInt(ccxt.Divide(until, 1000)),
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit)
            }
...
func  (this *p2b) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsGreaterThan((ccxt.Subtract(until, since)), 86400000)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchClosedOrders () the time between since and params[\"until\"] cannot be greater than 24 hours")))
            }
            var request interface{} = map[string]interface{} {
                "startTime": this.ParseToInt(ccxt.Divide(since, 1000)),
                "endTime": this.ParseToInt(ccxt.Divide(until, 1000)),
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                ...
                var marketOrders interface{} = ccxt.GetValue(result, marketId)
...
func  (this *p2b) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //
    //    {
    //        "id": 171366547790,           // ccxt.Order id
    //        "amount": "0.00032",          // Original amount
    //        "price": "34293.92",          // ccxt.Order price
    //        "type": "limit",              // ccxt.Order type
    //        "side": "sell",               // ccxt.Order side
    //        "ctime": 1698237533.497241,   // ccxt.Order creation time
    //        "ftime": 1698237535.41196,    // ccxt.Order fill time
    //        "market": "BTC_USDT",         // ccxt.Market name
    //        "takerFee": "0.0018",         // Taker fee
    //        "makerFee": "0.0016",         // ccxt.Market fee
...
func  (this *p2b) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ccxt.AddElementToObject(params, "request", ccxt.Add("/api/v2/", path))
        ccxt.AddElementToObject(params, "nonce", ccxt.ToString(this.Nonce()))
        var payload interface{} = this.StringToBase64(this.Json(params)) // Body json encoded in base64
        headers = map[string]interface{} {
            "Content-Type": "application/json",
            "X-TXC-APIKEY": this.ApiKey,
            "X-TXC-PAYLOAD": payload,
            "X-TXC-SIGNATURE": this.Hmac(this.Encode(payload), this.Encode(this.Secret), ccxt.Sha512),
        }
