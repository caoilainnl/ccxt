...
func  (this *paymium) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencies)); i++ {
        var code interface{} = ccxt.GetValue(currencies, i)
        var currency interface{} = this.Currency(code)
        var currencyId interface{} = ccxt.GetValue(currency, "id")
        var free interface{} = ccxt.Add("balance_", currencyId)
        if ccxt.IsTrue(ccxt.InOp(response, free)) {
            var account interface{} = this.Account()
            var used interface{} = ccxt.Add("locked_", currencyId)
...
func  (this *paymium) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var amountField interface{} = ccxt.Add("traded_", ccxt.ToLower(ccxt.GetValue(market, "base")))
...
func  (this *paymium) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": ccxt.Add(this.Capitalize(typeVar), "ccxt.Order"),
                "currency": ccxt.GetValue(market, "id"),
                "direction": side,
                "amount": amount,
            }
            ...
            ch <- this.SafeOrder(map[string]interface{} {
                "info": response,
                "id": ccxt.GetValue(response, "uuid"),
            }, market)
            return nil
...
func  (this *paymium) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var currency interface{} = this.Currency(code)
            if ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetIndexOf(toAccount, "@"), 0)) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " transfer() only allows transfers to an email address")))
            }
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(code, "BTC")) && ccxt.IsTrue(!ccxt.IsEqual(code, "EUR"))) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " transfer() only allows BTC or EUR")))
            }
            var request interface{} = map[string]interface{} {
...
func  (this *paymium) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        var auth interface{} = ccxt.Add(nonce, url)
