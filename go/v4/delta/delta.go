    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "order_size_exceed_available": ccxt.InvalidOrder,
                "risk_limits_breached": ccxt.BadRequest,
                "invalid_contract": ccxt.BadSymbol,
                "immediate_liquidation": ccxt.InvalidOrder,
                "out_of_bankruptcy": ccxt.InvalidOrder,
                "self_matching_disrupted_post_only": ccxt.InvalidOrder,
                "immediate_execution_post_only": ccxt.InvalidOrder,
                "bad_schema": ccxt.BadRequest,
                "invalid_api_key": ccxt.AuthenticationError,
                "invalid_signature": ccxt.AuthenticationError,
                "open_order_not_found": ccxt.OrderNotFound,
...
func  (this *delta) CreateExpiredOptionMarket(symbol interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(expiry, nil)) {
        expiry = ccxt.Add(ccxt.Add(ccxt.Slice(expiry, 4, nil), ccxt.Slice(expiry, 2, 4)), ccxt.Slice(expiry, 0, 2))
    }
    ...
    return map[string]interface{} {
        "id": ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(optionType, "-"), base), "-"), strike), "-"), expiry),
...
func  (this *delta) SafeMarket(optionalArgs ...interface{}) interface{}  {
    ...
    _ = marketType
    var isOption interface{} = ccxt.IsTrue((!ccxt.IsEqual(marketId, nil))) && ccxt.IsTrue((ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.EndsWith(marketId, "-C"))) || ccxt.IsTrue((ccxt.EndsWith(marketId, "-P")))) || ccxt.IsTrue((ccxt.StartsWith(marketId, "C-")))) || ccxt.IsTrue((ccxt.StartsWith(marketId, "P-")))))
...
func  (this *delta) FetchStatus(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var status interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(underMaintenance, "true"))), "maintenance", "ok")
...
func  (this *delta) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            "info": chain,
            "active": ccxt.IsEqual(this.SafeString(chain, "status"), "enabled"),
            "deposit": ccxt.IsEqual(this.SafeString(chain, "deposit_status"), "enabled"),
            "withdraw": ccxt.IsEqual(this.SafeString(chain, "withdrawal_status"), "enabled"),
            ...
            "info": currency,
            "active": nil,
            "deposit": ccxt.IsEqual(this.SafeString(currency, "deposit_status"), "enabled"),
            "withdraw": ccxt.IsEqual(this.SafeString(currency, "withdrawal_status"), "enabled"),
...
func  (this *delta) LoadMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(currenciesByNumericId, nil))) || ccxt.IsTrue(reload)) {
                ccxt.AddElementToObject(this.Options, "currenciesByNumericId", this.IndexByStringifiedNumericId(this.Currencies))
            }
            var marketsByNumericId interface{} = this.SafeDict(this.Options, "marketsByNumericId")
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(marketsByNumericId, nil))) || ccxt.IsTrue(reload)) {
                ccxt.AddElementToObject(this.Options, "marketsByNumericId", this.IndexByStringifiedNumericId(this.Markets))
            }
...
func  (this *delta) IndexByStringifiedNumericId(input interface{}) interface{}  {
    var result interface{} = map[string]interface{} {}
    if ccxt.IsTrue(ccxt.IsEqual(input, nil)) {
        return nil
    }
    var keys interface{} = ccxt.ObjectKeys(input)
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
        var key interface{} = ccxt.GetValue(keys, i)
        var item interface{} = ccxt.GetValue(input, key)
        var numericIdString interface{} = this.SafeString(item, "numericId")
        if ccxt.IsTrue(ccxt.IsEqual(numericIdString, nil)) {
            continue
        }
        ccxt.AddElementToObject(result, numericIdString, item)
    }
    return result
}
/**
...
func  (this *delta) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            //                 "short_description":"LINK Daily PUT ccxt.Options",
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(typeVar, "options_combos")) {
                    continue
                }
                ...
                var callOptions interface{} =         (ccxt.IsEqual(typeVar, "call_options"))
                var putOptions interface{} =         (ccxt.IsEqual(typeVar, "put_options"))
                var moveOptions interface{} =         (ccxt.IsEqual(typeVar, "move_options"))
                var spot interface{} =         (ccxt.IsEqual(typeVar, "spot"))
                var swap interface{} =         (ccxt.IsEqual(typeVar, "perpetual_futures"))
                var future interface{} =         (ccxt.IsEqual(typeVar, "futures"))
                var option interface{} =         (ccxt.IsTrue(ccxt.IsTrue(callOptions) || ccxt.IsTrue(putOptions)) || ccxt.IsTrue(moveOptions))
                ...
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(swap) || ccxt.IsTrue(future)) || ccxt.IsTrue(option)) {
                    symbol = ccxt.Add(ccxt.Add(symbol, ":"), settle)
                    if ccxt.IsTrue(ccxt.IsTrue(future) || ccxt.IsTrue(option)) {
                        symbol = ccxt.Add(ccxt.Add(symbol, "-"), this.Yymmdd(expiry))
                        if ccxt.IsTrue(option) {
                            typeVar = "option"
                            var letter interface{} = "C"
                            optionType = "call"
                            if ccxt.IsTrue(putOptions) {
                                letter = "P"
                                optionType = "put"
                            } else if ccxt.IsTrue(moveOptions) {
                                letter = "M"
                                optionType = "move"
                            }
                            symbol = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(symbol, "-"), strike), "-"), letter)
                        } else {
                            typeVar = "future"
                        }
                    } else {
                ...
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "type": typeVar,
                    "spot": spot,
                    "margin": ccxt.Ternary(ccxt.IsTrue(spot), nil, false),
                    "swap": swap,
                    "future": future,
                    "option": option,
                    "active": (ccxt.IsEqual(state, "live")),
                    "contract": !ccxt.IsTrue(spot),
                    "linear": ccxt.Ternary(ccxt.IsTrue(spot), nil, linear),
                    "inverse": ccxt.Ternary(ccxt.IsTrue(spot), nil, !ccxt.IsTrue(linear)),
                    "taker": this.SafeNumber(market, "taker_commission_rate"),
                    "maker": this.SafeNumber(market, "maker_commission_rate"),
                    "contractSize": ccxt.Ternary(ccxt.IsTrue(spot), nil, contractSize),
                    "expiry": expiry,
...
func  (this *delta) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseOrderBook(result, ccxt.GetValue(market, "symbol"), nil, "buy", "sell", "price", "size")
            return nil
...
func  (this *delta) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(side, nil)) {
        if ccxt.IsTrue(ccxt.IsEqual(sellerRole, "taker")) {
            side = "sell"
        } else if ccxt.IsTrue(ccxt.IsEqual(sellerRole, "maker")) {
            side = "buy"
        }
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(typeVar, nil)) {
        typeVar = ccxt.Replace(typeVar, "_order", "")
    }
...
func  (this *delta) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            limit = ccxt.Ternary(ccxt.IsTrue(limit), limit, 2000) // max 2000
            ...
            if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                var end interface{} = ccxt.Ternary(ccxt.IsTrue(untilIsDefined), until, this.Seconds())
                ccxt.AddElementToObject(request, "end", end)
                ccxt.AddElementToObject(request, "start", ccxt.Subtract(end, ccxt.Multiply(limit, duration)))
            } else {
                var start interface{} = this.ParseToInt(ccxt.Divide(since, 1000))
                ccxt.AddElementToObject(request, "start", start)
                ccxt.AddElementToObject(request, "end", ccxt.Ternary(ccxt.IsTrue(untilIsDefined), until, this.Sum(start, ccxt.Multiply(limit, duration))))
            }
            var price interface{} = this.SafeString(params, "price")
            if ccxt.IsTrue(ccxt.IsEqual(price, "mark")) {
                ccxt.AddElementToObject(request, "symbol", ccxt.Add("MARK:", ccxt.GetValue(market, "id")))
            } else if ccxt.IsTrue(ccxt.IsEqual(price, "index")) {
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(market, "info"), "spot_index"), "symbol"))
            } else {
...
func  (this *delta) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
        ...
        var code interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(currency, nil))), currencyId, ccxt.GetValue(currency, "code"))
        var account interface{} = this.Account()
        ccxt.AddElementToObject(account, "total", this.SafeString(balance, "balance"))
        ccxt.AddElementToObject(account, "free", this.SafeString(balance, "available_balance"))
...
func  (this *delta) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": ccxt.GetValue(market, "numericId"),
            }
...
func  (this *delta) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(sizeString, nil)) {
        if ccxt.IsTrue(ccxt.Precise.StringGt(sizeString, "0")) {
            side = "buy"
        } else if ccxt.IsTrue(ccxt.Precise.StringLt(sizeString, "0")) {
            side = "sell"
        }
    }
...
func  (this *delta) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var symbol interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(market, nil))), marketId, ccxt.GetValue(market, "symbol"))
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeCostString, nil)) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(market, nil)) {
            var settlingAsset interface{} = this.SafeDict(ccxt.GetValue(market, "info"), "settling_asset", map[string]interface{} {})
            var feeCurrencyId interface{} = this.SafeString(settlingAsset, "symbol")
...
func  (this *delta) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var orderType interface{} = ccxt.Add(typeVar, "_order")
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": ccxt.GetValue(market, "numericId"),
...
func  (this *delta) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes219215)
                ch <- retRes219215
                return nil
...
func  (this *delta) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes220715)
                ch <- retRes220715
                return nil
...
func  (this *delta) FetchOrdersWithMethod(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                ccxt.AddElementToObject(request, "product_ids", ccxt.GetValue(market, "numericId")) // accepts a comma-separated list of ids
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_time", ccxt.Add(ccxt.ToString(since), "000"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "page_size", limit)
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(method, "privateGetOrders")) {
                response = (<-this.PrivateGetOrders(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "privateGetOrdersHistory")) {
...
func  (this *delta) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                ...
                ccxt.AddElementToObject(request, "asset_id", ccxt.GetValue(currency, "numericId"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "page_size", limit)
            }
...
func  (this *delta) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "deposit"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "commission_rebate")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "referral_bonus")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "pnl")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "withdrawal_cancellation")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "promo_credit")))) {
        direction = "in"
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "withdrawal"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "commission")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "conversion")))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "perpetual_futures_funding")))) {
        direction = "out"
    }
    ...
    var before interface{} = ccxt.Precise.StringMax("0", ccxt.Precise.StringSub(after, amount))
...
func  (this *delta) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
                ccxt.AddElementToObject(request, "network", this.NetworkCodeToId(networkCode, code))
...
func  (this *delta) ParseFundingRate(contract interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var fundingRate interface{} = ccxt.Precise.StringDiv(fundingRateString, "100")
    return map[string]interface{} {
        "info": contract,
...
func  (this *delta) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes276115)
                ch <- retRes276115
                return nil
...
func  (this *delta) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes277515)
                ch <- retRes277515
                return nil
...
func  (this *delta) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "reduce")) {
                amount = ccxt.Precise.StringMul(amount, "-1")
            }
            var request interface{} = map[string]interface{} {
                "product_id": ccxt.GetValue(market, "numericId"),
                "delta_margin": amount,
...
func  (this *delta) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes306915)
                    //
            //     {
            //         "result": {
            //             "leverage": "20",
...
func  (this *delta) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    var requestPath interface{} = ccxt.Add(ccxt.Add(ccxt.Add("/", this.Version), "/"), this.ImplodeParams(path, params))
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        var auth interface{} = ccxt.Add(ccxt.Add(method, timestamp), requestPath)
        if ccxt.IsTrue(ccxt.IsEqual(method, "GET")) {
            if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
                var queryString interface{} = ccxt.Add("?", this.Urlencode(query))
                auth = ccxt.Add(auth, queryString)
