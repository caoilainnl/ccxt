    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "-3023": ccxt.BadRequest,
                "-3024": ccxt.ExchangeError,
                "-3025": ccxt.BadRequest,
                "-3026": ccxt.BadRequest,
                "-3027": ccxt.BadSymbol,
                "-3028": ccxt.BadSymbol,
                "-3029": ccxt.ExchangeError,
                "-3036": ccxt.AccountSuspended,
                "-3037": ccxt.ExchangeError,
                "-3038": ccxt.BadRequest,
                "-3041": ccxt.InsufficientFunds,
                "-3042": ccxt.BadRequest,
                "-3043": ccxt.BadRequest,
                "-3044": ccxt.DDoSProtection,
                "-3045": ccxt.ExchangeError,
                "-3999": ccxt.ExchangeError,
                ...
                "-5004": ccxt.BadRequest,
                "-5005": ccxt.InsufficientFunds,
                "-5006": ccxt.BadRequest,
                "-5007": ccxt.BadRequest,
                "-5008": ccxt.InsufficientFunds,
                "-5009": ccxt.BadRequest,
                "-5010": ccxt.ExchangeError,
                "-5011": ccxt.BadRequest,
                "-5012": ccxt.ExchangeError,
                "-5013": ccxt.InsufficientFunds,
                "-5021": ccxt.BadRequest,
                "-6001": ccxt.BadRequest,
                "-6003": ccxt.BadRequest,
                "-6004": ccxt.ExchangeError,
                "-6005": ccxt.InvalidOrder,
                "-6006": ccxt.BadRequest,
                "-6007": ccxt.BadRequest,
                "-6008": ccxt.BadRequest,
                "-6009": ccxt.RateLimitExceeded,
                "-6011": ccxt.BadRequest,
                "-6012": ccxt.InsufficientFunds,
                "-6013": ccxt.ExchangeError,
                "-6014": ccxt.BadRequest,
                "-6015": ccxt.BadRequest,
                "-6016": ccxt.BadRequest,
                "-6017": ccxt.BadRequest,
                "-6018": ccxt.BadRequest,
                "-6019": ccxt.AuthenticationError,
                "-6020": ccxt.BadRequest,
                "-7001": ccxt.BadRequest,
                "-7002": ccxt.BadRequest,
                "-9000": ccxt.InsufficientFunds,
                "-10017": ccxt.BadRequest,
                "-11008": ccxt.InsufficientFunds,
                "-12014": ccxt.RateLimitExceeded,
                "-13000": ccxt.BadRequest,
                "-13001": ccxt.BadRequest,
                "-13002": ccxt.BadRequest,
                "-13003": ccxt.BadRequest,
                "-13004": ccxt.BadRequest,
                "-13005": ccxt.BadRequest,
                "-13006": ccxt.InvalidOrder,
                "-13007": ccxt.AuthenticationError,
                "-21001": ccxt.BadRequest,
                "-21002": ccxt.BadRequest,
                "-21003": ccxt.BadRequest,
                "100001003": ccxt.BadRequest,
                "2202": ccxt.InsufficientFunds,
                "3210": ccxt.InvalidOrder,
                "3203": ccxt.InvalidOrder,
                "3211": ccxt.InvalidOrder,
                "3207": ccxt.InvalidOrder,
                "3218": ccxt.OrderNotFound,
            },
...
func  (this *tokocrypto) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(list)); i++ {
                var market interface{} = ccxt.GetValue(list, i)
                ...
                var active interface{} =         (ccxt.IsEqual(status, "1"))
            ...
            "max": this.SafeNumber(filter, "maxPrice"),
                    ...
                    ccxt.AddElementToObject(ccxt.GetValue(entry, "precision"), "price", ccxt.GetValue(filter, "tickSize"))
                }
            ...
            "max": this.SafeNumber(filter, "maxQty"),
                ...
                if ccxt.IsTrue(ccxt.InOp(filtersByType, "MIN_NOTIONAL")) {
...
func  (this *tokocrypto) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(market, "quote"), "USDT")) {
                ccxt.AddElementToObject(request, "symbol", ccxt.Add(ccxt.GetValue(market, "baseId"), ccxt.GetValue(market, "quoteId")))
            ...
            ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(data, "lastUpdateId"))
...
func  (this *tokocrypto) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(method, "binanceGetAggTrades"))) && ccxt.IsTrue((!ccxt.IsEqual(since, nil)))) {
...
func  (this *tokocrypto) GetMarketIdByType(market interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(market, "quote"), "USDT")) {
        return ccxt.Add(ccxt.GetValue(market, "baseId"), ccxt.GetValue(market, "quoteId"))
    }
...
func  (this *tokocrypto) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.Add(ccxt.GetValue(market, "baseId"), ccxt.GetValue(market, "quoteId")),
            }
...
func  (this *tokocrypto) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(price, "index")) {
                ccxt.AddElementToObject(request, "pair", ccxt.GetValue(market, "id")) // Index price takes this argument instead of symbol
            } else {
                ccxt.AddElementToObject(request, "symbol", this.GetMarketIdByType(market))
            }
...
func  (this *tokocrypto) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.Add(ccxt.Add(ccxt.GetValue(market, "baseId"), "_"), ccxt.GetValue(market, "quoteId")),
                "type": this.SafeString(reverseOrderTypeMapping, uppercaseType),
            }
            if ccxt.IsTrue(ccxt.IsEqual(side, "buy")) {
                ccxt.AddElementToObject(request, "side", 0)
            } else if ccxt.IsTrue(ccxt.IsEqual(side, "sell")) {
                ccxt.AddElementToObject(request, "side", 1)
            }
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(broker, nil)) {
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(brokerId, nil)) {
                        ccxt.AddElementToObject(request, "clientId", ccxt.Add(brokerId, this.Uuid22()))
                    }
                }
            } else {
                ccxt.AddElementToObject(request, "clientId", clientOrderId)
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(uppercaseType, "MARKET")) {
                if ccxt.IsTrue(ccxt.IsEqual(side, "buy")) {
                    ...
                    __tmp692677 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                    createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp692677, 0)
                    params = ccxt.GetValue(__tmp692677, 1)
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
                        ...
                        if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                            ...
                            quoteAmount = ccxt.Precise.StringMul(amountString, priceString)
                        }
                    } else {
                        quoteAmount = amount
                    }
                    ccxt.AddElementToObject(request, "quoteOrderQty", this.DecimalToPrecision(quoteAmount, ccxt.TRUNCATE, precision, this.PrecisionMode))
                } else {
...
func  (this *tokocrypto) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes199515)
                ch <- retRes199515
                return nil
...
func  (this *tokocrypto) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes201115)
                ch <- retRes201115
                return nil
...
func  (this *tokocrypto) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, nil)) {
        if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(insertTime, nil))) && ccxt.IsTrue((ccxt.IsEqual(createTime, nil)))) {
            typeVar = "deposit"
            timestamp = insertTime
        } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(insertTime, nil))) && ccxt.IsTrue((!ccxt.IsEqual(createTime, nil)))) {
            typeVar = "withdrawal"
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(internalRaw, nil)) {
        internal = true
    }
...
func  (this *tokocrypto) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp595782 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp595782, 0)
            params = ccxt.GetValue(__tmp595782, 1)
        
            retRes24498 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes24498)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": ccxt.GetValue(currency, "id"),
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(networkId, nil)) {
                ccxt.AddElementToObject(request, "network", ccxt.ToUpper(networkId))
            }
...
func  (this *tokocrypto) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    if !ccxt.IsTrue((ccxt.InOp(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "rest"), api))) {
        panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " does not have a testnet/sandbox URL for "), api), " endpoints")))
    }
    var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "rest"), api)
    url = ccxt.Add(url, ccxt.Add("/", path))
    if ccxt.IsTrue(ccxt.IsEqual(api, "wapi")) {
        url = ccxt.Add(url, ".html")
    }
    ...
    if ccxt.IsTrue(userDataStream) {
    ...
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(api, "private"))) || ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(api, "sapi")) && ccxt.IsTrue(!ccxt.IsEqual(path, "system/status"))))) || ccxt.IsTrue((ccxt.IsEqual(api, "sapiV3")))) || ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(api, "wapi")) && ccxt.IsTrue(!ccxt.IsEqual(path, "systemStatus"))))) || ccxt.IsTrue((ccxt.IsEqual(api, "dapiPrivate")))) || ccxt.IsTrue((ccxt.IsEqual(api, "dapiPrivateV2")))) || ccxt.IsTrue((ccxt.IsEqual(api, "fapiPrivate")))) || ccxt.IsTrue((ccxt.IsEqual(api, "fapiPrivateV2")))) {
        ...
        } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(path, "batchOrders"))) || ccxt.IsTrue((ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(path, "sub-account"), 0)))) || ccxt.IsTrue((ccxt.IsEqual(path, "capital/withdraw/apply")))) || ccxt.IsTrue((ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(path, "staking"), 0)))) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(method, "GET"))) || ccxt.IsTrue((ccxt.IsEqual(method, "DELETE")))) || ccxt.IsTrue((ccxt.IsEqual(api, "wapi")))) {
