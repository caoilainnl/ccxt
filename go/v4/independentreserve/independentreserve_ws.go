...
type independentreserveWs struct {
	independentreserve
	base independentreserve
}

func NewIndependentreserveWsCore() independentreserveWs {
   p := independentreserveWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *independentreserveWs) Describe() interface{}  {
 ...
 */
func  (this *independentreserveWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *independentreserveWs) HandleTrades(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *independentreserveWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
 ...
 */
func  (this *independentreserveWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *independentreserveWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *independentreserveWs) ValueToChecksum(value interface{}) interface{}  {
...
func  (this *independentreserveWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, "Price", "Volume")
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *independentreserveWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *independentreserveWs) HandleHeartbeat(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "Time": 1676156208182,
    //        "Event": "Heartbeat"
...
func  (this *independentreserveWs) HandleSubscriptions(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "Data": [ "ticker-btc-sgd" ],
    //        "Time": 1676157556223,
...
func  (this *independentreserveWs) HandleMessage(client interface{}, message interface{})  {
    var event interface{} = this.SafeString(message, "Event")
...
func (this *independentreserveWs) Init(userConfig map[string]interface{}) {
    this.independentreserve.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
