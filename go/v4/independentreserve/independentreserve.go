...
func  (this *independentreserve) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            baseCurrenciesquoteCurrencieslimitsVariable := (<-ccxt.PromiseAll([]interface{}{baseCurrenciesPromise, quoteCurrenciesPromise, limitsPromise}));
            baseCurrencies := ccxt.GetValue(baseCurrenciesquoteCurrencieslimitsVariable,0);
            quoteCurrencies := ccxt.GetValue(baseCurrenciesquoteCurrencieslimitsVariable,1);
            limits := ccxt.GetValue(baseCurrenciesquoteCurrencieslimitsVariable,2)
            //
            //     {
            //         "Xbt": 0.0001,
            //         "Eth": 0.001,
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(baseCurrencies)); i++ {
                var baseId interface{} = ccxt.GetValue(baseCurrencies, i)
                var base interface{} = this.SafeCurrencyCode(baseId)
                var minAmount interface{} = this.SafeNumber(limits, baseId)
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(quoteCurrencies)); j++ {
                    var quoteId interface{} = ccxt.GetValue(quoteCurrencies, j)
...
func  (this *independentreserve) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "primaryCurrencyCode": ccxt.GetValue(market, "baseId"),
                "secondaryCurrencyCode": ccxt.GetValue(market, "quoteId"),
            }
            ...
            ch <- this.ParseOrderBook(response, ccxt.GetValue(market, "symbol"), timestamp, "BuyOrders", "SellOrders", "Price", "Volume")
            return nil
...
func  (this *independentreserve) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(baseId, nil))) && ccxt.IsTrue((!ccxt.IsEqual(quoteId, nil)))) {
        defaultMarketId = ccxt.Add(ccxt.Add(baseId, "/"), quoteId)
    }
    market = this.SafeMarket(defaultMarketId, market, "/")
    var symbol interface{} = ccxt.GetValue(market, "symbol")
    var last interface{} = this.SafeString(ticker, "ccxt.LastPrice")
...
func  (this *independentreserve) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(orderType, nil)) {
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(orderType, "Bid"), 0)) {
            side = "buy"
        } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(orderType, "Offer"), 0)) {
            side = "sell"
        }
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(orderType, "ccxt.Market"), 0)) {
            orderType = "market"
        } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(orderType, "ccxt.Limit"), 0)) {
            orderType = "limit"
        }
    }
    ...
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(feeRate, nil)) && ccxt.IsTrue(!ccxt.IsEqual(filled, nil))) {
...
func  (this *independentreserve) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ccxt.AddElementToObject(request, "primaryCurrencyCode", ccxt.GetValue(market, "baseId"))
                ccxt.AddElementToObject(request, "secondaryCurrencyCode", ccxt.GetValue(market, "quoteId"))
            }
...
func  (this *independentreserve) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            since := ccxt.GetArg(optionalArgs, 1, nil)
            _ = since
            limit := ccxt.GetArg(optionalArgs, 2, 50)
            _ = limit
            params := ccxt.GetArg(optionalArgs, 3, map[string]interface{} {})
            _ = params
...
func  (this *independentreserve) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var timestamp interface{} = this.Parse8601(ccxt.GetValue(trade, "TradeTimestampUtc"))
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(baseId, nil))) && ccxt.IsTrue((!ccxt.IsEqual(quoteId, nil)))) {
        marketId = ccxt.Add(ccxt.Add(baseId, "/"), quoteId)
    }
    var symbol interface{} = this.SafeSymbol(marketId, market, "/")
    var side interface{} = this.SafeString(trade, "OrderType")
    if ccxt.IsTrue(!ccxt.IsEqual(side, nil)) {
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(side, "Bid"), 0)) {
            side = "buy"
        } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(side, "Offer"), 0)) {
            side = "sell"
        }
    }
...
func  (this *independentreserve) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseTrades(ccxt.GetValue(response, "Trades"), market, since, limit)
            return nil
...
func  (this *independentreserve) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                var code interface{} = this.SafeCurrencyCode(currencyId)
                var tradingFee interface{} = this.SafeNumber(fee, "ccxt.Fee")
                ccxt.AddElementToObject(fees, code, map[string]interface{} {
            "info": fee,
            "fee": tradingFee,
        })
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Symbols)); i++ {
                ...
                var market interface{} = this.Market(symbol)
                var fee interface{} = this.SafeValue(fees, ccxt.GetValue(market, "base"), map[string]interface{} {})
...
func  (this *independentreserve) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            orderType = ccxt.Add(orderType, ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "sell"))), "Offer", "Bid"))
            var request interface{} = this.Ordered(map[string]interface{} {
                "primaryCurrencyCode": ccxt.GetValue(market, "baseId"),
                "secondaryCurrencyCode": ccxt.GetValue(market, "quoteId"),
                "orderType": orderType,
            ...
            ccxt.AddElementToObject(request, "volume", amount)
            ...
            ch <- this.SafeOrder(map[string]interface{} {
                "info": response,
                "id": ccxt.GetValue(response, "OrderGuid"),
            }, market)
            return nil
...
func  (this *independentreserve) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "primaryCurrencyCode": ccxt.GetValue(currency, "id"),
            }
            ...
            //    {
            //        Tag: '3307446684',
            //        ccxt.DepositAddress: 'GCCQH4HACMRAD56EZZZ4TOIDQQRVNADMJ35QOFWF4B2VQGODMA2WVQ22',
...
func  (this *independentreserve) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = currency
    var address interface{} = this.SafeString(depositAddress, "ccxt.DepositAddress")
...
func  (this *independentreserve) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp839897 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp839897, 0)
            params = ccxt.GetValue(__tmp839897, 1)
        
            retRes9708 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes9708)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "primaryCurrencyCode": ccxt.GetValue(currency, "id"),
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                ccxt.AddElementToObject(request, "destinationTag", tag)
            }
            var networkCode interface{} = nil
            __tmp934971 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp934971, 0)
            params = ccxt.GetValue(__tmp934971, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " withdraw () does not accept params[\"networkCode\"]")))
            }
...
func  (this *independentreserve) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    return map[string]interface{} {
        ...
        "fee": map[string]interface{} {
            "currency": code,
            "cost": this.SafeNumber(amount, "ccxt.Fee"),
            "rate": nil,
        },
        "internal": false,
    }
...
func  (this *independentreserve) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        var auth interface{} = []interface{}{url, ccxt.Add("apiKey=", this.ApiKey), ccxt.Add("nonce=", ccxt.ToString(nonce))}
        var keys interface{} = ccxt.ObjectKeys(params)
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
            var key interface{} = ccxt.GetValue(keys, i)
            var value interface{} = ccxt.ToString(ccxt.GetValue(params, key))
            ccxt.AppendToArray(&auth, ccxt.Add(ccxt.Add(key, "="), value))
        }
        var message interface{} = ccxt.Join(auth, ",")
        var signature interface{} = this.Hmac(this.Encode(message), this.Encode(this.Secret), ccxt.Sha256)
        var query interface{} = this.Ordered(map[string]interface{} {})
        ccxt.AddElementToObject(query, "apiKey", this.ApiKey)
        ccxt.AddElementToObject(query, "nonce", nonce)
        ccxt.AddElementToObject(query, "signature", ccxt.ToUpper(signature))
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
            var key interface{} = ccxt.GetValue(keys, i)
            ccxt.AddElementToObject(query, key, ccxt.GetValue(params, key))
        }
