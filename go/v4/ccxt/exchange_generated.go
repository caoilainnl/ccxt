...
func  (this *Exchange) HandleRequestNetwork(params interface{}, request interface{}, exchangeSpecificKey interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    __tmp288927 := this.HandleNetworkCodeAndParams(params)
    networkCode = GetValue(__tmp288927, 0)
    params = GetValue(__tmp288927, 1)
    if IsTrue(!IsEqual(networkCode, nil)) {
...
func  (this *Exchange) Fetch2(path interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp54337 := this.HandleOptionAndParams(params, path, "maxRetriesOnFailure", 0)
            retries = GetValue(__tmp54337, 0)
            params = GetValue(__tmp54337, 1)
            var retryDelay interface{} = nil
            __tmp544883 := this.HandleOptionAndParams(params, path, "maxRetriesOnFailureDelay", 0)
            retryDelay = GetValue(__tmp544883, 0)
            params = GetValue(__tmp544883, 1)
...
func  (this *Exchange) HandleOptionAndParams(params interface{}, methodName interface{}, optionName interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if IsTrue(!IsEqual(value, nil)) {
        ...
        __tmp905386 := this.HandleParamString(params, "callerMethodName", methodName)
        methodName = GetValue(__tmp905386, 0)
        params = GetValue(__tmp905386, 1)
...
func  (this *Exchange) HandleOptionAndParams2(params interface{}, methodName1 interface{}, optionName1 interface{}, optionName2 interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    __tmp772850 := this.HandleOptionAndParams(params, methodName1, optionName1)
    value = GetValue(__tmp772850, 0)
    params = GetValue(__tmp772850, 1)
    if IsTrue(!IsEqual(value, nil)) {
    ...
    __tmp408459 := this.HandleOptionAndParams(params, methodName1, optionName2, defaultValue)
    value2 = GetValue(__tmp408459, 0)
    params = GetValue(__tmp408459, 1)
...
func  (this *Exchange) HandleMaxEntriesPerRequestAndParams(method interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    __tmp375507 := this.HandleOptionAndParams(params, method, "maxEntriesPerRequest")
    newMaxEntriesPerRequest = GetValue(__tmp375507, 0)
    params = GetValue(__tmp375507, 1)
...
func  (this *Exchange) FetchPaginatedCallDynamic(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp164639 := this.HandleOptionAndParams(params, method, "paginationCalls", 10)
            maxCalls = GetValue(__tmp164639, 0)
            params = GetValue(__tmp164639, 1)
            var maxRetries interface{} = nil
            __tmp70208 := this.HandleOptionAndParams(params, method, "maxRetries", 3)
            maxRetries = GetValue(__tmp70208, 0)
            params = GetValue(__tmp70208, 1)
            var paginationDirection interface{} = nil
            __tmp77053 := this.HandleOptionAndParams(params, method, "paginationDirection", "backward")
            paginationDirection = GetValue(__tmp77053, 0)
            params = GetValue(__tmp77053, 1)
            var paginationTimestamp interface{} = nil
            var removeRepeatedOption interface{} = removeRepeated
            __tmp400013 := this.HandleOptionAndParams(params, method, "removeRepeated", removeRepeated)
            removeRepeatedOption = GetValue(__tmp400013, 0)
            params = GetValue(__tmp400013, 1)
            ...
            __tmp531212 := this.HandleMaxEntriesPerRequestAndParams(method, maxEntriesPerRequest, params)
            maxEntriesPerRequest = GetValue(__tmp531212, 0)
            params = GetValue(__tmp531212, 1)
...
func  (this *Exchange) SafeDeterministicCall(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var maxRetries interface{} = nil
            __tmp42186 := this.HandleOptionAndParams(params, method, "maxRetries", 3)
            maxRetries = GetValue(__tmp42186, 0)
            params = GetValue(__tmp42186, 1)
            var errors interface{} = 0
...
func  (this *Exchange) FetchPaginatedCallDeterministic(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = maxEntriesPerRequest
            var maxCalls interface{} = nil
            __tmp588526 := this.HandleOptionAndParams(params, method, "paginationCalls", 10)
            maxCalls = GetValue(__tmp588526, 0)
            params = GetValue(__tmp588526, 1)
            __tmp820641 := this.HandleMaxEntriesPerRequestAndParams(method, maxEntriesPerRequest, params)
            maxEntriesPerRequest = GetValue(__tmp820641, 0)
            params = GetValue(__tmp820641, 1)
            var current interface{} = this.Milliseconds()
            var tasks interface{} = []interface{}{}
            var timestamp interface{} = Multiply(this.ParseTimeframe(timeframe), 1000)
            var step interface{} = Multiply(timestamp, maxEntriesPerRequest)
...
func  (this *Exchange) FetchPaginatedCallCursor(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = maxEntriesPerRequest
            var maxCalls interface{} = nil
            __tmp485093 := this.HandleOptionAndParams(params, method, "paginationCalls", 10)
            maxCalls = GetValue(__tmp485093, 0)
            params = GetValue(__tmp485093, 1)
            var maxRetries interface{} = nil
            __tmp524655 := this.HandleOptionAndParams(params, method, "maxRetries", 3)
            maxRetries = GetValue(__tmp524655, 0)
            params = GetValue(__tmp524655, 1)
            __tmp750878 := this.HandleMaxEntriesPerRequestAndParams(method, maxEntriesPerRequest, params)
            maxEntriesPerRequest = GetValue(__tmp750878, 0)
            params = GetValue(__tmp750878, 1)
...
func  (this *Exchange) FetchPaginatedCallIncremental(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = maxEntriesPerRequest
            var maxCalls interface{} = nil
            __tmp279863 := this.HandleOptionAndParams(params, method, "paginationCalls", 10)
            maxCalls = GetValue(__tmp279863, 0)
            params = GetValue(__tmp279863, 1)
            var maxRetries interface{} = nil
            __tmp843595 := this.HandleOptionAndParams(params, method, "maxRetries", 3)
            maxRetries = GetValue(__tmp843595, 0)
            params = GetValue(__tmp843595, 1)
            __tmp927761 := this.HandleMaxEntriesPerRequestAndParams(method, maxEntriesPerRequest, params)
            maxEntriesPerRequest = GetValue(__tmp927761, 0)
            params = GetValue(__tmp927761, 1)
            var i interface{} = 0
            var errors interface{} = 0
            var result interface{} = []interface{}{}
            for IsLessThan(i, maxCalls) {
