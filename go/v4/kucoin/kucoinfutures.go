    ...
    return this.DeepExtend(this.kucoin.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            ...
            "broad": map[string]interface{} {
                "ccxt.Position does not exist": ccxt.OrderNotFound,
            },
        },
...
func  (this *kucoinfutures) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                var future interface{} = ccxt.Ternary(ccxt.IsTrue(expiry), true, false)
                var swap interface{} =         !ccxt.IsTrue(future)
                ...
                if ccxt.IsTrue(ccxt.IsEqual(limitPriceMax, nil)) {
                    ...
                    limitPriceMax = this.ParseNumber(ccxt.Precise.StringDiv(quoteMaxSizeString, baseMinSizeString))
                }
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "future": future,
                    "option": false,
                    "active": (ccxt.IsEqual(status, "Open")),
                    "contract": true,
...
func  (this *kucoinfutures) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp107232 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate")
            paginate = ccxt.GetValue(__tmp107232, 0)
            params = ccxt.GetValue(__tmp107232, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(parsedTimeframe, nil)) {
                ccxt.AddElementToObject(request, "granularity", parsedTimeframe)
            } else {
            ...
            ccxt.AddElementToObject(request, "to", endAt)
...
func  (this *kucoinfutures) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(currencyId, "NIM")) {
                // contains spaces
...
func  (this *kucoinfutures) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(level, 2)) && ccxt.IsTrue(!ccxt.IsEqual(level, nil))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchOrderBook() can only return level 2")))
            }
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(limit, 20))) || ccxt.IsTrue((ccxt.IsEqual(limit, 100)))) {
                    ...
                    panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchOrderBook() limit argument must be 20 or 100")))
                }
            } else {
                ccxt.AddElementToObject(request, "limit", 20)
            }
            ...
            //           "sequence": 100,          //ccxt.Ticker sequence number
            //           "asks": [
            ...
            //
            var data interface{} = this.SafeValue(response, "data", map[string]interface{} {})
            var timestamp interface{} = this.ParseToInt(ccxt.Divide(this.SafeInteger(data, "ts"), 1000000))
            var orderbook interface{} = this.ParseOrderBook(data, ccxt.GetValue(market, "symbol"), timestamp, "bids", "asks", 0, 1)
...
func  (this *kucoinfutures) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp419744 := this.HandleOptionAndParams(params, "fetchTickers", "method", "futuresPublicGetContractsActive")
            method = ccxt.GetValue(__tmp419744, 0)
            params = ccxt.GetValue(__tmp419744, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(method, "futuresPublicGetAllTickers")) {
...
func  (this *kucoinfutures) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes111815)
                ch <- retRes111815
                return nil
...
func  (this *kucoinfutures) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ...
                ccxt.AddElementToObject(request, "maxCount", limit)
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(dataList)); i++ {
                var listItem interface{} = ccxt.GetValue(dataList, i)
...
func  (this *kucoinfutures) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //        "data": [
    //            {
    //                "id": "615ba79f83a3410001cde321",         // ccxt.Position ID
    //                "symbol": "ETHUSDTM",                     // Symbol
    //                "autoDeposit": false,                     // Auto deposit margin or not
    //                "maintMarginReq": 0.005,                  // Maintenance margin requirement
    //                "riskLimit": 1000000,                     // Risk limit
    //                "realLeverage": 25.92,                    // ccxt.Leverage of the order
    ...
    //                "posCost": 83.787,                        // ccxt.Position value
    //                "posCross": 0.0,                          // added margin
    //                "posInit": 3.35148,                       // ccxt.Leverage margin
    //                "posComm": 0.05228309,                    // Bankruptcy cost
    //                "posLoss": 0.0,                           // Funding fees paid out
    //                "posMargin": 3.40376309,                  // ccxt.Position margin
    //                "posMaint": 0.50707892,                   // Maintenance margin
    //                "maintMargin": 3.28436309,                // ccxt.Position margin
    ...
    //                "liquidationPrice": 4044.55,              // ccxt.Liquidation price
    //                "bankruptPrice": 4021.75,                 // Bankruptcy price
    //                "settleCurrency": "USDT",                 // ccxt.Currency used to clear and settle the trades
    //                "isInverse": false
    //            }
    //        ]
    //    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(size, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsGreaterThan(ccxt.GetIndexOf(typeVar, "long"), ccxt.OpNeg(1))) {
            side = "long"
        } else {
            side = "short"
        }
    }
    var notional interface{} = ccxt.Precise.StringAbs(this.SafeString(position, "posCost"))
    ...
    // const marginRatio = ccxt.Precise.stringDiv (maintenanceRate, collateral);
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(crossMode, nil)) {
        marginMode = ccxt.Ternary(ccxt.IsTrue(crossMode), "cross", "isolated")
    }
...
func  (this *kucoinfutures) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var isTpAndSlOrder interface{} = ccxt.IsTrue((!ccxt.IsEqual(this.SafeValue(params, "stopLoss"), nil))) || ccxt.IsTrue((!ccxt.IsEqual(this.SafeValue(params, "takeProfit"), nil)))
...
func  (this *kucoinfutures) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                var orderRequest interface{} = this.CreateContractOrderRequest(ccxt.GetValue(market, "id"), typeVar, side, amount, price, orderParams)
...
func  (this *kucoinfutures) CreateContractOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(marginModeUpper, nil)) {
        params = this.Omit(params, "marginMode")
        ccxt.AddElementToObject(request, "marginMode", marginModeUpper)
    }
    var cost interface{} = this.SafeString(params, "cost")
    params = this.Omit(params, "cost")
    if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
        ccxt.AddElementToObject(request, "valueQty", this.CostToPrecision(symbol, cost))
    } else {
        if ccxt.IsTrue(ccxt.IsLessThan(amount, 1)) {
            panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createOrder() minimum contract order amount is 1")))
        }
        ccxt.AddElementToObject(request, "size", ccxt.ParseInt(this.AmountToPrecision(symbol, amount)))
    }
    ...
    if ccxt.IsTrue(triggerPrice) {
        ccxt.AddElementToObject(request, "stop", ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), "up", "down"))
        ccxt.AddElementToObject(request, "stopPrice", this.PriceToPrecision(symbol, triggerPrice))
        ccxt.AddElementToObject(request, "stopPriceType", triggerPriceTypeValue)
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(stopLoss, nil)) {
            ...
            ccxt.AddElementToObject(request, "triggerStopDownPrice", this.PriceToPrecision(symbol, slPrice))
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(takeProfit, nil)) {
            ...
            ccxt.AddElementToObject(request, "triggerStopUpPrice", this.PriceToPrecision(symbol, tpPrice))
            priceType = this.SafeString(takeProfit, "triggerPriceType", "mark")
            priceType = this.SafeString(triggerPriceTypes, priceType, priceType)
        }
        ccxt.AddElementToObject(request, "stopPriceType", priceType)
        ...
        if ccxt.IsTrue(stopLossPrice) {
            ...
            ccxt.AddElementToObject(request, "stop", ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), "down", "up"))
    ...
    __tmp526644 := this.HandlePostOnly(ccxt.IsEqual(typeVar, "market"), false, params)
    postOnly = ccxt.GetValue(__tmp526644, 0)
    params = ccxt.GetValue(__tmp526644, 1)
    if ccxt.IsTrue(postOnly) {
        ccxt.AddElementToObject(request, "postOnly", true)
    }
    var hidden interface{} = this.SafeValue(params, "hidden")
    if ccxt.IsTrue(ccxt.IsTrue(postOnly) && ccxt.IsTrue((!ccxt.IsEqual(hidden, nil)))) {
        panic(ccxt.BadRequest(ccxt.Add(this.Id, " createOrder() does not support the postOnly parameter together with a hidden parameter")))
    }
    var iceberg interface{} = this.SafeValue(params, "iceberg")
    if ccxt.IsTrue(iceberg) {
        var visibleSize interface{} = this.SafeValue(params, "visibleSize")
        if ccxt.IsTrue(ccxt.IsEqual(visibleSize, nil)) {
            panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() requires a visibleSize parameter for iceberg orders")))
        }
    }
...
func  (this *kucoinfutures) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " cancelOrder() requires a symbol argument when cancelling by clientOrderId")))
                }
                var market interface{} = this.Market(symbol)
...
func  (this *kucoinfutures) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(clientOrderIds)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " cancelOrders() requires a symbol argument when cancelling by clientOrderIds")))
                }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ccxt.AppendToArray(&ordersRequests, ccxt.GetValue(ids, i))
            }
            var requestKey interface{} = ccxt.Ternary(ccxt.IsTrue(useClientorderId), "clientOidsList", "orderIdsList")
            var request interface{} = map[string]interface{} {}
            ccxt.AddElementToObject(request, requestKey, ordersRequests)
...
func  (this *kucoinfutures) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            //    {
            //        "code":"200000",
            //        "msg":"ccxt.Position does not exist"
            //    }
            //
            var data interface{} = this.SafeValue(response, "data")
...
func  (this *kucoinfutures) ParseMarginModification(info interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var mode interface{} = ccxt.Ternary(ccxt.IsTrue(crossMode), "cross", "isolated")
...
func  (this *kucoinfutures) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp433209 := this.HandleOptionAndParams(params, "fetchOrdersByStatus", "paginate")
            paginate = ccxt.GetValue(__tmp433209, 0)
            params = ccxt.GetValue(__tmp433209, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes204619 :=  (<-this.FetchPaginatedCallDynamic("fetchOrdersByStatus", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes204619)
                    ch <- retRes204619
                    return nil
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(status, "closed")) {
                status = "done"
            } else if ccxt.IsTrue(ccxt.IsEqual(status, "open")) {
                status = "active"
            }
            var request interface{} = map[string]interface{} {}
            if !ccxt.IsTrue(trigger) {
                ccxt.AddElementToObject(request, "status", status)
            } else if ccxt.IsTrue(!ccxt.IsEqual(status, "active")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchOrdersByStatus() can only fetch untriggered stop orders")))
            }
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *kucoinfutures) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes21518)
            var paginate interface{} = false
            __tmp376356 := this.HandleOptionAndParams(params, "fetchClosedOrders", "paginate")
            paginate = ccxt.GetValue(__tmp376356, 0)
            params = ccxt.GetValue(__tmp376356, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes215519 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes215519)
                    ch <- retRes215519
                    return nil
            }
        
                retRes215715 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
...
func  (this *kucoinfutures) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes21788)
            var paginate interface{} = false
            __tmp541688 := this.HandleOptionAndParams(params, "fetchOpenOrders", "paginate")
            paginate = ccxt.GetValue(__tmp541688, 0)
            params = ccxt.GetValue(__tmp541688, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes218219 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes218219)
                    ch <- retRes218219
                    return nil
            }
        
                retRes218415 :=  (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
...
func  (this *kucoinfutures) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(id, nil)) {
                var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
                if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                    panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " fetchOrder() requires parameter id or params.clientOid")))
                }
                ccxt.AddElementToObject(request, "clientOid", clientOrderId)
                params = this.Omit(params, []interface{}{"clientOid", "clientOrderId"})
...
func  (this *kucoinfutures) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(average, nil))) && ccxt.IsTrue(ccxt.Precise.StringGt(filled, "0"))) {
        var contractSize interface{} = this.SafeString(market, "contractSize")
        if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
            average = ccxt.Precise.StringDiv(cost, ccxt.Precise.StringMul(contractSize, filled))
        } else {
            average = ccxt.Precise.StringDiv(ccxt.Precise.StringMul(contractSize, filled), cost)
        }
    }
    // precision reported by their api is 8 d.p.
    // const average = ccxt.Precise.stringDiv (cost, ccxt.Precise.stringMul (filled, market['contractSize']));
    // bool
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(isActive, nil)) {
        status = ccxt.Ternary(ccxt.IsTrue(isActive), "open", "closed")
    }
    status = ccxt.Ternary(ccxt.IsTrue(cancelExist), "canceled", status)
...
func  (this *kucoinfutures) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes243815 :=  (<-this.FetchFundingRate(symbol, params))
                ccxt.PanicOnError(retRes243815)
                ch <- retRes243815
                return nil
...
func  (this *kucoinfutures) ParseBalance(response interface{}) interface{}  {
    ...
    ccxt.AddElementToObject(account, "total", this.SafeString(data, "accountEquity"))
...
func  (this *kucoinfutures) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes25548 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes25548)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoinfutures) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes26858 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes26858)
            var paginate interface{} = false
            __tmp38644 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp38644, 0)
            params = ccxt.GetValue(__tmp38644, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes268919 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes268919)
                    ch <- retRes268919
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "pageSize", ccxt.MathMin(1000, limit))
            }
            __tmp529177 := this.HandleUntilOption("endAt", request, params)
            request = ccxt.GetValue(__tmp529177, 0)
            params = ccxt.GetValue(__tmp529177, 1)
            ...
            //          "items": [
            //              {
            //                  "symbol": "XBTUSDM",  // ccxt.Ticker symbol of the contract
            //                  "tradeId": "5ce24c1f0c19fc3c58edc47c",  // ccxt.Trade ID
            //                  "orderId": "5ce24c16b210233c36ee321d",  // ccxt.Order ID
            //                  "side": "sell",  // ccxt.Transaction side
            //                  "liquidity": "taker",  // Liquidity- taker or maker
            //                  "price": "8302",  // Filled price
            //                  "size": 10,  // Filled amount
            //                  "value": "0.001204529",  // ccxt.Order value
            //                  "feeRate": "0.0005",  // Floating fees
            //                  "fixFee": "0.00000006",  // Fixed fees
            //                  "feeCurrency": "XBT",  // Charging currency
            //                  "stop": "",  // A mark to the stop order type
            //                  "fee": "0.0000012022",  // ccxt.Transaction fee
            //                  "orderType": "limit",  // ccxt.Order type
            //                  "tradeType": "trade",  // ccxt.Trade type (trade, liquidation, ADL or settlement)
...
func  (this *kucoinfutures) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(costString, nil)) {
        var contractSize interface{} = this.SafeString(market, "contractSize")
        var contractCost interface{} = ccxt.Precise.StringMul(priceString, amountString)
...
func  (this *kucoinfutures) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            //     }
            //
            var responseData interface{} = ccxt.GetValue(ccxt.GetValue(response, "data"), "items")
...
func  (this *kucoinfutures) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes30468)
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "contract")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchMarketLeverageTiers() supports contract markets only")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "from", since)
                if ccxt.IsTrue(ccxt.IsEqual(until, nil)) {
                    ccxt.AddElementToObject(request, "to", ccxt.Add(since, ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(1000, 8), 60), 60), 100)))
                }
            }
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "to", until)
                if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(request, "to", ccxt.Subtract(until, ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(1000, 8), 60), 60), 100)))
                }
            }
...
func  (this *kucoinfutures) ParseMarginMode(marginMode interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    marginType = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginType, "ISOLATED"))), "isolated", "cross")
    return map[string]interface{} {
        "info": marginMode,
        "symbol": ccxt.GetValue(market, "symbol"),
...
func  (this *kucoinfutures) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var marginMode interface{} = nil
            __tmp566805 := this.HandleMarginModeAndParams(symbol, params)
            marginMode = ccxt.GetValue(__tmp566805, 0)
            params = ccxt.GetValue(__tmp566805, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "cross")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchLeverage() currently supports only params[\"marginMode\"] = \"cross\"")))
            }
        
            retRes33428 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes33428)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var marginMode interface{} = nil
            __tmp119158 := this.HandleMarginModeAndParams(symbol, params)
            marginMode = ccxt.GetValue(__tmp119158, 0)
            params = ccxt.GetValue(__tmp119158, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "cross")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " setLeverage() currently supports only params[\"marginMode\"] = \"cross\"")))
            }
        
            retRes33808 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes33808)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
