 ...
 * @returns Response from the exchange
 */
func (this *Kucoin) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Kucoin) FetchOrdersByStatus(status interface{}, options ...ccxt.FetchOrdersByStatusOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Kucoin) FetchBorrowRateHistories(options ...ccxt.FetchBorrowRateHistoriesOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Kucoin) FetchBorrowRateHistory(code string, options ...ccxt.FetchBorrowRateHistoryOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Kucoin) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
