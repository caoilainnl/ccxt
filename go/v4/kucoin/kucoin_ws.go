...
func NewKucoinWsCore() kucoinWs {
   p := kucoinWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *kucoinWs) Describe() interface{}  {
...
func  (this *kucoinWs) Negotiate(privateChannel interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var spawaned interface{} = this.SafeValue(urls, connectId)
            if ccxt.IsTrue(!ccxt.IsEqual(spawaned, nil)) {
        
                    retRes6319 :=  (<-spawaned.(<-chan interface{}))
                    ccxt.PanicOnError(retRes6319)
                    ch <- retRes6319
                    return nil
            }
            ...
            var future interface{} = ccxt.GetValue(urls, connectId)
        
                retRes7115 :=  <-future.(<-chan interface{})
...
func  (this *kucoinWs) NegotiateHelper(privateChannel interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *kucoinWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *kucoinWs) interface{} {
            					// catch block:
                ...
                "connectId": connectId,
                    ...
                    client.(*ccxt.Client).KeepAlive = pingInterval
...
func  (this *kucoinWs) RequestId() interface{}  {
...
func  (this *kucoinWs) Subscribe(url interface{}, messageHash interface{}, subscriptionHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if !ccxt.IsTrue((ccxt.InOp(client.(ccxt.ClientInterface).GetSubscriptions(), subscriptionHash))) {
                ...
                retRes14115 :=  (<-this.Watch(url, messageHash, message, subscriptionHash, subscription))
...
func  (this *kucoinWs) SubscribeMultiple(url interface{}, messageHashes interface{}, topic interface{}, subscriptionHashes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(subscriptionHashes)); i++ {
                ...
                retRes16015 :=  (<-this.WatchMultiple(url, messageHashes, message, subscriptionHashes, subscription))
...
func  (this *kucoinWs) UnSubscribeMultiple(url interface{}, messageHashes interface{}, topic interface{}, subscriptionHashes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(subscriptionHashes)); i++ {
                ...
                retRes18215 :=  (<-this.WatchMultiple(url, messageHashes, message, subscriptionHashes, subscription))
 ...
 */
func  (this *kucoinWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.Add("ticker:", symbol)
                ...
                retRes20215 :=  (<-this.Subscribe(url, messageHash, topic, query))
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *kucoinWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp205970 := this.HandleOptionAndParams(params, "watchTickers", "method", "/market/ticker")
            method = ccxt.GetValue(__tmp205970, 0)
            params = ccxt.GetValue(__tmp205970, 1)
...
func  (this *kucoinWs) HandleTicker(client interface{}, message interface{})  {
    //
    // market/snapshot
    //
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *kucoinWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *kucoinWs) WatchMultiHelper(methodName interface{}, channelName interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes37615 :=  (<-this.WatchMultiple(url, messageHashes, message, messageHashes, nil))
...
func  (this *kucoinWs) HandleBidAsk(client interface{}, message interface{})  {
    //
...
func  (this *kucoinWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *kucoinWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *kucoinWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "data": {
    //             "symbol": "BTC-USDT",
 ...
 */
func  (this *kucoinWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes50615 :=  (<-this.WatchTradesForSymbols([]interface{}{symbol}, since, limit, params))
                ccxt.PanicOnError(retRes50615)
                ch <- retRes50615
                return nil
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *kucoinWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *kucoinWs) UnWatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes57615 :=  (<-this.UnSubscribeMultiple(url, messageHashes, topic, messageHashes, params, subscription))
                ccxt.PanicOnError(retRes57615)
                ch <- retRes57615
                return nil
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *kucoinWs) UnWatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes58915 :=  (<-this.UnWatchTradesForSymbols([]interface{}{symbol}, params))
...
func  (this *kucoinWs) HandleTrade(client interface{}, message interface{})  {
    //
    //     {
    //         "data": {
 ...
 */
func  (this *kucoinWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes65615 :=  (<-this.WatchOrderBookForSymbols([]interface{}{symbol}, limit, params))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *kucoinWs) UnWatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes67315 :=  (<-this.UnWatchOrderBookForSymbols([]interface{}{symbol}, params))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *kucoinWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(url)
            var method interface{} = nil
            __tmp994145 := this.HandleOptionAndParams(params, "watchOrderBook", "method", "/market/level2")
            method = ccxt.GetValue(__tmp994145, 0)
            params = ccxt.GetValue(__tmp994145, 1)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *kucoinWs) UnWatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(url)
            var method interface{} = nil
            __tmp827191 := this.HandleOptionAndParams(params, "watchOrderBook", "method", "/market/level2")
            method = ccxt.GetValue(__tmp827191, 0)
            params = ccxt.GetValue(__tmp827191, 1)
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(limit, 5))) || ccxt.IsTrue((ccxt.IsEqual(limit, 50)))) {
                method = ccxt.Add("/spotMarket/level2Depth", ccxt.ToString(limit))
            }
            var topic interface{} = ccxt.Add(ccxt.Add(method, ":"), ccxt.Join(marketIds, ","))
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes77015 :=  (<-this.UnSubscribeMultiple(url, messageHashes, topic, messageHashes, params, subscription))
...
func  (this *kucoinWs) HandleOrderBook(client interface{}, message interface{})  {
    //
...
func  (this *kucoinWs) GetCacheIndex(orderbook interface{}, cache interface{}) interface{}  {
...
func  (this *kucoinWs) HandleDelta(orderbook interface{}, delta interface{})  {
...
func  (this *kucoinWs) HandleBidAsks(bookSide interface{}, bidAsks interface{})  {
...
func  (this *kucoinWs) HandleOrderBookSubscription(client interface{}, message interface{}, subscription interface{})  {
    var limit interface{} = this.SafeInteger(subscription, "limit")
...
func  (this *kucoinWs) HandleSubscriptionStatus(client interface{}, message interface{})  {
    //
    //     {
    //         "id": "1578090438322",
    //         "type": "ack"
...
func  (this *kucoinWs) HandleSystemStatus(client interface{}, message interface{}) interface{}  {
    //
 ...
 */
func  (this *kucoinWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *kucoinWs) ParseWsOrderStatus(status interface{}) interface{}  {
...
func  (this *kucoinWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
...
func  (this *kucoinWs) HandleOrder(client interface{}, message interface{})  {
    //
    // Trigger Orders
    //
    //    {
 ...
 */
func  (this *kucoinWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp770073 := this.HandleOptionAndParams(params, "watchMyTrades", "method", "/spotMarket/tradeOrders")
            topic = ccxt.GetValue(__tmp770073, 0)
            params = ccxt.GetValue(__tmp770073, 1)
            var request interface{} = map[string]interface{} {
                "privateChannel": true,
            }
...
func  (this *kucoinWs) HandleMyTrade(client interface{}, message interface{})  {
    //
    //     {
    //         "type": "message",
...
func  (this *kucoinWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // /spotMarket/tradeOrders
    //
    //     {
 ...
 */
func  (this *kucoinWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = "balance"
                ...
                retRes131415 :=  (<-this.Subscribe(url, messageHash, topic, this.Extend(request, params)))
...
func  (this *kucoinWs) HandleBalance(client interface{}, message interface{})  {
    //
    // {
...
func  (this *kucoinWs) HandleSubject(client interface{}, message interface{})  {
    //
    //     {
    //         "type":"message",
    //         "topic":"/market/level2:BTC-USDT",
...
func  (this *kucoinWs) Ping(client interface{}) interface{}  {
...
func  (this *kucoinWs) HandlePong(client interface{}, message interface{})  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
}
func  (this *kucoinWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "id": "1",
    //        "type": "error",
    ...
    if ccxt.IsTrue(ccxt.IsEqual(data, "token is expired")) {
        ...
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(client.(*ccxt.Client).Url, "connectId=private"), 0)) {
            typeVar = "private"
        }
        ccxt.AddElementToObject(ccxt.GetValue(this.Options, "urls"), typeVar, nil)
    }
    this.HandleErrors(nil, nil, client.(*ccxt.Client).Url, nil, nil, data, message, nil, nil)
    return false
}
func  (this *kucoinWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *kucoinWs) Init(userConfig map[string]interface{}) {
