...
func (this *Woo) CreateTrailingAmountOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingAmountOrderOptions) (ccxt.Order, error) {
    ...
    opts := ccxt.CreateTrailingAmountOrderOptionsStruct{}
 ...
 */
func (this *Woo) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) (map[string]interface{}, error) {
 ...
 * @returns {object} response from the exchange
 */
func (this *Woo) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
