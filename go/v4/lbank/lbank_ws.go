...
func NewLbankWsCore() lbankWs {
   p := lbankWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *lbankWs) Describe() interface{}  {
...
func  (this *lbankWs) RequestId() interface{}  {
 ...
 */
func  (this *lbankWs) FetchOHLCVWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *lbankWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *lbankWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    // request
    //    {
    //        "records":[
 ...
 */
func  (this *lbankWs) FetchTickerWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *lbankWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *lbankWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "tick":{
    //             "to_cny":76643.5,
...
func  (this *lbankWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "tick":{
    //             "to_cny":76643.5,
 ...
 */
func  (this *lbankWs) FetchTradesWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *lbankWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *lbankWs) HandleTrades(client interface{}, message interface{})  {
    //
    // request
    //     {
...
func  (this *lbankWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // request
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *lbankWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *lbankWs) HandleOrders(client interface{}, message interface{})  {
    //
    //     {
    //         "orderUpdate":{
    //             "amount":"0.003",
...
func  (this *lbankWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "orderUpdate":{
    //             "amount":"0.003",
...
func  (this *lbankWs) ParseWsOrderStatus(status interface{}) interface{}  {
 ...
 */
func  (this *lbankWs) FetchOrderBookWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/en/latest/manual.html#order-book-structure} indexed by market symbols
 */
func  (this *lbankWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *lbankWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // request
    //    {
    //        "SERVER":"V2",
...
func  (this *lbankWs) HandleErrorMessage(client interface{}, message interface{})  {
    //
    //    {
    //        SERVER: 'V2',
    ...
    err := ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " "), errMsg))
    client.(ccxt.ClientInterface).Reject(err)
}
func  (this *lbankWs) HandlePing(client interface{}, message interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *lbankWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *lbankWs) interface{} {
            					// catch block:
                    ...
                    retRes84012 := (<-client.(ccxt.ClientInterface).Send(map[string]interface{} {
                        "action": "pong",
                        "pong": pingId,
                    }))
                    ccxt.PanicOnError(retRes84012)
            		return nil
            	}(this)
...
func  (this *lbankWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *lbankWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func (this *lbankWs) Init(userConfig map[string]interface{}) {
    this.lbank.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
