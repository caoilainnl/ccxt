...
func (this *Poloniex) FetchSpotMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
...
func (this *Poloniex) FetchSwapMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
...
func (this *Poloniex) FetchOrderStatus(id string, options ...ccxt.FetchOrderStatusOptions) (string, error) {
    ...
    opts := ccxt.FetchOrderStatusOptionsStruct{}
...
func (this *Poloniex) FetchTransactionsHelper(options ...ccxt.FetchTransactionsHelperOptions) (map[string]interface{}, error) {

    opts := ccxt.FetchTransactionsHelperOptionsStruct{}
 ...
 */
func (this *Poloniex) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
