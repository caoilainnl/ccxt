...
func NewPoloniexWsCore() poloniexWs {
   p := poloniexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *poloniexWs) Describe() interface{}  {
 ...
 */
func  (this *poloniexWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
 ...
 */
func  (this *poloniexWs) Subscribe(name interface{}, messageHash interface{}, isPrivate interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} data from the websocket stream
 */
func  (this *poloniexWs) TradeRequest(name interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(uppercaseType, "MARKET"))) && ccxt.IsTrue((ccxt.IsEqual(uppercaseSide, "BUY")))) {
                ...
                __tmp993072 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp993072, 0)
                params = ccxt.GetValue(__tmp993072, 1)
 ...
 */
func  (this *poloniexWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an list of [order structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#order-structure}
 */
func  (this *poloniexWs) CancelOrdersWs(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) CancelAllOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *poloniexWs) HandleOrderRequest(client interface{}, message interface{})  {
    //
    //    {
    //        "id": "1234567",
    //        "data": [{
 ...
 */
func  (this *poloniexWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *poloniexWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *poloniexWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp115150 := this.HandleOptionAndParams(params, "method", "name", name)
            name = ccxt.GetValue(__tmp115150, 0)
            params = ccxt.GetValue(__tmp115150, 1)
 ...
 */
func  (this *poloniexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *poloniexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *poloniexWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "symbol": "BTC_USDT",
    //        "amount": "840.7240416",
...
func  (this *poloniexWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    //    {
...
func  (this *poloniexWs) HandleTrade(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "channel": "trades",
    //        "data": [
...
func  (this *poloniexWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // handleTrade
    //
    //    {
...
func  (this *poloniexWs) ParseStatus(status interface{}) interface{}  {
...
func  (this *poloniexWs) ParseWsOrderTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "symbol": "BTC_USDT",
    //        "type": "LIMIT",
...
func  (this *poloniexWs) HandleOrder(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *poloniexWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "symbol": "BTC_USDT",
    //        "type": "LIMIT",
...
func  (this *poloniexWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "channel": "ticker",
    //        "data": [
...
func  (this *poloniexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // snapshot
    //
    //    {
...
func  (this *poloniexWs) HandleBalance(client interface{}, message interface{})  {
    //
    //    {
    //       "channel": "balances",
    //       "data": [
...
func  (this *poloniexWs) ParseWsBalance(response interface{}) interface{}  {
    //
    //    [
    //        {
    //            "changeTime": 1657312008411,
...
func  (this *poloniexWs) HandleMyTrades(client interface{}, parsedTrade interface{})  {
...
func  (this *poloniexWs) HandlePong(client interface{})  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
}
func  (this *poloniexWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *poloniexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(event, "error"))) || ccxt.IsTrue((ccxt.IsEqual(orderId, "0")))) {
        ...
        {		ret__ := func(this *poloniexWs) (ret_ interface{}) {
        		defer func() {
        			if e := recover(); e != nil {
                        if e == "break" {
        				    return
        			    }
        				ret_ = func(this *poloniexWs) interface{} {
        					// catch block:
        		...
        		// try block:
                            var err interface{} = this.SafeString(first, "message")
...
func  (this *poloniexWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "success": true,
    //        "ret_msg": '',
...
func  (this *poloniexWs) Ping(client interface{}) interface{}  {
...
func (this *poloniexWs) Init(userConfig map[string]interface{}) {
    this.poloniex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
