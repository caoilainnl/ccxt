...
func NewBingxWs(userConfig map[string]interface{}) BingxWs {
   p := &bingxWs{}
   p.Init(userConfig)
   return BingxWs{
       bingxWs: p,
...
func (this *BingxWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *BingxWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *BingxWs) WatchOrderBookForSymbols(symbols []string, options ...ccxt.WatchOrderBookForSymbolsOptions) (ccxt.IOrderBook, error) {
...
func (this *BingxWs) WatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...ccxt.WatchOHLCVForSymbolsOptions) (map[string]map[string][]ccxt.OHLCV, error) {
...
func (this *BingxWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *BingxWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *BingxWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *BingxWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *BingxWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *BingxWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
