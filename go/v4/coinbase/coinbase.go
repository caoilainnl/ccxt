    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "two_factor_required": ccxt.AuthenticationError,
                "param_required": ccxt.ExchangeError,
                "validation_error": ccxt.ExchangeError,
                "invalid_request": ccxt.ExchangeError,
                "personal_details_required": ccxt.AuthenticationError,
                "identity_verification_required": ccxt.AuthenticationError,
                "jumio_verification_required": ccxt.AuthenticationError,
                "jumio_face_match_verification_required": ccxt.AuthenticationError,
                "unverified_email": ccxt.AuthenticationError,
                "authentication_error": ccxt.AuthenticationError,
                "invalid_authentication_method": ccxt.AuthenticationError,
                "invalid_token": ccxt.AuthenticationError,
                "revoked_token": ccxt.AuthenticationError,
                "expired_token": ccxt.AuthenticationError,
                "invalid_scope": ccxt.AuthenticationError,
            ...
            "broad": map[string]interface{} {
                ...
                "request timestamp expired": ccxt.InvalidNonce,
                "order with this orderID was not found": ccxt.OrderNotFound,
            },
        },
...
func  (this *coinbase) FetchTime(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "v2PublicGetTime")) {
...
func  (this *coinbase) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "fetchAccountsV3")) {
        
                    retRes55819 :=  (<-this.FetchAccountsV3(params))
                    ccxt.PanicOnError(retRes55819)
                    ch <- retRes55819
                    return nil
            }
        
                retRes56015 :=  (<-this.FetchAccountsV2(params))
...
func  (this *coinbase) FetchAccountsV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp370306 := this.HandleOptionAndParams(params, "fetchAccounts", "paginate")
            paginate = ccxt.GetValue(__tmp370306, 0)
            params = ccxt.GetValue(__tmp370306, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes56819 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "next_starting_after", "starting_after", nil, 100))
                    ccxt.PanicOnError(retRes56819)
                    ch <- retRes56819
                    return nil
            }
            ...
            var lastIndex interface{} = ccxt.Subtract(length, 1)
            var last interface{} = this.SafeDict(accounts, lastIndex)
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(cursor, nil))) && ccxt.IsTrue((!ccxt.IsEqual(cursor, "")))) {
                ccxt.AddElementToObject(last, "next_starting_after", cursor)
                ccxt.AddElementToObject(accounts, lastIndex, last)
            }
...
func  (this *coinbase) FetchAccountsV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp735833 := this.HandleOptionAndParams(params, "fetchAccounts", "paginate")
            paginate = ccxt.GetValue(__tmp735833, 0)
            params = ccxt.GetValue(__tmp735833, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes63719 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "cursor", "cursor", nil, 250))
                    ccxt.PanicOnError(retRes63719)
                    ch <- retRes63719
                    return nil
            }
            var request interface{} = map[string]interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(cursor, nil))) && ccxt.IsTrue((!ccxt.IsEqual(cursor, "")))) {
                ccxt.AddElementToObject(last, "cursor", cursor)
                ccxt.AddElementToObject(accounts, lastIndex, last)
            }
...
func  (this *coinbase) FetchPortfolios(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(portfolios)); i++ {
                var portfolio interface{} = ccxt.GetValue(portfolios, i)
...
func  (this *coinbase) ParseAccount(account interface{}) interface{}  {
    ...
    var parts interface{} = ccxt.Split(typeV3, " ")
    return map[string]interface{} {
        "id": this.SafeString2(account, "id", "uuid"),
        "type": ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(active, nil))), this.SafeStringLower(parts, 1), typeV2),
...
func  (this *coinbase) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                ...
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Accounts)); i++ {
                    ...
                    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(account, "code"), code)) && ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(account, "type"), "wallet"))) {
                        accountId = ccxt.GetValue(account, "id")
                        break
                    }
                }
            }
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createDepositAddress() could not find the account with matching currency code "), code), ", specify an `account_id` extra param to target specific wallet")))
            }
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchMySells(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(sells)
        
            ch <- this.ParseTrades(ccxt.GetValue(sells, "data"), nil, since, limit)
            return nil
...
func  (this *coinbase) FetchMyBuys(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(buys)
        
            ch <- this.ParseTrades(ccxt.GetValue(buys, "data"), nil, since, limit)
            return nil
...
func  (this *coinbase) FetchTransactionsWithMethod(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp419714 := (<-this.PrepareAccountRequestWithCurrencyCode(code, limit, params))
            request = ccxt.GetValue(__tmp419714, 0)
            params = ccxt.GetValue(__tmp419714, 1)
            ...
            ch <- this.ParseTransactions(ccxt.GetValue(response, "data"), nil, since, limit)
            return nil
...
func  (this *coinbase) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp3 := this.HandleOptionAndParams(params, "fetchWithdrawals", "currencyType")
            currencyType = ccxt.GetValue(__tmp3, 0)
            params = ccxt.GetValue(__tmp3, 1)
            if ccxt.IsTrue(ccxt.IsEqual(currencyType, "crypto")) {
                ...
                retRes92615 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdWithdrawals", code, since, limit, params))
                ccxt.PanicOnError(retRes92615)
                ch <- retRes92615
                return nil
...
func  (this *coinbase) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var currencyType interface{} = nil
            __tmp243440 := this.HandleOptionAndParams(params, "fetchWithdrawals", "currencyType")
            currencyType = ccxt.GetValue(__tmp243440, 0)
            params = ccxt.GetValue(__tmp243440, 1)
            if ccxt.IsTrue(ccxt.IsEqual(currencyType, "crypto")) {
                ...
                retRes94815 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdDeposits", code, since, limit, params))
                ccxt.PanicOnError(retRes94815)
                ch <- retRes94815
                return nil
...
func  (this *coinbase) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(transactionType, "send")) {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(amountAndCurrencyObject, nil)) {
    ...
    var amountStringAbs interface{} = ccxt.Precise.StringAbs(amountString)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(status, nil)) {
        ...
        status = ccxt.Ternary(ccxt.IsTrue(committed), "ok", "pending")
    }
    ...
    if !ccxt.IsTrue(this.InArray(typeVar, []interface{}{"deposit", "withdrawal"})) {
...
func  (this *coinbase) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(market, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(baseId, nil))) && ccxt.IsTrue((!ccxt.IsEqual(quoteId, nil)))) {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(costString, nil))) && ccxt.IsTrue((!ccxt.IsEqual(amountString, nil)))) {
        priceString = ccxt.Precise.StringDiv(costString, amountString)
    } else {
        priceString = v3Price
    }
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(priceString, nil))) && ccxt.IsTrue((!ccxt.IsEqual(amountString, nil)))) {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(feeCurrencyId, nil))) && ccxt.IsTrue((!ccxt.IsEqual(market, nil)))) && ccxt.IsTrue((!ccxt.IsEqual(feeCost, nil)))) {
        feeCurrencyId = ccxt.GetValue(market, "quote")
    }
    ...
    return this.SafeTrade(map[string]interface{} {
        ...
        "symbol": symbol,
        "type": nil,
        "side": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "unknown_order_side"))), nil, side),
        "takerOrMaker": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(takerOrMaker, "unknown_liquidity_indicator"))), nil, takerOrMaker),
        "price": priceString,
        "amount": amountString,
        "cost": cost,
        "fee": map[string]interface{} {
...
func  (this *coinbase) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes133812 := (<-this.LoadTimeDifference())
                ccxt.PanicOnError(retRes133812)
            }
            var method interface{} = this.SafeString(this.Options, "fetchMarkets", "fetchMarketsV3")
            if ccxt.IsTrue(ccxt.IsEqual(method, "fetchMarketsV3")) {
        
                    retRes134219 :=  (<-this.FetchMarketsV3(params))
                    ccxt.PanicOnError(retRes134219)
                    ch <- retRes134219
                    return nil
            }
        
                retRes134415 :=  (<-this.FetchMarketsV2(params))
...
func  (this *coinbase) FetchMarketsV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var baseIds interface{} = ccxt.ObjectKeys(rates)
            var result interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(baseIds)); i++ {
                var baseId interface{} = ccxt.GetValue(baseIds, i)
                var base interface{} = this.SafeCurrencyCode(baseId)
                var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.InOp(dataById, baseId))), "fiat", "crypto")
                // https://github.com/ccxt/ccxt/issues/6066
                if ccxt.IsTrue(ccxt.IsEqual(typeVar, "crypto")) {
                    for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(data)); j++ {
                        var quoteCurrency interface{} = ccxt.GetValue(data, j)
                        ...
                        ccxt.AppendToArray(&result, this.SafeMarketStructure(map[string]interface{} {
                            "id": ccxt.Add(ccxt.Add(baseId, "-"), quoteId),
                            "symbol": ccxt.Add(ccxt.Add(base, "/"), quote),
                            "base": base,
                            "quote": quote,
                            "settle": nil,
...
func  (this *coinbase) FetchMarketsV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp557710 := this.HandleOptionAndParams(params, "fetchMarkets", "usePrivate", false)
            usePrivate = ccxt.GetValue(__tmp557710, 0)
            params = ccxt.GetValue(__tmp557710, 1)
            var spotUnresolvedPromises interface{} = []interface{}{}
            if ccxt.IsTrue(usePrivate) {
                ccxt.AppendToArray(&spotUnresolvedPromises, this.V3PrivateGetBrokerageProducts(params))
            } else {
                ccxt.AppendToArray(&spotUnresolvedPromises, this.V3PublicGetBrokerageMarketProducts(params))
            }
            //
            //    {
            //        products: [
            ...
            if ccxt.IsTrue(this.CheckRequiredCredentials(false)) {
                ccxt.AppendToArray(&spotUnresolvedPromises, this.V3PrivateGetBrokerageTransactionSummary(params))
            }
            //
            //    {
            ...
            promises:= (<-ccxt.PromiseAll(spotUnresolvedPromises))
            ...
            {		ret__ := func(this *coinbase) (ret_ interface{}) {
            		...
            		// try block:
                            contractPromises = (<-ccxt.PromiseAll(unresolvedContractPromises)) // some users don't have access to contracts
            		return nil
            	}(this)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ccxt.AppendToArray(&result, this.ParseSpotMarket(ccxt.GetValue(data, i), feeTier))
            }
            var futureData interface{} = this.SafeList(expiringFutures, "products", []interface{}{})
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(futureData)); i++ {
                ccxt.AppendToArray(&result, this.ParseContractMarket(ccxt.GetValue(futureData, i), expiringFeeTier))
            }
            var perpetualData interface{} = this.SafeList(perpetualFutures, "products", []interface{}{})
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(perpetualData)); i++ {
                ccxt.AppendToArray(&result, this.ParseContractMarket(ccxt.GetValue(perpetualData, i), perpetualFeeTier))
            }
            var newMarkets interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(result)); i++ {
                var market interface{} = ccxt.GetValue(result, i)
                ...
                var length interface{} =         ccxt.GetArrayLength(realMarketIds)
                if ccxt.IsTrue(ccxt.IsGreaterThan(length, 0)) {
                    ccxt.AddElementToObject(market, "alias", ccxt.GetValue(realMarketIds, 0))
                } else {
                    ccxt.AddElementToObject(market, "alias", nil)
                }
                ccxt.AppendToArray(&newMarkets, market)
            }
...
func  (this *coinbase) ParseSpotMarket(market interface{}, feeTier interface{}) interface{}  {
    ...
    var defaultTakerFee interface{} = this.SafeNumber(ccxt.GetValue(this.Fees, "trading"), "taker")
    var defaultMakerFee interface{} = this.SafeNumber(ccxt.GetValue(this.Fees, "trading"), "maker")
    var takerFee interface{} = ccxt.Ternary(ccxt.IsTrue(this.InArray(id, stablePairs)), 0.00001, this.SafeNumber(feeTier, "taker_fee_rate", defaultTakerFee))
    var makerFee interface{} = ccxt.Ternary(ccxt.IsTrue(this.InArray(id, stablePairs)), 0, this.SafeNumber(feeTier, "maker_fee_rate", defaultMakerFee))
    return this.SafeMarketStructure(map[string]interface{} {
        ...
        "settleId": nil,
        "type": marketType,
        "spot": (ccxt.IsEqual(marketType, "spot")),
        "margin": nil,
        "swap": false,
        "future": false,
        "option": false,
        "active": !ccxt.IsTrue(tradingDisabled),
        "contract": false,
        "linear": nil,
        "inverse": nil,
        "taker": takerFee,
...
func  (this *coinbase) ParseContractMarket(market interface{}, feeTier interface{}) interface{}  {
    ...
    var isSwap interface{} =     (ccxt.IsEqual(contractExpiryType, "PERPETUAL"))
    ...
    if ccxt.IsTrue(isSwap) {
        ...
        typeVar = "future"
        symbol = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(symbol, ":"), quote), "-"), this.Yymmdd(expireTimestamp))
    }
    ...
    var taker interface{} = ccxt.Ternary(ccxt.IsTrue(takerFeeRate), takerFeeRate, this.ParseNumber("0.06"))
    var maker interface{} = ccxt.Ternary(ccxt.IsTrue(makerFeeRate), makerFeeRate, this.ParseNumber("0.04"))
    return this.SafeMarketStructure(map[string]interface{} {
        "id": id,
        "symbol": symbol,
        "base": base,
...
func  (this *coinbase) FetchCurrenciesFromCache(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(timestamp, nil))) || ccxt.IsTrue((ccxt.IsGreaterThan((ccxt.Subtract(now, timestamp)), expires)))) {
                ...
                ccxt.PanicOnError(exchangeRates)
                ccxt.AddElementToObject(this.Options, "fetchCurrencies", this.Extend(options, map[string]interface{} {
...
func  (this *coinbase) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var ratesIds interface{} = ccxt.ObjectKeys(rates)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencies)); i++ {
                ...
                ccxt.AddElementToObject(ccxt.GetValue(this.Options, "networks"), code, ccxt.ToLower(name))
                ccxt.AddElementToObject(ccxt.GetValue(this.Options, "networksById"), code, ccxt.ToLower(name))
                var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(assetId, nil))), "crypto", "fiat")
            ...
            "limits": map[string]interface{} {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(assetId, nil)) {
                    var lowerCaseName interface{} = ccxt.ToLower(name)
                    ccxt.AddElementToObject(networks, code, lowerCaseName)
                    ccxt.AddElementToObject(networksById, lowerCaseName, code)
                }
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ratesIds)); i++ {
                var currencyId interface{} = ccxt.GetValue(ratesIds, i)
            ...
            ccxt.AddElementToObject(this.Options, "networks", this.Extend(networks, ccxt.GetValue(this.Options, "networks")))
            ccxt.AddElementToObject(this.Options, "networksById", this.Extend(networksById, ccxt.GetValue(this.Options, "networksById")))
...
func  (this *coinbase) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "fetchTickersV3")) {
        
                    retRes203819 :=  (<-this.FetchTickersV3(symbols, params))
                    ccxt.PanicOnError(retRes203819)
                    ch <- retRes203819
                    return nil
            }
        
                retRes204015 :=  (<-this.FetchTickersV2(symbols, params))
                ccxt.PanicOnError(retRes204015)
                ch <- retRes204015
                return nil
...
func  (this *coinbase) FetchTickersV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(baseIds)); i++ {
                var baseId interface{} = ccxt.GetValue(baseIds, i)
                var marketId interface{} = ccxt.Add(ccxt.Add(baseId, delimiter), quoteId)
                var market interface{} = this.SafeMarket(marketId, nil, delimiter)
                var symbol interface{} = ccxt.GetValue(market, "symbol")
                ccxt.AddElementToObject(result, symbol, this.ParseTicker(ccxt.GetValue(rates, baseId), market))
            }
...
func  (this *coinbase) FetchTickersV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes20798)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ccxt.AddElementToObject(request, "product_ids", this.MarketIds(symbols))
            }
            var marketType interface{} = nil
            __tmp124646 := this.HandleMarketTypeAndParams("fetchTickers", this.GetMarketFromSymbols(symbols), params, "default")
            marketType = ccxt.GetValue(__tmp124646, 0)
            params = ccxt.GetValue(__tmp124646, 1)
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(marketType, nil)) && ccxt.IsTrue(!ccxt.IsEqual(marketType, "default"))) {
                ccxt.AddElementToObject(request, "product_type", ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marketType, "swap"))), "FUTURE", "SPOT"))
            }
            var response interface{} = nil
            var usePrivate interface{} = false
            __tmp384905 := this.HandleOptionAndParams(params, "fetchTickers", "usePrivate", false)
            usePrivate = ccxt.GetValue(__tmp384905, 0)
            params = ccxt.GetValue(__tmp384905, 1)
            if ccxt.IsTrue(usePrivate) {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                var symbol interface{} = ccxt.GetValue(market, "symbol")
                ccxt.AddElementToObject(result, symbol, this.ParseTicker(entry, market))
            }
...
func  (this *coinbase) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "fetchTickerV3")) {
        
                    retRes216319 :=  (<-this.FetchTickerV3(symbol, params))
                    ccxt.PanicOnError(retRes216319)
                    ch <- retRes216319
                    return nil
            }
        
                retRes216515 :=  (<-this.FetchTickerV2(symbol, params))
                ccxt.PanicOnError(retRes216515)
                ch <- retRes216515
                return nil
...
func  (this *coinbase) FetchTickerV3(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": ccxt.GetValue(market, "id"),
                "limit": 1,
            }
            var usePrivate interface{} = false
            __tmp60958 := this.HandleOptionAndParams(params, "fetchTicker", "usePrivate", false)
            usePrivate = ccxt.GetValue(__tmp60958, 0)
            params = ccxt.GetValue(__tmp60958, 1)
            var response interface{} = nil
            if ccxt.IsTrue(usePrivate) {
            ...
            var ticker interface{} = this.ParseTicker(ccxt.GetValue(data, 0), market)
            ccxt.AddElementToObject(ticker, "bid", this.SafeNumber(response, "best_bid"))
            ccxt.AddElementToObject(ticker, "ask", this.SafeNumber(response, "best_ask"))
...
func  (this *coinbase) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue((ccxt.InOp(ticker, "bids"))) {
        var bids interface{} = this.SafeList(ticker, "bids", []interface{}{})
        var asks interface{} = this.SafeList(ticker, "asks", []interface{}{})
        bid = this.SafeNumber(ccxt.GetValue(bids, 0), "price")
        bidVolume = this.SafeNumber(ccxt.GetValue(bids, 0), "size")
        ask = this.SafeNumber(ccxt.GetValue(asks, 0), "price")
        askVolume = this.SafeNumber(ccxt.GetValue(asks, 0), "size")
    }
...
func  (this *coinbase) ParseCustomBalance(response interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var accounts interface{} = this.SafeList(params, "type", ccxt.GetValue(this.Options, "accounts"))
    var v3Accounts interface{} = this.SafeList(params, "type", ccxt.GetValue(this.Options, "v3Accounts"))
    var result interface{} = map[string]interface{} {
        "info": response,
    }
    for b := 0; ccxt.IsLessThan(b, ccxt.GetArrayLength(balances)); b++ {
        var balance interface{} = ccxt.GetValue(balances, b)
        var typeVar interface{} = this.SafeString(balance, "type")
        if ccxt.IsTrue(this.InArray(typeVar, accounts)) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(value, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(account, nil)) {
                    ...
                    ccxt.AddElementToObject(account, "free", ccxt.Precise.StringAdd(ccxt.GetValue(account, "free"), total))
                    ccxt.AddElementToObject(account, "total", ccxt.Precise.StringAdd(ccxt.GetValue(account, "total"), total))
                }
                ccxt.AddElementToObject(result, code, account)
            }
        } else if ccxt.IsTrue(this.InArray(typeVar, v3Accounts)) {
            var available interface{} = this.SafeDict(balance, "available_balance")
            var hold interface{} = this.SafeDict(balance, "hold")
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(available, nil)) && ccxt.IsTrue(!ccxt.IsEqual(hold, nil))) {
                ...
                var total interface{} = ccxt.Precise.StringAdd(used, free)
                var account interface{} = this.SafeDict(result, code)
                if ccxt.IsTrue(ccxt.IsEqual(account, nil)) {
                    account = this.Account()
                    ccxt.AddElementToObject(account, "free", free)
                    ...
                    ccxt.AddElementToObject(account, "free", ccxt.Precise.StringAdd(ccxt.GetValue(account, "free"), free))
                    ccxt.AddElementToObject(account, "used", ccxt.Precise.StringAdd(ccxt.GetValue(account, "used"), used))
                    ccxt.AddElementToObject(account, "total", ccxt.Precise.StringAdd(ccxt.GetValue(account, "total"), total))
                }
                ccxt.AddElementToObject(result, code, account)
            }
...
func  (this *coinbase) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes24258)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            var isV3 interface{} = this.SafeBool(params, "v3", false)
            params = this.Omit(params, []interface{}{"v3"})
            var marketType interface{} = nil
            __tmp297408 := this.HandleMarketTypeAndParams("fetchBalance", nil, params)
            marketType = ccxt.GetValue(__tmp297408, 0)
            params = ccxt.GetValue(__tmp297408, 1)
            ...
            } else if ccxt.IsTrue(ccxt.IsTrue((isV3)) || ccxt.IsTrue((ccxt.IsEqual(method, "v3PrivateGetBrokerageAccounts")))) {
                ccxt.AddElementToObject(request, "limit", 250)
                response = (<-this.V3PrivateGetBrokerageAccounts(this.Extend(request, params)))
            } else {
                ccxt.AddElementToObject(request, "limit", 250)
                response = (<-this.V2PrivateGetAccounts(this.Extend(request, params)))
            ...
            //     }
            //
            ccxt.AddElementToObject(params, "type", marketType)
...
func  (this *coinbase) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes25308)
            var paginate interface{} = false
            __tmp488628 := this.HandleOptionAndParams(params, "fetchLedger", "paginate")
            paginate = ccxt.GetValue(__tmp488628, 0)
            params = ccxt.GetValue(__tmp488628, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes253419 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))
                    ccxt.PanicOnError(retRes253419)
                    ch <- retRes253419
                    return nil
            }
            ...
            var request interface{} = nil
            __tmp163957 := (<-this.PrepareAccountRequestWithCurrencyCode(code, limit, params))
            request = ccxt.GetValue(__tmp163957, 0)
            params = ccxt.GetValue(__tmp163957, 1)
            ...
            ccxt.PanicOnError(response)
            var ledger interface{} = this.ParseLedger(ccxt.GetValue(response, "data"), currency, since, limit)
            var length interface{} =     ccxt.GetArrayLength(ledger)
            ...
            var cursor interface{} = this.SafeString(pagination, "next_starting_after")
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(cursor, nil))) && ccxt.IsTrue((!ccxt.IsEqual(cursor, "")))) {
                ccxt.AddElementToObject(ccxt.GetValue(last, "info"), "next_starting_after", cursor)
                ccxt.AddElementToObject(ledger, lastIndex, last)
            }
...
func  (this *coinbase) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(path, nil)) {
        var parts interface{} = ccxt.Split(path, "/")
        var numParts interface{} =         ccxt.GetArrayLength(parts)
        if ccxt.IsTrue(ccxt.IsGreaterThan(numParts, 3)) {
            accountId = ccxt.GetValue(parts, 3)
        }
    }
...
func  (this *coinbase) FindAccountId(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes28958)
        
            retRes28968 := (<-this.LoadAccounts(false, params))
            ccxt.PanicOnError(retRes28968)
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Accounts)); i++ {
                var account interface{} = ccxt.GetValue(this.Accounts, i)
                if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(account, "code"), code)) {
        
                    ch <- ccxt.GetValue(account, "id")
                    return nil
                }
            }
...
func  (this *coinbase) PrepareAccountRequest(optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " prepareAccountRequest() method requires an account_id (or accountId) parameter")))
    }
    var request interface{} = map[string]interface{} {
        "account_id": accountId,
    }
...
func  (this *coinbase) PrepareAccountRequestWithCurrencyCode(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " prepareAccountRequestWithCurrencyCode() method requires an account_id (or accountId) parameter OR a currency code argument")))
                }
                accountId = (<-this.FindAccountId(code, params))
                if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                    panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " prepareAccountRequestWithCurrencyCode() could not find account id for "), code)))
                }
            }
            var request interface{} = map[string]interface{} {
                "account_id": accountId,
...
func  (this *coinbase) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes295815 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                ccxt.PanicOnError(retRes295815)
                ch <- retRes295815
                return nil
...
func  (this *coinbase) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes29908)
            var market interface{} = this.Market(symbol)
            var id interface{} = this.SafeString(this.Options, "brokerId", "ccxt")
            var request interface{} = map[string]interface{} {
                "client_order_id": ccxt.Add(ccxt.Add(id, "-"), this.Uuid()),
                "product_id": ccxt.GetValue(market, "id"),
            ...
            var isStop interface{} = !ccxt.IsEqual(triggerPrice, nil)
            ...
            var postOnly interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(timeInForce, "PO"))), true, this.SafeBool2(params, "postOnly", "post_only", false))
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) {
                if ccxt.IsTrue(isStop) {
                    if ccxt.IsTrue(ccxt.IsEqual(stopDirection, nil)) {
                        stopDirection = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), "STOP_DIRECTION_STOP_DOWN", "STOP_DIRECTION_STOP_UP")
                    }
                    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(timeInForce, "GTD"))) || ccxt.IsTrue((!ccxt.IsEqual(endTime, nil)))) {
                        if ccxt.IsTrue(ccxt.IsEqual(endTime, nil)) {
                            panic(ccxt.ExchangeError(ccxt.Add(this.Id, " createOrder() requires an end_time parameter for a GTD order")))
                        }
                        ccxt.AddElementToObject(request, "order_configuration", map[string]interface{} {
            ...
            "stop_limit_stop_limit_gtc": map[string]interface{} {
                ...
                "stop_direction": stopDirection,
                    ...
                    if ccxt.IsTrue(isStopLoss) {
                        if ccxt.IsTrue(ccxt.IsEqual(stopDirection, nil)) {
                            stopDirection = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), "STOP_DIRECTION_STOP_UP", "STOP_DIRECTION_STOP_DOWN")
                        }
            ...
            "limit_limit_gtc": map[string]interface{} {
                ...
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(isStop) || ccxt.IsTrue(isStopLoss)) || ccxt.IsTrue(isTakeProfit)) {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrder() only stop limit orders are supported")))
                }
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.GetValue(market, "spot")) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))) {
                    var total interface{} = nil
                    var createMarketBuyOrderRequiresPrice interface{} = true
                    __tmp670815 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                    createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp670815, 0)
                    params = ccxt.GetValue(__tmp670815, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                    ccxt.AddElementToObject(request, "margin_type", "ISOLATED")
                } else if ccxt.IsTrue(ccxt.IsEqual(marginMode, "cross")) {
                    ccxt.AddElementToObject(request, "margin_type", "CROSS")
                }
            }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(success, true)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(errorResponse, nil)) {
                    this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errorTitle, errorMessage)
                    this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), errorTitle, errorMessage)
...
func  (this *coinbase) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var isLimit interface{} =     (ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(limitGTC, nil))) || ccxt.IsTrue((!ccxt.IsEqual(limitGTD, nil)))) || ccxt.IsTrue((!ccxt.IsEqual(limitIOC, nil))))
    var isStop interface{} =     (ccxt.IsTrue((!ccxt.IsEqual(stopLimitGTC, nil))) || ccxt.IsTrue((!ccxt.IsEqual(stopLimitGTD, nil))))
    ...
    if ccxt.IsTrue(isLimit) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(limitGTC, nil)) {
            target = limitGTC
        } else if ccxt.IsTrue(!ccxt.IsEqual(limitGTD, nil)) {
            target = limitGTD
        } else {
            target = limitIOC
        }
    ...
    } else if ccxt.IsTrue(isStop) {
        var stopTarget interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(stopLimitGTC, nil))), stopLimitGTC, stopLimitGTD)
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(totalFees, nil))) && ccxt.IsTrue((!ccxt.IsEqual(market, nil)))) {
        currencyFee = ccxt.GetValue(market, "quote")
    }
...
func  (this *coinbase) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                var success interface{} = this.SafeBool(ccxt.GetValue(orders, i), "success")
                if ccxt.IsTrue(!ccxt.IsEqual(success, true)) {
                    panic(ccxt.BadRequest(ccxt.Add(this.Id, " cancelOrders() has failed, check your arguments and parameters")))
                }
            }
...
func  (this *coinbase) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp221061 := this.HandleOptionAndParams(params, "fetchOrders", "paginate")
            paginate = ccxt.GetValue(__tmp221061, 0)
            params = ccxt.GetValue(__tmp221061, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes355819 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))
                    ccxt.PanicOnError(retRes355819)
                    ch <- retRes355819
                    return nil
            }
            var market interface{} = nil
            ...
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(market, nil)) {
                ccxt.AddElementToObject(request, "product_id", ccxt.GetValue(market, "id"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_date", this.Iso8601(since))
            }
            var until interface{} = this.SafeIntegerN(params, []interface{}{"until"})
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                params = this.Omit(params, []interface{}{"until"})
                ccxt.AddElementToObject(request, "end_date", this.Iso8601(until))
            }
            ...
            var cursor interface{} = this.SafeString(response, "cursor")
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(cursor, nil))) && ccxt.IsTrue((!ccxt.IsEqual(cursor, "")))) {
                ccxt.AddElementToObject(first, "cursor", cursor)
...
func  (this *coinbase) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes37238)
            var paginate interface{} = false
            __tmp383447 := this.HandleOptionAndParams(params, "fetchOpenOrders", "paginate")
            paginate = ccxt.GetValue(__tmp383447, 0)
            params = ccxt.GetValue(__tmp383447, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes372719 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    ccxt.PanicOnError(retRes372719)
                    ch <- retRes372719
                    return nil
            }
        
                retRes372915 :=  (<-this.FetchOrdersByStatus("OPEN", symbol, since, limit, params))
                ccxt.PanicOnError(retRes372915)
                ch <- retRes372915
                return nil
...
func  (this *coinbase) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes37468)
            var paginate interface{} = false
            __tmp917934 := this.HandleOptionAndParams(params, "fetchClosedOrders", "paginate")
            paginate = ccxt.GetValue(__tmp917934, 0)
            params = ccxt.GetValue(__tmp917934, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes375019 :=  (<-this.FetchPaginatedCallCursor("fetchClosedOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    ccxt.PanicOnError(retRes375019)
                    ch <- retRes375019
                    return nil
            }
        
                retRes375215 :=  (<-this.FetchOrdersByStatus("FILLED", symbol, since, limit, params))
                ccxt.PanicOnError(retRes375215)
                ch <- retRes375215
                return nil
...
func  (this *coinbase) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes376715 :=  (<-this.FetchOrdersByStatus("CANCELLED", symbol, since, limit, params))
                ccxt.PanicOnError(retRes376715)
                ch <- retRes376715
                return nil
...
func  (this *coinbase) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp565791 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate", false)
            paginate = ccxt.GetValue(__tmp565791, 0)
            params = ccxt.GetValue(__tmp565791, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes379219 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, ccxt.Subtract(maxLimit, 1)))
                    ccxt.PanicOnError(retRes379219)
                    ch <- retRes379219
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            var requestedDuration interface{} = ccxt.Multiply(limit, duration)
            var sinceString interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                sinceString = this.NumberToString(this.ParseToInt(ccxt.Divide(since, 1000)))
            } else {
                var now interface{} = ccxt.ToString(this.Seconds())
                sinceString = ccxt.Precise.StringSub(now, ccxt.ToString(requestedDuration))
            }
            ccxt.AddElementToObject(request, "start", sinceString)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "end", this.NumberToString(this.ParseToInt(ccxt.Divide(until, 1000))))
            } else {
                // 300 candles max
                ccxt.AddElementToObject(request, "end", ccxt.Precise.StringAdd(sinceString, ccxt.ToString(requestedDuration)))
            }
            var response interface{} = nil
            var usePrivate interface{} = false
            __tmp570457 := this.HandleOptionAndParams(params, "fetchOHLCV", "usePrivate", false)
            usePrivate = ccxt.GetValue(__tmp570457, 0)
            params = ccxt.GetValue(__tmp570457, 1)
            if ccxt.IsTrue(usePrivate) {
...
func  (this *coinbase) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes38798)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": ccxt.GetValue(market, "id"),
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start", this.NumberToString(this.ParseToInt(ccxt.Divide(since, 1000))))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", ccxt.MathMin(limit, 1000))
            }
            var until interface{} = nil
            __tmp93149 := this.HandleOptionAndParams(params, "fetchTrades", "until")
            until = ccxt.GetValue(__tmp93149, 0)
            params = ccxt.GetValue(__tmp93149, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "end", this.NumberToString(this.ParseToInt(ccxt.Divide(until, 1000))))
            } else if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchTrades() requires a `until` parameter when you use `since` argument")))
            }
            var response interface{} = nil
            var usePrivate interface{} = false
            __tmp598454 := this.HandleOptionAndParams(params, "fetchTrades", "usePrivate", false)
            usePrivate = ccxt.GetValue(__tmp598454, 0)
            params = ccxt.GetValue(__tmp598454, 1)
            if ccxt.IsTrue(usePrivate) {
                response = (<-this.V3PrivateGetBrokerageProductsProductIdTicker(this.Extend(request, params)))
            } else {
                response = (<-this.V3PublicGetBrokerageMarketProductsProductIdTicker(this.Extend(request, params)))
...
func  (this *coinbase) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes39398 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes39398)
            var paginate interface{} = false
            __tmp778620 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp778620, 0)
            params = ccxt.GetValue(__tmp778620, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes394319 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))
                    ccxt.PanicOnError(retRes394319)
                    ch <- retRes394319
                    return nil
            }
            var market interface{} = nil
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_sequence_timestamp", this.Iso8601(since))
            }
            var until interface{} = this.SafeIntegerN(params, []interface{}{"until"})
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                params = this.Omit(params, []interface{}{"until"})
                ccxt.AddElementToObject(request, "end_sequence_timestamp", this.Iso8601(until))
            }
            ...
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(cursor, nil))) && ccxt.IsTrue((!ccxt.IsEqual(cursor, "")))) {
                ccxt.AddElementToObject(first, "cursor", cursor)
                ccxt.AddElementToObject(trades, 0, first)
            }
...
func  (this *coinbase) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var response interface{} = nil
            var usePrivate interface{} = false
            __tmp496527 := this.HandleOptionAndParams(params, "fetchOrderBook", "usePrivate", false)
            usePrivate = ccxt.GetValue(__tmp496527, 0)
            params = ccxt.GetValue(__tmp496527, 1)
            if ccxt.IsTrue(usePrivate) {
...
func  (this *coinbase) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40628 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes40628)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ccxt.AddElementToObject(request, "product_ids", this.MarketIds(symbols))
...
func  (this *coinbase) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp230697 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp230697, 0)
            params = ccxt.GetValue(__tmp230697, 1)
            this.CheckAddress(address)
        
            retRes41108 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes41108)
            var currency interface{} = this.Currency(code)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " withdraw() requires an account_id (or accountId) parameter OR a currency code argument")))
                }
                accountId = (<-this.FindAccountId(code, params))
                if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                    panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " withdraw() could not find account id for "), code)))
                }
            }
            var request interface{} = map[string]interface{} {
                "account_id": accountId,
...
func  (this *coinbase) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes42008)
            var currency interface{} = this.Currency(code)
            var request interface{} = nil
            __tmp61307 := (<-this.PrepareAccountRequestWithCurrencyCode(ccxt.GetValue(currency, "code"), nil, params))
            request = ccxt.GetValue(__tmp61307, 0)
            params = ccxt.GetValue(__tmp61307, 1)
...
func  (this *coinbase) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(addressLabel, nil)) {
        var splitAddressLabel interface{} = ccxt.Split(addressLabel, " ")
...
func  (this *coinbase) Deposit(code interface{}, amount interface{}, id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes43428)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " deposit() requires an account_id (or accountId) parameter OR a currency code argument")))
                }
                accountId = (<-this.FindAccountId(code, params))
                if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                    panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " deposit() could not find account id for "), code)))
                }
            }
            var request interface{} = map[string]interface{} {
                "account_id": accountId,
                "amount": this.NumberToString(amount),
                "currency": ccxt.ToUpper(code),
                "payment_method": id,
                "commit": true,
            }
...
func  (this *coinbase) FetchDeposit(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes44158)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchDeposit() requires an account_id (or accountId) parameter OR a currency code argument")))
                }
                accountId = (<-this.FindAccountId(code, params))
                if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                    panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " fetchDeposit() could not find account id for "), code)))
                }
            }
            var request interface{} = map[string]interface{} {
                "account_id": accountId,
...
func  (this *coinbase) FetchDepositMethodIds(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes44828 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes44828)
...
func  (this *coinbase) ParseDepositMethodIds(ids interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
        var id interface{} = this.Extend(this.ParseDepositMethodId(ccxt.GetValue(ids, i)), params)
        ccxt.AppendToArray(&result, id)
    }
    return result
}
...
func  (this *coinbase) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46018 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes46018)
            var request interface{} = map[string]interface{} {
                "trade_id": id,
                "from_account": fromCode,
                "to_account": toCode,
...
func  (this *coinbase) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46248 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes46248)
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchConvertTrade() requires a code argument")))
            }
            var toCode interface{} = this.SafeString(params, "toCode")
            if ccxt.IsTrue(ccxt.IsEqual(toCode, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchConvertTrade() requires a toCode parameter")))
            }
...
func  (this *coinbase) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " closePosition() requires a clientOrderId parameter")))
            }
...
func  (this *coinbase) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var typeVar interface{} = nil
            __tmp307742 := this.HandleMarketTypeAndParams("fetchPositions", market, params)
            typeVar = ccxt.GetValue(__tmp307742, 0)
            params = ccxt.GetValue(__tmp307742, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "future")) {
                ...
                __tmp142854 := this.HandleOptionAndParams(params, "fetchPositions", "portfolio")
                portfolio = ccxt.GetValue(__tmp142854, 0)
                params = ccxt.GetValue(__tmp142854, 1)
                if ccxt.IsTrue(ccxt.IsEqual(portfolio, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchPositions() requires a \"portfolio\" value in params (eg: dbcb91e7-2bc9-515), or set as exchange.options[\"portfolio\"]. You can get a list of portfolios with fetchPortfolios()")))
                }
                var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes47458)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "future")) {
                var productId interface{} = this.SafeString(market, "product_id")
                if ccxt.IsTrue(ccxt.IsEqual(productId, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchPosition() requires a \"product_id\" in params")))
                }
                ...
                var portfolio interface{} = nil
                __tmp963871 := this.HandleOptionAndParams(params, "fetchPositions", "portfolio")
                portfolio = ccxt.GetValue(__tmp963871, 0)
                params = ccxt.GetValue(__tmp963871, 1)
                if ccxt.IsTrue(ccxt.IsEqual(portfolio, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchPosition() requires a \"portfolio\" value in params (eg: dbcb91e7-2bc9-515), or set as exchange.options[\"portfolio\"]. You can get a list of portfolios with fetchPortfolios()")))
                }
                var request interface{} = map[string]interface{} {
                    "symbol": ccxt.GetValue(market, "id"),
                    "portfolio_uuid": portfolio,
...
func  (this *coinbase) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(rawMargin, nil)) {
        marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(rawMargin, "MARGIN_TYPE_CROSS"))), "cross", "isolated")
    }
    ...
    var side interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(positionSide, "POSITION_SIDE_LONG"))), "long", "short")
...
func  (this *coinbase) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes49208)
            var typeVar interface{} = nil
            __tmp913769 := this.HandleMarketTypeAndParams("fetchTradingFees", nil, params)
            typeVar = ccxt.GetValue(__tmp913769, 0)
            params = ccxt.GetValue(__tmp913769, 1)
            var isSpot interface{} =     (ccxt.IsEqual(typeVar, "spot"))
            var productType interface{} = ccxt.Ternary(ccxt.IsTrue(isSpot), "SPOT", "FUTURE")
            var request interface{} = map[string]interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Symbols)); i++ {
                ...
                var market interface{} = this.Market(symbol)
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue(isSpot) && ccxt.IsTrue(ccxt.GetValue(market, "spot")))) || ccxt.IsTrue((!ccxt.IsTrue(isSpot) && !ccxt.IsTrue(ccxt.GetValue(market, "spot"))))) {
...
func  (this *coinbase) FetchPortfolioDetails(portfolioUuid interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49828 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes49828)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) ParsePortfolioDetails(portfolioData interface{}) interface{}  {
    var breakdown interface{} = ccxt.GetValue(portfolioData, "breakdown")
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(spotPositions)); i++ {
        var position interface{} = ccxt.GetValue(spotPositions, i)
        ...
        var holdAmount interface{} = ccxt.Subtract(totalBalanceFiat, availableBalance)
        ...
        var positionData interface{} = map[string]interface{} {
            ...
            "hold_amount": ccxt.Ternary(ccxt.IsTrue(ccxt.IsGreaterThan(holdAmount, 0)), holdAmount, 0),
        ...
        ccxt.AppendToArray(&parsedPositions, positionData)
    }
...
func  (this *coinbase) CreateAuthToken(seconds interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = method
    url := ccxt.GetArg(optionalArgs, 1, nil)
    _ = url
    var uri interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(url, nil)) {
        uri = ccxt.Add(ccxt.Add(method, " "), ccxt.Replace(url, "https://", ""))
        var quesPos interface{} = ccxt.GetIndexOf(uri, "?")
        ...
        if ccxt.IsTrue(ccxt.IsGreaterThan(quesPos, 0)) {
            uri = ccxt.Slice(uri, 0, quesPos)
        }
    }
    ...
    var request interface{} = map[string]interface{} {
        ...
        "iss": "coinbase-cloud",
        "nbf": seconds,
        "exp": ccxt.Add(seconds, 120),
        "sub": this.ApiKey,
        "iat": seconds,
    }
    if ccxt.IsTrue(!ccxt.IsEqual(uri, nil)) {
        ccxt.AddElementToObject(request, "uri", uri)
    }
    var token interface{} = ccxt.Jwt(request, this.Encode(this.Secret), ccxt.Sha256, false, map[string]interface{} {
        "kid": this.ApiKey,
        "nonce": nonce,
        "alg": "ES256",
    })
...
func  (this *coinbase) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var isV3 interface{} = ccxt.IsEqual(version, "v3")
    var pathPart interface{} = ccxt.Ternary(ccxt.IsTrue((isV3)), "api/v3", "v2")
    var fullPath interface{} = ccxt.Add(ccxt.Add(ccxt.Add("/", pathPart), "/"), this.ImplodeParams(path, params))
    ...
    if ccxt.IsTrue(signed) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(authorization, nil)) {
            authorizationString = authorization
        } else if ccxt.IsTrue(ccxt.IsTrue(this.Token) && !ccxt.IsTrue(this.CheckRequiredCredentials(false))) {
            authorizationString = ccxt.Add("Bearer ", this.Token)
        } else {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(method, "GET")) {
                ...
                if !ccxt.IsTrue(isV3) {
                    if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
                        payload = ccxt.Add(payload, ccxt.Add("?", this.Urlencode(query)))
                    }
                }
            }
            ...
            if ccxt.IsTrue(isCloudAPiKey) {
                ...
                // const token = jwt (request, this.encode (this.secret), ccxt.Sha256, false, { 'kid': this.apiKey, 'nonce': nonce, 'alg': 'ES256' });
                authorizationString = ccxt.Add("Bearer ", token)
            } else {
                ...
                var auth interface{} = ccxt.Add(ccxt.Add(ccxt.Add(timestampString, method), savedPath), payload)
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(authorizationString, nil)) {
            headers = map[string]interface{} {
...
func  (this *coinbase) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(errorResponse, nil)) {
        ...
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errorMessageInner, feedback)
        this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), errorMessageInner, feedback)
        panic(ccxt.ExchangeError(feedback))
    }
    var errors interface{} = this.SafeList(response, "errors")
    if ccxt.IsTrue(!ccxt.IsEqual(errors, nil)) {
        if ccxt.IsTrue(ccxt.IsArray(errors)) {
            var numErrors interface{} =             ccxt.GetArrayLength(errors)
            if ccxt.IsTrue(ccxt.IsGreaterThan(numErrors, 0)) {
                errorCode = this.SafeString(ccxt.GetValue(errors, 0), "id")
                var errorMessage interface{} = this.SafeString(ccxt.GetValue(errors, 0), "message")
                if ccxt.IsTrue(!ccxt.IsEqual(errorCode, nil)) {
                    this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errorCode, feedback)
                    this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), errorMessage, feedback)
                    panic(ccxt.ExchangeError(feedback))
    ...
    var advancedTrade interface{} = ccxt.GetValue(this.Options, "advanced")
    if ccxt.IsTrue(!ccxt.IsTrue((ccxt.InOp(response, "data"))) && ccxt.IsTrue((!ccxt.IsTrue(advancedTrade)))) {
        panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " failed due to a malformed response "), this.Json(response))))
    }
    return nil
}
