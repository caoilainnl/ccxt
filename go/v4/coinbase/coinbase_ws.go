...
func NewCoinbaseWsCore() coinbaseWs {
   p := coinbaseWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *coinbaseWs) Describe() interface{}  {
 ...
 */
func  (this *coinbaseWs) Subscribe(name interface{}, isPrivate interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(isPrivate) {
                ...
                retRes9015 :=  (<-this.Watch(url, messageHash, subscribe, messageHash))
 ...
 * @returns {object} subscription to a websocket channel
 */
func  (this *coinbaseWs) SubscribeMultiple(name interface{}, isPrivate interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(isPrivate) {
                ...
                retRes12515 :=  (<-this.WatchMultiple(url, messageHashes, subscribe, messageHashes, nil))
...
func  (this *coinbaseWs) CreateWSAuth(name interface{}, productIds interface{}) interface{}  {
    var subscribe interface{} = map[string]interface{} {}
 ...
 */
func  (this *coinbaseWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var name interface{} = "ticker"
                ...
                retRes16815 :=  (<-this.Subscribe(name, false, symbol, params))
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *coinbaseWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinbaseWs) HandleTickers(client interface{}, message interface{})  {
    //
    //    {
    //        "channel": "ticker",
    //        "client_id": "",
...
func  (this *coinbaseWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "type": "ticker",
    //         "product_id": "DOGE-USD",
 ...
 */
func  (this *coinbaseWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *coinbaseWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *coinbaseWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *coinbaseWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *coinbaseWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinbaseWs) HandleTrade(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *coinbaseWs) HandleOrder(client interface{}, message interface{})  {
    //
    //    {
    //        "channel": "user",
    //        "client_id": "",
...
func  (this *coinbaseWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "order_id": "XXX",
    //        "client_order_id": "YYY",
...
func  (this *coinbaseWs) HandleOrderBookHelper(orderbook interface{}, updates interface{})  {
...
func  (this *coinbaseWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //    {
    //        "channel": "l2_data",
    //        "client_id": "",
...
func  (this *coinbaseWs) TryResolveUsdc(client interface{}, messageHash interface{}, result interface{})  {
...
func  (this *coinbaseWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "type": "subscriptions",
    //         "channels": [
...
func  (this *coinbaseWs) HandleHeartbeats(client interface{}, message interface{}) interface{}  {
...
func  (this *coinbaseWs) HandleMessage(client interface{}, message interface{})  {
    var channel interface{} = this.SafeString(message, "channel")
...
func (this *coinbaseWs) Init(userConfig map[string]interface{}) {
