    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "803": ccxt.InvalidOrder,
                "804": ccxt.InvalidOrder,
                "805": ccxt.InvalidOrder,
                "806": ccxt.InvalidOrder,
                "807": ccxt.InvalidOrder,
                "831": ccxt.InsufficientFunds,
                "832": ccxt.InsufficientFunds,
                "833": ccxt.OrderNotFound,
            },
            "broad": map[string]interface{} {
                "Invalid pair name": ccxt.ExchangeError,
                ...
                "Total transaction amount": ccxt.InvalidOrder,
...
func  (this *yobit) ParseBalance(response interface{}) interface{}  {
    ...
    var currencyIds interface{} = ccxt.ObjectKeys(this.Extend(free, total))
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencyIds)); i++ {
        ...
        ccxt.AddElementToObject(account, "total", this.SafeString(total, currencyId))
...
func  (this *yobit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                ...
                feeString = ccxt.Precise.StringDiv(feeString, "100")
                // yobit maker = taker
...
func  (this *yobit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default = 150, max = 2000
            }
        
            response:= (<-this.PublicGetDepthPair(this.Extend(request, params)))
            ccxt.PanicOnError(response)
            var market_id_in_reponse interface{} =     (ccxt.InOp(response, ccxt.GetValue(market, "id")))
            if !ccxt.IsTrue(market_id_in_reponse) {
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), ccxt.GetValue(market, "symbol")), " order book is empty or not available")))
            }
            var orderbook interface{} = ccxt.GetValue(response, ccxt.GetValue(market, "id"))
...
func  (this *yobit) FetchOrderBooks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ...
                ccxt.AddElementToObject(result, symbol, this.ParseOrderBook(ccxt.GetValue(response, id), symbol))
            }
...
func  (this *yobit) FetchTickersHelper(idsString interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var result interface{} = map[string]interface{} {}
            var keys interface{} = ccxt.ObjectKeys(tickers)
            for k := 0; ccxt.IsLessThan(k, ccxt.GetArrayLength(keys)); k++ {
                var id interface{} = ccxt.GetValue(keys, k)
...
func  (this *yobit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp499408 := this.HandleParamBool(params, "all", false)
            allSymbols = ccxt.GetValue(__tmp499408, 0)
            params = ccxt.GetValue(__tmp499408, 1)
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) && !ccxt.IsTrue(allSymbols)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchTickers() requires \"symbols\" argument or use `params[\"all\"] = true` to send multiple requests for all markets")))
            }
            ...
            if ccxt.IsTrue(allSymbols) {
                ...
                var ids interface{} = ""
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Ids)); i++ {
                    var id interface{} = ccxt.GetValue(this.Ids, i)
                    var prefix interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(ids, ""))), "", "-")
                    ids = ccxt.Add(ids, ccxt.Add(prefix, id))
                    if ccxt.IsTrue(ccxt.IsGreaterThan(ccxt.GetLength(ids), maxLength)) {
                        ccxt.AppendToArray(&promises, this.FetchTickersHelper(ids, params))
                        ids = ""
                    }
                }
                if ccxt.IsTrue(!ccxt.IsEqual(ids, "")) {
                    ccxt.AppendToArray(&promises, this.FetchTickersHelper(ids, params))
                }
            } else {
                ...
                var idsString interface{} = ccxt.Join(ids, "-")
                var actualLength interface{} = ccxt.Add(ccxt.GetLength(idsString), lenghtOfBaseUrl)
                if ccxt.IsTrue(ccxt.IsGreaterThan(actualLength, maxLength)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchTickers() is being requested for "), ccxt.ToString(idsLength)), " markets (which has an URL length of "), ccxt.ToString(actualLength)), " characters), but it exceedes max URL length ("), ccxt.ToString(maxLength)), "), please pass limisted symbols array to fetchTickers to fit in one request")))
                }
                ccxt.AppendToArray(&promises, this.FetchTickersHelper(idsString, params))
            }
        
            resultAll:= (<-ccxt.PromiseAll(promises))
            ccxt.PanicOnError(resultAll)
            var finalResult interface{} = map[string]interface{} {}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(resultAll)); i++ {
                var result interface{} = this.FilterByArrayTickers(ccxt.GetValue(resultAll, i), "symbol", symbols)
...
func  (this *yobit) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(isYourOrder, nil)) {
...
func  (this *yobit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsArray(response)) {
                var numElements interface{} =         ccxt.GetArrayLength(response)
                if ccxt.IsTrue(ccxt.IsEqual(numElements, 0)) {
        
                    ch <- []interface{}{}
                    return nil
                }
            }
            var result interface{} = this.SafeList(response, ccxt.GetValue(market, "id"), []interface{}{})
...
func  (this *yobit) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketIds interface{} = ccxt.ObjectKeys(pairs)
            var result interface{} = map[string]interface{} {}
...
func  (this *yobit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                ccxt.AddElementToObject(request, "pair", ccxt.GetValue(marketInner, "id"))
            }
...
func  (this *yobit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ...
                var trade interface{} = this.ParseTrade(this.Extend(ccxt.GetValue(trades, id), map[string]interface{} {
                    "trade_id": id,
                }), market)
...
func  (this *yobit) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- map[string]interface{} {
                ...
                "tag": nil,
                "network": nil,
                "info": ccxt.GetValue(response, "info"),
            }
            return nil
...
func  (this *yobit) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(network, nil)) {
                if ccxt.IsTrue(!ccxt.IsEqual(network, "ERC20")) {
                    currencyId = ccxt.Add(currencyId, ccxt.ToLower(network))
                }
            ...
            ccxt.PanicOnError(response)
            var address interface{} = this.SafeString(ccxt.GetValue(response, "return"), "address")
            this.CheckAddress(address)
...
func  (this *yobit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp872937 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp872937, 0)
            params = ccxt.GetValue(__tmp872937, 1)
            this.CheckAddress(address)
            ...
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coinName": ccxt.GetValue(currency, "id"),
                "amount": amount,
                "address": address,
            }
            // no docs on the tag, yet...
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " withdraw() does not support the tag argument yet due to a lack of docs on withdrawing with tag/memo on behalf of the exchange.")))
            }
...
func  (this *yobit) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var signature interface{} = this.Hmac(this.Encode(body), this.Encode(this.Secret), ccxt.Sha512)
        headers = map[string]interface{} {
            "Content-Type": "application/x-www-form-urlencoded",
            "Key": this.ApiKey,
            "Sign": signature,
        }
    } else if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
