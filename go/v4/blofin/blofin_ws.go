...
func NewBlofinWsCore() blofinWs {
   p := blofinWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *blofinWs) Describe() interface{}  {
...
func  (this *blofinWs) Ping(client interface{}) interface{}  {
    return "ping"
}
func  (this *blofinWs) HandlePong(client interface{}, message interface{})  {
    //
    //   'pong'
    //
 ...
 */
func  (this *blofinWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *blofinWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(this.NewUpdates) {
                ...
                limit = trades.(ccxt.GetsLimit).GetLimit(firstSymbol, limit)
            }
...
func  (this *blofinWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //       arg: {
    //         channel: "trades",
...
func  (this *blofinWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *blofinWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *blofinWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp704876 := this.HandleParamString(params, "callerMethodName", "watchOrderBookForSymbols")
            callerMethodName = ccxt.GetValue(__tmp704876, 0)
            params = ccxt.GetValue(__tmp704876, 1)
            var channelName interface{} = nil
            __tmp528058 := this.HandleOptionAndParams(params, callerMethodName, "channel", "books")
            channelName = ccxt.GetValue(__tmp528058, 0)
            params = ccxt.GetValue(__tmp528058, 1)
...
func  (this *blofinWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //   {
    //     arg: {
    //         channel: "books",
 ...
 */
func  (this *blofinWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *blofinWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blofinWs) HandleTicker(client interface{}, message interface{})  {
    //
    // message
    //
    //     {
...
func  (this *blofinWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *blofinWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp977162 := this.HandleMarketTypeAndParams("watchBidsAsks", firstMarket, params)
            marketType = ccxt.GetValue(__tmp977162, 0)
            params = ccxt.GetValue(__tmp977162, 1)
            ...
            ticker:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), messageHashes, nil))
            ccxt.PanicOnError(ticker)
            if ccxt.IsTrue(this.NewUpdates) {
                var tickers interface{} = map[string]interface{} {}
                ccxt.AddElementToObject(tickers, ccxt.GetValue(ticker, "symbol"), ticker)
...
func  (this *blofinWs) HandleBidAsk(client interface{}, message interface{})  {
    var data interface{} = this.SafeList(message, "data")
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
...
func  (this *blofinWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
 ...
 */
func  (this *blofinWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *blofinWs) WatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blofinWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    // message
    //
    //     {
 ...
 */
func  (this *blofinWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var marketType interface{} = nil
            __tmp845442 := this.HandleMarketTypeAndParams("watchBalance", nil, params)
            marketType = ccxt.GetValue(__tmp845442, 0)
            params = ccxt.GetValue(__tmp845442, 1)
...
func  (this *blofinWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         arg: {
    //           channel: "account",
...
func  (this *blofinWs) ParseWsBalance(message interface{}) interface{}  {
 ...
 */
func  (this *blofinWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure
 */
func  (this *blofinWs) WatchOrdersForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(this.NewUpdates) {
                ...
                limit = orders.(ccxt.GetsLimit).GetLimit(tradeSymbol, limit)
            }
...
func  (this *blofinWs) HandleOrders(client interface{}, message interface{})  {
    //
    //     {
    //         action: 'update',
    //         arg: { channel: 'orders' },
...
func  (this *blofinWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
 ...
 */
func  (this *blofinWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blofinWs) HandlePositions(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *blofinWs) ParseWsPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    return this.ParsePosition(position, market)
}
func  (this *blofinWs) WatchMultipleWrapper(isPublic interface{}, channelName interface{}, callerMethodName interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp680226 := this.HandleParamString(params, "callerMethodName", callerMethodName)
            callerMethodName = ccxt.GetValue(__tmp680226, 0)
            params = ccxt.GetValue(__tmp680226, 1)
            ...
            var marketType interface{} = nil
            __tmp96200 := this.HandleMarketTypeAndParams(callerMethodName, firstMarket, params)
            marketType = ccxt.GetValue(__tmp96200, 0)
            params = ccxt.GetValue(__tmp96200, 1)
            ...
            var url interface{} = this.ImplodeHostname(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), marketType), privateOrPublic))
                ...
                retRes68315 :=  (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), messageHashes, nil))
...
func  (this *blofinWs) GetSubscriptionRequest(args interface{}) interface{}  {
    return map[string]interface{} {
        "op": "subscribe",
        "args": args,
    }
}
func  (this *blofinWs) HandleMessage(client interface{}, message interface{})  {
    //
    // message examples
    //
    // {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(message, "pong")) {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(event, "subscribe")) {
            ...
            var future interface{} = this.SafeValue(client.(*ccxt.Client).Futures, "authenticate_hash")
...
func  (this *blofinWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func (this *blofinWs) Init(userConfig map[string]interface{}) {
    this.blofin.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
