    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "152001": ccxt.BadRequest,
                "152002": ccxt.BadRequest,
                "152003": ccxt.BadRequest,
                "152004": ccxt.BadRequest,
                "152005": ccxt.BadRequest,
                "152006": ccxt.InvalidOrder,
                "152007": ccxt.InvalidOrder,
                "152008": ccxt.InvalidOrder,
                "152009": ccxt.InvalidOrder,
                "150003": ccxt.InvalidOrder,
                "150004": ccxt.InvalidOrder,
                "542": ccxt.InvalidOrder,
                "102002": ccxt.InvalidOrder,
                "102005": ccxt.InvalidOrder,
                "102014": ccxt.InvalidOrder,
                "102015": ccxt.InvalidOrder,
                "102022": ccxt.InvalidOrder,
                "102037": ccxt.InvalidOrder,
                "102038": ccxt.InvalidOrder,
                "102039": ccxt.InvalidOrder,
                "102040": ccxt.InvalidOrder,
                "102047": ccxt.InvalidOrder,
                "102048": ccxt.InvalidOrder,
                "102049": ccxt.InvalidOrder,
                "102050": ccxt.InvalidOrder,
                "102051": ccxt.InvalidOrder,
                "102052": ccxt.InvalidOrder,
                "102053": ccxt.InvalidOrder,
                "102054": ccxt.InvalidOrder,
                "102055": ccxt.InvalidOrder,
                "102064": ccxt.BadRequest,
                "102065": ccxt.BadRequest,
                "102068": ccxt.BadRequest,
                "103013": ccxt.ExchangeError,
                "ccxt.Order failed. Insufficient USDT margin in account": ccxt.InsufficientFunds,
            },
...
func  (this *blofin) ParseMarket(market interface{}) interface{}  {
    ...
    var contract interface{} = ccxt.IsTrue(swap) || ccxt.IsTrue(future)
    ...
    var isActive interface{} =     (ccxt.IsEqual(this.SafeString(market, "state"), "live"))
    return this.SafeMarketStructure(map[string]interface{} {
        ...
        "contractSize": ccxt.Ternary(ccxt.IsTrue(contract), this.SafeNumber(market, "contractValue"), nil),
        "expiry": expiry,
...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            limit = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(limit, nil))), 50, limit)
...
func  (this *blofin) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var quoteVolume interface{} = ccxt.Ternary(ccxt.IsTrue(spot), this.SafeString(ticker, "volCurrency24h"), nil)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp406516 := this.HandleOptionAndParams(params, "fetchTrades", "paginate")
            paginate = ccxt.GetValue(__tmp406516, 0)
            params = ccxt.GetValue(__tmp406516, 1)
            ...
            __tmp114283 := this.HandleOptionAndParams(params, "fetchTrades", "method", "publicGetMarketTrades")
            method = ccxt.GetValue(__tmp114283, 0)
            params = ccxt.GetValue(__tmp114283, 1)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            __tmp510959 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate")
            paginate = ccxt.GetValue(__tmp510959, 0)
            params = ccxt.GetValue(__tmp510959, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes88819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    ccxt.PanicOnError(retRes88819)
                    ch <- retRes88819
                    return nil
            }
            if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp622342 := this.HandleOptionAndParams(params, "fetchFundingRateHistory", "paginate")
            paginate = ccxt.GetValue(__tmp622342, 0)
            params = ccxt.GetValue(__tmp622342, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes93019 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
                    ccxt.PanicOnError(retRes93019)
                    ch <- retRes93019
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) ParseBalanceByType(response interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(data, nil))) && ccxt.IsTrue(ccxt.IsArray(data))) {
...
func  (this *blofin) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(details)); i++ {
        ...
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(eq, nil))) || ccxt.IsTrue((ccxt.IsEqual(availEq, nil)))) {
            ccxt.AddElementToObject(account, "free", this.SafeString(balance, "availableEquity"))
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp502103 := this.HandleOptionAndParams2(params, "fetchBalance", "accountType", "type")
            accountType = ccxt.GetValue(__tmp502103, 0)
            params = ccxt.GetValue(__tmp502103, 1)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(accountType, nil)) && ccxt.IsTrue(!ccxt.IsEqual(accountType, "swap"))) {
                ...
                ccxt.AddElementToObject(request, "accountType", parsedAccountType)
...
func  (this *blofin) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    __tmp127033 := this.HandleMarginModeAndParams("createOrder", params, "cross")
    marginMode = ccxt.GetValue(__tmp127033, 0)
    params = ccxt.GetValue(__tmp127033, 1)
    ccxt.AddElementToObject(request, "marginMode", marginMode)
    ...
    var marketIOC interface{} =     (ccxt.IsTrue(isMarketOrder) && ccxt.IsTrue(ioc))
    if ccxt.IsTrue(ccxt.IsTrue(isMarketOrder) || ccxt.IsTrue(marketIOC)) {
        ccxt.AddElementToObject(request, "orderType", "market")
    } else {
        var key interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(triggerPrice, nil))), "orderPrice", "price")
        ccxt.AddElementToObject(request, key, this.PriceToPrecision(symbol, price))
    }
    var postOnly interface{} = false
    __tmp602828 := this.HandlePostOnly(isMarketOrder, ccxt.IsEqual(typeVar, "post_only"), params)
    postOnly = ccxt.GetValue(__tmp602828, 0)
    params = ccxt.GetValue(__tmp602828, 1)
    ...
    if ccxt.IsTrue(ccxt.IsTrue(isStopLoss) || ccxt.IsTrue(isTakeProfit)) {
        if ccxt.IsTrue(isStopLoss) {
            ...
            ccxt.AddElementToObject(request, "slTriggerPrice", this.PriceToPrecision(symbol, slTriggerPrice))
            var slOrderPrice interface{} = this.SafeString(stopLoss, "price", "-1")
            ccxt.AddElementToObject(request, "slOrderPrice", this.PriceToPrecision(symbol, slOrderPrice))
        }
        if ccxt.IsTrue(isTakeProfit) {
            var tpTriggerPrice interface{} = this.SafeString2(takeProfit, "triggerPrice", "stopPrice")
            ccxt.AddElementToObject(request, "tpTriggerPrice", this.PriceToPrecision(symbol, tpTriggerPrice))
            var tpPrice interface{} = this.SafeString(takeProfit, "price", "-1")
            ccxt.AddElementToObject(request, "tpOrderPrice", this.PriceToPrecision(symbol, tpPrice))
        }
    } else if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
        ccxt.AddElementToObject(request, "orderType", "trigger")
        ccxt.AddElementToObject(request, "triggerPrice", this.PriceToPrecision(symbol, triggerPrice))
        if ccxt.IsTrue(isMarketOrder) {
            ccxt.AddElementToObject(request, "orderPrice", "-1")
        }
    }
...
func  (this *blofin) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var baseAmount interface{} = ccxt.Precise.StringMul(contractSize, filled)
    var cost interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(average, nil)) {
        cost = ccxt.Precise.StringMul(average, baseAmount)
        cost = ccxt.Precise.StringDiv(cost, leverage)
    }
    // spot market buy: "sz" can refer either to base currency units or to quote currency units
    var fee interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(feeCostString, nil)) {
        var feeCostSigned interface{} = ccxt.Precise.StringAbs(feeCostString)
    ...
    var reduceOnly interface{} =     (ccxt.IsEqual(reduceOnlyRaw, "true"))
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var method interface{} = nil
            __tmp927086 := this.HandleOptionAndParams(params, "createOrder", "method", "privatePostTradeOrder")
            method = ccxt.GetValue(__tmp927086, 0)
            params = ccxt.GetValue(__tmp927086, 1)
            var isStopLossPriceDefined interface{} = !ccxt.IsEqual(this.SafeString(params, "stopLossPrice"), nil)
            var isTakeProfitPriceDefined interface{} = !ccxt.IsEqual(this.SafeString(params, "takeProfitPrice"), nil)
            var isTriggerOrder interface{} = !ccxt.IsEqual(this.SafeString(params, "triggerPrice"), nil)
            var isType2Order interface{} =     (ccxt.IsTrue(isStopLossPriceDefined) || ccxt.IsTrue(isTakeProfitPriceDefined))
            var response interface{} = nil
            var reduceOnly interface{} = this.SafeBool(params, "reduceOnly")
            if ccxt.IsTrue(!ccxt.IsEqual(reduceOnly, nil)) {
                ccxt.AddElementToObject(params, "reduceOnly", ccxt.Ternary(ccxt.IsTrue(reduceOnly), "true", "false"))
            }
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(tpsl) || ccxt.IsTrue((ccxt.IsEqual(method, "privatePostTradeOrderTpsl")))) || ccxt.IsTrue(isType2Order)) {
            ...
            } else if ccxt.IsTrue(ccxt.IsTrue(isTriggerOrder) || ccxt.IsTrue((ccxt.IsEqual(method, "privatePostTradeOrderAlgo")))) {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(isTriggerOrder) || ccxt.IsTrue((ccxt.IsEqual(method, "privatePostTradeOrderAlgo")))) {
...
func  (this *blofin) CreateTpslOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(marginMode, "cross")) && ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated"))) {
        panic(ccxt.BadRequest(ccxt.Add(this.Id, " createTpslOrder() requires a marginMode parameter that must be either cross or isolated")))
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(stopLossPrice, nil)) {
        ccxt.AddElementToObject(request, "slTriggerPrice", this.PriceToPrecision(symbol, stopLossPrice))
        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
            ccxt.AddElementToObject(request, "slOrderPrice", "-1")
        } else {
            ccxt.AddElementToObject(request, "slOrderPrice", this.PriceToPrecision(symbol, price))
        }
    } else if ccxt.IsTrue(!ccxt.IsEqual(takeProfitPrice, nil)) {
        ccxt.AddElementToObject(request, "tpTriggerPrice", this.PriceToPrecision(symbol, takeProfitPrice))
        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
            ccxt.AddElementToObject(request, "tpOrderPrice", "-1")
        } else {
            ccxt.AddElementToObject(request, "tpOrderPrice", this.PriceToPrecision(symbol, price))
        }
    }
    ccxt.AddElementToObject(request, "marginMode", marginMode)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsTrue(isTrigger) && !ccxt.IsTrue(isTpsl)) {
                    ccxt.AddElementToObject(request, "orderId", ccxt.ToString(id))
                } else if ccxt.IsTrue(isTpsl) {
                    ccxt.AddElementToObject(request, "tpslId", ccxt.ToString(id))
                } else if ccxt.IsTrue(isTrigger) {
                    ccxt.AddElementToObject(request, "algoId", ccxt.ToString(id))
                }
            }
            var query interface{} = this.Omit(params, []interface{}{"orderId", "clientOrderId", "stop", "trigger", "tpsl"})
            if ccxt.IsTrue(isTpsl) {
        
                tpslResponse:= (<-this.CancelOrders([]interface{}{id}, symbol, params))
                ccxt.PanicOnError(tpslResponse)
                ...
                ccxt.PanicOnError(triggerResponse)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp934494 := this.HandleOptionAndParams(params, "fetchOpenOrders", "paginate")
            paginate = ccxt.GetValue(__tmp934494, 0)
            params = ccxt.GetValue(__tmp934494, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes157619 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes157619)
                    ch <- retRes157619
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            var isTpSl interface{} = this.SafeBool2(params, "tpsl", "TPSL", false)
            var method interface{} = nil
            __tmp354991 := this.HandleOptionAndParams(params, "fetchOpenOrders", "method", "privateGetTradeOrdersPending")
            method = ccxt.GetValue(__tmp354991, 0)
            params = ccxt.GetValue(__tmp354991, 1)
            var query interface{} = this.Omit(params, []interface{}{"method", "stop", "trigger", "tpsl", "TPSL"})
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue(isTpSl) || ccxt.IsTrue((ccxt.IsEqual(method, "privateGetTradeOrdersTpslPending")))) {
                response = (<-this.PrivateGetTradeOrdersTpslPending(this.Extend(request, query)))
            } else if ccxt.IsTrue(ccxt.IsTrue(isTrigger) || ccxt.IsTrue((ccxt.IsEqual(method, "privateGetTradeOrdersAlgoPending")))) {
                ccxt.AddElementToObject(request, "orderType", "trigger")
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp120561 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp120561, 0)
            params = ccxt.GetValue(__tmp120561, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes162419 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes162419)
                    ch <- retRes162419
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            __tmp23162 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp23162, 0)
            params = ccxt.GetValue(__tmp23162, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default 100, max 100
            }
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes16568)
            var paginate interface{} = false
            __tmp214328 := this.HandleOptionAndParams(params, "fetchDeposits", "paginate")
            paginate = ccxt.GetValue(__tmp214328, 0)
            params = ccxt.GetValue(__tmp214328, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes166019 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    ccxt.PanicOnError(retRes166019)
                    ch <- retRes166019
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            __tmp244855 := this.HandleUntilOption("after", request, params)
            request = ccxt.GetValue(__tmp244855, 0)
            params = ccxt.GetValue(__tmp244855, 1)
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp208190 := this.HandleOptionAndParams(params, "fetchWithdrawals", "paginate")
            paginate = ccxt.GetValue(__tmp208190, 0)
            params = ccxt.GetValue(__tmp208190, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes169919 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    ccxt.PanicOnError(retRes169919)
                    ch <- retRes169919
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            __tmp122300 := this.HandleUntilOption("after", request, params)
            request = ccxt.GetValue(__tmp122300, 0)
            params = ccxt.GetValue(__tmp122300, 1)
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp808996 := this.HandleOptionAndParams(params, "fetchLedger", "paginate")
            paginate = ccxt.GetValue(__tmp808996, 0)
            params = ccxt.GetValue(__tmp808996, 1)
            if ccxt.IsTrue(paginate) {
            ...
            __tmp751331 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp751331, 0)
            params = ccxt.GetValue(__tmp751331, 1)
            var response interface{} = nil
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderIds, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(tpslIds, nil)) {
                    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(tpslIds)); i++ {
                        ccxt.AppendToArray(&request, map[string]interface{} {
                            "tpslId": ccxt.GetValue(tpslIds, i),
                            "instId": ccxt.GetValue(market, "id"),
                        })
                    }
                }
                ...
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(clientOrderIds)); i++ {
                    ccxt.AppendToArray(&request, map[string]interface{} {
                        "instId": ccxt.GetValue(market, "id"),
                        "clientOrderId": ccxt.GetValue(clientOrderIds, i),
                    })
                }
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(method, "privatePostTradeCancelTpsl")) {
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchLeverages() requires a symbols argument")))
            }
            var marginMode interface{} = nil
            __tmp653149 := this.HandleMarginModeAndParams("fetchLeverages", params)
            marginMode = ccxt.GetValue(__tmp653149, 0)
            params = ccxt.GetValue(__tmp653149, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marginMode, nil)) {
                marginMode = this.SafeString(params, "marginMode", "cross") // cross as default marginMode
            }
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(marginMode, "cross"))) && ccxt.IsTrue((!ccxt.IsEqual(marginMode, "isolated")))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchLeverages() requires a marginMode parameter that must be either cross or isolated")))
            }
            symbols = this.MarketSymbols(symbols)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsGreaterThan(i, 0)) {
                    instIds = ccxt.Add(ccxt.Add(instIds, ","), ccxt.GetValue(entryMarket, "id"))
                } else {
                    instIds = ccxt.Add(instIds, ccxt.GetValue(entryMarket, "id"))
                }
            }
            var request interface{} = map[string]interface{} {
                "instId": instIds,
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes22488)
            var marginMode interface{} = nil
            __tmp127672 := this.HandleMarginModeAndParams("fetchLeverage", params)
            marginMode = ccxt.GetValue(__tmp127672, 0)
            params = ccxt.GetValue(__tmp127672, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marginMode, nil)) {
                marginMode = this.SafeString(params, "marginMode", "cross") // cross as default marginMode
            }
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(marginMode, "cross"))) && ccxt.IsTrue((!ccxt.IsEqual(marginMode, "isolated")))) {
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
            __tmp331369 := this.HandleMarginModeAndParams("setLeverage", params, "cross")
            marginMode = ccxt.GetValue(__tmp331369, 0)
            params = ccxt.GetValue(__tmp331369, 1)
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(marginMode, "cross"))) && ccxt.IsTrue((!ccxt.IsEqual(marginMode, "isolated")))) {
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
            __tmp119857 := this.HandleMarginModeAndParams("closePosition", params, "cross")
            marginMode = ccxt.GetValue(__tmp119857, 0)
            params = ccxt.GetValue(__tmp119857, 1)
            var request interface{} = map[string]interface{} {
                "instId": ccxt.GetValue(market, "id"),
                "marginMode": marginMode,
            }
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes23768)
            var paginate interface{} = false
            __tmp12556 := this.HandleOptionAndParams(params, "fetchClosedOrders", "paginate")
            paginate = ccxt.GetValue(__tmp12556, 0)
            params = ccxt.GetValue(__tmp12556, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes238019 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes238019)
                    ch <- retRes238019
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            var method interface{} = nil
            __tmp784637 := this.HandleOptionAndParams(params, "fetchOpenOrders", "method", "privateGetTradeOrdersHistory")
            method = ccxt.GetValue(__tmp784637, 0)
            params = ccxt.GetValue(__tmp784637, 1)
            var query interface{} = this.Omit(params, []interface{}{"method", "stop", "trigger", "tpsl", "TPSL"})
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue((isTrigger)) || ccxt.IsTrue((ccxt.IsEqual(method, "privateGetTradeOrdersTpslHistory")))) {
...
func  (this *blofin) FetchPositionMode(optionalArgs ...interface{}) <- chan interface{} {
        ...
        ch <- map[string]interface{} {
                "info": data,
                "hedged": ccxt.IsEqual(positionMode, "long_short_mode"),
            }
            return nil
...
func  (this *blofin) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var request interface{} = map[string]interface{} {
                "positionMode": ccxt.Ternary(ccxt.IsTrue(hedged), "long_short_mode", "net_mode"),
            }
        
                retRes252815 :=  (<-this.PrivatePostAccountSetPositionMode(this.Extend(request, params)))
                ccxt.PanicOnError(retRes252815)
                    //
            //     {
            //         "code": "0",
            //         "msg": "success",
...
func  (this *blofin) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    //      orderId: null,
    //      clientOrderId: '',
    //      msg: 'ccxt.Order failed. Insufficient USDT margin in account',
    //      code: '103003'
    //  }
    //
    var data interface{} = this.SafeList(response, "data")
    ...
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(insideCode, nil)) && ccxt.IsTrue(!ccxt.IsEqual(insideCode, "0"))) {
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), insideCode, feedback)
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), insideMsg, feedback)
        this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), insideMsg, feedback)
    }
    return nil
}
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(method, "GET")) {
            if !ccxt.IsTrue(this.IsEmpty(query)) {
                ...
                request = ccxt.Add(request, urlencodedQuery)
            }
        } else {
            if !ccxt.IsTrue(this.IsEmpty(query)) {
        ...
        var auth interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(request, method), timestamp), timestamp), sign_body)
        var signature interface{} = this.StringToBase64(this.Hmac(this.Encode(auth), this.Encode(this.Secret), ccxt.Sha256))
        ccxt.AddElementToObject(headers, "ACCESS-SIGN", signature)
    }
    return map[string]interface{} {
        "url": url,
        "method": method,
