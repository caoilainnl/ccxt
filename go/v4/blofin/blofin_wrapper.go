 ...
 */
func (this *Blofin) CancelOrders(ids interface{}, options ...ccxt.CancelOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Blofin) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
 ...
 * @returns {object} response from the exchange
 */
func (this *Blofin) SetMarginMode(marginMode string, options ...ccxt.SetMarginModeOptions) (ccxt.MarginMode, error) {
