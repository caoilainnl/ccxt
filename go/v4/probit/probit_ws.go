...
func NewProbitWsCore() probitWs {
   p := probitWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *probitWs) Describe() interface{}  {
 ...
 */
func  (this *probitWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *probitWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "balance",
    //         "reset": false,
...
func  (this *probitWs) ParseWSBalance(message interface{})  {
    //
    //     {
    //         "channel": "balance",
    //         "reset": false,
 ...
 */
func  (this *probitWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *probitWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "marketdata",
    //         "market_id": "BTC-USDT",
 ...
 */
func  (this *probitWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *probitWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "marketdata",
    //         "market_id": "BTC-USDT",
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *probitWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *probitWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //     {
 ...
 */
func  (this *probitWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *probitWs) HandleOrders(client interface{}, message interface{})  {
    //
    //     {
 ...
 */
func  (this *probitWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp226433 := this.HandleOptionAndParams(params, "watchOrderBook", "filter", "order_books")
            channel = ccxt.GetValue(__tmp226433, 0)
            params = ccxt.GetValue(__tmp226433, 1)
...
func  (this *probitWs) SubscribePrivate(messageHash interface{}, channel interface{}, params interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *probitWs) SubscribePublic(methodName interface{}, symbol interface{}, dataType interface{}, filter interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp507976 := this.HandleOptionAndParams(params, methodName, "interval", 100)
            interval = ccxt.GetValue(__tmp507976, 0)
            params = ccxt.GetValue(__tmp507976, 1)
...
func  (this *probitWs) HandleOrderBook(client interface{}, message interface{}, orderBook interface{})  {
    //
    //     {
    //         "channel": "marketdata",
    //         "market_id": "BTC-USDT",
...
func  (this *probitWs) HandleBidAsks(bookSide interface{}, bidAsks interface{})  {
...
func  (this *probitWs) HandleDelta(orderbook interface{}, delta interface{})  {
...
func  (this *probitWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
...
func  (this *probitWs) HandleAuthenticate(client interface{}, message interface{})  {
    //
...
func  (this *probitWs) HandleMarketData(client interface{}, message interface{})  {
...
func  (this *probitWs) HandleMessage(client interface{}, message interface{})  {
    //
    //     {
    //         "errorCode": "INVALID_ARGUMENT",
    //         "message": '',
    ...
    err := ccxt.NotSupported(ccxt.Add(ccxt.Add(this.Id, " handleMessage: unknown message: "), this.Json(message)))
    client.(ccxt.ClientInterface).Reject(err)
}
func  (this *probitWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func (this *probitWs) Init(userConfig map[string]interface{}) {
    this.probit.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
