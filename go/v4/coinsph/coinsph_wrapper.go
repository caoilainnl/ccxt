 ...
 */
func (this *Coinsph) FetchCurrencies(params ...interface{}) (ccxt.Currencies, error) {
 ...
 */
func (this *Coinsph) FetchMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 */
func (this *Coinsph) FetchTickers(options ...ccxt.FetchTickersOptions) (ccxt.Tickers, error) {
 ...
 */
func (this *Coinsph) FetchTicker(symbol string, options ...ccxt.FetchTickerOptions) (ccxt.Ticker, error) {
 ...
 */
func (this *Coinsph) FetchOrderBook(symbol string, options ...ccxt.FetchOrderBookOptions) (ccxt.OrderBook, error) {
 ...
 */
func (this *Coinsph) FetchOHLCV(symbol string, options ...ccxt.FetchOHLCVOptions) ([]ccxt.OHLCV, error) {
 ...
 */
func (this *Coinsph) FetchTrades(symbol string, options ...ccxt.FetchTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Coinsph) FetchMyTrades(options ...ccxt.FetchMyTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Coinsph) FetchOrderTrades(id string, options ...ccxt.FetchOrderTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Coinsph) FetchBalance(params ...interface{}) (ccxt.Balances, error) {
 ...
 */
func (this *Coinsph) CreateOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinsph) FetchOrder(id string, options ...ccxt.FetchOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Coinsph) FetchOpenOrders(options ...ccxt.FetchOpenOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinsph) FetchClosedOrders(options ...ccxt.FetchClosedOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coinsph) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Coinsph) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Coinsph) FetchTradingFee(symbol string, options ...ccxt.FetchTradingFeeOptions) (ccxt.TradingFeeInterface, error) {
 ...
 */
func (this *Coinsph) FetchTradingFees(params ...interface{}) (ccxt.TradingFees, error) {
 ...
 */
func (this *Coinsph) Withdraw(code string, amount float64, address string, options ...ccxt.WithdrawOptions) (ccxt.Transaction, error) {
 ...
 */
func (this *Coinsph) FetchDeposits(options ...ccxt.FetchDepositsOptions) ([]ccxt.Transaction, error) {
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Coinsph) FetchWithdrawals(options ...ccxt.FetchWithdrawalsOptions) ([]ccxt.Transaction, error) {
 ...
 */
func (this *Coinsph) FetchDepositAddress(code string, options ...ccxt.FetchDepositAddressOptions) (ccxt.DepositAddress, error) {
