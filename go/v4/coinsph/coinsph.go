...
func  (this *coinsph) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "urls": map[string]interface{} {
            ...
            "fees": "https://support.coins.ph/hc/en-us/sections/4407198694681-ccxt.Limits-Fees",
        },
        "api": map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "-1023": ccxt.AuthenticationError,
                "-1024": ccxt.BadRequest,
                "-1025": ccxt.BadRequest,
                "-1030": ccxt.ExchangeError,
                ...
                "-1121": ccxt.BadSymbol,
                "-1122": ccxt.InvalidOrder,
                "-1125": ccxt.BadRequest,
                "-1127": ccxt.BadRequest,
                "-1128": ccxt.BadRequest,
                "-1130": ccxt.BadRequest,
                "-1131": ccxt.InsufficientFunds,
                "-1132": ccxt.InvalidOrder,
                "-1133": ccxt.InvalidOrder,
                "-1134": ccxt.InvalidOrder,
                "-1135": ccxt.InvalidOrder,
                "-1136": ccxt.InvalidOrder,
                "-1137": ccxt.InvalidOrder,
                "-1138": ccxt.InvalidOrder,
                "-1139": ccxt.InvalidOrder,
                "-1140": ccxt.InvalidOrder,
                "-1141": ccxt.DuplicateOrderId,
                "-1142": ccxt.InvalidOrder,
                "-1143": ccxt.OrderNotFound,
                "-1144": ccxt.InvalidOrder,
                "-1145": ccxt.InvalidOrder,
                "-1146": ccxt.InvalidOrder,
                "-1147": ccxt.InvalidOrder,
                "-1148": ccxt.InvalidOrder,
                "-1149": ccxt.InvalidOrder,
                "-1150": ccxt.InvalidOrder,
                "-1151": ccxt.BadSymbol,
                "-1152": ccxt.NotSupported,
                "-1153": ccxt.AuthenticationError,
                "-1154": ccxt.BadRequest,
                "-1155": ccxt.BadRequest,
                "-1156": ccxt.InvalidOrder,
                "-1157": ccxt.BadSymbol,
                "-1158": ccxt.InvalidOrder,
                "-1159": ccxt.InvalidOrder,
                "-1160": ccxt.BadRequest,
                "-1161": ccxt.BadRequest,
                "-2010": ccxt.InvalidOrder,
                "-2013": ccxt.OrderNotFound,
                "-2011": ccxt.BadRequest,
                "-2014": ccxt.BadRequest,
                "-2015": ccxt.AuthenticationError,
                "-2016": ccxt.BadResponse,
                "-3126": ccxt.InvalidOrder,
                "-3127": ccxt.InvalidOrder,
                "-4001": ccxt.BadRequest,
                "-100011": ccxt.BadSymbol,
                "-100012": ccxt.BadSymbol,
                "-30008": ccxt.InsufficientFunds,
                "-30036": ccxt.InsufficientFunds,
                "403": ccxt.ExchangeNotAvailable,
            },
            "broad": map[string]interface{} {
                "Unknown order sent": ccxt.OrderNotFound,
                "Duplicate order sent": ccxt.DuplicateOrderId,
                "ccxt.Market is closed": ccxt.BadSymbol,
                "ccxt.Account has insufficient balance for requested action": ccxt.InsufficientFunds,
                "ccxt.Market orders are not supported for this symbol": ccxt.BadSymbol,
                "Iceberg orders are not supported for this symbol": ccxt.BadSymbol,
                "Stop loss orders are not supported for this symbol": ccxt.BadSymbol,
                "Stop loss limit orders are not supported for this symbol": ccxt.BadSymbol,
                "Take profit orders are not supported for this symbol": ccxt.BadSymbol,
                "Take profit limit orders are not supported for this symbol": ccxt.BadSymbol,
                "Price* QTY is zero or less": ccxt.BadRequest,
                "IcebergQty exceeds QTY": ccxt.BadRequest,
                "This action disabled is on this account": ccxt.PermissionDenied,
                "Unsupported order combination": ccxt.InvalidOrder,
                "ccxt.Order would trigger immediately": ccxt.InvalidOrder,
                "ccxt.Cancel order is invalid. Check origClOrdId and orderId": ccxt.InvalidOrder,
                "ccxt.Order would immediately match and take": ccxt.OrderImmediatelyFillable,
                "PRICE_FILTER": ccxt.InvalidOrder,
                "LOT_SIZE": ccxt.InvalidOrder,
                "MIN_NOTIONAL": ccxt.InvalidOrder,
                "MAX_NUM_ORDERS": ccxt.InvalidOrder,
                "MAX_ALGO_ORDERS": ccxt.InvalidOrder,
                "BROKER_MAX_NUM_ORDERS": ccxt.InvalidOrder,
                "BROKER_MAX_ALGO_ORDERS": ccxt.InvalidOrder,
                "ICEBERG_PARTS": ccxt.BadRequest,
            },
        },
    })
}
...
func  (this *coinsph) CalculateRateLimiterCost(api interface{}, method interface{}, path interface{}, params interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.InOp(config, "noSymbol"))) && !ccxt.IsTrue((ccxt.InOp(params, "symbol")))) {
    ...
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.InOp(config, "noSymbolAndNoSymbols"))) && !ccxt.IsTrue((ccxt.InOp(params, "symbol")))) && !ccxt.IsTrue((ccxt.InOp(params, "symbols")))) {
        return ccxt.GetValue(config, "noSymbolAndNoSymbols")
    } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.InOp(config, "byNumberOfSymbols"))) && ccxt.IsTrue((ccxt.InOp(params, "symbols")))) {
        var symbols interface{} = ccxt.GetValue(params, "symbols")
        var symbolsAmount interface{} =         ccxt.GetArrayLength(symbols)
        var byNumberOfSymbols interface{} = ccxt.GetValue(config, "byNumberOfSymbols")
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(byNumberOfSymbols)); i++ {
            var entry interface{} = ccxt.GetValue(byNumberOfSymbols, i)
            if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(symbolsAmount, ccxt.GetValue(entry, 0))) {
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(byLimit)); i++ {
            ...
            if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(limit, ccxt.GetValue(entry, 0))) {
                return ccxt.GetValue(entry, 1)
            }
        }
    }
...
func  (this *coinsph) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                ...
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "future": false,
                    "option": false,
                    "active": ccxt.IsEqual(this.SafeStringLower(market, "status"), "trading"),
                    "contract": false,
                    "linear": nil,
                    "inverse": nil,
                    "taker": nil,
...
func  (this *coinsph) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
                    ...
                    ccxt.AppendToArray(&ids, id)
                }
                ccxt.AddElementToObject(request, "symbols", ids)
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "publicGetOpenapiQuoteV1TickerPrice")) {
                tickers = (<-this.PublicGetOpenapiQuoteV1TickerPrice(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "publicGetOpenapiQuoteV1TickerBookTicker")) {
...
func  (this *coinsph) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ...
                    var endTimeByLimit interface{} = this.Sum(since, ccxt.Multiply(duration, (ccxt.Subtract(limit, 1))))
                    var now interface{} = this.Milliseconds()
                    ccxt.AddElementToObject(request, "endTime", ccxt.MathMin(endTimeByLimit, now))
                }
            } else if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "endTime", until)
                // since work properly only when it is "younger" than last "limit" candle
                var duration interface{} = ccxt.Multiply(this.ParseTimeframe(timeframe), 1000)
                ccxt.AddElementToObject(request, "startTime", ccxt.Subtract(until, (ccxt.Multiply(duration, (ccxt.Subtract(limit, 1))))))
            }
            ccxt.AddElementToObject(request, "limit", limit)
...
func  (this *coinsph) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes119315 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                ccxt.PanicOnError(retRes119315)
                ch <- retRes119315
                return nil
...
func  (this *coinsph) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(isBuyer, nil)) {
        side = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(isBuyer, true))), "buy", "sell")
    }
    var isMaker interface{} = this.SafeString2(trade, "isMaker", nil)
    var takerOrMaker interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(isMaker, nil)) {
        takerOrMaker = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(isMaker, "true"))), "maker", "taker")
    }
...
func  (this *coinsph) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            // if limit order
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(orderType, "LIMIT")) || ccxt.IsTrue(ccxt.IsEqual(orderType, "STOP_LOSS_LIMIT"))) || ccxt.IsTrue(ccxt.IsEqual(orderType, "TAKE_PROFIT_LIMIT"))) || ccxt.IsTrue(ccxt.IsEqual(orderType, "LIMIT_MAKER"))) {
                if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() requires a price argument for a "), typeVar), " order")))
                }
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(orderType, "LIMIT_MAKER")) {
                    ccxt.AddElementToObject(request, "timeInForce", this.SafeString(options, "timeInForce", "GTC"))
                }
            } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(orderType, "MARKET")) || ccxt.IsTrue(ccxt.IsEqual(orderType, "STOP_LOSS"))) || ccxt.IsTrue(ccxt.IsEqual(orderType, "TAKE_PROFIT"))) {
                newOrderRespType = this.SafeString(newOrderRespType, "market", "FULL")
                if ccxt.IsTrue(ccxt.IsEqual(orderSide, "SELL")) {
                    ccxt.AddElementToObject(request, "quantity", this.AmountToPrecision(symbol, amount))
                } else if ccxt.IsTrue(ccxt.IsEqual(orderSide, "BUY")) {
                    var quoteAmount interface{} = nil
                    var createMarketBuyOrderRequiresPrice interface{} = true
                    __tmp754501 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                    createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp754501, 0)
                    params = ccxt.GetValue(__tmp754501, 1)
                    ...
                    ccxt.AddElementToObject(request, "quoteOrderQty", quoteAmount)
                }
            }
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(orderType, "STOP_LOSS")) || ccxt.IsTrue(ccxt.IsEqual(orderType, "STOP_LOSS_LIMIT"))) || ccxt.IsTrue(ccxt.IsEqual(orderType, "TAKE_PROFIT"))) || ccxt.IsTrue(ccxt.IsEqual(orderType, "TAKE_PROFIT_LIMIT"))) {
                var triggerPrice interface{} = this.SafeString2(params, "triggerPrice", "stopPrice")
                if ccxt.IsTrue(ccxt.IsEqual(triggerPrice, nil)) {
                    panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createOrder () requires a triggerPrice or stopPrice param for stop_loss, take_profit, stop_loss_limit, and take_profit_limit orders")))
                }
                ccxt.AddElementToObject(request, "stopPrice", this.PriceToPrecision(symbol, triggerPrice))
            }
            ccxt.AddElementToObject(request, "newOrderRespType", newOrderRespType)
...
func  (this *coinsph) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(warning) {
                panic(ccxt.InvalidAddress(ccxt.Add(this.Id, " withdraw() makes a withdrawals only to coins_ph account, add .options[\\'withdraw\\'][\\'warning\\'] = false to make a withdrawal to your coins_ph account")))
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(networkId, nil)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " withdraw() require network parameter")))
            }
        
            retRes18528 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes18528)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                ccxt.AddElementToObject(request, "withdrawOrderId", tag)
            }
...
func  (this *coinsph) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(withdrawOrderId, nil)) {
        typeVar = "withdrawal"
    } else if ccxt.IsTrue(!ccxt.IsEqual(depositOrderId, nil)) {
        typeVar = "deposit"
    }
    ...
    var internal interface{} = ccxt.IsEqual(network, "Internal")
    return map[string]interface{} {
        "info": transaction,
        "id": id,
        "txid": txid,
...
func  (this *coinsph) UrlEncodeQuery(optionalArgs ...interface{}) interface{}  {
    query := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
    _ = query
    var encodedArrayParams interface{} = ""
    var keys interface{} = ccxt.ObjectKeys(query)
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
        var key interface{} = ccxt.GetValue(keys, i)
        if ccxt.IsTrue(ccxt.IsArray(ccxt.GetValue(query, key))) {
            if ccxt.IsTrue(!ccxt.IsEqual(i, 0)) {
                encodedArrayParams = ccxt.Add(encodedArrayParams, "&")
            }
            var innerArray interface{} = ccxt.GetValue(query, key)
            query = this.Omit(query, key)
            var encodedArrayParam interface{} = this.ParseArrayParam(innerArray, key)
            encodedArrayParams = ccxt.Add(encodedArrayParams, encodedArrayParam)
        }
    }
    var encodedQuery interface{} = this.Urlencode(query)
    if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetArrayLength(encodedQuery), 0)) {
        return ccxt.Add(ccxt.Add(encodedQuery, "&"), encodedArrayParams)
    } else {
...
func  (this *coinsph) ParseArrayParam(array interface{}, key interface{}) interface{}  {
    ...
    stringifiedArray = ccxt.Replace(stringifiedArray, "[", "%5B")
    stringifiedArray = ccxt.Replace(stringifiedArray, "]", "%5D")
    var urlEncodedParam interface{} = ccxt.Add(ccxt.Add(key, "="), stringifiedArray)
...
func  (this *coinsph) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    url = ccxt.Add(ccxt.Add(url, "/"), endpoint)
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        this.CheckRequiredCredentials()
        ccxt.AddElementToObject(query, "timestamp", this.Milliseconds())
        ...
        if ccxt.IsTrue(ccxt.IsEqual(recvWindow, nil)) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(defaultRecvWindow, nil)) {
                ccxt.AddElementToObject(query, "recvWindow", defaultRecvWindow)
            }
        }
        query = this.UrlEncodeQuery(query)
        var signature interface{} = this.Hmac(this.Encode(query), this.Encode(this.Secret), ccxt.Sha256)
        url = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(url, "?"), query), "&signature="), signature)
