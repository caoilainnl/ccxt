    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "-1006": ccxt.InvalidOrder,
                "-1007": ccxt.BadRequest,
                "-1008": ccxt.InvalidOrder,
                "-1009": ccxt.InsufficientFunds,
                "-1011": ccxt.NetworkError,
...
func  (this *modetrade) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(tokenRows)); i++ {
                var token interface{} = ccxt.GetValue(tokenRows, i)
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(networks)); j++ {
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(precision, nil)) {
                        minPrecision = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(minPrecision, nil))), precision, ccxt.Precise.StringMin(precision, minPrecision))
                    }
                    ccxt.AddElementToObject(resultingNetworks, networkId, map[string]interface{} {
            "id": networkId,
            "network": networkId,
            "limits": map[string]interface{} {
...
func  (this *modetrade) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(isFromFetchOrder) {
        var isMaker interface{} = ccxt.IsEqual(this.SafeString(trade, "is_maker"), "1")
...
func  (this *modetrade) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp105389 := this.HandleOptionAndParams(params, "fetchFundingRateHistory", "paginate")
            paginate = ccxt.GetValue(__tmp105389, 0)
            params = ccxt.GetValue(__tmp105389, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_t", since)
            }
            __tmp671666 := this.HandleUntilOption("end_t", request, params, 0.001)
            request = ccxt.GetValue(__tmp671666, 0)
            params = ccxt.GetValue(__tmp671666, 1)
...
func  (this *modetrade) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                limit = ccxt.MathMin(limit, 1000)
                ccxt.AddElementToObject(request, "max_level", limit)
            }
...
func  (this *modetrade) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(success, nil)) {
        status = ccxt.Ternary(ccxt.IsTrue((success)), "NEW", "REJECTED")
    }
    ...
    var remaining interface{} = ccxt.Precise.StringSub(cost, filled)
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(childOrders, nil)) {
        ...
        var innerChildOrdersLength interface{} =         ccxt.GetArrayLength(innerChildOrders)
        if ccxt.IsTrue(ccxt.IsGreaterThan(innerChildOrdersLength, 0)) {
...
func  (this *modetrade) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    var isConditional interface{} = ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) || ccxt.IsTrue(!ccxt.IsEqual(stopLoss, nil))) || ccxt.IsTrue(!ccxt.IsEqual(takeProfit, nil))) || ccxt.IsTrue((!ccxt.IsEqual(this.SafeValue(params, "childOrders"), nil)))
    ...
    var orderQtyKey interface{} = ccxt.Ternary(ccxt.IsTrue(isConditional), "quantity", "order_quantity")
    var priceKey interface{} = ccxt.Ternary(ccxt.IsTrue(isConditional), "price", "order_price")
    var typeKey interface{} = ccxt.Ternary(ccxt.IsTrue(isConditional), "type", "order_type")
    ccxt.AddElementToObject(request, typeKey, orderType) // LIMIT/MARKET/IOC/FOK/POST_ONLY/ASK/BID
    if !ccxt.IsTrue(isConditional) {
        if ccxt.IsTrue(postOnly) {
            ccxt.AddElementToObject(request, "order_type", "POST_ONLY")
        } else if ccxt.IsTrue(ccxt.IsEqual(timeInForce, "fok")) {
            ccxt.AddElementToObject(request, "order_type", "FOK")
        } else if ccxt.IsTrue(ccxt.IsEqual(timeInForce, "ioc")) {
            ccxt.AddElementToObject(request, "order_type", "IOC")
        }
    }
    ...
    if ccxt.IsTrue(ccxt.IsTrue(isMarket) && !ccxt.IsTrue(isConditional)) {
        ccxt.AddElementToObject(request, orderQtyKey, this.AmountToPrecision(symbol, amount))
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
        ...
        var childOrders interface{} = ccxt.GetValue(outterOrder, "child_orders")
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(takeProfit, nil)) {
            ...
            ccxt.AppendToArray(&outterOrder, takeProfitOrder)
        }
        ccxt.AddElementToObject(request, "child_orders", []interface{}{outterOrder})
    }
...
func  (this *modetrade) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(data, "timestamp", this.SafeInteger(response, "timestamp"))
...
func  (this *modetrade) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                var isConditional interface{} = ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) || ccxt.IsTrue(!ccxt.IsEqual(stopLoss, nil))) || ccxt.IsTrue(!ccxt.IsEqual(takeProfit, nil))) || ccxt.IsTrue((!ccxt.IsEqual(this.SafeValue(orderParams, "childOrders"), nil)))
                if ccxt.IsTrue(isConditional) {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrders() only support non-stop order")))
                }
...
func  (this *modetrade) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var isConditional interface{} = ccxt.IsTrue((!ccxt.IsEqual(triggerPrice, nil))) || ccxt.IsTrue((!ccxt.IsEqual(this.SafeValue(params, "childOrders"), nil)))
            var orderQtyKey interface{} = ccxt.Ternary(ccxt.IsTrue(isConditional), "quantity", "order_quantity")
            var priceKey interface{} = ccxt.Ternary(ccxt.IsTrue(isConditional), "price", "order_price")
            if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
                ccxt.AddElementToObject(request, priceKey, this.PriceToPrecision(symbol, price))
            ...
            if ccxt.IsTrue(isConditional) {
                ...
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                ccxt.AddElementToObject(request, "side", ccxt.ToUpper(side))
                var orderType interface{} = ccxt.ToUpper(typeVar)
                var timeInForce interface{} = this.SafeStringLower(params, "timeInForce")
                var isMarket interface{} = ccxt.IsEqual(orderType, "MARKET")
                var postOnly interface{} = this.IsPostOnly(isMarket, nil, params)
...
func  (this *modetrade) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsTrue(trigger) && ccxt.IsTrue((ccxt.IsEqual(symbol, nil)))) {
            ...
            if ccxt.IsTrue(isByClientOrder) {
                ...
                ccxt.AddElementToObject(extendParams, "id", id)
            }
            if ccxt.IsTrue(trigger) {
...
func  (this *modetrade) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(clientOrderIds) {
                ccxt.AddElementToObject(request, "client_order_ids", ccxt.Join(clientOrderIds, ","))
...
func  (this *modetrade) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var maxLimit interface{} = ccxt.Ternary(ccxt.IsTrue((isTrigger)), 100, 500)
            __tmp320329 := this.HandleOptionAndParams(params, "fetchOrders", "paginate")
            paginate = ccxt.GetValue(__tmp320329, 0)
            params = ccxt.GetValue(__tmp320329, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes193119 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    ccxt.PanicOnError(retRes193119)
                    ch <- retRes193119
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ...
                ccxt.AddElementToObject(request, "size", maxLimit)
            }
            if ccxt.IsTrue(isTrigger) {
                ccxt.AddElementToObject(request, "algo_type", "STOP")
            }
            __tmp837747 := this.HandleUntilOption("end_t", request, params)
            request = ccxt.GetValue(__tmp837747, 0)
            params = ccxt.GetValue(__tmp837747, 1)
            var response interface{} = nil
            if ccxt.IsTrue(isTrigger) {
...
func  (this *modetrade) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes201715)
                ch <- retRes201715
                return nil
...
func  (this *modetrade) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp228565 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp228565, 0)
            params = ccxt.GetValue(__tmp228565, 1)
            if ccxt.IsTrue(paginate) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ...
                ccxt.AddElementToObject(request, "size", 500)
            }
            __tmp72231 := this.HandleUntilOption("end_t", request, params)
            request = ccxt.GetValue(__tmp72231, 0)
            params = ccxt.GetValue(__tmp72231, 1)
...
func  (this *modetrade) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                ...
                ccxt.AddElementToObject(request, "balance_token", ccxt.GetValue(currency, "id"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_t", since)
            }
...
func  (this *modetrade) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes236815)
                ch <- retRes236815
                return nil
...
func  (this *modetrade) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes238615)
                ch <- retRes238615
                return nil
...
func  (this *modetrade) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(coinNetworkId, nil)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " withdraw() require chainId parameter")))
            }
        
            withdrawNonce:= (<-this.GetWithdrawNonce(params))
            ccxt.PanicOnError(withdrawNonce)
...
func  (this *modetrade) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes25978)
            var isMinLeverage interface{} = ccxt.IsLessThan(leverage, 1)
            var isMaxLeverage interface{} = ccxt.IsGreaterThan(leverage, 50)
            if ccxt.IsTrue(ccxt.IsTrue(isMinLeverage) || ccxt.IsTrue(isMaxLeverage)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " leverage should be between 1 and 50")))
            }
            var request interface{} = map[string]interface{} {
                "leverage": leverage,
            }
                ...
                ccxt.PanicOnError(retRes260615)
                ch <- retRes260615
                return nil
...
func  (this *modetrade) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(access, "public")) {
        ...
        var isPostOrPut interface{} = ccxt.IsTrue(ccxt.IsEqual(method, "POST")) || ccxt.IsTrue(ccxt.IsEqual(method, "PUT"))
        var isOrder interface{} = ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(path, "algo/order")) || ccxt.IsTrue(ccxt.IsEqual(path, "order"))) || ccxt.IsTrue(ccxt.IsEqual(path, "batch-order"))
        if ccxt.IsTrue(ccxt.IsTrue(isPostOrPut) && ccxt.IsTrue(isOrder)) {
            ...
            if !ccxt.IsTrue(isSandboxMode) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(path, "batch-order")) {
                    var ordersList interface{} = this.SafeList(params, "orders", []interface{}{})
                    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ordersList)); i++ {
                        ccxt.AddElementToObject(ccxt.GetValue(ccxt.GetValue(params, "orders"), i), "order_tag", brokerId)
                    }
                } else {
                    ccxt.AddElementToObject(params, "order_tag", brokerId)
                }
            }
            params = this.Keysort(params)
        }
        ...
        if ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetIndexOf(apiKey, "ccxt.Ed25519:"), 0)) {
            apiKey = ccxt.Add("ccxt.Ed25519:", apiKey)
        }
        ...
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(method, "POST")) || ccxt.IsTrue(ccxt.IsEqual(method, "PUT"))) {
            ...
            if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(params))) {
                url = ccxt.Add(url, ccxt.Add("?", this.Urlencode(params)))
                auth = ccxt.Add(auth, ccxt.Add("?", this.Rawencode(params)))
            }
            ccxt.AddElementToObject(headers, "content-type", "application/x-www-form-urlencoded")
            if ccxt.IsTrue(ccxt.IsEqual(method, "DELETE")) {
                body = ""
            }
        }
        ...
        ccxt.AddElementToObject(headers, "orderly-signature", this.UrlencodeBase64(this.Base64ToBinary(signature)))
    }
    return map[string]interface{} {
        "url": url,
        "method": method,
