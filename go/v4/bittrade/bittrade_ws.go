...
func NewBittradeWsCore() bittradeWs {
   p := bittradeWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bittradeWs) Describe() interface{}  {
...
func  (this *bittradeWs) RequestId() interface{}  {
 ...
 */
func  (this *bittradeWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *bittradeWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    //     {
 ...
 */
func  (this *bittradeWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittradeWs) HandleTrades(client interface{}, message interface{}) interface{}  {
    //
    //     {
 ...
 */
func  (this *bittradeWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittradeWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
 ...
 */
func  (this *bittradeWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittradeWs) HandleOrderBookSnapshot(client interface{}, message interface{}, subscription interface{})  {
    //
    //     {
    //         "id": 1583473663565,
...
func  (this *bittradeWs) WatchOrderBookSnapshot(client interface{}, message interface{}, subscription interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *bittradeWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *bittradeWs) interface{} {
            					// catch block:
...
func  (this *bittradeWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *bittradeWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *bittradeWs) HandleOrderBookMessage(client interface{}, message interface{}, orderbook interface{}) interface{}  {
    //
    //     {
...
func  (this *bittradeWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // deltas
    //
    //     {
...
func  (this *bittradeWs) HandleOrderBookSubscription(client interface{}, message interface{}, subscription interface{})  {
    var symbol interface{} = this.SafeString(subscription, "symbol")
    var limit interface{} = this.SafeInteger(subscription, "limit")
...
func  (this *bittradeWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "id": 1583414227,
    //         "status": "ok",
...
func  (this *bittradeWs) HandleSystemStatus(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *bittradeWs) HandleSubject(client interface{}, message interface{})  {
    //
    //     {
    //         "ch": "market.btcusdt.mbp.150",
    //         "ts": 1583472025885,
...
func  (this *bittradeWs) Pong(client interface{}, message interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittradeWs) HandlePing(client interface{}, message interface{})  {
    this.Spawn(this.Pong, client, message)
}
func  (this *bittradeWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "ts": 1586323747018,
    //         "status": "error",
    ...
    if ccxt.IsTrue(ccxt.IsEqual(status, "error")) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(subscription, nil)) {
            ...
            {		ret__ := func(this *bittradeWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
...
func  (this *bittradeWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *bittradeWs) Init(userConfig map[string]interface{}) {
    this.bittrade.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
