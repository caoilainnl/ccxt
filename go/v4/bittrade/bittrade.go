...
func  (this *bittrade) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "rateLimit": 100,
        "userAgent": ccxt.GetValue(this.UserAgents, "chrome39"),
        "certified": false,
        "version": "v1",
 ...
 */
func  (this *bittrade) FetchTime(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *bittrade) FetchTradingLimits(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) FetchTradingLimitsById(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) ParseTradingLimits(limits interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //   {                                  symbol: "aidocbtc",
    //                  "buy-limit-must-less-than":  1.1,
    //              "sell-limit-must-greater-than":  0.9,
...
func  (this *bittrade) CostToPrecision(symbol interface{}, cost interface{}) interface{}  {
 ...
 */
func  (this *bittrade) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
            _ = params
            var method interface{} = ccxt.GetValue(this.Options, "fetchMarketsMethod")
            ...
            if ccxt.IsTrue(ccxt.IsLessThan(numMarkets, 1)) {
                panic(ccxt.NetworkError(ccxt.Add(ccxt.Add(this.Id, " fetchMarkets() returned empty response: "), this.Json(markets))))
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                ...
                var margin interface{} = ccxt.IsTrue(ccxt.Precise.StringGt(leverageRatio, "1")) || ccxt.IsTrue(ccxt.Precise.StringGt(superLeverageRatio, "1"))
                var fee interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(base, "OMG"))), this.ParseNumber("0"), this.ParseNumber("0.002"))
...
func  (this *bittrade) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchTicker
    //
    //     {
    ...
    if ccxt.IsTrue(ccxt.InOp(ticker, "bid")) {
        if ccxt.IsTrue(ccxt.IsArray(ccxt.GetValue(ticker, "bid"))) {
    ...
    if ccxt.IsTrue(ccxt.InOp(ticker, "ask")) {
        if ccxt.IsTrue(ccxt.IsArray(ccxt.GetValue(ticker, "ask"))) {
 ...
 */
func  (this *bittrade) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bittrade) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            //     }
            //
            var ticker interface{} = this.ParseTicker(ccxt.GetValue(response, "tick"), market)
 ...
 */
func  (this *bittrade) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(tickers)); i++ {
                var marketId interface{} = this.SafeString(ccxt.GetValue(tickers, i), "symbol")
...
func  (this *bittrade) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchTrades (public)
    //
    //     {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(filledPoints, nil)) {
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(feeCost, nil))) || ccxt.IsTrue((ccxt.Precise.StringEq(feeCost, "0.0")))) {
 ...
 */
func  (this *bittrade) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bittrade) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", limit) // 1-100 orders, default is 100
            }
 ...
 */
func  (this *bittrade) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", ccxt.MathMin(limit, 2000))
            }
...
func  (this *bittrade) ParseOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "amount":1.2082,
    //         "open":0.025096,
 ...
 */
func  (this *bittrade) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            since := ccxt.GetArg(optionalArgs, 1, nil)
            _ = since
            limit := ccxt.GetArg(optionalArgs, 2, 1000)
            _ = limit
            params := ccxt.GetArg(optionalArgs, 3, map[string]interface{} {})
            _ = params
 ...
 */
func  (this *bittrade) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ch <- ccxt.GetValue(response, "data")
            return nil
 ...
 */
func  (this *bittrade) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
            var request interface{} = map[string]interface{} {
                "language": ccxt.GetValue(this.Options, "language"),
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencies)); i++ {
                ...
                var active interface{} = ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(visible) && ccxt.IsTrue(depositEnabled)) && ccxt.IsTrue(withdrawEnabled)) && ccxt.IsTrue((ccxt.IsEqual(state, "online")))) && !ccxt.IsTrue(countryDisabled)
...
func  (this *bittrade) ParseBalance(response interface{}) interface{}  {
    var balances interface{} = this.SafeValue(ccxt.GetValue(response, "data"), "list", []interface{}{})
    var result interface{} = map[string]interface{} {
        "info": response,
    }
 ...
 */
func  (this *bittrade) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var method interface{} = ccxt.GetValue(this.Options, "fetchBalanceMethod")
            var request interface{} = map[string]interface{} {
                "id": ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id"),
            }
...
func  (this *bittrade) FetchOrdersByStates(states interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            //                         "canceled-at":  0                      }  ] }
            //
        ch <- this.ParseOrders(ccxt.GetValue(response, "data"), market, since, limit)
            return nil
 ...
 */
func  (this *bittrade) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bittrade) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bittrade) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) FetchOpenOrdersV1(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOpenOrdersV1() requires a symbol argument")))
            }
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bittrade) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes132115)
                ch <- retRes132115
                return nil
...
func  (this *bittrade) FetchOpenOrdersV2(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) ParseOrderStatus(status interface{}) interface{}  {
...
func  (this *bittrade) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {                  id:  13997833014,
    //                    "symbol": "ethbtc",
    //              "account-id":  3398321,
    ...
    var fee interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(feeCost, nil)) {
        var feeCurrency interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "sell"))), ccxt.GetValue(market, "quote"), ccxt.GetValue(market, "base"))
        fee = map[string]interface{} {
            "cost": feeCost,
            "currency": feeCurrency,
        }
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bittrade) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bittrade) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "account-id": ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id"),
                "symbol": ccxt.GetValue(market, "id"),
                "type": ccxt.Add(ccxt.Add(side, "-"), typeVar),
            }
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "market"))) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))) {
                ...
                __tmp727343 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp727343, 0)
                params = ccxt.GetValue(__tmp727343, 1)
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "ioc"))) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit-maker"))) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "stop-limit"))) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "stop-limit-fok"))) {
                ccxt.AddElementToObject(request, "price", this.PriceToPrecision(symbol, price))
            }
            var method interface{} = ccxt.GetValue(this.Options, "createOrderMethod")
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *bittrade) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bittrade) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) ParseCancelOrders(orders interface{}) interface{}  {
    //
    //    {
    //        "success": [
    //            "5983466"
 ...
 */
func  (this *bittrade) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "currency": "usdt",
 ...
 */
func  (this *bittrade) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func  (this *bittrade) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bittrade) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchDeposits
    //
    //     {
...
func  (this *bittrade) ParseTransactionStatus(status interface{}) interface{}  {
    var statuses interface{} = map[string]interface{} {
        "unknown": "failed",
        "confirming": "pending",
        "confirmed": "ok",
 ...
 */
func  (this *bittrade) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp80427 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp80427, 0)
            params = ccxt.GetValue(__tmp80427, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(network, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(network, "erc20")) {
                    ccxt.AddElementToObject(request, "chain", ccxt.Add(ccxt.GetValue(currency, "id"), network))
                } else {
                    ccxt.AddElementToObject(request, "chain", ccxt.Add(network, ccxt.GetValue(currency, "id")))
                }
...
func  (this *bittrade) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    var url interface{} = "/"
    if ccxt.IsTrue(ccxt.IsEqual(api, "market")) {
        url = ccxt.Add(url, api)
    } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(api, "public"))) || ccxt.IsTrue((ccxt.IsEqual(api, "private")))) {
...
func  (this *bittrade) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
...
func (this *bittrade) Init(userConfig map[string]interface{}) {
