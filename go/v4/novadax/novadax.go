    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "A99999": ccxt.ExchangeError,
                "A10001": ccxt.BadRequest,
                "A10002": ccxt.ExchangeError,
                "A10003": ccxt.AuthenticationError,
                "A10004": ccxt.RateLimitExceeded,
                "A10005": ccxt.PermissionDenied,
                "A10006": ccxt.AccountSuspended,
                "A10007": ccxt.AccountNotEnabled,
                "A10011": ccxt.BadSymbol,
                "A10012": ccxt.BadSymbol,
                "A10013": ccxt.OnMaintenance,
                "A30001": ccxt.OrderNotFound,
                "A30002": ccxt.InvalidOrder,
                "A30003": ccxt.InvalidOrder,
                "A30004": ccxt.InvalidOrder,
                "A30005": ccxt.InvalidOrder,
                "A30006": ccxt.InvalidOrder,
                "A30007": ccxt.InsufficientFunds,
                "A30008": ccxt.InvalidOrder,
                "A30009": ccxt.InvalidOrder,
                "A30010": ccxt.CancelPending,
                "A30011": ccxt.InvalidOrder,
                "A30012": ccxt.InvalidOrder,
                "A40004": ccxt.InsufficientFunds,
            },
...
func  (this *novadax) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default 10, max 20
            }
            ...
            ch <- this.ParseOrderBook(data, ccxt.GetValue(market, "symbol"), timestamp, "bids", "asks")
            return nil
...
func  (this *novadax) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeString, nil)) {
...
func  (this *novadax) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "from", ccxt.Subtract(now, ccxt.Multiply(limit, duration)))
                ccxt.AddElementToObject(request, "to", now)
            } else {
                var startFrom interface{} = this.ParseToInt(ccxt.Divide(since, 1000))
                ccxt.AddElementToObject(request, "from", startFrom)
                ccxt.AddElementToObject(request, "to", this.Sum(startFrom, ccxt.Multiply(limit, duration)))
            }
...
func  (this *novadax) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(triggerPrice, nil)) {
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(uppercaseType, "STOP_LIMIT"))) || ccxt.IsTrue((ccxt.IsEqual(uppercaseType, "STOP_MARKET")))) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() requires a stopPrice parameter for "), uppercaseType), " orders")))
                }
            } else {
                ...
                var defaultOperator interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(uppercaseSide, "BUY"))), "LTE", "GTE")
                ccxt.AddElementToObject(request, "operator", this.SafeString(params, "operator", defaultOperator))
            ...
            } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(uppercaseType, "MARKET"))) || ccxt.IsTrue((ccxt.IsEqual(uppercaseType, "STOP_MARKET")))) {
                if ccxt.IsTrue(ccxt.IsEqual(uppercaseSide, "SELL")) {
                    ccxt.AddElementToObject(request, "amount", this.AmountToPrecision(symbol, amount))
                } else if ccxt.IsTrue(ccxt.IsEqual(uppercaseSide, "BUY")) {
                    var quoteAmount interface{} = nil
                    var createMarketBuyOrderRequiresPrice interface{} = true
                    __tmp321766 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                    createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp321766, 0)
                    params = ccxt.GetValue(__tmp321766, 1)
                    ...
                    ccxt.AddElementToObject(request, "value", quoteAmount)
                }
            }
...
func  (this *novadax) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "fromTimestamp", since)
            }
...
func  (this *novadax) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes107315)
                ch <- retRes107315
                return nil
...
func  (this *novadax) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(fromAccount, "main")) && ccxt.IsTrue(!ccxt.IsEqual(toAccount, "main"))) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " transfer() supports transfers between main account and subaccounts only")))
            }
            // master-transfer-in = from master account to subaccount
            // master-transfer-out = from subaccount to master account
            var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(fromAccount, "main"))), "master-transfer-in", "master-transfer-out")
            var request interface{} = map[string]interface{} {
                "transferAmount": this.CurrencyToPrecision(code, amount),
                "currency": ccxt.GetValue(currency, "id"),
                "subId": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(typeVar, "master-transfer-in"))), toAccount, fromAccount),
...
func  (this *novadax) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp591304 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp591304, 0)
            params = ccxt.GetValue(__tmp591304, 1)
        
            retRes13188 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes13188)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "code": ccxt.GetValue(currency, "id"),
...
func  (this *novadax) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes141215)
                ch <- retRes141215
                return nil
...
func  (this *novadax) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, "COIN_IN")) {
        typeVar = "deposit"
    } else if ccxt.IsTrue(ccxt.IsEqual(typeVar, "COIN_OUT")) {
        typeVar = "withdraw"
    }
...
func  (this *novadax) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var url interface{} = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), api), request)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(method, "POST")) {
            ...
            queryString = this.Hash(this.Encode(body), ccxt.Md5)
        ...
        var auth interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(method, "\n"), request), "\n"), queryString), "\n"), timestamp) // eslint-disable-line quotes
        ccxt.AddElementToObject(headers, "X-Nova-Signature", this.Hmac(this.Encode(auth), this.Encode(this.Secret), ccxt.Sha256))
    }
    return map[string]interface{} {
        "url": url,
        "method": method,
...
func  (this *novadax) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(errorCode, "A10000")) {
