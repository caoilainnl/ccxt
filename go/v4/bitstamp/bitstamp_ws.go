...
func NewBitstampWsCore() bitstampWs {
   p := bitstampWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bitstampWs) Describe() interface{}  {
 ...
 */
func  (this *bitstampWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *bitstampWs) HandleOrderBook(client interface{}, message interface{})  {
    //
...
func  (this *bitstampWs) HandleDelta(orderbook interface{}, delta interface{})  {
...
func  (this *bitstampWs) HandleBidAsks(bookSide interface{}, bidAsks interface{})  {
...
func  (this *bitstampWs) GetCacheIndex(orderbook interface{}, deltas interface{}) interface{}  {
 ...
 */
func  (this *bitstampWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitstampWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
...
func  (this *bitstampWs) HandleTrade(client interface{}, message interface{})  {
    //
    //     {
    //         "data": {
 ...
 */
func  (this *bitstampWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitstampWs) HandleOrders(client interface{}, message interface{})  {
    //
    // {
    //     "data":{
    //        "id":"1463471322288128",
...
func  (this *bitstampWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "id": "1894876776091648",
...
func  (this *bitstampWs) HandleOrderBookSubscription(client interface{}, message interface{})  {
    var channel interface{} = this.SafeString(message, "channel")
    var parts interface{} = ccxt.Split(channel, "_")
    var marketId interface{} = this.SafeString(parts, 3)
    var symbol interface{} = this.SafeSymbol(marketId)
...
func  (this *bitstampWs) HandleSubscriptionStatus(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *bitstampWs) HandleSubject(client interface{}, message interface{})  {
    //
    //     {
    //         "data": {
    //             "timestamp": "1583656800",
...
func  (this *bitstampWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    // {
    //     "event": "bts:error",
    //     "channel": '',
...
func  (this *bitstampWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *bitstampWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(expiresIn, nil))) || ccxt.IsTrue((ccxt.IsGreaterThan(now, expiresIn)))) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(sessionToken, nil)) {
                    ...
                    ccxt.AddElementToObject(this.Options, "expiresIn", this.Sum(now, validity))
...
func  (this *bitstampWs) SubscribePrivate(subscription interface{}, messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func (this *bitstampWs) Init(userConfig map[string]interface{}) {
    this.bitstamp.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
