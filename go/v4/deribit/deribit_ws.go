...
func NewDeribitWsCore() deribitWs {
   p := deribitWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *deribitWs) Describe() interface{}  {
...
func  (this *deribitWs) RequestId() interface{}  {
 ...
 */
func  (this *deribitWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *deribitWs) HandleBalance(client interface{}, message interface{})  {
    //
    // subscription
    //     {
    //         "jsonrpc": "2.0",
 ...
 */
func  (this *deribitWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *deribitWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deribitWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *deribitWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deribitWs) HandleBidAsk(client interface{}, message interface{})  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
...
func  (this *deribitWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *deribitWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *deribitWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp270724 := this.HandleOptionAndParams(params, "watchTradesForSymbols", "interval", "100ms")
            interval = ccxt.GetValue(__tmp270724, 0)
            params = ccxt.GetValue(__tmp270724, 1)
            if ccxt.IsTrue(ccxt.IsEqual(interval, "raw")) {
...
func  (this *deribitWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *deribitWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deribitWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
 ...
 */
func  (this *deribitWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *deribitWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
            var interval interface{} = nil
            __tmp274350 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "interval", "100ms")
            interval = ccxt.GetValue(__tmp274350, 0)
            params = ccxt.GetValue(__tmp274350, 1)
            if ccxt.IsTrue(ccxt.IsEqual(interval, "raw")) {
            ...
            __tmp972677 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "useDepthEndpoint", false)
            useDepthEndpoint = ccxt.GetValue(__tmp972677, 0)
            params = ccxt.GetValue(__tmp972677, 1)
            if ccxt.IsTrue(useDepthEndpoint) {
                var depth interface{} = nil
                __tmp763462 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "depth", "20")
                depth = ccxt.GetValue(__tmp763462, 0)
                params = ccxt.GetValue(__tmp763462, 1)
                var group interface{} = nil
                __tmp293278 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "group", "none")
                group = ccxt.GetValue(__tmp293278, 0)
                params = ccxt.GetValue(__tmp293278, 1)
...
func  (this *deribitWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //  snapshot
    //     {
    //         "jsonrpc": "2.0",
...
func  (this *deribitWs) CleanOrderBook(data interface{}) interface{}  {
    var bids interface{} = this.SafeList(data, "bids", []interface{}{})
    var asks interface{} = this.SafeList(data, "asks", []interface{}{})
...
func  (this *deribitWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *deribitWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *deribitWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deribitWs) HandleOrders(client interface{}, message interface{})  {
 ...
 */
func  (this *deribitWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *deribitWs) WatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *deribitWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
...
func  (this *deribitWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "c": "28909.0",
    //        "o": "28915.4",
...
func  (this *deribitWs) WatchMultipleWrapper(channelName interface{}, channelDescriptor interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetLength(jsonedText), maxMessageByteLimit)) {
                ...
                retRes93915 :=  (<-this.WatchMultiple(url, messageHashes, extendedRequest, rawSubscriptions, nil))
...
func  (this *deribitWs) HandleMessage(client interface{}, message interface{})  {
    //
    // error
    //     {
    //         "jsonrpc": "2.0",
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(err, nil)) {
        panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " "), this.Json(err))))
    }
...
func  (this *deribitWs) HandleAuthenticationMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "id": 1,
...
func  (this *deribitWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var timeString interface{} = this.NumberToString(now)
...
func (this *deribitWs) Init(userConfig map[string]interface{}) {
    this.deribit.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
