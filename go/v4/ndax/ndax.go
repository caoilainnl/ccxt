    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "Not_Enough_Funds": ccxt.InsufficientFunds,
                "Server ccxt.Error": ccxt.ExchangeError,
                "Resource Not Found": ccxt.OrderNotFound,
            },
            "broad": map[string]interface{} {
                "Invalid InstrumentId": ccxt.BadSymbol,
...
func  (this *ndax) SignIn(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(this.Login, nil)) || ccxt.IsTrue(ccxt.IsEqual(this.Password, nil))) {
                panic(ccxt.AuthenticationError(ccxt.Add(this.Id, " signIn() requires exchange.login, exchange.password")))
            }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(sessionToken, nil)) {
                ccxt.AddElementToObject(this.Options, "sessionToken", sessionToken)
        
                ch <- response
                return nil
            }
            var pending2faToken interface{} = this.SafeString(response, "Pending2FaToken")
            if ccxt.IsTrue(!ccxt.IsEqual(pending2faToken, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(this.Twofa, nil)) {
                    panic(ccxt.AuthenticationError(ccxt.Add(this.Id, " signIn() requires exchange.twofa credentials")))
                }
                ccxt.AddElementToObject(this.Options, "pending2faToken", pending2faToken)
                request = map[string]interface{} {
                    "Code": ccxt.Totp(this.Twofa),
                }
...
func  (this *ndax) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(ProductType, "NationalCurrency"))), "fiat", "crypto")
                if ccxt.IsTrue(ccxt.IsEqual(ProductType, "Unknown")) {
            ...
            "info": currency,
            "active": !ccxt.IsTrue(this.SafeBool(currency, "IsDisabled")),
...
func  (this *ndax) ParseMarket(market interface{}) interface{}  {
    ...
    var sessionRunning interface{} =     (ccxt.IsEqual(sessionStatus, "Running"))
    return map[string]interface{} {
        ...
        "future": false,
        "option": false,
        "active": (ccxt.IsTrue(sessionRunning) && !ccxt.IsTrue(isDisable)),
        "contract": false,
        "linear": nil,
        "inverse": nil,
        "contractSize": nil,
...
func  (this *ndax) ParseOrderBook(orderbook interface{}, symbol interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = asksKey
    priceKey := ccxt.GetArg(optionalArgs, 3, 6)
    _ = priceKey
    amountKey := ccxt.GetArg(optionalArgs, 4, 8)
    _ = amountKey
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orderbook)); i++ {
        var level interface{} = ccxt.GetValue(orderbook, i)
        ...
        var side interface{} = ccxt.Ternary(ccxt.IsTrue(levelSide), asksKey, bidsKey)
        var resultSide interface{} = ccxt.GetValue(result, side)
        ccxt.AppendToArray(&resultSide, bidask)
    }
...
func  (this *ndax) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            limit = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(limit, nil))), 100, limit) // default 100
            var request interface{} = map[string]interface{} {
                "omsId": omsId,
                "InstrumentId": ccxt.GetValue(market, "id"),
                "Depth": limit,
            }
...
func  (this *ndax) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "FromDate", this.Ymdhms(ccxt.Subtract(now, ccxt.Multiply(ccxt.Multiply(duration, limit), 1000))))
                    ccxt.AddElementToObject(request, "ToDate", this.Ymdhms(now))
                }
            } else {
                ccxt.AddElementToObject(request, "FromDate", this.Ymdhms(since))
                if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "ToDate", this.Ymdhms(now))
                } else {
                    ccxt.AddElementToObject(request, "ToDate", this.Ymdhms(this.Sum(since, ccxt.Multiply(ccxt.Multiply(duration, limit), 1000))))
                }
            }
...
func  (this *ndax) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //         "Direction":"ccxt.NoChange",
    //         "IsBlockTrade":false,
    //         "ccxt.Fee":1.1727625650000000000000000000,
    //         "FeeProductId":8,
    //         "OrderOriginator":446,
    ...
    if ccxt.IsTrue(ccxt.IsArray(trade)) {
        ...
        side = ccxt.Ternary(ccxt.IsTrue(takerSide), "sell", "buy")
        ...
        var feeCostString interface{} = this.SafeString(trade, "ccxt.Fee")
...
func  (this *ndax) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                ...
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
            _ = params
            if !ccxt.IsTrue(this.Login) {
                panic(ccxt.AuthenticationError(ccxt.Add(this.Id, " fetchAccounts() requires exchange.login email credential")))
            }
            var omsId interface{} = this.SafeInteger(this.Options, "omsId", 1)
            this.CheckRequiredCredentials()
            var request interface{} = map[string]interface{} {
...
func  (this *ndax) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                accountId = ccxt.ParseInt(ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id"))
            }
...
func  (this *ndax) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //         "ProductId": 1,
    //         "ccxt.Balance": 10.000000000000000000000000000,
    ...
    if ccxt.IsTrue(ccxt.Precise.StringLt(credit, "0")) {
        amount = credit
        direction = "in"
    } else if ccxt.IsTrue(ccxt.Precise.StringLt(debit, "0")) {
        amount = debit
        direction = "out"
    }
    var before interface{} = nil
    var after interface{} = this.SafeString(item, "ccxt.Balance")
    if ccxt.IsTrue(ccxt.IsEqual(direction, "out")) {
        before = ccxt.Precise.StringAdd(after, amount)
    } else if ccxt.IsTrue(ccxt.IsEqual(direction, "in")) {
        before = ccxt.Precise.StringMax("0", ccxt.Precise.StringSub(after, amount))
    }
...
func  (this *ndax) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes13148 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes13148)
            var defaultAccountId interface{} = this.SafeInteger2(this.Options, "accountId", "AccountId", ccxt.ParseInt(ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id")))
            var accountId interface{} = this.SafeInteger2(params, "accountId", "AccountId", defaultAccountId)
            params = this.Omit(params, []interface{}{"accountId", "AccountId"})
            var request interface{} = map[string]interface{} {
                "omsId": omsId,
...
func  (this *ndax) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes14768 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes14768)
            var defaultAccountId interface{} = this.SafeInteger2(this.Options, "accountId", "AccountId", ccxt.ParseInt(ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id")))
            var accountId interface{} = this.SafeInteger2(params, "accountId", "AccountId", defaultAccountId)
            var clientOrderId interface{} = this.SafeInteger2(params, "ClientOrderId", "clientOrderId")
            var orderType interface{} = this.SafeInteger(ccxt.GetValue(this.Options, "orderTypes"), this.Capitalize(typeVar))
            ...
            var market interface{} = this.Market(symbol)
            var orderSide interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), 0, 1)
            var request interface{} = map[string]interface{} {
                ...
                "ccxt.TimeInForce": 1,
                "Side": orderSide,
                "Quantity": ccxt.ParseFloat(this.AmountToPrecision(symbol, amount)),
                "OrderType": orderType,
            }
            // If OrderType=1 (ccxt.Market), Side=0 (Buy), and LimitPrice is supplied, the ccxt.Market order will execute up to the value specified
            if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
                ccxt.AddElementToObject(request, "LimitPrice", ccxt.ParseFloat(this.PriceToPrecision(symbol, price)))
            }
...
func  (this *ndax) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var orderSide interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), 0, 1)
            var request interface{} = map[string]interface{} {
                "OrderIdToReplace": ccxt.ParseInt(id),
                "InstrumentId": ccxt.ParseInt(ccxt.GetValue(market, "id")),
                "omsId": omsId,
                "AccountId": accountId,
                "ccxt.TimeInForce": 1,
                "Side": orderSide,
                "Quantity": ccxt.ParseFloat(this.AmountToPrecision(symbol, amount)),
                "OrderType": this.SafeInteger(ccxt.GetValue(this.Options, "orderTypes"), this.Capitalize(typeVar)),
            }
            // If OrderType=1 (ccxt.Market), Side=0 (Buy), and LimitPrice is supplied, the ccxt.Market order will execute up to the value specified
            if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
                ccxt.AddElementToObject(request, "LimitPrice", ccxt.ParseFloat(this.PriceToPrecision(symbol, price)))
...
func  (this *ndax) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes15938 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes15938)
            var defaultAccountId interface{} = this.SafeInteger2(this.Options, "accountId", "AccountId", ccxt.ParseInt(ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id")))
            var accountId interface{} = this.SafeInteger2(params, "accountId", "AccountId", defaultAccountId)
            params = this.Omit(params, []interface{}{"accountId", "AccountId"})
            var request interface{} = map[string]interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                ccxt.AddElementToObject(request, "InstrumentId", ccxt.GetValue(market, "id"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "StartTimeStamp", this.ParseToInt(ccxt.Divide(since, 1000)))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "Depth", limit)
            }
...
func  (this *ndax) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                var market interface{} = this.Market(symbol)
                ccxt.AddElementToObject(request, "IntrumentId", ccxt.GetValue(market, "id"))
            }
...
func  (this *ndax) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                ccxt.AddElementToObject(request, "ClOrderId", clientOrderId)
            } else {
                ccxt.AddElementToObject(request, "OrderId", ccxt.ParseInt(id))
            }
...
func  (this *ndax) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes18438 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes18438)
            var defaultAccountId interface{} = this.SafeInteger2(this.Options, "accountId", "AccountId", ccxt.ParseInt(ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id")))
            var accountId interface{} = this.SafeInteger2(params, "accountId", "AccountId", defaultAccountId)
            params = this.Omit(params, []interface{}{"accountId", "AccountId"})
            var request interface{} = map[string]interface{} {
...
func  (this *ndax) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes19378)
        
            retRes19388 := (<-this.LoadAccounts())
...
func  (this *ndax) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes20178)
        
            retRes20188 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes20188)
            // const defaultAccountId = this.safeInteger2 (this.options, 'accountId', 'AccountId', parseInt (this.accounts[0]['id']));
            // const accountId = this.safeInteger2 (params, 'accountId', 'AccountId', defaultAccountId);
            // params = this.omit (params, [ 'accountId', 'AccountId' ]);
            var market interface{} = nil
            ...
            var trades interface{} = this.SafeList(grouped, "ccxt.Trade", []interface{}{})
...
func  (this *ndax) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "omsId": omsId,
                "AccountId": accountId,
                "ProductId": ccxt.GetValue(currency, "id"),
...
func  (this *ndax) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var depositInfo interface{} = ccxt.JsonParse(depositInfoString)
    var depositInfoLength interface{} =     ccxt.GetArrayLength(depositInfo)
    var lastString interface{} = this.SafeString(depositInfo, ccxt.Subtract(depositInfoLength, 1))
    var parts interface{} = ccxt.Split(lastString, "?memo=")
...
func  (this *ndax) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes217315 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func  (this *ndax) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsString(response)) {
                ...
                ch <- this.ParseTransactions(ccxt.JsonParse(response), currency, since, limit)
                return nil
            }
...
func  (this *ndax) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22518 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes22518)
            var defaultAccountId interface{} = this.SafeInteger2(this.Options, "accountId", "AccountId", ccxt.ParseInt(ccxt.GetValue(ccxt.GetValue(this.Accounts, 0), "id")))
            var accountId interface{} = this.SafeInteger2(params, "accountId", "AccountId", defaultAccountId)
            params = this.Omit(params, []interface{}{"accountId", "AccountId"})
            var currency interface{} = nil
...
func  (this *ndax) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(transaction, "DepositId")) {
        ...
        typeVar = "deposit"
    } else if ccxt.IsTrue(ccxt.InOp(transaction, "WithdrawId")) {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(templateForm, nil)) {
...
func  (this *ndax) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp396546 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp396546, 0)
            params = ccxt.GetValue(__tmp396546, 1)
            // this method required login, password and twofa key
            var sessionToken interface{} = this.SafeString(this.Options, "sessionToken")
            if ccxt.IsTrue(ccxt.IsEqual(sessionToken, nil)) {
                panic(ccxt.AuthenticationError(ccxt.Add(this.Id, " call signIn() method to obtain a session token")))
            }
            if ccxt.IsTrue(ccxt.IsEqual(this.Twofa, nil)) {
                panic(ccxt.AuthenticationError(ccxt.Add(this.Id, " withdraw() requires exchange.twofa credentials")))
            }
            this.CheckAddress(address)
            var omsId interface{} = this.SafeInteger(this.Options, "omsId", 1)
        
            retRes24628 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes24628)
        
            retRes24638 := (<-this.LoadAccounts())
            ...
            ccxt.PanicOnError(withdrawTemplateTypesResponse)
            //
            //     {
            //         "result": true,
            //         "errormsg": null,
            ...
            if ccxt.IsTrue(ccxt.IsEqual(firstTemplateType, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " withdraw() could not find a withdraw template type for "), ccxt.GetValue(currency, "code"))))
            }
            ...
            var withdrawTemplateRequest interface{} = map[string]interface{} {
                ...
                "AccountProviderId": ccxt.GetValue(firstTemplateType, "AccountProviderId"),
            }
        
            withdrawTemplateResponse:= (<-this.PrivateGetGetWithdrawTemplate(withdrawTemplateRequest))
            ccxt.PanicOnError(withdrawTemplateResponse)
            //
            //     {
            //         "result": true,
            //         "errormsg": null,
            ...
            if ccxt.IsTrue(ccxt.IsEqual(template, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " withdraw() could not find a withdraw template for "), ccxt.GetValue(currency, "code"))))
            }
            var withdrawTemplate interface{} = ccxt.JsonParse(template)
            ccxt.AddElementToObject(withdrawTemplate, "ExternalAddress", address)
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                if ccxt.IsTrue(ccxt.InOp(withdrawTemplate, "Memo")) {
                    ccxt.AddElementToObject(withdrawTemplate, "Memo", tag)
                }
            }
...
func  (this *ndax) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    var url interface{} = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), api), "/"), this.ImplodeParams(path, params))
    var query interface{} = this.Omit(params, this.ExtractParams(path))
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        if ccxt.IsTrue(ccxt.IsEqual(path, "Authenticate")) {
            var auth interface{} = ccxt.Add(ccxt.Add(this.Login, ":"), this.Password)
            var auth64 interface{} = this.StringToBase64(auth)
            headers = map[string]interface{} {
                "Authorization": ccxt.Add("Basic ", auth64),
            }
        } else if ccxt.IsTrue(ccxt.IsEqual(path, "Authenticate2FA")) {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(sessionToken, nil)) {
            ...
            var auth interface{} = ccxt.Add(ccxt.Add(nonce, this.Uid), this.ApiKey)
...
func  (this *ndax) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsEqual(code, 404)) {
        panic(ccxt.AuthenticationError(ccxt.Add(ccxt.Add(this.Id, " "), body)))
    }
    ...
    //     {"result":false,"errormsg":"Server ccxt.Error","errorcode":102,"detail":null}
    //
    var message interface{} = this.SafeString(response, "errormsg")
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(message, nil))) && ccxt.IsTrue((!ccxt.IsEqual(message, "")))) {
