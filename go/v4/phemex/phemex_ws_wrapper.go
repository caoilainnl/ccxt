...
func NewPhemexWs(userConfig map[string]interface{}) PhemexWs {
   p := &phemexWs{}
   p.Init(userConfig)
   return PhemexWs{
       phemexWs: p,
...
func (this *PhemexWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
...
func (this *PhemexWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *PhemexWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *PhemexWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *PhemexWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *PhemexWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *PhemexWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *PhemexWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
