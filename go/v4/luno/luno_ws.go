...
func NewLunoWsCore() lunoWs {
   p := lunoWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *lunoWs) Describe() interface{}  {
 ...
 */
func  (this *lunoWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *lunoWs) HandleTrades(client interface{}, message interface{}, subscription interface{})  {
    //
    //     {
    //         "sequence": "110980825",
    //         "trade_updates": [],
...
func  (this *lunoWs) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // watchTrades (public)
    //
    //     {
 ...
 */
func  (this *lunoWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *lunoWs) HandleOrderBook(client interface{}, message interface{}, subscription interface{})  {
    //
    //     {
    //         "sequence": "24352",
    //         "asks": [{
...
func  (this *lunoWs) CustomParseOrderBook(orderbook interface{}, symbol interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *lunoWs) ParseBidsAsks(bidasks interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *lunoWs) CustomParseBidAsk(bidask interface{}, optionalArgs ...interface{}) interface{}  {
    priceKey := ccxt.GetArg(optionalArgs, 0, "price")
    _ = priceKey
    amountKey := ccxt.GetArg(optionalArgs, 1, "volume")
    _ = amountKey
...
func  (this *lunoWs) HandleDelta(orderbook interface{}, message interface{})  {
    //
    //  create
    //     {
    //         "sequence": "110980825",
...
func  (this *lunoWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *lunoWs) Init(userConfig map[string]interface{}) {
    this.luno.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
