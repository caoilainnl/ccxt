...
func NewHtxWsCore() htxWs {
   p := htxWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *htxWs) Describe() interface{}  {
...
func  (this *htxWs) RequestId() interface{}  {
 ...
 */
func  (this *htxWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var url interface{} = this.GetUrlByMarketType(ccxt.GetValue(market, "type"), ccxt.GetValue(market, "linear"))
                ...
                retRes15515 :=  (<-this.SubscribePublic(url, symbol, messageHash, nil, params))
...
func  (this *htxWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
 ...
 */
func  (this *htxWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *htxWs) HandleTrades(client interface{}, message interface{}) interface{}  {
    //
    //     {
 ...
 */
func  (this *htxWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *htxWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
 ...
 */
func  (this *htxWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                limit = ccxt.Ternary(ccxt.IsTrue(ccxt.GetValue(market, "spot")), 150, 20)
            }
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                messageHash = ccxt.Add(ccxt.Add(ccxt.Add("market.", ccxt.GetValue(market, "id")), ".mbp."), ccxt.ToString(limit))
            } else {
                messageHash = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add("market.", ccxt.GetValue(market, "id")), ".depth.size_"), ccxt.ToString(limit)), ".high_freq")
            }
...
func  (this *htxWs) HandleOrderBookSnapshot(client interface{}, message interface{}, subscription interface{})  {
    //
    //     {
    //         "id": 1583473663565,
    ...
    {		 func(this *htxWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *htxWs) interface{} {
    					// catch block:
...
func  (this *htxWs) WatchOrderBookSnapshot(client interface{}, message interface{}, subscription interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *htxWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *htxWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *htxWs) HandleOrderBookMessage(client interface{}, message interface{})  {
    // spot markets
    //
    //     {
...
func  (this *htxWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // deltas
    //
    // spot markets
...
func  (this *htxWs) HandleOrderBookSubscription(client interface{}, message interface{}, subscription interface{})  {
    var symbol interface{} = this.SafeString(subscription, "symbol")
    var market interface{} = this.Market(symbol)
    var limit interface{} = this.SafeInteger(subscription, "limit")
    ccxt.AddElementToObject(this.Orderbooks, symbol, this.OrderBook(map[string]interface{} {}, limit))
 ...
 */
func  (this *htxWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *htxWs) GetOrderChannelAndMessageHash(typeVar interface{}, subType interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *htxWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *htxWs) HandleOrder(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
...
func  (this *htxWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //
    //     {
...
func  (this *htxWs) ParseOrderTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *htxWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(market, nil)) {
                ...
                __tmp54212 := this.HandleMarketTypeAndParams("watchPositions", market, params)
                typeVar = ccxt.GetValue(__tmp54212, 0)
                params = ccxt.GetValue(__tmp54212, 1)
                if ccxt.IsTrue(ccxt.IsEqual(typeVar, "spot")) {
                    typeVar = "future"
                }
                __tmp558309 := this.HandleOptionAndParams(params, "watchPositions", "subType", subType)
                subType = ccxt.GetValue(__tmp558309, 0)
                params = ccxt.GetValue(__tmp558309, 1)
            }
            symbols = this.MarketSymbols(symbols)
            var marginMode interface{} = nil
            __tmp883772 := this.HandleMarginModeAndParams("watchPositions", params, "cross")
            marginMode = ccxt.GetValue(__tmp883772, 0)
            params = ccxt.GetValue(__tmp883772, 1)
...
func  (this *htxWs) HandlePositions(client interface{}, message interface{})  {
    //
    //    {
    //        op: 'notify',
 ...
 */
func  (this *htxWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
            var typeVar interface{} = nil
            __tmp524517 := this.HandleMarketTypeAndParams("watchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp524517, 0)
            params = ccxt.GetValue(__tmp524517, 1)
            var subType interface{} = nil
            __tmp269677 := this.HandleSubTypeAndParams("watchBalance", nil, params, "linear")
            subType = ccxt.GetValue(__tmp269677, 0)
            params = ccxt.GetValue(__tmp269677, 1)
            ...
            var subscriptionParams interface{} = map[string]interface{} {
                ...
                retRes145915 :=  (<-this.SubscribePrivate(channel, messageHash, typeVar, subType, params, subscriptionParams))
                ccxt.PanicOnError(retRes145915)
...
func  (this *htxWs) HandleBalance(client interface{}, message interface{})  {
    // spot
    //
    //     {
    //         "action": "push",
...
func  (this *htxWs) HandleSubscriptionStatus(client interface{}, message interface{})  {
    //
    //     {
    //         "id": 1583414227,
    //         "status": "ok",
...
func  (this *htxWs) HandleSystemStatus(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *htxWs) HandleSubject(client interface{}, message interface{})  {
    // spot
    //     {
    //         "ch": "market.btcusdt.mbp.150",
    //         "ts": 1583472025885,
...
func  (this *htxWs) Pong(client interface{}, message interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *htxWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
            				...
            				ret_ = func(this *htxWs) interface{} {
            					// catch block:
                                        err := ccxt.NetworkError(ccxt.Add(ccxt.Add(this.Id, " pong failed "), this.Json(e)))
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(ping, nil)) {
                        ...
                        retRes187516 := (<-client.(ccxt.ClientInterface).Send(map[string]interface{} {
                            "pong": ping,
                        }))
                        ccxt.PanicOnError(retRes187516)
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(action, "ping")) {
                        ...
                        retRes188216 := (<-client.(ccxt.ClientInterface).Send(map[string]interface{} {
                            "action": "pong",
                            "data": map[string]interface{} {
                                "ts": pingTs,
                            },
                        }))
                        ccxt.PanicOnError(retRes188216)
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(op, "ping")) {
                        ...
                        retRes188816 := (<-client.(ccxt.ClientInterface).Send(map[string]interface{} {
                            "op": "pong",
                            "ts": pingTs,
                        }))
                        ccxt.PanicOnError(retRes188816)
                    }
            		return nil
            	}(this)
...
func  (this *htxWs) HandlePing(client interface{}, message interface{})  {
    this.Spawn(this.Pong, client, message)
}
func  (this *htxWs) HandleAuthenticate(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
    ...
    //    }
    //
    var promise interface{} = ccxt.GetValue(client.(*ccxt.Client).Futures, "auth")
    promise.(*ccxt.Future).Resolve(ccxt.ToGetsLimit(message))
}
func  (this *htxWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "action": "sub",
    //         "code": 2002,
    ...
    if ccxt.IsTrue(ccxt.IsEqual(status, "error")) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(subscription, nil)) {
            ...
            {		ret__ := func(this *htxWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
...
func  (this *htxWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *htxWs) HandleMyTrade(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    // spot
    //
    //     {
...
func  (this *htxWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    // spot private
    //
    //     {
    //         "eventType":"trade",
...
func  (this *htxWs) GetUrlByMarketType(typeVar interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *htxWs) SubscribePublic(url interface{}, symbol interface{}, messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(method, nil)) {
                ...
                retRes230315 :=  (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash, subscription))
...
func  (this *htxWs) SubscribePrivate(channel interface{}, messageHash interface{}, typeVar interface{}, subtype interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes23358 := (<-this.Authenticate(authParams))
            ccxt.PanicOnError(retRes23358)
        
                retRes233615 :=  (<-this.Watch(url, messageHash, this.Extend(request, params), channel, extendedSubsription))
...
func  (this *htxWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                var auth interface{} = this.Urlencode(signatureParams)
                ...
                retRes240815 :=  <-future.(<-chan interface{})
                ccxt.PanicOnError(retRes240815)
                ch <- retRes240815
                return nil
...
func (this *htxWs) Init(userConfig map[string]interface{}) {
