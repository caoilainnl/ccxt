...
func  (this *htx) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "rateLimit": 100,
        "userAgent": ccxt.GetValue(this.UserAgents, "chrome100"),
        "certified": true,
        "version": "v1",
        ...
        "exceptions": map[string]interface{} {
            "broad": map[string]interface{} {
                ...
                "API key has no permission": ccxt.PermissionDenied,
            },
            "exact": map[string]interface{} {
                "403": ccxt.AuthenticationError,
                "1010": ccxt.AccountNotEnabled,
                "1003": ccxt.AuthenticationError,
                "1013": ccxt.BadSymbol,
                "1017": ccxt.OrderNotFound,
                "1034": ccxt.InvalidOrder,
                "1036": ccxt.InvalidOrder,
                "1039": ccxt.InvalidOrder,
                "1041": ccxt.InvalidOrder,
                "1047": ccxt.InsufficientFunds,
                "1048": ccxt.InsufficientFunds,
                "1061": ccxt.OrderNotFound,
                "1051": ccxt.InvalidOrder,
                "1066": ccxt.BadSymbol,
                "1067": ccxt.InvalidOrder,
                "1094": ccxt.InvalidOrder,
                "1220": ccxt.AccountNotEnabled,
                "1303": ccxt.BadRequest,
                "1461": ccxt.InvalidOrder,
                "4007": ccxt.BadRequest,
                "bad-request": ccxt.BadRequest,
                "validation-format-error": ccxt.BadRequest,
                "validation-constraints-required": ccxt.BadRequest,
                "base-date-limit-error": ccxt.BadRequest,
                "api-not-support-temp-addr": ccxt.PermissionDenied,
                "timeout": ccxt.RequestTimeout,
                "gateway-internal-error": ccxt.ExchangeNotAvailable,
                ...
                "order-limitorder-amount-max-error": ccxt.InvalidOrder,
                "order-marketorder-amount-min-error": ccxt.InvalidOrder,
                "order-limitorder-price-min-error": ccxt.InvalidOrder,
                "order-limitorder-price-max-error": ccxt.InvalidOrder,
                "order-stop-order-hit-trigger": ccxt.InvalidOrder,
                "order-value-min-error": ccxt.InvalidOrder,
                "order-invalid-price": ccxt.InvalidOrder,
                "order-holding-limit-failed": ccxt.InvalidOrder,
                "order-orderprice-precision-error": ccxt.InvalidOrder,
                "order-etp-nav-price-max-error": ccxt.InvalidOrder,
                "order-orderstate-error": ccxt.OrderNotFound,
                "order-queryorder-invalid": ccxt.OrderNotFound,
                "order-update-error": ccxt.ExchangeNotAvailable,
                "api-signature-check-failed": ccxt.AuthenticationError,
                "api-signature-not-valid": ccxt.AuthenticationError,
                "base-record-invalid": ccxt.OrderNotFound,
                "base-symbol-trade-disabled": ccxt.BadSymbol,
                "base-symbol-error": ccxt.BadSymbol,
                "system-maintenance": ccxt.OnMaintenance,
                "base-request-exceed-frequency-limit": ccxt.RateLimitExceeded,
                "invalid symbol": ccxt.BadSymbol,
                "symbol trade not open now": ccxt.BadSymbol,
                "require-symbol": ccxt.BadSymbol,
                "invalid-address": ccxt.BadRequest,
                "base-currency-chain-error": ccxt.BadRequest,
                "dw-insufficient-balance": ccxt.InsufficientFunds,
                "base-withdraw-fee-error": ccxt.BadRequest,
                "dw-withdraw-min-limit": ccxt.BadRequest,
                "request limit": ccxt.RateLimitExceeded,
            },
        },
...
func  (this *htx) FetchStatus(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp121683 := this.HandleMarketTypeAndParams("fetchStatus", nil, params)
            marketType = ccxt.GetValue(__tmp121683, 0)
            params = ccxt.GetValue(__tmp121683, 1)
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(marketType, "spot")) && ccxt.IsTrue(enabledForContracts)) {
                var subType interface{} = this.SafeString(params, "subType", ccxt.GetValue(this.Options, "defaultSubType"))
                ...
                } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "contract")) {
            ...
            //                      "name": "ccxt.Market data is delayed",  // incident name
            ...
            //                              "body": "ccxt.Market data is delayed",
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "contract")) {
                var statusRaw interface{} = this.SafeString(response, "status")
                if ccxt.IsTrue(ccxt.IsEqual(statusRaw, nil)) {
                    status = nil
                } else {
                    status = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(statusRaw, "ok"))), "ok", "maintenance") // 'ok', 'error'
                }
                ...
                status = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(statusRaw, "none"))), "ok", "maintenance") // none, minor, major, critical, maintenance
...
func  (this *htx) FetchTradingLimits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
                ...
                ccxt.AddElementToObject(result, symbol, (<-this.FetchTradingLimitsById(this.MarketId(symbol), params)))
            }
...
func  (this *htx) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                ccxt.PanicOnError(retRes178312)
            }
            var types interface{} = nil
            __tmp711237 := this.HandleOptionAndParams(params, "fetchMarkets", "types", map[string]interface{} {})
            types = ccxt.GetValue(__tmp711237, 0)
            params = ccxt.GetValue(__tmp711237, 1)
            var allMarkets interface{} = []interface{}{}
            var promises interface{} = []interface{}{}
            var keys interface{} = ccxt.ObjectKeys(types)
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                var key interface{} = ccxt.GetValue(keys, i)
                if ccxt.IsTrue(this.SafeBool(types, key)) {
                    if ccxt.IsTrue(ccxt.IsEqual(key, "spot")) {
                        ccxt.AppendToArray(&promises, this.FetchMarketsByTypeAndSubType("spot", nil, params))
                    } else if ccxt.IsTrue(ccxt.IsEqual(key, "linear")) {
                        ccxt.AppendToArray(&promises, this.FetchMarketsByTypeAndSubType(nil, "linear", params))
                    } else if ccxt.IsTrue(ccxt.IsEqual(key, "inverse")) {
                        ccxt.AppendToArray(&promises, this.FetchMarketsByTypeAndSubType("swap", "inverse", params))
                        ccxt.AppendToArray(&promises, this.FetchMarketsByTypeAndSubType("future", "inverse", params))
                    }
                }
            }
            promises = (<-ccxt.PromiseAll(promises))
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(promises)); i++ {
                allMarkets = this.ArrayConcat(allMarkets, ccxt.GetValue(promises, i))
            }
...
func  (this *htx) FetchMarketsByTypeAndSubType(typeVar interface{}, subType interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !ccxt.IsTrue(isSpot) {
                if ccxt.IsTrue(ccxt.IsEqual(subType, "linear")) {
                    ccxt.AddElementToObject(request, "business_type", "all") // override default to fetch all linear markets
            ...
            //                 "rebal-time":"00:00:00",
            //                 "rebal-threshold":-5,
            //                 "ccxt.init-nav":10.000000000000000000,
            //                 "api-trading":"enabled",
            ...
            var numMarkets interface{} =     ccxt.GetArrayLength(markets)
            if ccxt.IsTrue(ccxt.IsLessThan(numMarkets, 1)) {
                panic(ccxt.OperationFailed(ccxt.Add(ccxt.Add(this.Id, " fetchMarkets() returned an empty response: "), this.Json(response))))
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                ...
                var contract interface{} =         (ccxt.InOp(market, "contract_code"))
                ...
                if ccxt.IsTrue(contract) {
                    ...
                    future = !ccxt.IsEqual(delivery_date, nil)
                    swap = !ccxt.IsTrue(future)
                    linear = !ccxt.IsEqual(business_type, nil)
                    ...
                    if ccxt.IsTrue(swap) {
                        ...
                        settleId = ccxt.Ternary(ccxt.IsTrue(inverse), baseId, quoteId)
                    } else if ccxt.IsTrue(future) {
                        typeVar = "future"
                        baseId = this.SafeStringLower(market, "symbol")
                        if ccxt.IsTrue(inverse) {
                            quoteId = "USD"
                            settleId = baseId
                        } else {
                ...
                if ccxt.IsTrue(contract) {
                    ...
                    } else if ccxt.IsTrue(linear) {
                        symbol = ccxt.Add(symbol, ccxt.Add(":", quote))
                    }
                    if ccxt.IsTrue(future) {
                        expiry = this.SafeInteger(market, "delivery_time")
                        symbol = ccxt.Add(symbol, ccxt.Add("-", this.Yymmdd(expiry)))
                    }
                }
                ...
                if ccxt.IsTrue(spot) {
                    ...
                    active = (ccxt.IsEqual(state, "online"))
                } else {
                    ...
                    active = (ccxt.IsEqual(contractStatus, 1))
                }
                ...
                var hasLeverage interface{} = ccxt.IsTrue(ccxt.Precise.StringGt(leverageRatio, "1")) || ccxt.IsTrue(ccxt.Precise.StringGt(superLeverageRatio, "1"))
                // 0 Delisting
                // 1 Listing
                // 2 Pending Listing
                // 3 Suspension
                ...
                // 8 Delivered
                // 9 Suspending of ccxt.Trade
                var created interface{} = nil
                var createdDate interface{} = this.SafeString(market, "create_date") // i.e 20230101
                if ccxt.IsTrue(!ccxt.IsEqual(createdDate, nil)) {
                    var createdArray interface{} = this.StringToCharsArray(createdDate)
                    createdDate = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.GetValue(createdArray, 0), ccxt.GetValue(createdArray, 1)), ccxt.GetValue(createdArray, 2)), ccxt.GetValue(createdArray, 3)), "-"), ccxt.GetValue(createdArray, 4)), ccxt.GetValue(createdArray, 5)), "-"), ccxt.GetValue(createdArray, 6)), ccxt.GetValue(createdArray, 7)), " 00:00:00")
                ...
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "type": typeVar,
                    "spot": spot,
                    "margin": (ccxt.IsTrue(spot) && ccxt.IsTrue(hasLeverage)),
                    "swap": swap,
                    "future": future,
                    "option": false,
                    "active": active,
...
func  (this *htx) TryGetSymbolFromFutureMarkets(symbolOrMarketId interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.InOp(this.Markets, symbolOrMarketId)) {
    ...
    if !ccxt.IsTrue((ccxt.InOp(this.Options, "futureMarketIdsForSymbols"))) {
        ccxt.AddElementToObject(this.Options, "futureMarketIdsForSymbols", map[string]interface{} {})
    }
    var futureMarketIdsForSymbols interface{} = this.SafeDict(this.Options, "futureMarketIdsForSymbols", map[string]interface{} {})
    if ccxt.IsTrue(ccxt.InOp(futureMarketIdsForSymbols, symbolOrMarketId)) {
        return ccxt.GetValue(futureMarketIdsForSymbols, symbolOrMarketId)
    }
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(futureMarkets)); i++ {
        var market interface{} = ccxt.GetValue(futureMarkets, i)
        ...
        var contractSuffix interface{} = ccxt.GetValue(futuresCharsMaps, contractType)
        // see comment on formats a bit above
        var constructedId interface{} = ccxt.Ternary(ccxt.IsTrue(ccxt.GetValue(market, "linear")), ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.GetValue(market, "base"), "-"), ccxt.GetValue(market, "quote")), "-"), contractSuffix), ccxt.Add(ccxt.Add(ccxt.GetValue(market, "base"), "_"), contractSuffix))
        if ccxt.IsTrue(ccxt.IsEqual(constructedId, symbolOrMarketId)) {
            var symbol interface{} = ccxt.GetValue(market, "symbol")
            ccxt.AddElementToObject(ccxt.GetValue(this.Options, "futureMarketIdsForSymbols"), symbolOrMarketId, symbol)
            return symbol
        }
    }
    // if not found, just save it to avoid unnecessary future iterations
    ccxt.AddElementToObject(ccxt.GetValue(this.Options, "futureMarketIdsForSymbols"), symbolOrMarketId, symbolOrMarketId)
    return symbolOrMarketId
}
func  (this *htx) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(ticker, "bid")) {
        if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(ticker, "bid"), nil)) && ccxt.IsTrue(ccxt.IsArray(ccxt.GetValue(ticker, "bid")))) {
            bid = this.SafeString(ccxt.GetValue(ticker, "bid"), 0)
            bidVolume = this.SafeString(ccxt.GetValue(ticker, "bid"), 1)
        } else {
            bid = this.SafeString(ticker, "bid")
            bidVolume = this.SafeString(ticker, "bidSize")
        }
    }
    if ccxt.IsTrue(ccxt.InOp(ticker, "ask")) {
        if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(ticker, "ask"), nil)) && ccxt.IsTrue(ccxt.IsArray(ccxt.GetValue(ticker, "ask")))) {
            ask = this.SafeString(ccxt.GetValue(ticker, "ask"), 0)
            askVolume = this.SafeString(ccxt.GetValue(ticker, "ask"), 1)
        } else {
...
func  (this *htx) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
...
func  (this *htx) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var isSubTypeRequested interface{} = ccxt.IsTrue((ccxt.InOp(params, "subType"))) || ccxt.IsTrue((ccxt.InOp(params, "business_type")))
            var typeVar interface{} = nil
            var subType interface{} = nil
            __tmp905215 := this.HandleMarketTypeAndParams("fetchTickers", market, params)
            typeVar = ccxt.GetValue(__tmp905215, 0)
            params = ccxt.GetValue(__tmp905215, 1)
            __tmp189066 := this.HandleSubTypeAndParams("fetchTickers", market, params)
            subType = ccxt.GetValue(__tmp189066, 0)
            params = ccxt.GetValue(__tmp189066, 1)
            var request interface{} = map[string]interface{} {}
            var isSpot interface{} =     (ccxt.IsEqual(typeVar, "spot"))
            var future interface{} =     (ccxt.IsEqual(typeVar, "future"))
            var swap interface{} =     (ccxt.IsEqual(typeVar, "swap"))
            var linear interface{} =     (ccxt.IsEqual(subType, "linear"))
            var inverse interface{} =     (ccxt.IsEqual(subType, "inverse"))
            var response interface{} = nil
            if ccxt.IsTrue(!ccxt.IsTrue(isSpot) || ccxt.IsTrue(isSubTypeRequested)) {
                if ccxt.IsTrue(linear) {
                    // independently of type, supports calling all linear symbols i.e. fetchTickers(undefined, {subType:'linear'})
                    if ccxt.IsTrue(future) {
                        ccxt.AddElementToObject(request, "business_type", "futures")
                    } else if ccxt.IsTrue(swap) {
                        ccxt.AddElementToObject(request, "business_type", "swap")
                    } else {
                        ccxt.AddElementToObject(request, "business_type", "all")
                    }
                    ...
                    if ccxt.IsTrue(future) {
                        ...
                        panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTickers() you have to set params[\"type\"] to either \"swap\" or \"future\" for inverse contracts")))
                    }
                } else {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTickers() you have to set params[\"subType\"] to either \"linear\" or \"inverse\" for contracts")))
                }
            } else {
...
func  (this *htx) FetchLastPrices(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes24578)
            symbols = this.MarketSymbols(symbols)
            var market interface{} = this.GetMarketFromSymbols(symbols)
            var typeVar interface{} = nil
            var subType interface{} = nil
            __tmp815742 := this.HandleSubTypeAndParams("fetchLastPrices", market, params)
            subType = ccxt.GetValue(__tmp815742, 0)
            params = ccxt.GetValue(__tmp815742, 1)
            __tmp836292 := this.HandleMarketTypeAndParams("fetchLastPrices", market, params)
            typeVar = ccxt.GetValue(__tmp836292, 0)
            params = ccxt.GetValue(__tmp836292, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue((ccxt.IsEqual(typeVar, "swap"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "future"))))) && ccxt.IsTrue((ccxt.IsEqual(subType, "linear")))) {
                response = (<-this.ContractPublicGetLinearSwapExMarketTrade(params))
            } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "swap"))) && ccxt.IsTrue((ccxt.IsEqual(subType, "inverse")))) {
                response = (<-this.ContractPublicGetSwapExMarketTrade(params))
            } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "future"))) && ccxt.IsTrue((ccxt.IsEqual(subType, "inverse")))) {
...
func  (this *htx) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(limit, 5))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 10)))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 20)))) && ccxt.IsTrue((!ccxt.IsEqual(limit, 150)))) {
                        panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchOrderBook() limit argument must be undefined, 5, 10, 20, or 150, default is 150")))
                    }
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(limit, 150)) {
            ...
            //     }
            //
            if ccxt.IsTrue(ccxt.InOp(response, "tick")) {
                if !ccxt.IsTrue(ccxt.GetValue(response, "tick")) {
                    panic(ccxt.BadSymbol(ccxt.Add(ccxt.Add(this.Id, " fetchOrderBook() returned empty response: "), this.Json(response))))
                }
                ...
                ccxt.AddElementToObject(result, "nonce", this.SafeInteger(tick, "version"))
        
                ch <- result
                return nil
            }
            panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " fetchOrderBook() returned unrecognized response: "), this.Json(response))))
...
func  (this *htx) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(feeCost, nil)) {
        feeCost = ccxt.Precise.StringNeg(this.SafeString(trade, "trade_fee"))
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(filledPoints, nil)) {
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(feeCost, nil))) || ccxt.IsTrue(ccxt.Precise.StringEquals(feeCost, "0"))) {
            var feeDeductCurrency interface{} = this.SafeString(trade, "fee-deduct-currency")
            if ccxt.IsTrue(!ccxt.IsEqual(feeDeductCurrency, nil)) {
...
func  (this *htx) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketType interface{} = nil
            __tmp299029 := this.HandleMarketTypeAndParams("fetchOrderTrades", market, params)
            marketType = ccxt.GetValue(__tmp299029, 0)
            params = ccxt.GetValue(__tmp299029, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(marketType, "spot")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOrderTrades() is only supported for spot markets")))
            }
        
                retRes281915 :=  (<-this.FetchSpotOrderTrades(id, symbol, since, limit, params))
                ccxt.PanicOnError(retRes281915)
                ch <- retRes281915
                return nil
...
func  (this *htx) FetchSpotOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseTrades(ccxt.GetValue(response, "data"), nil, since, limit)
            return nil
...
func  (this *htx) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes28608)
            var paginate interface{} = false
            __tmp167821 := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
            paginate = ccxt.GetValue(__tmp167821, 0)
            params = ccxt.GetValue(__tmp167821, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes286419 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes286419)
                    ch <- retRes286419
                    return nil
            }
            var market interface{} = nil
            ...
            var marketType interface{} = nil
            __tmp538231 := this.HandleMarketTypeAndParams("fetchMyTrades", market, params)
            marketType = ccxt.GetValue(__tmp538231, 0)
            params = ccxt.GetValue(__tmp538231, 1)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "size", limit) // default 100, max 500
                }
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(request, "start-time", since) // a date within 120 days from today
                }
                __tmp76141 := this.HandleUntilOption("end-time", request, params)
                request = ccxt.GetValue(__tmp76141, 0)
                params = ccxt.GetValue(__tmp76141, 1)
                ...
                ccxt.AddElementToObject(request, "trade_type", 0) // 0 all, 1 open long, 2 open short, 3 close short, 4 close long, 5 liquidate long positions, 6 liquidate short positions
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(request, "start_time", since) // a date within 120 days from today
                }
                __tmp972021 := this.HandleUntilOption("end_time", request, params)
                request = ccxt.GetValue(__tmp972021, 0)
                params = ccxt.GetValue(__tmp972021, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "page_size", limit) // default 100, max 500
                }
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    var marginMode interface{} = nil
                    __tmp424058 := this.HandleMarginModeAndParams("fetchMyTrades", params)
                    marginMode = ccxt.GetValue(__tmp424058, 0)
                    params = ccxt.GetValue(__tmp424058, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(marketType, "future")) {
                        ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "settleId"))
                        ...
                        panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchMyTrades() does not support "), marketType), " markets")))
                    }
                }
            }
            //
            ...
            if !ccxt.IsTrue(ccxt.IsArray(trades)) {
...
func  (this *htx) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = since
            limit := ccxt.GetArg(optionalArgs, 1, 1000)
            _ = limit
            ...
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", ccxt.MathMin(limit, 2000)) // max 2000
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "future")) {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                var trades interface{} = this.SafeValue(ccxt.GetValue(data, i), "data", []interface{}{})
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(trades)); j++ {
                    var trade interface{} = this.ParseTrade(ccxt.GetValue(trades, j), market)
                    ccxt.AppendToArray(&result, trade)
                }
            }
            result = this.SortBy(result, "timestamp")
        
            ch <- this.FilterBySymbolSinceLimit(result, ccxt.GetValue(market, "symbol"), since, limit)
            return nil
...
func  (this *htx) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes31358)
            var paginate interface{} = false
            __tmp928192 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate")
            paginate = ccxt.GetValue(__tmp928192, 0)
            params = ccxt.GetValue(__tmp928192, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes313919 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    ccxt.PanicOnError(retRes313919)
                    ch <- retRes313919
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            __tmp47902 := this.HandleParamInteger(params, "until")
            until = ccxt.GetValue(__tmp47902, 0)
            params = ccxt.GetValue(__tmp47902, 1)
            var untilSeconds interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(until, nil))), this.ParseToInt(ccxt.Divide(until, 1000)), nil)
            if ccxt.IsTrue(ccxt.GetValue(market, "contract")) {
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "size", ccxt.MathMin(limit, 2000)) // when using limit: from & to are ignored
                } else {
                    limit = 2000 // only used for from/to calculation
                }
                if ccxt.IsTrue(ccxt.IsEqual(priceType, nil)) {
                    var duration interface{} = this.ParseTimeframe(timeframe)
                    var calcualtedEnd interface{} = nil
                    if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                        var now interface{} = this.Seconds()
                        ccxt.AddElementToObject(request, "from", ccxt.Subtract(now, ccxt.Multiply(duration, (ccxt.Subtract(limit, 1)))))
                        calcualtedEnd = now
                    } else {
                        var start interface{} = this.ParseToInt(ccxt.Divide(since, 1000))
                        ccxt.AddElementToObject(request, "from", start)
                        calcualtedEnd = this.Sum(start, ccxt.Multiply(duration, (ccxt.Subtract(limit, 1))))
                    }
                    ccxt.AddElementToObject(request, "to", ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(untilSeconds, nil))), untilSeconds, calcualtedEnd))
                }
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "future")) {
                if ccxt.IsTrue(ccxt.GetValue(market, "inverse")) {
                    ...
                    } else if ccxt.IsTrue(ccxt.IsEqual(priceType, "premiumIndex")) {
                        panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), ccxt.GetValue(market, "type")), " has no api endpoint for "), priceType), " kline data")))
                    } else {
                ...
                __tmp669154 := this.HandleOptionAndParams(params, "fetchOHLCV", "useHistoricalEndpointForSpot", true)
                useHistorical = ccxt.GetValue(__tmp669154, 0)
                params = ccxt.GetValue(__tmp669154, 1)
                if !ccxt.IsTrue(useHistorical) {
                    if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                        ccxt.AddElementToObject(request, "size", ccxt.MathMin(limit, 2000)) // max 2000
                    }
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(untilSeconds, nil)) {
                        ccxt.AddElementToObject(request, "to", untilSeconds)
                    }
                    if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                        ccxt.AddElementToObject(request, "size", ccxt.MathMin(1000, limit)) // max 1000, otherwise default returns 150
                    }
...
func  (this *htx) FetchAccountIdByType(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                    marginMode := ccxt.GetArg(optionalArgs, 0, nil)
            _ = marginMode
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(accounts)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(typeVar, "margin")) {
                    if ccxt.IsTrue(ccxt.IsEqual(subtype, marketId)) {
        
                        ch <- this.SafeString(account, "id")
                        return nil
                    }
                } else if ccxt.IsTrue(ccxt.IsEqual(typeVar, typeFromAccount)) {
...
func  (this *htx) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var data interface{} = this.SafeList(response, "data", []interface{}{})
            var result interface{} = map[string]interface{} {}
            ccxt.AddElementToObject(this.Options, "networkChainIdsByNames", map[string]interface{} {})
            ccxt.AddElementToObject(this.Options, "networkNamesByChainIds", map[string]interface{} {})
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue(ccxt.IsEqual(assetType, "1")), "crypto", "fiat")
                ccxt.AddElementToObject(ccxt.GetValue(this.Options, "networkChainIdsByNames"), code, map[string]interface{} {})
                var chains interface{} = this.SafeList(entry, "chains", []interface{}{})
                var networks interface{} = map[string]interface{} {}
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(chains)); j++ {
                    var chainEntry interface{} = ccxt.GetValue(chains, j)
                    ...
                    ccxt.AddElementToObject(ccxt.GetValue(ccxt.GetValue(this.Options, "networkChainIdsByNames"), code), title, uniqueChainId)
                    ccxt.AddElementToObject(ccxt.GetValue(this.Options, "networkNamesByChainIds"), uniqueChainId, title)
            ...
            "active": nil,
            "deposit": ccxt.IsEqual(this.SafeString(chainEntry, "depositStatus"), "allowed"),
            "withdraw": ccxt.IsEqual(this.SafeString(chainEntry, "withdrawStatus"), "allowed"),
            ...
            "code": code,
            "id": currencyId,
            "active": ccxt.IsEqual(this.SafeString(entry, "instStatus"), "normal"),
            "deposit": nil,
            "withdraw": nil,
            "fee": nil,
            "name": nil,
...
func  (this *htx) NetworkIdToCode(optionalArgs ...interface{}) interface{}  {
    ...
    networkId := ccxt.GetArg(optionalArgs, 0, nil)
    _ = networkId
    currencyCode := ccxt.GetArg(optionalArgs, 1, nil)
    _ = currencyCode
    var keys interface{} = ccxt.ObjectKeys(ccxt.GetValue(this.Options, "networkNamesByChainIds"))
    var keysLength interface{} =     ccxt.GetArrayLength(keys)
    if ccxt.IsTrue(ccxt.IsEqual(keysLength, 0)) {
        panic(ccxt.ExchangeError(ccxt.Add(this.Id, " networkIdToCode() - markets need to be loaded at first")))
    }
    var networkTitle interface{} = this.SafeValue(ccxt.GetValue(this.Options, "networkNamesByChainIds"), networkId, networkId)
...
func  (this *htx) NetworkCodeToId(networkCode interface{}, optionalArgs ...interface{}) interface{}  {
    currencyCode := ccxt.GetArg(optionalArgs, 0, nil)
    _ = currencyCode
    if ccxt.IsTrue(ccxt.IsEqual(currencyCode, nil)) {
        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " networkCodeToId() requires a currencyCode argument")))
    }
    var keys interface{} = ccxt.ObjectKeys(ccxt.GetValue(this.Options, "networkChainIdsByNames"))
    var keysLength interface{} =     ccxt.GetArrayLength(keys)
    if ccxt.IsTrue(ccxt.IsEqual(keysLength, 0)) {
        panic(ccxt.ExchangeError(ccxt.Add(this.Id, " networkCodeToId() - markets need to be loaded at first")))
    }
    var uniqueNetworkIds interface{} = this.SafeValue(ccxt.GetValue(this.Options, "networkChainIdsByNames"), currencyCode, map[string]interface{} {})
    if ccxt.IsTrue(ccxt.InOp(uniqueNetworkIds, networkCode)) {
        return ccxt.GetValue(uniqueNetworkIds, networkCode)
    } else {
...
func  (this *htx) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes35168)
            var typeVar interface{} = nil
            __tmp241713 := this.HandleMarketTypeAndParams("fetchBalance", nil, params)
            typeVar = ccxt.GetValue(__tmp241713, 0)
            params = ccxt.GetValue(__tmp241713, 1)
            ...
            var linear interface{} =     (ccxt.IsEqual(subType, "linear"))
            var marginMode interface{} = nil
            __tmp727546 := this.HandleMarginModeAndParams("fetchBalance", params)
            marginMode = ccxt.GetValue(__tmp727546, 0)
            params = ccxt.GetValue(__tmp727546, 1)
            params = this.Omit(params, []interface{}{"defaultSubType", "subType"})
            var isolated interface{} =     (ccxt.IsEqual(marginMode, "isolated"))
            var cross interface{} =     (ccxt.IsEqual(marginMode, "cross"))
            var margin interface{} = ccxt.IsTrue((ccxt.IsEqual(typeVar, "margin"))) || ccxt.IsTrue((ccxt.IsTrue(spot) && ccxt.IsTrue((ccxt.IsTrue(cross) || ccxt.IsTrue(isolated)))))
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue(spot) || ccxt.IsTrue(margin)) {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(spot) || ccxt.IsTrue(margin)) {
                if ccxt.IsTrue(isolated) {
                    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                        ...
                        for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(balances)); j++ {
                            var balance interface{} = ccxt.GetValue(balances, j)
                            var currencyId interface{} = this.SafeString(balance, "currency")
                            var code interface{} = this.SafeCurrencyCode(currencyId)
                            ccxt.AddElementToObject(subResult, code, this.ParseMarginBalanceHelper(balance, code, subResult))
                        }
                    ...
                    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
                        ...
                        var currencyId interface{} = this.SafeString(balance, "currency")
                        var code interface{} = this.SafeCurrencyCode(currencyId)
                        ccxt.AddElementToObject(result, code, this.ParseMarginBalanceHelper(balance, code, result))
                    }
                ...
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                    ...
                    if ccxt.IsTrue(isolated) {
                        ...
                        for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(isolated_swap)); j++ {
                            var balance interface{} = ccxt.GetValue(isolated_swap, j)
                            ...
                            ccxt.AddElementToObject(result, symbol, subBalance)
                            result = this.SafeBalance(result)
                        }
                    } else {
                        var account interface{} = this.Account()
                        ccxt.AddElementToObject(account, "free", this.SafeString(entry, "margin_static"))
                        ccxt.AddElementToObject(account, "used", this.SafeString(entry, "margin_frozen"))
                ...
                if ccxt.IsTrue(isolated) {
                    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                        ...
                        if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                            var account interface{} = this.Account()
                            ccxt.AddElementToObject(account, "free", this.SafeString(balance, "margin_balance"))
                            ...
                            var symbol interface{} = ccxt.GetValue(market, "symbol")
                            ccxt.AddElementToObject(result, symbol, this.SafeBalance(accountsByCode))
                        }
                    }
                } else {
                    var account interface{} = this.Account()
                    ccxt.AddElementToObject(account, "free", this.SafeString(first, "withdraw_available"))
...
func  (this *htx) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes38408)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marketType interface{} = nil
            __tmp181256 := this.HandleMarketTypeAndParams("fetchOrder", market, params)
            marketType = ccxt.GetValue(__tmp181256, 0)
            params = ccxt.GetValue(__tmp181256, 1)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                    ...
                    ccxt.AddElementToObject(request, "order-id", id)
                ...
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    var marginMode interface{} = nil
                    __tmp181379 := this.HandleMarginModeAndParams("fetchOrder", params)
                    marginMode = ccxt.GetValue(__tmp181379, 0)
                    params = ccxt.GetValue(__tmp181379, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(marketType, "future")) {
                        ...
                        panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOrder() does not support "), marketType), " markets")))
                    }
                }
            }
            //
            ...
            if ccxt.IsTrue(ccxt.IsArray(order)) {
...
func  (this *htx) ParseMarginBalanceHelper(balance interface{}, code interface{}, result interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(result, code)) {
        account = ccxt.GetValue(result, code)
    } else {
        account = this.Account()
    }
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(balance, "type"), "trade")) {
        ccxt.AddElementToObject(account, "free", this.SafeString(balance, "balance"))
    }
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(balance, "type"), "frozen")) {
        ccxt.AddElementToObject(account, "used", this.SafeString(balance, "balance"))
    }
    return account
}
func  (this *htx) FetchSpotOrdersByStates(states interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "spot_private_get_v1_order_orders")) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start-time", since) // a window of 48 hours within 180 days
                ccxt.AddElementToObject(request, "end-time", this.Sum(since, ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(48, 60), 60), 1000)))
            }
            __tmp379702 := this.HandleUntilOption("end-time", request, params)
            request = ccxt.GetValue(__tmp379702, 0)
            params = ccxt.GetValue(__tmp379702, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
...
func  (this *htx) FetchSpotOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes412715)
                ch <- retRes412715
                return nil
...
func  (this *htx) FetchClosedSpotOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes413115)
                ch <- retRes413115
                return nil
...
func  (this *htx) FetchContractOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchContractOrders() requires a symbol argument")))
            }
        
            retRes41388 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes41388)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "trade_type": 0,
                "status": "0",
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(trigger) || ccxt.IsTrue(stopLossTakeProfit)) || ccxt.IsTrue(trailing)) {
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "page_size", limit)
                }
                ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
                ccxt.AddElementToObject(request, "create_date", 90)
            } else {
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(request, "start_time", since) // max 90 days back
                }
                ccxt.AddElementToObject(request, "contract", ccxt.GetValue(market, "id"))
                ccxt.AddElementToObject(request, "type", 1) // 1:All Orders,2:ccxt.Order in Finished Status
            }
            __tmp117054 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp117054, 0)
            params = ccxt.GetValue(__tmp117054, 1)
            if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                var marginMode interface{} = nil
                __tmp180860 := this.HandleMarginModeAndParams("fetchContractOrders", params)
                marginMode = ccxt.GetValue(__tmp180860, 0)
                params = ccxt.GetValue(__tmp180860, 1)
                marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
...
func  (this *htx) FetchClosedContractOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes437215)
                ch <- retRes437215
                return nil
...
func  (this *htx) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes43968)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marketType interface{} = nil
            __tmp692442 := this.HandleMarketTypeAndParams("fetchOrders", market, params)
            marketType = ccxt.GetValue(__tmp692442, 0)
            params = ccxt.GetValue(__tmp692442, 1)
            var contract interface{} = ccxt.IsTrue((ccxt.IsEqual(marketType, "swap"))) || ccxt.IsTrue((ccxt.IsEqual(marketType, "future")))
            if ccxt.IsTrue(ccxt.IsTrue(contract) && ccxt.IsTrue((ccxt.IsEqual(symbol, nil)))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOrders() requires a symbol argument for "), marketType), " orders")))
            }
            if ccxt.IsTrue(contract) {
        
                    retRes440819 :=  (<-this.FetchContractOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes440819)
                    ch <- retRes440819
                    return nil
            } else {
        
                    retRes441019 :=  (<-this.FetchSpotOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes441019)
                    ch <- retRes441019
                    return nil
            }
                return nil
...
func  (this *htx) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes44338)
            var paginate interface{} = false
            __tmp816164 := this.HandleOptionAndParams(params, "fetchClosedOrders", "paginate")
            paginate = ccxt.GetValue(__tmp816164, 0)
            params = ccxt.GetValue(__tmp816164, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes443719 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, 100))
                    ccxt.PanicOnError(retRes443719)
                    ch <- retRes443719
                    return nil
            }
            var market interface{} = nil
            ...
            var marketType interface{} = nil
            __tmp535095 := this.HandleMarketTypeAndParams("fetchClosedOrders", market, params)
            marketType = ccxt.GetValue(__tmp535095, 0)
            params = ccxt.GetValue(__tmp535095, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
        
                    retRes444619 :=  (<-this.FetchClosedSpotOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes444619)
                    ch <- retRes444619
                    return nil
            } else {
        
                    retRes444819 :=  (<-this.FetchClosedContractOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes444819)
                    ch <- retRes444819
                    return nil
            }
                return nil
...
func  (this *htx) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            var marketType interface{} = nil
            __tmp384296 := this.HandleMarketTypeAndParams("fetchOpenOrders", market, params)
            marketType = ccxt.GetValue(__tmp384296, 0)
            params = ccxt.GetValue(__tmp384296, 1)
            var subType interface{} = nil
            __tmp900166 := this.HandleSubTypeAndParams("fetchOpenOrders", market, params, "linear")
            subType = ccxt.GetValue(__tmp900166, 0)
            params = ccxt.GetValue(__tmp900166, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                    ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                ...
                if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                    ...
                    ccxt.PanicOnError(retRes448816)
                    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Accounts)); i++ {
                        var account interface{} = ccxt.GetValue(this.Accounts, i)
                        if ccxt.IsTrue(ccxt.IsEqual(this.SafeString(account, "type"), "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                    // throw new ccxt.ArgumentsRequired (this.id + ' fetchOpenOrders() requires a symbol argument');
                    ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "page_size", limit)
                ...
                if ccxt.IsTrue(ccxt.IsEqual(subType, "linear")) {
                    var marginMode interface{} = nil
                    __tmp254355 := this.HandleMarginModeAndParams("fetchOpenOrders", params)
                    marginMode = ccxt.GetValue(__tmp254355, 0)
                    params = ccxt.GetValue(__tmp254355, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                        if ccxt.IsTrue(trigger) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
                        ...
                        ccxt.AddElementToObject(request, "symbol", this.SafeString(market, "settleId", "usdt"))
                        if ccxt.IsTrue(trigger) {
...
func  (this *htx) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(rejectedCreateOrders, nil)) {
        status = "rejected"
    }
    ...
    if ccxt.IsTrue(ccxt.InOp(order, "type")) {
        var orderType interface{} = ccxt.Split(ccxt.GetValue(order, "type"), "-")
        side = ccxt.GetValue(orderType, 0)
        typeVar = ccxt.GetValue(orderType, 1)
    }
    ...
    var clientOrderId interface{} = this.SafeString2(order, "client_order_id", ccxt.Add("client-or", "der-id")) // transpiler regex trick for php issue
    var cost interface{} = nil
    var amount interface{} = nil
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(typeVar, nil))) && ccxt.IsTrue((ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "market"), 0)))) {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(reduceOnlyInteger, nil)) {
        reduceOnly = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(reduceOnlyInteger, 0))), false, true)
    }
...
func  (this *htx) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                ccxt.PanicOnError(retRes523215)
                ch <- retRes523215
                return nil
...
func  (this *htx) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                ccxt.PanicOnError(retRes525815)
                ch <- retRes525815
                return nil
...
func  (this *htx) CreateSpotOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes52778)
        
            retRes52788 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes52788)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
            __tmp925590 := this.HandleMarginModeAndParams("createOrder", params)
            marginMode = ccxt.GetValue(__tmp925590, 0)
            params = ccxt.GetValue(__tmp925590, 1)
        
            accountId:= (<-this.FetchAccountIdByType(ccxt.GetValue(market, "type"), marginMode, symbol))
            ccxt.PanicOnError(accountId)
            var request interface{} = map[string]interface{} {
                "account-id": accountId,
                "symbol": ccxt.GetValue(market, "id"),
            }
            var orderType interface{} = ccxt.Replace(typeVar, "buy-", "")
            orderType = ccxt.Replace(orderType, "sell-", "")
            ...
            if ccxt.IsTrue(ccxt.IsEqual(triggerPrice, nil)) {
                ...
                if ccxt.IsTrue(ccxt.InOp(stopOrderTypes, orderType)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() requires a triggerPrice for a trigger order")))
                }
            } else {
                var defaultOperator interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "sell"))), "lte", "gte")
                var stopOperator interface{} = this.SafeString(params, "operator", defaultOperator)
                ccxt.AddElementToObject(request, "stop-price", this.PriceToPrecision(symbol, triggerPrice))
                ccxt.AddElementToObject(request, "operator", stopOperator)
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(orderType, "limit"))) || ccxt.IsTrue((ccxt.IsEqual(orderType, "limit-fok")))) {
                    orderType = ccxt.Add("stop-", orderType)
                } else if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(orderType, "stop-limit"))) && ccxt.IsTrue((!ccxt.IsEqual(orderType, "stop-limit-fok")))) {
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() does not support "), typeVar), " orders")))
                }
            }
            var postOnly interface{} = nil
            __tmp622471 := this.HandlePostOnly(ccxt.IsEqual(orderType, "market"), ccxt.IsEqual(orderType, "limit-maker"), params)
            postOnly = ccxt.GetValue(__tmp622471, 0)
            params = ccxt.GetValue(__tmp622471, 1)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(timeInForce, "FOK")) {
                orderType = ccxt.Add(orderType, "-fok")
            } else if ccxt.IsTrue(ccxt.IsEqual(timeInForce, "IOC")) {
                orderType = "ioc"
            }
            ccxt.AddElementToObject(request, "type", ccxt.Add(ccxt.Add(side, "-"), orderType))
            ...
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                ...
                ccxt.AddElementToObject(request, "client-order-id", ccxt.Add(brokerId, this.Uuid()))
            } else {
                ccxt.AddElementToObject(request, "client-order-id", clientOrderId)
            }
            if ccxt.IsTrue(ccxt.IsEqual(marginMode, "cross")) {
                ccxt.AddElementToObject(request, "source", "super-margin-api")
            } else if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                ccxt.AddElementToObject(request, "source", "margin-api")
            } else if ccxt.IsTrue(ccxt.IsEqual(marginMode, "c2c")) {
                ccxt.AddElementToObject(request, "source", "c2c-margin-api")
            }
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(orderType, "market"))) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))) {
                var quoteAmount interface{} = nil
                var createMarketBuyOrderRequiresPrice interface{} = true
                __tmp692233 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
                createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp692233, 0)
                params = ccxt.GetValue(__tmp692233, 1)
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                        ...
                        quoteAmount = this.AmountToPrecision(symbol, ccxt.Precise.StringMul(amountString, priceString))
                    }
                } else {
            ...
            if ccxt.IsTrue(ccxt.InOp(limitOrderTypes, orderType)) {
...
func  (this *htx) CreateContractOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    var market interface{} = this.Market(symbol)
    var request interface{} = map[string]interface{} {
        "contract_code": ccxt.GetValue(market, "id"),
        "volume": this.AmountToPrecision(symbol, amount),
        "direction": side,
    }
    var postOnly interface{} = nil
    __tmp87623 := this.HandlePostOnly(ccxt.IsEqual(typeVar, "market"), ccxt.IsEqual(typeVar, "post_only"), params)
    postOnly = ccxt.GetValue(__tmp87623, 0)
    params = ccxt.GetValue(__tmp87623, 1)
    if ccxt.IsTrue(postOnly) {
        typeVar = "post_only"
    }
    var timeInForce interface{} = this.SafeString(params, "timeInForce", "GTC")
    ...
    if ccxt.IsTrue(isTrigger) {
        ...
        ccxt.AddElementToObject(request, "trigger_type", triggerType)
        ccxt.AddElementToObject(request, "trigger_price", this.PriceToPrecision(symbol, triggerPrice))
        if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
            ccxt.AddElementToObject(request, "order_price", this.PriceToPrecision(symbol, price))
        }
    } else if ccxt.IsTrue(ccxt.IsTrue(isStopLossTriggerOrder) || ccxt.IsTrue(isTakeProfitTriggerOrder)) {
        if ccxt.IsTrue(isStopLossTriggerOrder) {
            ccxt.AddElementToObject(request, "sl_order_price_type", typeVar)
            ccxt.AddElementToObject(request, "sl_trigger_price", this.PriceToPrecision(symbol, stopLossTriggerPrice))
            if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
                ccxt.AddElementToObject(request, "sl_order_price", this.PriceToPrecision(symbol, price))
            }
        } else {
            ccxt.AddElementToObject(request, "tp_order_price_type", typeVar)
            ccxt.AddElementToObject(request, "tp_trigger_price", this.PriceToPrecision(symbol, takeProfitTriggerPrice))
            if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
                ccxt.AddElementToObject(request, "tp_order_price", this.PriceToPrecision(symbol, price))
            }
        }
    } else if ccxt.IsTrue(isTrailingPercentOrder) {
        var trailingPercentString interface{} = ccxt.Precise.StringDiv(trailingPercent, "100")
        ccxt.AddElementToObject(request, "callback_rate", this.ParseToNumeric(trailingPercentString))
        ccxt.AddElementToObject(request, "active_price", trailingTriggerPrice)
        ccxt.AddElementToObject(request, "order_price_type", this.SafeString(params, "order_price_type", "formula_price"))
    } else {
        ...
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "ioc"))) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "fok"))) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "post_only"))) {
            ccxt.AddElementToObject(request, "price", this.PriceToPrecision(symbol, price))
        }
    }
    ...
    if ccxt.IsTrue(!ccxt.IsTrue(isStopLossTriggerOrder) && !ccxt.IsTrue(isTakeProfitTriggerOrder)) {
        if ccxt.IsTrue(reduceOnly) {
            ccxt.AddElementToObject(request, "reduce_only", 1)
        }
        ccxt.AddElementToObject(request, "lever_rate", this.SafeIntegerN(params, []interface{}{"leverRate", "lever_rate", "leverage"}, 1))
        if !ccxt.IsTrue(isTrailingPercentOrder) {
            ccxt.AddElementToObject(request, "order_price_type", typeVar)
        }
    }
    var hedged interface{} = this.SafeBool(params, "hedged", false)
    if ccxt.IsTrue(hedged) {
        if ccxt.IsTrue(reduceOnly) {
            ccxt.AddElementToObject(request, "offset", "close")
        } else {
            ccxt.AddElementToObject(request, "offset", "open")
        }
    }
    var broker interface{} = this.SafeValue(this.Options, "broker", map[string]interface{} {})
    var brokerId interface{} = this.SafeString(broker, "id")
    ccxt.AddElementToObject(request, "channel_code", brokerId)
...
func  (this *htx) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                if ccxt.IsTrue(isTrailingPercentOrder) {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrder() does not support trailing orders for spot markets")))
                }
        
                spotRequest:= (<-this.CreateSpotOrderRequest(symbol, typeVar, side, amount, price, params))
                ccxt.PanicOnError(spotRequest)
                ...
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    var marginMode interface{} = nil
                    __tmp609784 := this.HandleMarginModeAndParams("createOrder", contractRequest)
                    marginMode = ccxt.GetValue(__tmp609784, 0)
                    contractRequest = ccxt.GetValue(__tmp609784, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                        if ccxt.IsTrue(isTrigger) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(offset, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder () requires an extra parameter params[\"offset\"] to be set to \"open\" or \"close\" when placing orders in inverse markets")))
                    }
                    if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                        if ccxt.IsTrue(isTrigger) {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                return nil
            } else if ccxt.IsTrue(isStopLossTriggerOrder) {
...
func  (this *htx) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                ccxt.AddElementToObject(request, "orders_data", ordersRequests)
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
...
func  (this *htx) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes57998)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marketType interface{} = nil
            __tmp680971 := this.HandleMarketTypeAndParams("cancelOrder", market, params)
            marketType = ccxt.GetValue(__tmp680971, 0)
            params = ccxt.GetValue(__tmp680971, 1)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    var marginMode interface{} = nil
                    __tmp966917 := this.HandleMarginModeAndParams("cancelOrder", params)
                    marginMode = ccxt.GetValue(__tmp966917, 0)
                    params = ccxt.GetValue(__tmp966917, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                        if ccxt.IsTrue(trigger) {
                    ...
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelOrder() does not support "), marketType), " markets")))
                }
            }
...
func  (this *htx) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes59378)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marketType interface{} = nil
            __tmp655584 := this.HandleMarketTypeAndParams("cancelOrders", market, params)
            marketType = ccxt.GetValue(__tmp655584, 0)
            params = ccxt.GetValue(__tmp655584, 1)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(clientOrderIds, nil)) {
                    if ccxt.IsTrue(ccxt.IsString(clientOrderIds)) {
                        ccxt.AddElementToObject(request, "order-ids", []interface{}{ids})
                    } else {
                        ccxt.AddElementToObject(request, "order-ids", ids)
                    }
                } else {
                    if ccxt.IsTrue(ccxt.IsString(clientOrderIds)) {
                        ccxt.AddElementToObject(request, "client-order-ids", []interface{}{clientOrderIds})
                    } else {
                        ccxt.AddElementToObject(request, "client-order-ids", clientOrderIds)
                    }
                ...
                if ccxt.IsTrue(ccxt.IsEqual(clientOrderIds, nil)) {
                    ccxt.AddElementToObject(request, "order_id", ccxt.Join(ids, ","))
                } else {
                    ccxt.AddElementToObject(request, "client_order_id", clientOrderIds)
                ...
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    var marginMode interface{} = nil
                    __tmp36010 := this.HandleMarginModeAndParams("cancelOrders", params)
                    marginMode = ccxt.GetValue(__tmp36010, 0)
                    params = ccxt.GetValue(__tmp36010, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                        if ccxt.IsTrue(trigger) {
                            response = (<-this.ContractPrivatePostLinearSwapApiV1SwapTriggerCancel(this.Extend(request, params)))
                    ...
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelOrders() does not support "), marketType), " markets")))
                }
            }
            //
            // spot
...
func  (this *htx) ParseCancelOrders(orders interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(successes, nil)) {
        success = ccxt.Split(successes, ",")
    } else {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(failed)); i++ {
        var order interface{} = ccxt.GetValue(failed, i)
        ccxt.AppendToArray(&result, this.SafeOrder(map[string]interface{} {
            "info": order,
...
func  (this *htx) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes61618)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marketType interface{} = nil
            __tmp261430 := this.HandleMarketTypeAndParams("cancelAllOrders", market, params)
            marketType = ccxt.GetValue(__tmp261430, 0)
            params = ccxt.GetValue(__tmp261430, 1)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
            ...
            "info": data,
                ...
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    var marginMode interface{} = nil
                    __tmp297837 := this.HandleMarginModeAndParams("cancelAllOrders", params)
                    marginMode = ccxt.GetValue(__tmp297837, 0)
                    params = ccxt.GetValue(__tmp297837, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                        if ccxt.IsTrue(trigger) {
                    ...
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelAllOrders() does not support "), marketType), " markets")))
                }
                //
                //     {
                //         "status": "ok",
...
func  (this *htx) FetchWithdrawAddresses(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                    note := ccxt.GetArg(optionalArgs, 0, nil)
            _ = note
            networkCode := ccxt.GetArg(optionalArgs, 1, nil)
            _ = networkCode
            params := ccxt.GetArg(optionalArgs, 2, map[string]interface{} {})
            _ = params
        
            retRes63898 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes63898)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": ccxt.GetValue(currency, "id"),
            }
            ...
            //
            var data interface{} = this.SafeValue(response, "data", []interface{}{})
            var allAddresses interface{} = this.ParseDepositAddresses(data, []interface{}{ccxt.GetValue(currency, "code")}, false) // cjg: to do remove this weird object or array ambiguity
            var addresses interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(allAddresses)); i++ {
                var address interface{} = ccxt.GetValue(allAddresses, i)
                var noteMatch interface{} = ccxt.IsTrue((ccxt.IsEqual(note, nil))) || ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(address, "note"), note)))
                var networkMatch interface{} = ccxt.IsTrue((ccxt.IsEqual(networkCode, nil))) || ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(address, "network"), networkCode)))
                if ccxt.IsTrue(ccxt.IsTrue(noteMatch) && ccxt.IsTrue(networkMatch)) {
                    ccxt.AppendToArray(&addresses, address)
                }
            }
...
func  (this *htx) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", limit) // max 100
            }
            ...
            //     }
            //
        ch <- this.ParseTransactions(ccxt.GetValue(response, "data"), currency, since, limit)
            return nil
...
func  (this *htx) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(networkId, "ETH")) && ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetIndexOf(txHash, "0x"), 0))) {
        txHash = ccxt.Add("0x", txHash)
    }
    var subType interface{} = this.SafeString(transaction, "sub-type")
    var internal interface{} = ccxt.IsEqual(subType, "FAST")
    return map[string]interface{} {
        "info": transaction,
...
func  (this *htx) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp736453 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp736453, 0)
            params = ccxt.GetValue(__tmp736453, 1)
        
            retRes66778 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes66778)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "address": address,
                "currency": ccxt.ToLower(ccxt.GetValue(currency, "id")),
            }
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                ccxt.AddElementToObject(request, "addr-tag", tag) // only for XRP?
            }
            var networkCode interface{} = nil
            __tmp369028 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp369028, 0)
            params = ccxt.GetValue(__tmp369028, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
                ccxt.AddElementToObject(request, "chain", this.NetworkCodeToId(networkCode, code))
            }
            amount = ccxt.ParseFloat(this.CurrencyToPrecision(code, amount, networkCode))
            var withdrawOptions interface{} = this.SafeValue(this.Options, "withdraw", map[string]interface{} {})
            if ccxt.IsTrue(this.SafeBool(withdrawOptions, "includeFee", false)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(fee, nil)) {
                    ...
                    var targetNetwork interface{} = this.SafeValue(ccxt.GetValue(currency, "networks"), networkCode, map[string]interface{} {})
                    fee = this.SafeNumber(targetNetwork, "fee")
                    if ccxt.IsTrue(ccxt.IsEqual(fee, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " withdraw() function can not find withdraw fee for chosen network. You need to re-load markets with \"exchange.loadMarkets(true)\", or provide the \"fee\" parameter")))
                    }
                }
                ...
                var amountString interface{} = this.NumberToString(amount)
                var amountSubtractedString interface{} = ccxt.Precise.StringSub(amountString, feeString)
                var amountSubtracted interface{} = ccxt.ParseFloat(amountSubtractedString)
                ccxt.AddElementToObject(request, "fee", ccxt.ParseFloat(feeString))
                amount = ccxt.ParseFloat(this.CurrencyToPrecision(code, amountSubtracted, networkCode))
            }
...
func  (this *htx) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes67708)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": ccxt.GetValue(currency, "id"),
                "amount": ccxt.ParseFloat(this.CurrencyToPrecision(code, amount)),
            }
            var subType interface{} = nil
            __tmp254030 := this.HandleSubTypeAndParams("transfer", nil, params)
            subType = ccxt.GetValue(__tmp254030, 0)
            params = ccxt.GetValue(__tmp254030, 1)
            ...
            var toCross interface{} = ccxt.IsEqual(toAccountId, "cross")
            var fromCross interface{} = ccxt.IsEqual(fromAccountId, "cross")
            var toIsolated interface{} = this.InArray(toAccountId, this.Ids)
            var fromIsolated interface{} = this.InArray(fromAccountId, this.Ids)
            var fromSpot interface{} = ccxt.IsEqual(fromAccountId, "pro")
            var toSpot interface{} = ccxt.IsEqual(toAccountId, "pro")
            if ccxt.IsTrue(ccxt.IsTrue(fromSpot) && ccxt.IsTrue(toSpot)) {
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " transfer () cannot make a transfer between "), fromAccount), " and "), toAccount)))
            }
            var fromOrToFuturesAccount interface{} = ccxt.IsTrue((ccxt.IsEqual(fromAccountId, "futures"))) || ccxt.IsTrue((ccxt.IsEqual(toAccountId, "futures")))
            var response interface{} = nil
            if ccxt.IsTrue(fromOrToFuturesAccount) {
                var typeVar interface{} = ccxt.Add(ccxt.Add(fromAccountId, "-to-"), toAccountId)
                typeVar = this.SafeString(params, "type", typeVar)
                ccxt.AddElementToObject(request, "type", typeVar)
                response = (<-this.SpotPrivatePostV1FuturesTransfer(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsTrue(fromSpot) && ccxt.IsTrue(toCross)) {
                response = (<-this.PrivatePostCrossMarginTransferIn(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsTrue(fromCross) && ccxt.IsTrue(toSpot)) {
                ...
                ccxt.AddElementToObject(request, "symbol", toAccountId)
                response = (<-this.PrivatePostDwTransferInMargin(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsTrue(fromIsolated) && ccxt.IsTrue(toSpot)) {
                ccxt.AddElementToObject(request, "symbol", fromAccountId)
                response = (<-this.PrivatePostDwTransferOutMargin(this.Extend(request, params)))
            } else {
                if ccxt.IsTrue(ccxt.IsEqual(subType, "linear")) {
                    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(fromAccountId, "swap"))) || ccxt.IsTrue((ccxt.IsEqual(fromAccount, "linear-swap")))) {
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                        ...
                        ccxt.AddElementToObject(request, "margin-account", symbol)
                    } else {
                        ccxt.AddElementToObject(request, "margin-account", "USDT") // cross-margin
                    }
                }
                ccxt.AddElementToObject(request, "from", ccxt.Ternary(ccxt.IsTrue(fromSpot), "spot", fromAccountId))
                ccxt.AddElementToObject(request, "to", ccxt.Ternary(ccxt.IsTrue(toSpot), "spot", toAccountId))
...
func  (this *htx) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp86959 := this.HandleOptionAndParams(params, "fetchFundingRateHistory", "paginate")
            paginate = ccxt.GetValue(__tmp86959, 0)
            params = ccxt.GetValue(__tmp86959, 1)
            if ccxt.IsTrue(paginate) {
                    ...
                    ccxt.PanicOnError(retRes694719)
                    ch <- retRes694719
                    return nil
            }
        
            retRes69498 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes69498)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "contract_code": ccxt.GetValue(market, "id"),
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ...
                ccxt.AddElementToObject(request, "page_size", 50) // max
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "inverse")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchFundingRateHistory() supports inverse and linear swaps only")))
            }
            //
            // {
            //     "status": "ok",
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(result)); i++ {
                ...
                ccxt.AddElementToObject(entry, "current_page", cursor)
...
func  (this *htx) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "inverse")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchFundingRate() supports inverse and linear swaps only")))
            }
            //
            // {
            //     "status": "ok",
...
func  (this *htx) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes71228)
            symbols = this.MarketSymbols(symbols)
            var defaultSubType interface{} = this.SafeString(this.Options, "defaultSubType", "linear")
            var subType interface{} = nil
            __tmp269353 := this.HandleOptionAndParams(params, "fetchFundingRates", "subType", defaultSubType)
            subType = ccxt.GetValue(__tmp269353, 0)
            params = ccxt.GetValue(__tmp269353, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                var firstSymbol interface{} = this.SafeString(symbols, 0)
                var market interface{} = this.Market(firstSymbol)
                var isLinear interface{} = ccxt.GetValue(market, "linear")
                subType = ccxt.Ternary(ccxt.IsTrue(isLinear), "linear", "inverse")
            }
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(subType, "linear")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchFundingRates() not support this market type")))
            }
            //
            //     {
            //         "status": "ok",
...
func  (this *htx) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes71808)
            var marginMode interface{} = nil
            __tmp895328 := this.HandleMarginModeAndParams("fetchBorrowInterest", params)
            marginMode = ccxt.GetValue(__tmp895328, 0)
            params = ccxt.GetValue(__tmp895328, 1)
            marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start-date", this.Yyyymmdd(since))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "size", limit)
            }
...
func  (this *htx) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsString(api)) {
        // signing implementation for the old endpoints
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(api, "public"))) || ccxt.IsTrue((ccxt.IsEqual(api, "private")))) {
            url = ccxt.Add(url, this.Version)
        } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(api, "v2Public"))) || ccxt.IsTrue((ccxt.IsEqual(api, "v2Private")))) {
            url = ccxt.Add(url, "v2")
        }
        url = ccxt.Add(url, ccxt.Add("/", this.ImplodeParams(path, params)))
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(api, "private")) || ccxt.IsTrue(ccxt.IsEqual(api, "v2Private"))) {
            ...
            var payload interface{} = ccxt.Join([]interface{}{method, this.Hostname, url, auth}, "\n") // eslint-disable-line quotes
            var signature interface{} = this.Hmac(this.Encode(payload), this.Encode(this.Secret), ccxt.Sha256, "base64")
            auth = ccxt.Add(auth, ccxt.Add("&", this.Urlencode(map[string]interface{} {
    "Signature": signature,
})))
        ...
        url = ccxt.Add(this.ImplodeParams(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), api), map[string]interface{} {
    "hostname": this.Hostname,
        ...
        var hostnames interface{} = this.SafeValue(ccxt.GetValue(this.Urls, "hostnames"), typeVar)
        if ccxt.IsTrue(!ccxt.IsString(hostnames)) {
            hostnames = this.SafeValue(hostnames, levelOneNestedPath)
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsString(hostnames))) && ccxt.IsTrue((!ccxt.IsEqual(levelTwoNestedPath, nil)))) {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(access, "public")) {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "POST")) {
                ...
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(ccxt.GetIndexOf(path, "cancel"), ccxt.OpNeg(1))) && ccxt.IsTrue(ccxt.EndsWith(path, "order"))) {
                    // swap order placement
                    var channelCode interface{} = this.SafeString(params, "channel_code")
                    if ccxt.IsTrue(ccxt.IsEqual(channelCode, nil)) {
                        ccxt.AddElementToObject(params, "channel_code", id)
                    }
                } else if ccxt.IsTrue(ccxt.EndsWith(path, "orders/place")) {
                    // spot order placement
                    var clientOrderId interface{} = this.SafeString(params, "client-order-id")
                    if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                        ccxt.AddElementToObject(params, "client-order-id", ccxt.Add(id, this.Uuid()))
                    }
                }
            }
            var timestamp interface{} = this.Ymdhms(this.Nonce(), "T")
            ...
            var auth interface{} = ccxt.Replace(this.Urlencode(request, true), "%2c", "%2C") // in c# it manually needs to be uppercased
            // unfortunately, PHP demands double quotes for the escaped newline symbol
            var payload interface{} = ccxt.Join([]interface{}{method, hostname, url, auth}, "\n") // eslint-disable-line quotes
            var signature interface{} = this.Hmac(this.Encode(payload), this.Encode(this.Secret), ccxt.Sha256, "base64")
            auth = ccxt.Add(auth, ccxt.Add("&", this.Urlencode(map[string]interface{} {
    "Signature": signature,
})))
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "POST")) {
                body = this.Json(query)
                if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetArrayLength(body), 2)) {
                    body = "{}"
                }
                headers = map[string]interface{} {
                    "Content-Type": "application/json",
        ...
        url = ccxt.Add(this.ImplodeParams(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), typeVar), map[string]interface{} {
    "hostname": hostname,
}), url)
    }
    return map[string]interface{} {
...
func  (this *htx) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(response, "status")) {
        //
    ...
    if ccxt.IsTrue(ccxt.InOp(response, "code")) {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(errorsList, nil)) {
        ...
        var feedBack interface{} = ccxt.Add(ccxt.Add(this.Id, " "), body)
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errcode, feedBack)
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errmessage, feedBack)
    }
    return nil
}
/**
...
func  (this *htx) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_date", since)
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
                ccxt.AddElementToObject(request, "contract", ccxt.GetValue(market, "id"))
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                    ...
                    //
                    var marginMode interface{} = nil
                    __tmp734059 := this.HandleMarginModeAndParams("fetchFundingHistory", params)
                    marginMode = ccxt.GetValue(__tmp734059, 0)
                    params = ccxt.GetValue(__tmp734059, 1)
                    marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                    if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                        ccxt.AddElementToObject(request, "mar_acct", ccxt.GetValue(market, "id"))
                    } else {
                        ccxt.AddElementToObject(request, "mar_acct", ccxt.GetValue(market, "quoteId"))
                    }
...
func  (this *htx) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(marketType, "future")) && ccxt.IsTrue(ccxt.GetValue(market, "inverse"))) {
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "settleId"))
            } else {
                ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
            }
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                var marginMode interface{} = nil
                __tmp312126 := this.HandleMarginModeAndParams("setLeverage", params)
                marginMode = ccxt.GetValue(__tmp312126, 0)
                params = ccxt.GetValue(__tmp312126, 1)
                marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
                if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
...
func  (this *htx) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var percentage interface{} = ccxt.Precise.StringMul(this.SafeString(position, "profit_rate"), "100")
    var lastPrice interface{} = this.SafeString(position, "last_price")
    var faceValue interface{} = ccxt.Precise.StringMul(contracts, contractSizeString)
    ...
    var intialMarginPercentage interface{} = ccxt.Precise.StringDiv(initialMargin, notional)
    ...
    var maintenanceMarginPercentage interface{} = ccxt.Precise.StringDiv(adjustmentFactor, leverage)
    var maintenanceMargin interface{} = ccxt.Precise.StringMul(maintenanceMarginPercentage, notional)
    var marginRatio interface{} = ccxt.Precise.StringDiv(maintenanceMargin, collateral)
...
func  (this *htx) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marginMode interface{} = nil
            __tmp730376 := this.HandleMarginModeAndParams("fetchPositions", params, "cross")
            marginMode = ccxt.GetValue(__tmp730376, 0)
            params = ccxt.GetValue(__tmp730376, 1)
            var subType interface{} = nil
            __tmp706434 := this.HandleSubTypeAndParams("fetchPositions", market, params, "linear")
            subType = ccxt.GetValue(__tmp706434, 0)
            params = ccxt.GetValue(__tmp706434, 1)
            var marketType interface{} = nil
            __tmp126154 := this.HandleMarketTypeAndParams("fetchPositions", market, params)
            marketType = ccxt.GetValue(__tmp126154, 0)
            params = ccxt.GetValue(__tmp126154, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                marketType = "future"
            }
            var response interface{} = nil
            ...
            var result interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                var position interface{} = ccxt.GetValue(data, i)
                var parsed interface{} = this.ParsePosition(position)
                ccxt.AppendToArray(&result, this.Extend(parsed, map[string]interface{} {
                    "timestamp": timestamp,
                    "datetime": this.Iso8601(timestamp),
                }))
            }
...
func  (this *htx) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes79108)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
            __tmp253585 := this.HandleMarginModeAndParams("fetchPosition", params)
            marginMode = ccxt.GetValue(__tmp253585, 0)
            params = ccxt.GetValue(__tmp253585, 1)
            marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, nil))), "cross", marginMode)
            marketTypequeryVariable := this.HandleMarketTypeAndParams("fetchPosition", market, params);
            marketType := ccxt.GetValue(marketTypequeryVariable,0);
            query := ccxt.GetValue(marketTypequeryVariable,1)
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.GetValue(market, "future")) && ccxt.IsTrue(ccxt.GetValue(market, "inverse"))) {
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "settleId"))
            } else {
                if ccxt.IsTrue(ccxt.IsEqual(marginMode, "cross")) {
                    ccxt.AddElementToObject(request, "margin_account", "USDT") // only allowed value
                }
                ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
            }
            var response interface{} = nil
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.GetValue(market, "future")) && ccxt.IsTrue(ccxt.GetValue(market, "inverse"))) {
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(positions)); i++ {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(entry, "contract_code"), ccxt.GetValue(market, "id"))) {
                        position = entry
                        break
                    }
                }
...
func  (this *htx) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes82318)
            var paginate interface{} = false
            __tmp593877 := this.HandleOptionAndParams(params, "fetchLedger", "paginate")
            paginate = ccxt.GetValue(__tmp593877, 0)
            params = ccxt.GetValue(__tmp593877, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes823519 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 500))
                    ccxt.PanicOnError(retRes823519)
                    ch <- retRes823519
                    return nil
            }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // max 500
            }
            __tmp130432 := this.HandleUntilOption("endTime", request, params)
            request = ccxt.GetValue(__tmp130432, 0)
            params = ccxt.GetValue(__tmp130432, 1)
...
func  (this *htx) ParseMarketLeverageTiers(info interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(brackets)); i++ {
        var item interface{} = ccxt.GetValue(brackets, i)
        var leverage interface{} = this.SafeString(item, "lever_rate")
        var ladders interface{} = this.SafeList(item, "ladders", []interface{}{})
        for k := 0; ccxt.IsLessThan(k, ccxt.GetArrayLength(ladders)); k++ {
            var bracket interface{} = ccxt.GetValue(ladders, k)
            ...
            ccxt.AppendToArray(&tiers, map[string]interface{} {
                ...
                "maintenanceMarginRate": this.ParseNumber(ccxt.Precise.StringDiv(adjustFactor, leverage)),
...
func  (this *htx) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 3, map[string]interface{} {})
            _ = params
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(timeframe, "1h")) && ccxt.IsTrue(!ccxt.IsEqual(timeframe, "4h"))) && ccxt.IsTrue(!ccxt.IsEqual(timeframe, "12h"))) && ccxt.IsTrue(!ccxt.IsEqual(timeframe, "1d"))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchOpenInterestHistory cannot only use the 1h, 4h, 12h and 1d timeframe")))
            }
        
            retRes83888 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes83888)
            ...
            var request interface{} = map[string]interface{} {
                "period": ccxt.GetValue(timeframes, timeframe),
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "future")) {
                ccxt.AddElementToObject(request, "contract_type", this.SafeString(ccxt.GetValue(market, "info"), "contract_type"))
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "baseId")) // currency code on coin-m futures
                // coin-m futures
                response = (<-this.ContractPublicGetApiV1ContractHisOpenInterest(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                ccxt.AddElementToObject(request, "contract_type", "swap")
                ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
                ccxt.AddElementToObject(request, "contract_code", ccxt.GetValue(market, "id"))
                // USDT-M
...
func  (this *htx) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            var subType interface{} = nil
            __tmp892873 := this.HandleSubTypeAndParams("fetchPositions", market, params, "linear")
            subType = ccxt.GetValue(__tmp892873, 0)
            params = ccxt.GetValue(__tmp892873, 1)
            var marketType interface{} = nil
            __tmp122359 := this.HandleMarketTypeAndParams("fetchPositions", market, params)
            marketType = ccxt.GetValue(__tmp122359, 0)
            params = ccxt.GetValue(__tmp122359, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "future")) {
...
func  (this *htx) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "option")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOpenInterest() does not currently support option markets")))
            }
            var request interface{} = map[string]interface{} {
                "contract_code": ccxt.GetValue(market, "id"),
            }
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "future")) {
                ccxt.AddElementToObject(request, "contract_type", this.SafeString(ccxt.GetValue(market, "info"), "contract_type"))
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "baseId"))
                // COIN-M futures
                response = (<-this.ContractPublicGetApiV1ContractOpenInterest(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                ccxt.AddElementToObject(request, "contract_type", "swap")
            ...
            //
            var data interface{} = this.SafeValue(response, "data", []interface{}{})
            var openInterest interface{} = this.ParseOpenInterest(ccxt.GetValue(data, 0), market)
            var timestamp interface{} = this.SafeInteger(response, "ts")
            ccxt.AddElementToObject(openInterest, "timestamp", timestamp)
            ccxt.AddElementToObject(openInterest, "datetime", this.Iso8601(timestamp))
...
func  (this *htx) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(chains)); j++ {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(withdrawFeeType, "fixed")) {
...
func  (this *htx) ParseSettlements(settlements interface{}, market interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(settlements)); i++ {
        var settlement interface{} = ccxt.GetValue(settlements, i)
        var list interface{} = this.SafeValue(settlement, "list")
        if ccxt.IsTrue(!ccxt.IsEqual(list, nil)) {
            var timestamp interface{} = this.SafeInteger(settlement, "settlement_time")
            var timestampDetails interface{} = map[string]interface{} {
                "timestamp": timestamp,
                "datetime": this.Iso8601(timestamp),
            }
            for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(list)); j++ {
                var item interface{} = ccxt.GetValue(list, j)
                var parsedSettlement interface{} = this.ParseSettlement(item, market)
                ccxt.AppendToArray(&result, this.Extend(parsedSettlement, timestampDetails))
            }
        } else {
...
func  (this *htx) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp471453 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp471453, 0)
            params = ccxt.GetValue(__tmp471453, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ccxt.AddElementToObject(request, "contract", ccxt.GetValue(market, "id"))
                if ccxt.IsTrue(ccxt.GetValue(market, "linear")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchLiquidations() does not support "), ccxt.GetValue(market, "type")), " orders")))
            }
            //
            //     {
            //         "code": 200,
...
func  (this *htx) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes93788)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            if !ccxt.IsTrue(ccxt.GetValue(market, "contract")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " closePosition() symbol supports contract markets only")))
            }
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "inverse")) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(amount, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " closePosition () requires an extra argument params[\"amount\"] for inverse markets")))
                }
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "inverse")) {
                ...
                var marginMode interface{} = nil
                __tmp870376 := this.HandleMarginModeAndParams("closePosition", params, "cross")
                marginMode = ccxt.GetValue(__tmp870376, 0)
                params = ccxt.GetValue(__tmp870376, 1)
                if ccxt.IsTrue(ccxt.IsEqual(marginMode, "cross")) {
...
func  (this *htx) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes94328)
            var posMode interface{} = ccxt.Ternary(ccxt.IsTrue(hedged), "dual_side", "single_side")
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marginMode interface{} = nil
            __tmp962072 := this.HandleMarginModeAndParams("setPositionMode", params, "cross")
            marginMode = ccxt.GetValue(__tmp962072, 0)
            params = ccxt.GetValue(__tmp962072, 1)
            var request interface{} = map[string]interface{} {
                "position_mode": posMode,
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(market, nil))) && ccxt.IsTrue((ccxt.GetValue(market, "inverse")))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " setPositionMode can only be used for linear markets")))
            }
            if ccxt.IsTrue(ccxt.IsEqual(marginMode, "isolated")) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " setPositionMode requires a symbol argument for isolated margin mode")))
                }
                ccxt.AddElementToObject(request, "margin_account", ccxt.GetValue(market, "id"))
                response = (<-this.ContractPrivatePostLinearSwapApiV1SwapSwitchPositionMode(this.Extend(request, params)))
            } else {
                ccxt.AddElementToObject(request, "margin_account", "USDT")
