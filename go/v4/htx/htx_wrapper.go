 ...
 */
func (this *Htx) FetchTradingLimitsById(id string, options ...ccxt.FetchTradingLimitsByIdOptions) (map[string]interface{}, error) {

    opts := ccxt.FetchTradingLimitsByIdOptionsStruct{}
 ...
 * @returns {object[]} an array of objects representing market data
 */
func (this *Htx) FetchMarketsByTypeAndSubType(typeVar string, subType string, options ...ccxt.FetchMarketsByTypeAndSubTypeOptions) ([]map[string]interface{}, error) {

    opts := ccxt.FetchMarketsByTypeAndSubTypeOptionsStruct{}
...
func (this *Htx) FetchSpotOrderTrades(id string, options ...ccxt.FetchSpotOrderTradesOptions) ([]ccxt.Trade, error) {

    opts := ccxt.FetchSpotOrderTradesOptionsStruct{}
 ...
 * @returns {object} a dictionary of [account structures]{@link https://docs.ccxt.com/#/?id=account-structure} indexed by the account type
 */
func (this *Htx) FetchAccountIdByType(typeVar string, options ...ccxt.FetchAccountIdByTypeOptions) (map[string]interface{}, error) {

    opts := ccxt.FetchAccountIdByTypeOptionsStruct{}
...
func (this *Htx) FetchSpotOrdersByStates(states interface{}, options ...ccxt.FetchSpotOrdersByStatesOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchSpotOrdersByStatesOptionsStruct{}
...
func (this *Htx) FetchSpotOrders(options ...ccxt.FetchSpotOrdersOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchSpotOrdersOptionsStruct{}
...
func (this *Htx) FetchClosedSpotOrders(options ...ccxt.FetchClosedSpotOrdersOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchClosedSpotOrdersOptionsStruct{}
...
func (this *Htx) FetchContractOrders(options ...ccxt.FetchContractOrdersOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchContractOrdersOptionsStruct{}
...
func (this *Htx) FetchClosedContractOrders(options ...ccxt.FetchClosedContractOrdersOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchClosedContractOrdersOptionsStruct{}
...
func (this *Htx) CreateTrailingPercentOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingPercentOrderOptions) (ccxt.Order, error) {
    ...
    opts := ccxt.CreateTrailingPercentOrderOptionsStruct{}
 ...
 */
func (this *Htx) CreateSpotOrderRequest(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateSpotOrderRequestOptions) (map[string]interface{}, error) {

    opts := ccxt.CreateSpotOrderRequestOptionsStruct{}
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Htx) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Htx) CancelOrders(ids interface{}, options ...ccxt.CancelOrdersOptions) ([]map[string]interface{}, error) {
 ...
 */
func (this *Htx) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) ([]map[string]interface{}, error) {
...
func (this *Htx) FetchWithdrawAddresses(code string, options ...ccxt.FetchWithdrawAddressesOptions) ([]map[string]interface{}, error) {

    opts := ccxt.FetchWithdrawAddressesOptionsStruct{}
 ...
 */
func (this *Htx) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Htx) FetchSettlementHistory(options ...ccxt.FetchSettlementHistoryOptions) ([]map[string]interface{}, error) {
