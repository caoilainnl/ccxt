...
func  (this *apex) ParseBalance(response interface{}) interface{}  {
    ...
    ccxt.AddElementToObject(account, "free", this.SafeString(response, "availableBalance"))
    ccxt.AddElementToObject(account, "total", this.SafeString(response, "totalEquityValue"))
...
func  (this *apex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(rows)); i++ {
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(chains)); j++ {
                    ...
                    for f := 0; ccxt.IsLessThan(f, ccxt.GetArrayLength(tokens)); f++ {
                        var token interface{} = ccxt.GetValue(tokens, f)
                        var tokenName interface{} = this.SafeString(token, "token")
                        if ccxt.IsTrue(ccxt.IsEqual(tokenName, currencyId)) {
            ...
            "network": networkCode,
            "active": nil,
            "deposit": !ccxt.IsTrue(this.SafeBool(chain, "depositDisable")),
            ...
            "limits": map[string]interface{} {
                ...
                var networksLength interface{} =         ccxt.GetArrayLength(networkKeys)
                var emptyChains interface{} = ccxt.IsEqual(networksLength, 0) // non-functional coins
                var valueForEmpty interface{} = ccxt.Ternary(ccxt.IsTrue(emptyChains), false, nil)
...
func  (this *apex) ParseMarket(market interface{}) interface{}  {
    ...
    var symbol interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(baseId, "/"), quote), ":"), settle)
    ...
    return this.SafeMarketStructure(map[string]interface{} {
        ...
        "expiry": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(expiry, 0))), nil, expiry),
...
func  (this *apex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id2"),
            }
...
func  (this *apex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(request, "limit", limit) // max 200, default 200
            __tmp259276 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp259276, 0)
            params = ccxt.GetValue(__tmp259276, 1)
            ...
            ccxt.PanicOnError(response)
            var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
            var OHLCVs interface{} = this.SafeList(data, ccxt.GetValue(market, "id2"), []interface{}{})
...
func  (this *apex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(request, "limit", limit) // max 100, default 100
            ...
            var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
            var timestamp interface{} = this.Milliseconds()
            var orderbook interface{} = this.ParseOrderBook(data, ccxt.GetValue(market, "symbol"), timestamp, "b", "a")
            ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(data, "u"))
...
func  (this *apex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "beginTimeInclusive", since)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit)
            }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(endTimeExclusive, nil)) {
                ccxt.AddElementToObject(request, "endTimeExclusive", endTimeExclusive)
            }
...
func  (this *apex) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    return this.SafeOrder(map[string]interface{} {
        ...
        "fee": map[string]interface{} {
            ...
            "currency": ccxt.GetValue(market, "settleId"),
        },
        "info": order,
    }, market)
}
...
func  (this *apex) SafeMarket(optionalArgs ...interface{}) interface{}  {
    ...
    _ = marketType
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(market, nil)) && ccxt.IsTrue(!ccxt.IsEqual(marketId, nil))) {
        if ccxt.IsTrue(ccxt.InOp(this.Markets, marketId)) {
            market = ccxt.GetValue(this.Markets, marketId)
        } else if ccxt.IsTrue(ccxt.InOp(this.Markets_by_id, marketId)) {
            market = ccxt.GetValue(this.Markets_by_id, marketId)
        } else {
            var newMarketId interface{} = this.AddHyphenBeforeUsdt(marketId)
            if ccxt.IsTrue(ccxt.InOp(this.Markets_by_id, newMarketId)) {
                var markets interface{} = ccxt.GetValue(this.Markets_by_id, newMarketId)
                var numMarkets interface{} =                 ccxt.GetArrayLength(markets)
                if ccxt.IsTrue(ccxt.IsGreaterThan(numMarkets, 0)) {
                    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Markets_by_id, newMarketId), 0), "id2"), marketId)) {
                        market = ccxt.GetValue(ccxt.GetValue(this.Markets_by_id, newMarketId), 0)
                    }
                }
            }
        }
...
func  (this *apex) GenerateRandomClientIdOmni(_accountId interface{}) interface{}  {
    var accountId interface{} = ccxt.IsTrue(_accountId) || ccxt.IsTrue(ccxt.ToString(this.RandNumber(12)))
    return ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add("apexomni-", accountId), "-"), ccxt.ToString(this.Milliseconds())), "-"), ccxt.ToString(this.RandNumber(6)))
}
func  (this *apex) AddHyphenBeforeUsdt(symbol interface{}) interface{}  {
    var uppercaseSymbol interface{} = ccxt.ToUpper(symbol)
    var index interface{} = ccxt.GetIndexOf(uppercaseSymbol, "USDT")
    var symbolChar interface{} = this.SafeString(symbol, ccxt.Subtract(index, 1))
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsGreaterThan(index, 0)) && ccxt.IsTrue(!ccxt.IsEqual(symbolChar, "-"))) {
        return ccxt.Add(ccxt.Add(ccxt.Slice(symbol, 0, index), "-"), ccxt.Slice(symbol, index, nil))
    }
    return symbol
}
func  (this *apex) GetSeeds() interface{}  {
    var seeds interface{} = this.SafeString(this.Options, "seeds")
    if ccxt.IsTrue(ccxt.IsEqual(seeds, nil)) {
        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " the \"seeds\" key is required in the options to access private endpoints. You can find it in API Management > Omni Key, and then set it as exchange.options[\"seeds\"] = XXXX")))
    }
    return seeds
}
func  (this *apex) GetAccountId() <- chan interface{} {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(accountId, "0")) {
        
            accountData:= (<-this.FetchAccount())
            ccxt.PanicOnError(accountData)
            ccxt.AddElementToObject(this.Options, "accountId", this.SafeString(accountData, "id", "0"))
        }
        
        ch <- ccxt.GetValue(this.Options, "accountId")
        return nil
...
func  (this *apex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var limitFee interface{} = this.DecimalToPrecision(ccxt.Precise.StringAdd(ccxt.Precise.StringMul(ccxt.Precise.StringMul(orderPrice, orderSize), ccxt.ToString(taker)), ccxt.ToString(ccxt.GetValue(ccxt.GetValue(market, "precision"), "price"))), ccxt.TRUNCATE, ccxt.GetValue(ccxt.GetValue(market, "precision"), "price"), this.PrecisionMode, this.PaddingMode)
            ...
            if ccxt.IsTrue(ccxt.IsTrue(isMarket) && ccxt.IsTrue((ccxt.IsEqual(price, nil)))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() requires a price argument for market orders")))
            }
            ...
            var orderToSign interface{} = map[string]interface{} {
                ...
                "nonce": clientOrderId,
                "pairId": ccxt.GetValue(market, "quoteId"),
                "size": orderSize,
                "price": orderPrice,
                "direction": orderSide,
                "makerFeeRate": ccxt.ToString(maker),
                "takerFeeRate": ccxt.ToString(taker),
            }
        
            signature:= (<-this.GetZKContractSignatureObj(this.Remove0xPrefix(this.GetSeeds()), orderToSign))
            ccxt.PanicOnError(signature)
            var request interface{} = map[string]interface{} {
                ...
                "price": orderPrice,
                "limitFee": limitFee,
                "expiration": ccxt.MathFloor(ccxt.Add(ccxt.Divide(timeNow, 1000), ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(30, 24), 60), 60))),
...
func  (this *apex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(configResponse)
            ...
            ccxt.PanicOnError(accountResponse)
            ...
            if ccxt.IsTrue(ccxt.IsGreaterThan(ccxt.GetArrayLength(subAccounts), 0)) {
                nonce = this.SafeString(ccxt.GetValue(subAccounts, 0), "nonce", "0")
            }
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(fromAccount, nil)) && ccxt.IsTrue(ccxt.IsEqual(ccxt.ToLower(fromAccount), "contract"))) {
                assets = contractAssets
            } else {
                assets = spotAssets
            }
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(assets)); i++ {
                if ccxt.IsTrue(ccxt.IsEqual(this.SafeString(ccxt.GetValue(assets, i), "token", ""), code)) {
                    currency = ccxt.GetValue(assets, i)
                }
            }
            var tokenId interface{} = this.SafeString(currency, "tokenId", "")
            var amountNumber interface{} = this.ParseToInt(ccxt.Multiply(amount, (ccxt.MathPow(10, this.SafeNumber(currency, "decimals", 0)))))
            var timestampSeconds interface{} = this.ParseToInt(ccxt.Divide(this.Milliseconds(), 1000))
            var clientOrderId interface{} = this.SafeStringN(params, []interface{}{"clientId", "clientOrderId", "client_order_id"})
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(fromAccount, nil)) && ccxt.IsTrue(ccxt.IsEqual(ccxt.ToLower(fromAccount), "contract"))) {
                ...
                var zkSignAccountId interface{} = ccxt.Precise.StringMod(accountId, formattedUint32)
                var expireTime interface{} = ccxt.Add(timestampSeconds, ccxt.Multiply(ccxt.Multiply(3600, 24), 28))
                var orderToSign interface{} = map[string]interface{} {
                    ...
                    "tokenId": tokenId,
                    "amount": ccxt.ToString(amountNumber),
                    "fee": "0",
                    "nonce": clientOrderId,
...
func  (this *apex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var initialMarginRate interface{} = ccxt.Precise.StringDiv("1", leverageString, 4)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
...
func  (this *apex) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(this.PrecisionFromString(customInitialMarginRate), 0)) {
        leverage = this.ParseToInt(ccxt.Precise.StringDiv("1", customInitialMarginRate, 4))
    }
...
func  (this *apex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var signPath interface{} = ccxt.Add("/api/", path)
    var signBody interface{} = body
    if ccxt.IsTrue(!ccxt.IsEqual(ccxt.ToUpper(method), "POST")) {
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(params))) {
            signPath = ccxt.Add(signPath, ccxt.Add("?", this.Rawencode(params)))
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var messageString interface{} = ccxt.Add(ccxt.Add(timestamp, ccxt.ToUpper(method)), signPath)
        if ccxt.IsTrue(!ccxt.IsEqual(signBody, nil)) {
            messageString = ccxt.Add(messageString, signBody)
        }
        ...
        ccxt.AddElementToObject(headers, "APEX-SIGNATURE", signature)
        ccxt.AddElementToObject(headers, "APEX-API-KEY", this.ApiKey)
        ccxt.AddElementToObject(headers, "APEX-TIMESTAMP", timestamp)
        ccxt.AddElementToObject(headers, "APEX-PASSPHRASE", this.Password)
    }
    return map[string]interface{} {
        "url": url,
        "method": method,
...
func  (this *apex) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    //
    // {"code":3,"msg":"ccxt.Order price must be greater than 0. ccxt.Order price is 0.","key":"ORDER_PRICE_MUST_GREETER_ZERO","detail":{"price":"0"}}
    ...
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(errorCode, nil)) && ccxt.IsTrue(!ccxt.IsEqual(errorCode, 0))) {
        ...
        var status interface{} = ccxt.ToString(code)
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), status, feedback)
