...
func NewApexWsCore() apexWs {
   p := apexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *apexWs) Describe() interface{}  {
 ...
 */
func  (this *apexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 */
func  (this *apexWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *apexWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *apexWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // public
    //    {
    //         "T": 1672304486865,
 ...
 */
func  (this *apexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes20115 :=  (<-this.WatchOrderBookForSymbols([]interface{}{symbol}, limit, params))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *apexWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *apexWs) WatchTopics(url interface{}, messageHashes interface{}, topics interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes24615 :=  (<-this.WatchMultiple(url, messageHashes, message, messageHashes, nil))
                ccxt.PanicOnError(retRes24615)
                ch <- retRes24615
                return nil
...
func  (this *apexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *apexWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, 0, 1)
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *apexWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *apexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var topics interface{} = []interface{}{topic}
                ...
                retRes33915 :=  (<-this.WatchTopics(url, []interface{}{messageHash}, topics, params))
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *apexWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *apexWs) HandleTicker(client interface{}, message interface{})  {
 ...
 */
func  (this *apexWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *apexWs) WatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *apexWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *apexWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "start": 1670363160000,
    //         "end": 1670363219999,
 ...
 */
func  (this *apexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes5768 := (<-this.Authenticate(url))
 ...
 */
func  (this *apexWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes6068 := (<-this.Authenticate(url))
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *apexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes6418 := (<-this.Authenticate(url))
...
func  (this *apexWs) HandleMyTrades(client interface{}, lists interface{})  {
    // [
    //     {
    //         "symbol":"ETH-USDT",
    //         "side":"BUY",
...
func  (this *apexWs) HandleOrder(client interface{}, lists interface{})  {
    // [
    //     {
    //         "symbol":"ETH-USDT",
...
func  (this *apexWs) SetPositionsCache(client interface{}, optionalArgs ...interface{})  {
    symbols := ccxt.GetArg(optionalArgs, 0, nil)
    _ = symbols
...
func  (this *apexWs) LoadPositionsSnapshot(client interface{}, messageHash interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *apexWs) HandlePositions(client interface{}, lists interface{})  {
    //
    // [
    //     {
    //         "symbol":"ETH-USDT",
...
func  (this *apexWs) Authenticate(url interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes86715 :=  <-future.(<-chan interface{})
                ccxt.PanicOnError(retRes86715)
                ch <- retRes86715
                return nil
...
func  (this *apexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //   {
    //       "success": false,
    ...
    {		ret__ := func(this *apexWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *apexWs) interface{} {
    					// catch block:
...
func  (this *apexWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *apexWs) Ping(client interface{}) interface{}  {
    var timeStamp interface{} = ccxt.ToString(this.Milliseconds())
...
func  (this *apexWs) HandlePong(client interface{}, message interface{}) interface{}  {
    //
    //   {
    //       "success": true,
    //       "ret_msg": "pong",
...
func  (this *apexWs) HandleAccount(client interface{}, message interface{})  {
...
func  (this *apexWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "success": true,
    //        "ret_msg": '',
...
func  (this *apexWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "topic": "kline",
    //        "event": "sub",
...
func (this *apexWs) Init(userConfig map[string]interface{}) {
    this.apex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
