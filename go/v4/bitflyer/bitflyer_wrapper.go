 ...
 */
func (this *Bitflyer) FetchMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 */
func (this *Bitflyer) FetchBalance(params ...interface{}) (ccxt.Balances, error) {
 ...
 */
func (this *Bitflyer) FetchOrderBook(symbol string, options ...ccxt.FetchOrderBookOptions) (ccxt.OrderBook, error) {
 ...
 */
func (this *Bitflyer) FetchTicker(symbol string, options ...ccxt.FetchTickerOptions) (ccxt.Ticker, error) {
 ...
 */
func (this *Bitflyer) FetchTrades(symbol string, options ...ccxt.FetchTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Bitflyer) FetchTradingFee(symbol string, options ...ccxt.FetchTradingFeeOptions) (ccxt.TradingFeeInterface, error) {
 ...
 */
func (this *Bitflyer) CreateOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bitflyer) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Bitflyer) FetchOrders(options ...ccxt.FetchOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bitflyer) FetchOpenOrders(options ...ccxt.FetchOpenOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bitflyer) FetchClosedOrders(options ...ccxt.FetchClosedOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bitflyer) FetchOrder(id string, options ...ccxt.FetchOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Bitflyer) FetchMyTrades(options ...ccxt.FetchMyTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Bitflyer) FetchPositions(options ...ccxt.FetchPositionsOptions) ([]ccxt.Position, error) {
 ...
 */
func (this *Bitflyer) Withdraw(code string, amount float64, address string, options ...ccxt.WithdrawOptions) (ccxt.Transaction, error) {
 ...
 */
func (this *Bitflyer) FetchDeposits(options ...ccxt.FetchDepositsOptions) ([]ccxt.Transaction, error) {
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Bitflyer) FetchWithdrawals(options ...ccxt.FetchWithdrawalsOptions) ([]ccxt.Transaction, error) {
 ...
 */
func (this *Bitflyer) FetchFundingRate(symbol string, options ...ccxt.FetchFundingRateOptions) (ccxt.FundingRate, error) {
