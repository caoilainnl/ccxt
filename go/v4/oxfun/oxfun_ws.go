...
func NewOxfunWsCore() oxfunWs {
   p := oxfunWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *oxfunWs) Describe() interface{}  {
...
func  (this *oxfunWs) SubscribeMultiple(messageHashes interface{}, argsArray interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes7115 :=  (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, nil))
 ...
 */
func  (this *oxfunWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *oxfunWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         table: 'trade',
    //         data: [
...
func  (this *oxfunWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         side: 'SELL',
    //         quantity: '0.074',
 ...
 */
func  (this *oxfunWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(this.NewUpdates) {
                limit = ohlcvs.(ccxt.GetsLimit).GetLimit(symbol, limit)
            }
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *oxfunWs) WatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "candles60s",
    //         "data": [
...
func  (this *oxfunWs) ParseWsOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     [
    //         "1594313762698", //timestamp
    //         "9633.1",        //open
 ...
 */
func  (this *oxfunWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *oxfunWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "depth",
    //         "data": {
 ...
 */
func  (this *oxfunWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *oxfunWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "ticker",
    //         "data": [
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *oxfunWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleBidAsk(client interface{}, message interface{})  {
    //
    //     {
    //       "table": "bestBidAsk",
    //       "data": {
...
func  (this *oxfunWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
 ...
 */
func  (this *oxfunWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "balance",
    //         "accountId": "106464",
 ...
 */
func  (this *oxfunWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandlePositions(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "position",
    //         "accountId": "106464",
...
func  (this *oxfunWs) ParseWsPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "instrumentId": "ETH-USD-SWAP-LIN",
    //         "quantity": "0.01",
 ...
 */
func  (this *oxfunWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandleOrders(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "order",
    //         "data": [
 ...
 */
func  (this *oxfunWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *oxfunWs) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) HandlePlaceOrders(client interface{}, message interface{})  {
    //
    //     {
    //         "event": "placeorder",
    //         "submitted": true,
    ...
    if !ccxt.IsTrue(submitted) {
        ...
        this.HandleErrors(code, nil, client.(*ccxt.Client).Url, method, nil, stringMsg, message, nil, nil)
    }
 ...
 */
func  (this *oxfunWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *oxfunWs) CancelOrdersWs(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *oxfunWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes107015 :=  <-future.(<-chan interface{})
...
func  (this *oxfunWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
    var authenticated interface{} = this.SafeBool(message, "success", false)
    var messageHash interface{} = "authenticated"
    if ccxt.IsTrue(authenticated) {
        // we resolve the future here permanently so authentication only happens once
        var future interface{} = this.SafeDict(client.(*ccxt.Client).Futures, messageHash)
...
func  (this *oxfunWs) Ping(client interface{}) interface{}  {
    return "ping"
}
func  (this *oxfunWs) HandlePong(client interface{}, message interface{}) interface{}  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
    return message
}
func  (this *oxfunWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *oxfunWs) Init(userConfig map[string]interface{}) {
    this.oxfun.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
