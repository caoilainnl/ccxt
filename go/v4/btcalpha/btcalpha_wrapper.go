 ...
 */
func (this *Btcalpha) FetchMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 */
func (this *Btcalpha) FetchTickers(options ...ccxt.FetchTickersOptions) (ccxt.Tickers, error) {
 ...
 */
func (this *Btcalpha) FetchTicker(symbol string, options ...ccxt.FetchTickerOptions) (ccxt.Ticker, error) {
 ...
 */
func (this *Btcalpha) FetchOrderBook(symbol string, options ...ccxt.FetchOrderBookOptions) (ccxt.OrderBook, error) {
 ...
 */
func (this *Btcalpha) FetchTrades(symbol string, options ...ccxt.FetchTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Btcalpha) FetchDeposits(options ...ccxt.FetchDepositsOptions) ([]ccxt.Transaction, error) {
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Btcalpha) FetchWithdrawals(options ...ccxt.FetchWithdrawalsOptions) ([]ccxt.Transaction, error) {
 ...
 */
func (this *Btcalpha) FetchOHLCV(symbol string, options ...ccxt.FetchOHLCVOptions) ([]ccxt.OHLCV, error) {
 ...
 */
func (this *Btcalpha) FetchBalance(params ...interface{}) (ccxt.Balances, error) {
 ...
 */
func (this *Btcalpha) CreateOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Btcalpha) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Btcalpha) FetchOrder(id string, options ...ccxt.FetchOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Btcalpha) FetchOrders(options ...ccxt.FetchOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Btcalpha) FetchOpenOrders(options ...ccxt.FetchOpenOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Btcalpha) FetchClosedOrders(options ...ccxt.FetchClosedOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Btcalpha) FetchMyTrades(options ...ccxt.FetchMyTradesOptions) ([]ccxt.Trade, error) {
