...
func NewCexWsCore() cexWs {
   p := cexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *cexWs) Describe() interface{}  {
...
func  (this *cexWs) RequestId() interface{}  {
 ...
 */
func  (this *cexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *cexWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "get-balance",
    //         "data": {
 ...
 */
func  (this *cexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cexWs) HandleTradesSnapshot(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "history",
    //         "data": [
...
func  (this *cexWs) ParseWsOldTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //  snapshot trade
...
func  (this *cexWs) HandleTrade(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "history-update",
    //         "data": [
 ...
 */
func  (this *cexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *cexWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *cexWs) FetchTickerWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cexWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "tick",
    //         "data": {
...
func  (this *cexWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //  public
    //    {
    //        "symbol1": "LRC",
 ...
 * @returns {object} a [balance structure]{@link https://docs.ccxt.com/#/?id=balance-structure}
 */
func  (this *cexWs) FetchBalanceWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *cexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *cexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cexWs) HandleTransaction(client interface{}, message interface{})  {
...
func  (this *cexWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "tx",
    //         "data": {
...
func  (this *cexWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "d": "order:59091012956:a:BTC",
    //         "c": "user:up105393824:a:BTC",
...
func  (this *cexWs) HandleOrderUpdate(client interface{}, message interface{})  {
    //
    //  partialExecution
    //     {
    //         "e": "order",
...
func  (this *cexWs) ParseWsOrderUpdate(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //      {
    //          "id": "150714937",
    //          "remains": "1000000",
    ...
    var orderTime interface{} = this.SafeInteger(order, "time", this.Milliseconds())
    var timestamp interface{} = orderTime
    if ccxt.IsTrue(isTransaction) {
...
func  (this *cexWs) FromPrecision(amount interface{}, scale interface{}) interface{}  {
...
func  (this *cexWs) CurrencyFromPrecision(currency interface{}, amount interface{}) interface{}  {
...
func  (this *cexWs) HandleOrdersSnapshot(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "open-orders",
    //         "data": [{
 ...
 */
func  (this *cexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cexWs) HandleOrderBookSnapshot(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "order-book-subscribe",
    //         "data": {
...
func  (this *cexWs) PairToSymbol(pair interface{}) interface{}  {
...
func  (this *cexWs) HandleOrderBookUpdate(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "md_update",
    //         "data": {
...
func  (this *cexWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, 0, 1)
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *cexWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *cexWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cexWs) HandleInitOHLCV(client interface{}, message interface{})  {
    //
    //     {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(sorted)); i++ {
        stored.(ccxt.Appender).Append(this.ParseOHLCV(ccxt.GetValue(sorted, i), market))
    }
...
func  (this *cexWs) HandleOHLCV24(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "e": "ohlcv24",
...
func  (this *cexWs) HandleOHLCV1m(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "ohlcv1m",
    //         "data": {
...
func  (this *cexWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "ohlcv",
    //         "data": [
 ...
 */
func  (this *cexWs) FetchOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *cexWs) FetchOpenOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *cexWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/en/latest/manual.html#order-structure}
 */
func  (this *cexWs) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *cexWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *cexWs) CancelOrdersWs(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cexWs) ResolveData(client interface{}, message interface{})  {
    //
    //    "e": "open-orders",
    //    "data": [
    //       {
...
func  (this *cexWs) HandleConnected(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "e": "connected"
    //     }
...
func  (this *cexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    
    {		ret__ := func(this *cexWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *cexWs) interface{} {
    					// catch block:
                                var messageHash interface{} = this.SafeString(message, "oid")
    		...
    		// try block:
                    var data interface{} = this.SafeValue(message, "data", map[string]interface{} {})
            var err interface{} = this.SafeString(data, "error")
            var event interface{} = this.SafeString(message, "e", "")
            var feedback interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), event), " "), err)
...
func  (this *cexWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *cexWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "auth",
    //         "data": {
...
func  (this *cexWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var future interface{} = client.(ccxt.ClientInterface).Future("authenticated")
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes157412 := (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash))
                ccxt.PanicOnError(retRes157412)
            }
        
                retRes157615 :=  <-future.(<-chan interface{})
...
func (this *cexWs) Init(userConfig map[string]interface{}) {
    this.cex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
