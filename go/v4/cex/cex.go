    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            ...
            "broad": map[string]interface{} {
                ...
                "ccxt.Market Trigger orders are not allowed": ccxt.BadRequest,
...
func  (this *cex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AppendToArray(&promises, this.PublicPostGetCurrenciesInfo(params))
            //
            //    {
            //        "ok": "ok",
            //        "data": [
            ...
            //            ...
            //
            ccxt.AppendToArray(&promises, this.PublicPostGetProcessingInfo(params))
            //
            //    {
            //        "ok": "ok",
            //        "data": {
            ...
            var dataCurrencies interface{} = this.SafeList(ccxt.GetValue(responses, 0), "data", []interface{}{})
            var dataNetworks interface{} = this.SafeDict(ccxt.GetValue(responses, 1), "data", map[string]interface{} {})
...
func  (this *cex) ParseCurrency(rawCurrency interface{}) interface{}  {
    ...
    var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue(this.SafeBool(rawCurrency, "fiat")), "fiat", "crypto")
    ...
    var keys interface{} = ccxt.ObjectKeys(rawNetworks)
    for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(keys)); j++ {
        var networkId interface{} = ccxt.GetValue(keys, j)
        var rawNetwork interface{} = ccxt.GetValue(rawNetworks, networkId)
        var networkCode interface{} = this.NetworkIdToCode(networkId)
        var deposit interface{} = ccxt.IsEqual(this.SafeString(rawNetwork, "deposit"), "enabled")
        var withdraw interface{} = ccxt.IsEqual(this.SafeString(rawNetwork, "withdrawal"), "enabled")
...
func  (this *cex) ParseMarket(market interface{}) interface{}  {
    ...
    var id interface{} = ccxt.Add(ccxt.Add(base, "-"), quote) // not actual id, but for this exchange we can use this abbreviation, because e.g. tickers have hyphen in between
...
func  (this *cex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ccxt.AddElementToObject(request, "pairs", this.MarketIds(symbols))
            }
...
func  (this *cex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "fromDateISO", this.Iso8601(since))
            }
            var until interface{} = nil
            __tmp473136 := this.HandleParamInteger2(params, "until", "till")
            until = ccxt.GetValue(__tmp473136, 0)
            params = ccxt.GetValue(__tmp473136, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "toDateISO", this.Iso8601(until))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "pageSize", ccxt.MathMin(limit, 10000)) // has a bug, still returns more trades
            }
...
func  (this *cex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp911177 := this.HandleOptionAndParams(params, "fetchOHLCV", "dataType")
            dataType = ccxt.GetValue(__tmp911177, 0)
            params = ccxt.GetValue(__tmp911177, 1)
            if ccxt.IsTrue(ccxt.IsEqual(dataType, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOHLCV requires a parameter \"dataType\" to be either \"bestBid\" or \"bestAsk\"")))
            }
            ...
            var request interface{} = map[string]interface{} {
                "pair": ccxt.GetValue(market, "id"),
                "resolution": ccxt.GetValue(this.Timeframes, timeframe),
                "dataType": dataType,
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "fromISO", this.Iso8601(since))
            }
            var until interface{} = nil
            __tmp619715 := this.HandleParamInteger2(params, "until", "till")
            until = ccxt.GetValue(__tmp619715, 0)
            params = ccxt.GetValue(__tmp619715, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "toISO", this.Iso8601(until))
            } else if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                // exchange still requires that we provide one of them
                ccxt.AddElementToObject(request, "toISO", this.Iso8601(this.Milliseconds()))
            }
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(since, nil)) && ccxt.IsTrue(!ccxt.IsEqual(until, nil))) && ccxt.IsTrue(!ccxt.IsEqual(limit, nil))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOHLCV does not support fetching candles with both a limit and since/until")))
            } else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue(!ccxt.IsEqual(since, nil)) || ccxt.IsTrue(!ccxt.IsEqual(until, nil)))) && ccxt.IsTrue(ccxt.IsEqual(limit, nil))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOHLCV requires a limit parameter when fetching candles with since or until")))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
...
func  (this *cex) ParseTradingFees(response interface{}, optionalArgs ...interface{}) interface{}  {
    useKeyAsId := ccxt.GetArg(optionalArgs, 0, false)
    _ = useKeyAsId
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
        ...
        if ccxt.IsTrue(useKeyAsId) {
            market = this.SafeMarket(key)
        }
        var parsed interface{} = this.ParseTradingFee(ccxt.GetValue(response, key), market)
        ccxt.AddElementToObject(result, ccxt.GetValue(parsed, "symbol"), parsed)
    }
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Symbols)); i++ {
        var symbol interface{} = ccxt.GetValue(this.Symbols, i)
        if !ccxt.IsTrue((ccxt.InOp(result, symbol))) {
            var market interface{} = this.Market(symbol)
...
func  (this *cex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp797651 := this.HandleParamString(params, "account", "")
            accountName = ccxt.GetValue(__tmp797651, 0)
            params = ccxt.GetValue(__tmp797651, 1) // default is empty string
            var method interface{} = nil
            __tmp478628 := this.HandleParamString(params, "method", "privatePostGetMyWalletBalance")
            method = ccxt.GetValue(__tmp478628, 0)
            params = ccxt.GetValue(__tmp478628, 1)
            var accountBalance interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(method, "privatePostGetMyAccountStatusV3")) {
...
func  (this *cex) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            var isClosedOrders interface{} =     (ccxt.IsEqual(status, "closed"))
            if ccxt.IsTrue(isClosedOrders) {
                ccxt.AddElementToObject(request, "archived", true)
            }
            var market interface{} = nil
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "serverCreateTimestampFrom", since)
            } else if ccxt.IsTrue(isClosedOrders) {
                // exchange requires a `since` parameter for closed orders, so set default to allowed 365
                ccxt.AddElementToObject(request, "serverCreateTimestampFrom", ccxt.Subtract(this.Milliseconds(), ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(364, 24), 60), 60), 1000)))
            }
            var until interface{} = nil
            __tmp367127 := this.HandleParamInteger2(params, "until", "till")
            until = ccxt.GetValue(__tmp367127, 0)
            params = ccxt.GetValue(__tmp367127, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "serverCreateTimestampTo", until)
            }
...
func  (this *cex) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(currency1, nil)) && ccxt.IsTrue(!ccxt.IsEqual(currency2, nil))) {
        marketId = ccxt.Add(ccxt.Add(currency1, "-"), currency2)
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeAmount, nil)) {
        ...
        ccxt.AddElementToObject(fee, "currency", feeCode)
        ccxt.AddElementToObject(fee, "cost", feeAmount)
    }
...
func  (this *cex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp727864 := this.HandleOptionAndParams(params, "createOrder", "accountId")
            accountId = ccxt.GetValue(__tmp727864, 0)
            params = ccxt.GetValue(__tmp727864, 1)
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() : API trading is now allowed from main account, set params[\"accountId\"] or .options[\"createOrder\"][\"accountId\"] to the name of your sub-account")))
            }
            ...
            var request interface{} = map[string]interface{} {
                ...
                "currency1": ccxt.GetValue(market, "baseId"),
                "currency2": ccxt.GetValue(market, "quoteId"),
                "accountId": accountId,
                "orderType": this.Capitalize(ccxt.ToLower(typeVar)),
                "side": ccxt.ToUpper(side),
                "timestamp": this.Milliseconds(),
                "amountCcy1": this.AmountToPrecision(symbol, amount),
            }
            var timeInForce interface{} = nil
            __tmp468048 := this.HandleOptionAndParams(params, "createOrder", "timeInForce", "GTC")
            timeInForce = ccxt.GetValue(__tmp468048, 0)
            params = ccxt.GetValue(__tmp468048, 1)
            ...
            __tmp959425 := this.HandleParamString(params, "triggerPrice")
            triggerPrice = ccxt.GetValue(__tmp959425, 0)
            params = ccxt.GetValue(__tmp959425, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
                ccxt.AddElementToObject(request, "type", "Stop ccxt.Limit")
...
func  (this *cex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "orderId": ccxt.ParseInt(id),
                "cancelRequestId": ccxt.Add("c_", ccxt.ToString((this.Milliseconds()))),
                "timestamp": this.Milliseconds(),
            }
...
func  (this *cex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "dateFrom", since)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "pageSize", limit)
            }
            var until interface{} = nil
            __tmp745347 := this.HandleParamInteger2(params, "until", "till")
            until = ccxt.GetValue(__tmp745347, 0)
            params = ccxt.GetValue(__tmp745347, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "dateTo", until)
            }
...
func  (this *cex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var until interface{} = nil
            __tmp17321 := this.HandleParamInteger2(params, "until", "till")
            until = ccxt.GetValue(__tmp17321, 0)
            params = ccxt.GetValue(__tmp17321, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "dateTo", until)
            }
...
func  (this *cex) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(direction, "withdraw"))), "withdrawal", "deposit")
    var code interface{} = this.SafeCurrencyCode(currencyId, currency)
...
func  (this *cex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(toAccount, "")) && ccxt.IsTrue(!ccxt.IsEqual(fromAccount, ""))) {
...
func  (this *cex) TransferBetweenMainAndSubAccount(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var fromMain interface{} =     (ccxt.IsEqual(fromAccount, ""))
            var targetAccount interface{} = ccxt.Ternary(ccxt.IsTrue(fromMain), toAccount, fromAccount)
...
func  (this *cex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var accountId interface{} = nil
            __tmp575922 := this.HandleOptionAndParams(params, "createOrder", "accountId")
            accountId = ccxt.GetValue(__tmp575922, 0)
            params = ccxt.GetValue(__tmp575922, 1)
            if ccxt.IsTrue(ccxt.IsEqual(accountId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchDepositAddress() : main account is not allowed to fetch deposit address from api, set params[\"accountId\"] or .options[\"createOrder\"][\"accountId\"] to the name of your sub-account")))
            }
        
            retRes17298 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes17298)
            var networkCode interface{} = nil
            __tmp90797 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp90797, 0)
            params = ccxt.GetValue(__tmp90797, 1)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "accountId": accountId,
                "currency": ccxt.GetValue(currency, "id"),
...
func  (this *cex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        var seconds interface{} = ccxt.ToString(this.Seconds())
        body = this.Json(query)
        var auth interface{} = ccxt.Add(ccxt.Add(path, seconds), body)
...
func  (this *cex) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(response, nil)) {
        if ccxt.IsTrue(ccxt.IsEqual(body, nil)) {
            panic(ccxt.NullResponse(ccxt.Add(this.Id, " returned empty response")))
        } else if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(body, 0), "{")) {
            var fixed interface{} = this.FixStringifiedJsonMembers(body)
            response = this.ParseJson(fixed)
        } else {
            panic(ccxt.NullResponse(ccxt.Add(ccxt.Add(this.Id, " returned unparsed response: "), body)))
        }
    }
    ...
    if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(url, "do_my_new_order"), 0)) {
        var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
        var rejectReason interface{} = this.SafeString(data, "rejectReason")
        if ccxt.IsTrue(!ccxt.IsEqual(rejectReason, nil)) {
            this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), rejectReason, rejectReason)
            panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " createOrder() "), rejectReason)))
        }
    }
    return nil
}
