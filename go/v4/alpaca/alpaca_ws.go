...
func NewAlpacaWsCore() alpacaWs {
   p := alpacaWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *alpacaWs) Describe() interface{}  {
 ...
 */
func  (this *alpacaWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628 := (<-this.Authenticate(url))
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes7015 :=  (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash))
...
func  (this *alpacaWs) HandleTicker(client interface{}, message interface{})  {
    //
    //    {
    //         "T": "q",
    //         "S": "BTC/USDT",
...
func  (this *alpacaWs) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //         "T": "q",
    //         "S": "BTC/USDT",
 ...
 */
func  (this *alpacaWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes1448 := (<-this.Authenticate(url))
...
func  (this *alpacaWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //    {
    //        "T": "b",
    //        "S": "BTC/USDT",
 ...
 */
func  (this *alpacaWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes2018 := (<-this.Authenticate(url))
...
func  (this *alpacaWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // snapshot
    //    {
    //        "T": "o",
...
func  (this *alpacaWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, "p", "s")
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *alpacaWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *alpacaWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes2858 := (<-this.Authenticate(url))
...
func  (this *alpacaWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "T": "t",
    //         "S": "BTC/USDT",
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
 */
func  (this *alpacaWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes3418 := (<-this.Authenticate(url))
 ...
 */
func  (this *alpacaWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes3738 := (<-this.Authenticate(url))
...
func  (this *alpacaWs) HandleTradeUpdate(client interface{}, message interface{})  {
    this.HandleOrder(client, message)
    this.HandleMyTrade(client, message)
}
func  (this *alpacaWs) HandleOrder(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *alpacaWs) HandleMyTrade(client interface{}, message interface{})  {
    //
    //    {
    //        "stream": "trade_updates",
    //        "data": {
...
func  (this *alpacaWs) ParseMyTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "id": "c2470331-8993-4051-bf5d-428d5bdc9a48",
    //        "client_order_id": "0f1f3764-107a-4d09-8b9a-d75a11738f5c",
...
func  (this *alpacaWs) Authenticate(url interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes61115 :=  <-future.(<-chan interface{})
                ccxt.PanicOnError(retRes61115)
                ch <- retRes61115
                return nil
...
func  (this *alpacaWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "T": "error",
    //        "code": 400,
...
func  (this *alpacaWs) HandleConnected(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "T": "success",
    //        "msg": "connected"
...
func  (this *alpacaWs) HandleCryptoMessage(client interface{}, message interface{})  {
...
func  (this *alpacaWs) HandleTradingMessage(client interface{}, message interface{})  {
...
func  (this *alpacaWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *alpacaWs) HandleAuthenticate(client interface{}, message interface{})  {
    //
    // crypto
    //    {
    //        "T": "success",
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(T, "success")) || ccxt.IsTrue(ccxt.IsEqual(status, "authorized"))) {
        var promise interface{} = ccxt.GetValue(client.(*ccxt.Client).Futures, "authenticated")
...
func  (this *alpacaWs) HandleSubscription(client interface{}, message interface{}) interface{}  {
    //
    // crypto
    //    {
    //          "T": "subscription",
...
func (this *alpacaWs) Init(userConfig map[string]interface{}) {
    this.alpaca.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
