    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "40410000": ccxt.InvalidOrder,
                "40010001": ccxt.BadRequest,
                "40110000": ccxt.PermissionDenied,
                "40310000": ccxt.InsufficientFunds,
                "42910000": ccxt.RateLimitExceeded,
            },
            "broad": map[string]interface{} {
                "Invalid format for parameter": ccxt.BadRequest,
...
func  (this *alpaca) FetchTime(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var localTime interface{} = ccxt.Slice(timestamp, 0, 23)
            var jetlagStrStart interface{} = ccxt.Subtract(ccxt.GetLength(timestamp), 6)
            var jetlagStrEnd interface{} = ccxt.Subtract(ccxt.GetLength(timestamp), 3)
            var jetlag interface{} = ccxt.Slice(timestamp, jetlagStrStart, jetlagStrEnd)
            var iso interface{} = ccxt.Subtract(this.Parse8601(localTime), ccxt.Multiply(ccxt.Multiply(this.ParseToNumeric(jetlag), 3600), 1000))
...
func  (this *alpaca) ParseMarket(asset interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(quote, nil)) && ccxt.IsTrue(ccxt.IsEqual(assetClass, "us_equity"))) {
        quote = "USD"
    }
    var symbol interface{} = ccxt.Add(ccxt.Add(base, "/"), quote)
    var status interface{} = this.SafeString(asset, "status")
    var active interface{} =     (ccxt.IsEqual(status, "active"))
...
func  (this *alpaca) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "marketPublicGetV1beta3CryptoLocTrades")) {
            ...
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "marketPublicGetV1beta3CryptoLocLatestTrades")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchTrades() does not support "), method), ", marketPublicGetV1beta3CryptoLocTrades and marketPublicGetV1beta3CryptoLocLatestTrades are supported")))
            }
...
func  (this *alpaca) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseOrderBook(rawOrderbook, ccxt.GetValue(market, "symbol"), timestamp, "b", "a", "p", "s")
            return nil
...
func  (this *alpaca) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "marketPublicGetV1beta3CryptoLocBars")) {
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "limit", limit)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(request, "start", this.Yyyymmdd(since))
                }
                ccxt.AddElementToObject(request, "timeframe", this.SafeString(this.Timeframes, timeframe, timeframe))
            ...
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "marketPublicGetV1beta3CryptoLocLatestBars")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOHLCV() does not support "), method), ", marketPublicGetV1beta3CryptoLocBars and marketPublicGetV1beta3CryptoLocLatestBars are supported")))
            }
...
func  (this *alpaca) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchTickers() requires a symbols argument")))
            }
            ...
            var marketIds interface{} = ccxt.ObjectKeys(snapshots)
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketIds)); i++ {
                ...
                ccxt.AppendToArray(&results, ticker)
            }
...
func  (this *alpaca) GenerateClientOrderId(params interface{}) interface{}  {
    ...
    var parts interface{} = ccxt.Split(uuid, "-")
    var random_id interface{} = ccxt.Join(parts, "")
...
func  (this *alpaca) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "limit"), 0)) {
                    ...
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() does not support stop orders for "), typeVar), " orders, only stop_limit orders are supported")))
                }
                ccxt.AddElementToObject(request, "stop_price", this.PriceToPrecision(symbol, triggerPrice))
                ccxt.AddElementToObject(request, "type", newType)
            }
            if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "limit"), 0)) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
                ...
                ccxt.AddElementToObject(request, "notional", this.CostToPrecision(symbol, cost))
            } else {
                ccxt.AddElementToObject(request, "qty", this.AmountToPrecision(symbol, amount))
            }
            var defaultTIF interface{} = this.SafeString(this.Options, "defaultTimeInForce")
            ccxt.AddElementToObject(request, "time_in_force", this.SafeString(params, "timeInForce", defaultTIF))
            params = this.Omit(params, []interface{}{"timeInForce", "triggerPrice"})
            ccxt.AddElementToObject(request, "client_order_id", this.GenerateClientOrderId(params))
...
func  (this *alpaca) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "after", this.Iso8601(since))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit)
            }
...
func  (this *alpaca) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes128215)
                ch <- retRes128215
                return nil
...
func  (this *alpaca) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes130115)
                ch <- retRes130115
                return nil
...
func  (this *alpaca) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp813375 := this.HandleOptionAndParams2(params, "editOrder", "timeInForce", "defaultTimeInForce")
            timeInForce = ccxt.GetValue(__tmp813375, 0)
            params = ccxt.GetValue(__tmp813375, 1)
...
func  (this *alpaca) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(orderType, nil)) {
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(orderType, "limit"), 0)) {
...
func  (this *alpaca) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                params = this.Omit(params, "until")
                ccxt.AddElementToObject(request, "until", this.Iso8601(until))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "after", this.Iso8601(since))
            }
            ...
            __tmp865201 := this.HandleUntilOption("until", request, params)
            request = ccxt.GetValue(__tmp865201, 0)
            params = ccxt.GetValue(__tmp865201, 1)
...
func  (this *alpaca) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(alpacaSide, "B")) {
        side = "buy"
    } else if ccxt.IsTrue(ccxt.IsEqual(alpacaSide, "S")) {
        side = "sell"
    }
...
func  (this *alpaca) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(currency, nil)) {
        parsedCurrency = ccxt.GetValue(currency, "id")
    }
    return map[string]interface{} {
        "info": depositAddress,
...
func  (this *alpaca) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp181041 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp181041, 0)
            params = ccxt.GetValue(__tmp181041, 1)
...
func  (this *alpaca) FetchTransactionsHelper(typeVar interface{}, code interface{}, since interface{}, limit interface{}, params interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(direction, typeVar)) {
                    ccxt.AppendToArray(&results, entry)
                } else if ccxt.IsTrue(ccxt.IsEqual(typeVar, "BOTH")) {
                    ccxt.AppendToArray(&results, entry)
                }
            }
...
func  (this *alpaca) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes171715)
                ch <- retRes171715
                return nil
...
func  (this *alpaca) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes173215)
                ch <- retRes173215
                return nil
...
func  (this *alpaca) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes174715)
                ch <- retRes174715
                return nil
...
func  (this *alpaca) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var totalFee interface{} = ccxt.Precise.StringAdd(fees, networkFee)
...
func  (this *alpaca) ParseBalance(response interface{}) interface{}  {
    ...
    ccxt.AddElementToObject(account, "free", this.SafeString(response, "cash"))
    ccxt.AddElementToObject(account, "total", this.SafeString(response, "equity"))
...
func  (this *alpaca) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var url interface{} = this.ImplodeHostname(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), ccxt.GetValue(api, 0)))
    headers = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(headers, nil))), headers, map[string]interface{} {})
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(api, 1), "private")) {
        this.CheckRequiredCredentials()
        ccxt.AddElementToObject(headers, "APCA-API-KEY-ID", this.ApiKey)
        ccxt.AddElementToObject(headers, "APCA-API-SECRET-KEY", this.Secret)
    }
