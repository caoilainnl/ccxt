    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "broad": map[string]interface{} {
                ...
                "ccxt.Error 1001 - ccxt.Order rejected. ccxt.Order could not be submitted as this order was set to a post only order.": ccxt.OrderImmediatelyFillable,
            },
        ...
        "options": map[string]interface{} {
            "api-expires": this.ParseToInt(ccxt.Divide(this.Timeout, 1000)),
...
func  (this *hollaex) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var keys interface{} = ccxt.ObjectKeys(pairs)
            var result interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                var key interface{} = ccxt.GetValue(keys, i)
                var market interface{} = ccxt.GetValue(pairs, key)
                var baseId interface{} = this.SafeString(market, "pair_base")
                var quoteId interface{} = this.SafeString(market, "pair_2")
                var base interface{} = this.CommonCurrencyCode(ccxt.ToUpper(baseId))
                var quote interface{} = this.CommonCurrencyCode(ccxt.ToUpper(quoteId))
...
func  (this *hollaex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var keys interface{} = ccxt.ObjectKeys(coins)
            var result interface{} = map[string]interface{} {}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                var key interface{} = ccxt.GetValue(keys, i)
                var currency interface{} = ccxt.GetValue(coins, key)
                ...
                var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(rawType, "blockchain"))), "crypto", "other")
                var rawNetworks interface{} = this.SafeDict(currency, "withdrawal_fees", map[string]interface{} {})
                var networks interface{} = map[string]interface{} {}
                var networkIds interface{} = ccxt.ObjectKeys(rawNetworks)
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(networkIds)); j++ {
                    var networkId interface{} = ccxt.GetValue(networkIds, j)
...
func  (this *hollaex) FetchOrderBooks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketIds)); i++ {
                ...
                ccxt.AddElementToObject(result, symbol, this.ParseOrderBook(ccxt.GetValue(response, marketId), symbol, timestamp))
            }
...
func  (this *hollaex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            //     }
            //
            var orderbook interface{} = this.SafeValue(response, ccxt.GetValue(market, "id"))
            var timestamp interface{} = this.Parse8601(this.SafeString(orderbook, "timestamp"))
...
func  (this *hollaex) ParseTickers(tickers interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
        var key interface{} = ccxt.GetValue(keys, i)
        var ticker interface{} = ccxt.GetValue(tickers, key)
        var marketId interface{} = this.SafeString(ticker, "symbol", key)
        var market interface{} = this.SafeMarket(marketId, nil, "-")
        var symbol interface{} = ccxt.GetValue(market, "symbol")
        ccxt.AddElementToObject(result, symbol, this.Extend(this.ParseTicker(ticker, market), params))
    }
...
func  (this *hollaex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            //     }
            //
            var trades interface{} = this.SafeList(response, ccxt.GetValue(market, "id"), []interface{}{})
...
func  (this *hollaex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Symbols)); i++ {
                ...
                var market interface{} = this.Market(symbol)
                var makerString interface{} = this.SafeString(makerFees, ccxt.GetValue(market, "id"))
                var takerString interface{} = this.SafeString(takerFees, ccxt.GetValue(market, "id"))
...
func  (this *hollaex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp157120 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate", paginate)
            paginate = ccxt.GetValue(__tmp157120, 0)
            params = ccxt.GetValue(__tmp157120, 1)
            if ccxt.IsTrue(paginate) {
                    ...
                    ccxt.PanicOnError(retRes93219)
                    ch <- retRes93219
                    return nil
            }
            var until interface{} = this.SafeInteger(params, "until")
            var timeDelta interface{} = ccxt.Multiply(ccxt.Multiply(this.ParseTimeframe(timeframe), maxLimit), 1000)
            var start interface{} = since
            var now interface{} = this.Milliseconds()
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(until, nil)) && ccxt.IsTrue(ccxt.IsEqual(start, nil))) {
                until = now
                start = ccxt.Subtract(until, timeDelta)
            ...
            } else if ccxt.IsTrue(ccxt.IsEqual(start, nil)) {
                start = ccxt.Subtract(until, timeDelta)
            }
            ccxt.AddElementToObject(request, "from", this.ParseToInt(ccxt.Divide(start, 1000))) // convert to seconds
            ccxt.AddElementToObject(request, "to", this.ParseToInt(ccxt.Divide(until, 1000))) // convert to seconds
...
func  (this *hollaex) ParseBalance(response interface{}) interface{}  {
    ...
    var currencyIds interface{} = ccxt.ObjectKeys(this.Currencies_by_id)
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencyIds)); i++ {
        ...
        ccxt.AddElementToObject(account, "free", this.SafeString(response, ccxt.Add(currencyId, "_available")))
        ccxt.AddElementToObject(account, "total", this.SafeString(response, ccxt.Add(currencyId, "_balance")))
...
func  (this *hollaex) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default 50, max 100
            }
...
func  (this *hollaex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
                ccxt.AddElementToObject(request, "stop", this.PriceToPrecision(symbol, triggerPrice))
            }
            if ccxt.IsTrue(postOnly) {
                ccxt.AddElementToObject(request, "meta", map[string]interface{} {
            "post_only": true,
        })
            }
...
func  (this *hollaex) FetchDepositAddresses(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var addresses interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(network, nil))), wallet, this.FilterBy(wallet, "network", network))
...
func  (this *hollaex) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(status) {
        status = "ok"
    } else if ccxt.IsTrue(dismissed) {
        status = "canceled"
    } else if ccxt.IsTrue(rejected) {
        status = "failed"
    } else {
        status = "pending"
    }
...
func  (this *hollaex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp573919 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp573919, 0)
            params = ccxt.GetValue(__tmp573919, 1)
            this.CheckAddress(address)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                address = ccxt.Add(address, ccxt.Add(":", tag))
            }
            var network interface{} = this.SafeString(params, "network")
...
func  (this *hollaex) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(allowWithdrawal) {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(withdrawalFees, nil)) {
        var keys interface{} = ccxt.ObjectKeys(withdrawalFees)
        var keysLength interface{} =         ccxt.GetArrayLength(keys)
        for i := 0; ccxt.IsLessThan(i, keysLength); i++ {
            var key interface{} = ccxt.GetValue(keys, i)
            var value interface{} = ccxt.GetValue(withdrawalFees, key)
            ...
            var networkCodeUpper interface{} = ccxt.ToUpper(networkCode) // default to the upper case network code
            var withdrawalFee interface{} = this.SafeNumber(value, "value")
            ccxt.AddElementToObject(ccxt.GetValue(result, "networks"), networkCodeUpper, map[string]interface{} {
    "deposit": nil,
...
func  (this *hollaex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    path = ccxt.Add(ccxt.Add(ccxt.Add("/", this.Version), "/"), this.ImplodeParams(path, params))
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(method, "GET"))) || ccxt.IsTrue((ccxt.IsEqual(method, "DELETE")))) {
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            path = ccxt.Add(path, ccxt.Add("?", this.Urlencode(query)))
        }
    }
    var url interface{} = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "rest"), path)
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        this.CheckRequiredCredentials()
        var defaultExpires interface{} = this.SafeInteger2(this.Options, "api-expires", "expires", this.ParseToInt(ccxt.Divide(this.Timeout, 1000)))
        var expires interface{} = this.Sum(this.Seconds(), defaultExpires)
        var expiresString interface{} = ccxt.ToString(expires)
        var auth interface{} = ccxt.Add(ccxt.Add(method, path), expiresString)
        ...
        ccxt.AddElementToObject(headers, "api-signature", signature)
    }
    return map[string]interface{} {
        "url": url,
        "method": method,
...
func  (this *hollaex) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsGreaterThanOrEqual(code, 400))) && ccxt.IsTrue((ccxt.IsLessThanOrEqual(code, 503)))) {
        //
        //  { "message": "Invalid token" }
        //
        // different errors return the same code eg
        //
        //  { "message":"ccxt.Error 1001 - ccxt.Order rejected. ccxt.Order could not be submitted as this order was set to a post only order." }
        //
        //  { "message":"ccxt.Error 1001 - POST ONLY order can not be of type market" }
        //
