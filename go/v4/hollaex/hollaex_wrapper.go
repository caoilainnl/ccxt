 ...
 */
func (this *Hollaex) FetchOpenOrder(id string, options ...ccxt.FetchOpenOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Hollaex) FetchWithdrawal(id string, options ...ccxt.FetchWithdrawalOptions) (ccxt.Transaction, error) {
