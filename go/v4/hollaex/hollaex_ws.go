...
func NewHollaexWsCore() hollaexWs {
   p := hollaexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *hollaexWs) Describe() interface{}  {
 ...
 */
func  (this *hollaexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *hollaexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "topic":"orderbook",
    //         "action":"partial",
 ...
 */
func  (this *hollaexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hollaexWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "topic": "trade",
    //         "action": "partial",
 ...
 */
func  (this *hollaexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hollaexWs) HandleMyTrades(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    // {
    //     "topic":"usertrade",
    //     "action":"insert",
 ...
 */
func  (this *hollaexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hollaexWs) HandleOrder(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    //     {
    //         "topic": "order",
    //         "action": "insert",
 ...
 */
func  (this *hollaexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hollaexWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "topic": "wallet",
    //         "action": "partial",
...
func  (this *hollaexWs) WatchPublic(messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hollaexWs) WatchPrivate(messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *hollaexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     { error: "Bearer or HMAC authentication required" }
    //     { error: "ccxt.Error: wrong input" }
    //
    var err interface{} = this.SafeInteger(message, "error")
    
    {		ret__ := func(this *hollaexWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *hollaexWs) interface{} {
    					// catch block:
    		...
    		// try block:
                ...
                this.ThrowExactlyMatchedException(ccxt.GetValue(ccxt.GetValue(this.Exceptions, "ws"), "exact"), err, feedback)
            }
    		return nil
    	}(this)
...
func  (this *hollaexWs) HandleMessage(client interface{}, message interface{})  {
    //
    // pong
    //
    //     { message: "pong" }
...
func  (this *hollaexWs) Ping(client interface{}) interface{}  {
    // hollaex does not support built-in ws protocol-level ping-pong
    return map[string]interface{} {
        "op": "ping",
    }
}
func  (this *hollaexWs) HandlePong(client interface{}, message interface{}) interface{}  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
    return message
}
func  (this *hollaexWs) OnError(client interface{}, error interface{})  {
    ccxt.AddElementToObject(this.Options, "ws-expires", nil)
    this.base.OnError(client, error)
}
func  (this *hollaexWs) OnClose(client interface{}, error interface{})  {
    ccxt.AddElementToObject(this.Options, "ws-expires", nil)
    this.base.OnClose(client, error)
}


func (this *hollaexWs) Init(userConfig map[string]interface{}) {
    this.hollaex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
