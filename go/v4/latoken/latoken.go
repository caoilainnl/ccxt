    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "NOT_AUTHORIZED": ccxt.AuthenticationError,
                "FORBIDDEN": ccxt.PermissionDenied,
                "BAD_REQUEST": ccxt.BadRequest,
                "NOT_FOUND": ccxt.ExchangeError,
                "ACCESS_DENIED": ccxt.PermissionDenied,
                "REQUEST_REJECTED": ccxt.ExchangeError,
                "HTTP_MEDIA_TYPE_NOT_SUPPORTED": ccxt.BadRequest,
                "MEDIA_TYPE_NOT_ACCEPTABLE": ccxt.BadRequest,
                "METHOD_ARGUMENT_NOT_VALID": ccxt.BadRequest,
                "VALIDATION_ERROR": ccxt.BadRequest,
                "ACCOUNT_EXPIRED": ccxt.AccountSuspended,
                "BAD_CREDENTIALS": ccxt.AuthenticationError,
                "COOKIE_THEFT": ccxt.AuthenticationError,
                "CREDENTIALS_EXPIRED": ccxt.AccountSuspended,
                "INSUFFICIENT_AUTHENTICATION": ccxt.AuthenticationError,
                "UNKNOWN_LOCATION": ccxt.AuthenticationError,
                "TOO_MANY_REQUESTS": ccxt.RateLimitExceeded,
                "INSUFFICIENT_FUNDS": ccxt.InsufficientFunds,
                "ORDER_VALIDATION": ccxt.InvalidOrder,
                "BAD_TICKS": ccxt.InvalidOrder,
            },
            "broad": map[string]interface{} {
                "invalid API key, signature or digest": ccxt.AuthenticationError,
                "The API key was revoked": ccxt.AuthenticationError,
                "request expired or bad": ccxt.InvalidNonce,
                "For input string": ccxt.BadRequest,
                "Unable to resolve currency by tag": ccxt.BadSymbol,
                "Can\\'t find currency with tag": ccxt.BadSymbol,
                "Unable to place order because pair is in inactive state": ccxt.BadSymbol,
                "API keys are not available for": ccxt.AccountSuspended,
            },
        },
...
func  (this *latoken) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            //     ]
            //
            if ccxt.IsTrue(this.SafeBool(this.Options, "adjustForTimeDifference", false)) {
        
                retRes36412 := (<-this.LoadTimeDifference())
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(baseCurrencyInfo, nil)) && ccxt.IsTrue(!ccxt.IsEqual(quoteCurrencyInfo, nil))) {
                    ...
                    var lowercaseQuote interface{} = ccxt.ToLower(quote)
                    ...
                    ccxt.AppendToArray(&result, map[string]interface{} {
                        ...
                        "future": false,
                        "option": false,
                        "active": (ccxt.IsEqual(status, "PAIR_STATUS_ACTIVE")),
                        "contract": false,
                        "linear": nil,
                        "inverse": nil,
                        "contractSize": nil,
                        ...
                        "limits": map[string]interface{} {
                            ...
                            "cost": map[string]interface{} {
                                "min": this.SafeNumber(market, ccxt.Add("minOrderCost", capitalizedQuote)),
                                "max": this.SafeNumber(market, ccxt.Add("maxOrderCost", capitalizedQuote)),
                            },
                        },
...
func  (this *latoken) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                var isCrypto interface{} =         (ccxt.IsTrue(ccxt.IsEqual(currencyType, "CURRENCY_TYPE_CRYPTO")) || ccxt.IsTrue(ccxt.IsEqual(currencyType, "CURRENCY_TYPE_IEO")))
            ...
            "active": ccxt.IsEqual(this.SafeString(currency, "status"), "CURRENCY_STATUS_ACTIVE"),
            "deposit": nil,
            "withdraw": nil,
...
func  (this *latoken) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(timestamp, nil)) {
                    if ccxt.IsTrue(ccxt.IsEqual(maxTimestamp, nil)) {
                        maxTimestamp = timestamp
                    } else {
                        maxTimestamp = ccxt.MathMax(maxTimestamp, timestamp)
                    }
                }
                var code interface{} = this.SafeCurrencyCode(currencyId)
                var account interface{} = this.Account()
                ccxt.AddElementToObject(account, "free", this.SafeString(balance, "available"))
                ccxt.AddElementToObject(account, "used", this.SafeString(balance, "blocked"))
                ccxt.AddElementToObject(result, code, account)
            }
            ccxt.AddElementToObject(result, "timestamp", maxTimestamp)
            ccxt.AddElementToObject(result, "datetime", this.Iso8601(maxTimestamp))
...
func  (this *latoken) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "currency": ccxt.GetValue(market, "baseId"),
                "quote": ccxt.GetValue(market, "quoteId"),
            }
...
func  (this *latoken) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "base": ccxt.GetValue(market, "baseId"),
                "quote": ccxt.GetValue(market, "quoteId"),
            }
...
func  (this *latoken) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(side, nil)) {
        side = ccxt.Ternary(ccxt.IsTrue(makerBuyer), "sell", "buy")
    } else {
        if ccxt.IsTrue(ccxt.IsEqual(side, "TRADE_DIRECTION_BUY")) {
            side = "buy"
        } else if ccxt.IsTrue(ccxt.IsEqual(side, "TRADE_DIRECTION_SELL")) {
            side = "sell"
        }
    }
    var isBuy interface{} =     (ccxt.IsEqual(side, "buy"))
    var takerOrMaker interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsTrue(makerBuyer) && ccxt.IsTrue(isBuy))), "maker", "taker")
...
func  (this *latoken) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", ccxt.MathMin(limit, 100)) // default 100, limit 100
            }
...
func  (this *latoken) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "fetchPrivateTradingFee")) {
        
                    retRes88319 :=  (<-this.FetchPrivateTradingFee(symbol, params))
                    ccxt.PanicOnError(retRes88319)
                    ch <- retRes88319
                    return nil
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "fetchPublicTradingFee")) {
        
                    retRes88519 :=  (<-this.FetchPublicTradingFee(symbol, params))
                    ccxt.PanicOnError(retRes88519)
                    ch <- retRes88519
                    return nil
            } else {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " not support this method")))
            }
                return nil
            }()
            return ch
...
func  (this *latoken) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ccxt.AddElementToObject(request, "currency", ccxt.GetValue(market, "baseId"))
                ccxt.AddElementToObject(request, "quote", ccxt.GetValue(market, "quoteId"))
...
func  (this *latoken) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(orderSide, nil)) {
        var parts interface{} = ccxt.Split(orderSide, "_")
        var partsLength interface{} =         ccxt.GetArrayLength(parts)
        side = this.SafeStringLower(parts, ccxt.Subtract(partsLength, 1))
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(message, nil)) {
        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(message, "cancel"), 0)) {
            status = "canceled"
        } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(message, "accept"), 0)) {
            status = "open"
        }
    }
...
func  (this *latoken) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            // privateGetAuthOrderActive doesn't work even though its listed at https://api.latoken.com/doc/v2/#tag/ccxt.Order/operation/getMyActiveOrders
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "currency": ccxt.GetValue(market, "baseId"),
                "quote": ccxt.GetValue(market, "quoteId"),
...
func  (this *latoken) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "baseCurrency": ccxt.GetValue(market, "baseId"),
                "quoteCurrency": ccxt.GetValue(market, "quoteId"),
...
func  (this *latoken) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(toAccount, "@"), 0)) {
                response = (<-this.PrivatePostAuthTransferEmail(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetLength(toAccount), 36)) {
...
func  (this *latoken) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = method
    params := ccxt.GetArg(optionalArgs, 2, nil)
    _ = params
    headers := ccxt.GetArg(optionalArgs, 3, nil)
    _ = headers
    body := ccxt.GetArg(optionalArgs, 4, nil)
    _ = body
    var request interface{} = ccxt.Add(ccxt.Add(ccxt.Add("/", this.Version), "/"), this.ImplodeParams(path, params))
    ...
    if ccxt.IsTrue(ccxt.IsEqual(method, "GET")) {
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            requestString = ccxt.Add(requestString, ccxt.Add("?", urlencodedQuery))
        }
    }
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        this.CheckRequiredCredentials()
        var auth interface{} = ccxt.Add(ccxt.Add(method, request), urlencodedQuery)
        var signature interface{} = this.Hmac(this.Encode(auth), this.Encode(this.Secret), ccxt.Sha512)
    ...
    var url interface{} = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "rest"), requestString)
    return map[string]interface{} {
        "url": url,
        "method": method,
        "body": body,
...
func  (this *latoken) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    // {"message":"Internal Server ccxt.Error","error":"INTERNAL_ERROR","status":"FAILURE"}
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(err, nil))) || ccxt.IsTrue((!ccxt.IsEqual(errorMessage, nil)))) {
