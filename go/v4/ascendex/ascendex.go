    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "1900": ccxt.BadRequest,
                "2100": ccxt.AuthenticationError,
                "5002": ccxt.BadSymbol,
                "6001": ccxt.BadSymbol,
                "6010": ccxt.InsufficientFunds,
                "60060": ccxt.InvalidOrder,
                "600503": ccxt.InvalidOrder,
                "100001": ccxt.BadRequest,
                "100002": ccxt.BadRequest,
                "100003": ccxt.BadRequest,
                "100004": ccxt.BadRequest,
                "100005": ccxt.BadRequest,
                "100006": ccxt.BadRequest,
                "100007": ccxt.BadRequest,
                "100008": ccxt.BadSymbol,
                "100009": ccxt.AuthenticationError,
                "100010": ccxt.BadRequest,
                "100011": ccxt.BadRequest,
                "100012": ccxt.BadRequest,
                "100013": ccxt.BadRequest,
                "100101": ccxt.ExchangeError,
                "150001": ccxt.BadRequest,
                "200001": ccxt.AuthenticationError,
                "200002": ccxt.ExchangeError,
                "200003": ccxt.ExchangeError,
                "200004": ccxt.ExchangeError,
                "200005": ccxt.ExchangeError,
                "200006": ccxt.ExchangeError,
                "200007": ccxt.ExchangeError,
                "200008": ccxt.ExchangeError,
                "200009": ccxt.ExchangeError,
                "200010": ccxt.AuthenticationError,
                "200011": ccxt.ExchangeError,
                "200012": ccxt.ExchangeError,
                "200013": ccxt.ExchangeError,
                "200014": ccxt.PermissionDenied,
                "200015": ccxt.PermissionDenied,
                "300001": ccxt.InvalidOrder,
                "300002": ccxt.InvalidOrder,
                "300003": ccxt.InvalidOrder,
                "300004": ccxt.InvalidOrder,
                "300005": ccxt.InvalidOrder,
                "300006": ccxt.InvalidOrder,
                "300007": ccxt.InvalidOrder,
                "300008": ccxt.InvalidOrder,
                "300009": ccxt.InvalidOrder,
                "300011": ccxt.InsufficientFunds,
                "300012": ccxt.BadSymbol,
                "300013": ccxt.InvalidOrder,
                "300014": ccxt.InvalidOrder,
                "300020": ccxt.InvalidOrder,
                "300021": ccxt.AccountSuspended,
                "300031": ccxt.InvalidOrder,
                "310001": ccxt.InsufficientFunds,
                "310002": ccxt.InvalidOrder,
                "310003": ccxt.InvalidOrder,
                "310004": ccxt.BadSymbol,
                "310005": ccxt.InvalidOrder,
                "510001": ccxt.ExchangeError,
                "900001": ccxt.ExchangeError,
            },
...
func  (this *ascendex) GetAccount(optionalArgs ...interface{}) interface{}  {
    ...
    _ = params
    var account interface{} = this.SafeValue(params, "account", ccxt.GetValue(this.Options, "account"))
    var lowercaseAccount interface{} = ccxt.ToLower(account)
...
func  (this *ascendex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(chains)); j++ {
                    var networkEtnry interface{} = ccxt.GetValue(chains, j)
...
func  (this *ascendex) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            spotMarketscontractMarketsVariable := (<-ccxt.PromiseAll([]interface{}{spotPromise, contractPromise}));
            spotMarkets := ccxt.GetValue(spotMarketscontractMarketsVariable,0);
            contractMarkets := ccxt.GetValue(spotMarketscontractMarketsVariable,1)
...
func  (this *ascendex) FetchSpotMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            //     }
            //
            productscashVariable := (<-ccxt.PromiseAll([]interface{}{productsPromise, cashPromise}));
            products := ccxt.GetValue(productscashVariable,0);
            cash := ccxt.GetValue(productscashVariable,1)
            ...
            var ids interface{} = ccxt.ObjectKeys(dataById)
            var result interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                var id interface{} = ccxt.GetValue(ids, i)
                if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(id, "-PERP"), 0)) {
                    continue
                }
                var market interface{} = ccxt.GetValue(dataById, id)
                var status interface{} = this.SafeString(market, "status")
                var domain interface{} = this.SafeString(market, "domain")
                var active interface{} = false
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue((ccxt.IsEqual(status, "Normal"))) || ccxt.IsTrue((ccxt.IsEqual(status, "InternalTrading"))))) && ccxt.IsTrue((!ccxt.IsEqual(domain, "LeveragedETF")))) {
                    active = true
                }
...
func  (this *ascendex) FetchContractMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                var linear interface{} = ccxt.IsEqual(settle, quote)
                var inverse interface{} = ccxt.IsEqual(settle, base)
                ...
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "future": false,
                    "option": false,
                    "active": ccxt.IsEqual(this.SafeString(market, "status"), "Normal"),
                    "contract": true,
                    "linear": linear,
                    "inverse": inverse,
                    "taker": fee,
...
func  (this *ascendex) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(accountGroup, nil)) {
                ...
                ccxt.AddElementToObject(this.Options, "account-group", accountGroup)
            }
...
func  (this *ascendex) ParseSwapBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(collaterals)); i++ {
        var balance interface{} = ccxt.GetValue(collaterals, i)
        var code interface{} = this.SafeCurrencyCode(this.SafeString(balance, "asset"))
        var account interface{} = this.Account()
...
func  (this *ascendex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes9908 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes9908)
            var marketType interface{} = nil
            var marginMode interface{} = nil
            __tmp15100 := this.HandleMarketTypeAndParams("fetchBalance", nil, params)
            marketType = ccxt.GetValue(__tmp15100, 0)
            params = ccxt.GetValue(__tmp15100, 1)
            __tmp329192 := this.HandleMarginModeAndParams("fetchBalance", params)
            marginMode = ccxt.GetValue(__tmp329192, 0)
            params = ccxt.GetValue(__tmp329192, 1)
            var isMargin interface{} = this.SafeBool(params, "margin", false)
            var isCross interface{} = ccxt.IsEqual(marginMode, "cross")
            marketType = ccxt.Ternary(ccxt.IsTrue((ccxt.IsTrue(isMargin) || ccxt.IsTrue(isCross))), "margin", marketType)
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(marginMode, "isolated"))) && ccxt.IsTrue((!ccxt.IsEqual(marketType, "swap")))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " does not supported isolated margin trading")))
            }
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(accountCategory, "cash"))) || ccxt.IsTrue((ccxt.IsEqual(accountCategory, "margin")))) {
                ccxt.AddElementToObject(request, "account-category", accountCategory)
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(marketType, "spot"))) || ccxt.IsTrue((ccxt.IsEqual(marketType, "margin")))) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchBalance() is not currently supported for "), marketType), " markets")))
            }
            //
            // cash
            //
...
func  (this *ascendex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(result, "nonce", this.SafeInteger(orderbook, "seqnum"))
...
func  (this *ascendex) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var delimiter interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(typeVar, "spot"))), "/", nil)
...
func  (this *ascendex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                ccxt.AddElementToObject(request, "symbol", ccxt.Join(marketIds, ","))
            }
            var typeVar interface{} = nil
            __tmp992329 := this.HandleMarketTypeAndParams("fetchTickers", market, params)
            typeVar = ccxt.GetValue(__tmp992329, 0)
            params = ccxt.GetValue(__tmp992329, 1)
            var response interface{} = nil
...
func  (this *ascendex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                    ...
                    limit = ccxt.MathMin(limit, defaultLimit)
                }
                var toWithLimit interface{} = this.Sum(since, ccxt.Multiply(ccxt.Multiply(limit, duration), 1000), 1)
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ccxt.AddElementToObject(request, "to", ccxt.MathMin(toWithLimit, ccxt.Add(until, 1)))
                } else {
                    ccxt.AddElementToObject(request, "to", toWithLimit)
                }
            } else if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "to", ccxt.Add(until, 1))
                if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                    limit = defaultLimit
                } else {
                    limit = ccxt.MathMin(limit, defaultLimit)
                }
                ccxt.AddElementToObject(request, "from", ccxt.Subtract(until, (ccxt.Multiply(ccxt.Multiply(limit, duration), 1000))))
            } else if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "n", limit) // max 500
            }
...
func  (this *ascendex) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var side interface{} = ccxt.Ternary(ccxt.IsTrue(buyerIsMaker), "sell", "buy")
...
func  (this *ascendex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes14018)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "n", limit) // max 100
            }
...
func  (this *ascendex) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //         "orderType": "ccxt.Limit",                            // order type (ccxt.Limit/ccxt.Market/StopMarket/StopLimit)
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
        if ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetLength(clientOrderId), 1)) {
            clientOrderId = nil
        }
    }
    var rawTypeLower interface{} = this.SafeStringLower(order, "orderType")
    var typeVar interface{} = rawTypeLower
    if ccxt.IsTrue(!ccxt.IsEqual(rawTypeLower, nil)) {
        if ccxt.IsTrue(ccxt.IsEqual(rawTypeLower, "stoplimit")) {
            typeVar = "limit"
        }
        if ccxt.IsTrue(ccxt.IsEqual(rawTypeLower, "stopmarket")) {
            typeVar = "market"
        }
    }
    ...
    if ccxt.IsTrue(ccxt.IsEqual(execInst, "post")) {
        postOnly = true
    }
...
func  (this *ascendex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes16328)
        
            retRes16338 := (<-this.LoadAccounts())
...
func  (this *ascendex) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    var marginMode interface{} = nil
    var marketType interface{} = nil
    __tmp443000 := this.HandleMarginModeAndParams("createOrderRequest", params)
    marginMode = ccxt.GetValue(__tmp443000, 0)
    params = ccxt.GetValue(__tmp443000, 1)
    __tmp456727 := this.HandleMarketTypeAndParams("createOrderRequest", market, params)
    marketType = ccxt.GetValue(__tmp456727, 0)
    params = ccxt.GetValue(__tmp456727, 1)
    var accountsByType interface{} = this.SafeDict(this.Options, "accountsByType", map[string]interface{} {})
    var accountCategory interface{} = this.SafeString(accountsByType, marketType, "cash")
    ...
    var isMarketOrder interface{} =     (ccxt.IsTrue((ccxt.IsEqual(typeVar, "market"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "stop_market"))))
    var isLimitOrder interface{} =     (ccxt.IsTrue((ccxt.IsEqual(typeVar, "limit"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "stop_limit"))))
    ...
    if ccxt.IsTrue(isLimitOrder) {
        ccxt.AddElementToObject(request, "orderPrice", this.PriceToPrecision(symbol, price))
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
        ...
        if ccxt.IsTrue(isLimitOrder) {
            ccxt.AddElementToObject(request, "orderType", "stop_limit")
        } else if ccxt.IsTrue(isMarketOrder) {
            ccxt.AddElementToObject(request, "orderType", "stop_market")
        }
    }
    if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
        ccxt.AddElementToObject(request, "id", clientOrderId)
    }
    if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
        if ccxt.IsTrue(!ccxt.IsEqual(accountCategory, nil)) {
            ccxt.AddElementToObject(request, "category", accountCategory)
        }
    } else {
        ccxt.AddElementToObject(request, "account-category", accountCategory)
        if ccxt.IsTrue(reduceOnly) {
            ccxt.AddElementToObject(request, "execInst", "ReduceOnly")
        }
        if ccxt.IsTrue(postOnly) {
            ccxt.AddElementToObject(request, "execInst", "Post")
        }
    }
...
func  (this *ascendex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes18778)
        
            retRes18788 := (<-this.LoadAccounts())
            ...
            var market interface{} = this.Market(symbol)
            var accountsByType interface{} = this.SafeDict(this.Options, "accountsByType", map[string]interface{} {})
            var accountCategory interface{} = this.SafeString(accountsByType, ccxt.GetValue(market, "type"), "cash")
            if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                accountCategory = "margin"
            }
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrders() is not currently supported for swap markets on ascendex")))
            } else {
                ccxt.AddElementToObject(request, "account-group", accountGroup)
                ccxt.AddElementToObject(request, "account-category", accountCategory)
                ccxt.AddElementToObject(request, "orders", ordersRequests)
...
func  (this *ascendex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes19728)
        
            retRes19738 := (<-this.LoadAccounts())
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "spot"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "margin")))) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOrder() is not currently supported for "), typeVar), " markets")))
            }
            //
...
func  (this *ascendex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "spot"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "margin")))) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOpenOrders() is not currently supported for "), typeVar), " markets")))
            }
            //
            ...
            //                 "orderType": "ccxt.Limit",  // order type
            ...
            //
            var data interface{} = this.SafeList(response, "data", []interface{}{})
            if ccxt.IsTrue(ccxt.IsEqual(accountCategory, "futures")) {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                var order interface{} = this.ParseOrder(ccxt.GetValue(data, i), market)
...
func  (this *ascendex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22018 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes22018)
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
            var accountGroup interface{} = this.SafeString(account, "id")
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(method, "v1PrivateAccountCategoryGetOrderHistCurrent")) {
                ccxt.AddElementToObject(request, "account-group", accountGroup)
                ccxt.AddElementToObject(request, "account-category", accountCategory)
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
            ...
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "v2PrivateDataGetOrderHist")) {
                ccxt.AddElementToObject(request, "account", accountCategory)
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "limit", limit)
                }
                response = (<-this.V2PrivateDataGetOrderHist(this.Extend(request, query)))
            } else if ccxt.IsTrue(ccxt.IsEqual(method, "v2PrivateAccountGroupGetFuturesOrderHistCurrent")) {
                ccxt.AddElementToObject(request, "account-group", accountGroup)
                ccxt.AddElementToObject(request, "account-category", accountCategory)
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchClosedOrders() is not currently supported for "), typeVar), " markets")))
            }
            //
...
func  (this *ascendex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes23748)
        
            retRes23758 := (<-this.LoadAccounts())
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "spot"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "margin")))) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelOrder() is not currently supported for "), typeVar), " markets")))
            }
            //
...
func  (this *ascendex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24858 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes24858)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "spot"))) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "margin")))) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelAllOrders() is not currently supported for "), typeVar), " markets")))
            }
...
func  (this *ascendex) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var code interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(currency, nil))), nil, ccxt.GetValue(currency, "code"))
...
func  (this *ascendex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var numAddresses interface{} =     ccxt.GetArrayLength(addresses)
            var address interface{} = nil
            if ccxt.IsTrue(ccxt.IsGreaterThan(numAddresses, 1)) {
                var addressesByChainName interface{} = this.IndexBy(addresses, "chainName")
                if ccxt.IsTrue(ccxt.IsEqual(networkId, nil)) {
                    var chainNames interface{} = ccxt.ObjectKeys(addressesByChainName)
                    var chains interface{} = ccxt.Join(chainNames, ", ")
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(this.Id, " fetchDepositAddress() returned more than one address, a chainName parameter is required, one of "), chains)))
                }
...
func  (this *ascendex) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes267115 :=  (<-this.FetchTransactions(code, since, limit, this.Extend(request, params)))
                ccxt.PanicOnError(retRes267115)
                ch <- retRes267115
                return nil
...
func  (this *ascendex) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes268815 :=  (<-this.FetchTransactions(code, since, limit, this.Extend(request, params)))
                ccxt.PanicOnError(retRes268815)
                ch <- retRes268815
                return nil
...
func  (this *ascendex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes28288)
        
            retRes28298 := (<-this.LoadAccounts())
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(position)); i++ {
                ccxt.AppendToArray(&result, this.ParsePosition(ccxt.GetValue(position, i)))
            }
...
func  (this *ascendex) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.Precise.StringEq(notional, "0")) {
        notional = this.SafeString(position, "sellOpenOrderNotional")
    }
    var marginType interface{} = this.SafeString(position, "marginType")
    var marginMode interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginType, "crossed"))), "cross", "isolated")
...
func  (this *ascendex) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes30328)
        
            retRes30338 := (<-this.LoadAccounts())
...
func  (this *ascendex) ParseMarginModification(data interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var status interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(errorCode, "0"))), "ok", "failed")
    return map[string]interface{} {
        "info": data,
        "symbol": ccxt.GetValue(market, "symbol"),
        "type": nil,
...
func  (this *ascendex) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes309415 :=  (<-this.ModifyMarginHelper(symbol, ccxt.OpNeg(amount), "reduce", params))
                ccxt.PanicOnError(retRes309415)
                ch <- retRes309415
                return nil
...
func  (this *ascendex) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes310715 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                ccxt.PanicOnError(retRes310715)
                ch <- retRes310715
                return nil
...
func  (this *ascendex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes314015 :=  (<-this.V2PrivateAccountGroupPostFuturesLeverage(this.Extend(request, params)))
                ccxt.PanicOnError(retRes314015)
                ch <- retRes314015
                return nil
...
func  (this *ascendex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes31648)
        
            retRes31658 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes31658)
            var market interface{} = this.Market(symbol)
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
            var accountGroup interface{} = this.SafeString(account, "id")
            var request interface{} = map[string]interface{} {
            ...
            if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                retRes317715 :=  (<-this.V2PrivateAccountGroupPostFuturesMarginType(this.Extend(request, params)))
                ccxt.PanicOnError(retRes317715)
                ch <- retRes317715
                return nil
...
func  (this *ascendex) ParseMarketLeverageTiers(info interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marginRequirements)); i++ {
        var tier interface{} = ccxt.GetValue(marginRequirements, i)
...
func  (this *ascendex) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var blockChainsLength interface{} =     ccxt.GetArrayLength(blockChains)
    var result interface{} = map[string]interface{} {
        "info": fee,
        "withdraw": map[string]interface{} {
            "fee": nil,
    ...
    for i := 0; ccxt.IsLessThan(i, blockChainsLength); i++ {
        var blockChain interface{} = ccxt.GetValue(blockChains, i)
    ...
    "withdraw": map[string]interface{} {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(blockChainsLength, 1)) {
            ccxt.AddElementToObject(ccxt.GetValue(result, "withdraw"), "fee", this.SafeNumber(blockChain, "withdrawFee"))
...
func  (this *ascendex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(fromId, "cash")) && ccxt.IsTrue(!ccxt.IsEqual(toId, "cash"))) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " transfer() only supports direct balance transfer between spot and swap, spot and margin")))
            }
            var request interface{} = map[string]interface{} {
                "account-group": accountGroup,
...
func  (this *ascendex) ParseTransferStatus(status interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsEqual(status, "0")) {
        return "ok"
    }
    return "failed"
}
...
func  (this *ascendex) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes34268 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes34268)
            var paginate interface{} = false
            __tmp166239 := this.HandleOptionAndParams(params, "fetchFundingHistory", "paginate")
            paginate = ccxt.GetValue(__tmp166239, 0)
            params = ccxt.GetValue(__tmp166239, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes343019 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 25))
...
func  (this *ascendex) FetchMarginModes(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes35018)
        
            retRes35028 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes35028)
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
            var accountGroup interface{} = this.SafeString(account, "id")
            var request interface{} = map[string]interface{} {
                "account-group": accountGroup,
...
func  (this *ascendex) ParseMarginMode(marginMode interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var margin interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginType, "crossed"))), "cross", "isolated")
    return map[string]interface{} {
        "info": marginMode,
...
func  (this *ascendex) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes35748)
        
            retRes35758 := (<-this.LoadAccounts())
            ccxt.PanicOnError(retRes35758)
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
            var accountGroup interface{} = this.SafeString(account, "id")
            var request interface{} = map[string]interface{} {
                "account-group": accountGroup,
...
func  (this *ascendex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var access interface{} = ccxt.GetValue(api, 1)
    var typeVar interface{} = this.SafeString(api, 2)
    var url interface{} = ""
    var accountCategory interface{} =     (ccxt.IsEqual(typeVar, "accountCategory"))
    if ccxt.IsTrue(ccxt.IsTrue(accountCategory) || ccxt.IsTrue((ccxt.IsEqual(typeVar, "accountGroup")))) {
        url = ccxt.Add(url, this.ImplodeParams("/{account-group}", params))
        params = this.Omit(params, "account-group")
    }
    var request interface{} = this.ImplodeParams(path, params)
    url = ccxt.Add(url, "/api/pro/")
    if ccxt.IsTrue(ccxt.IsEqual(version, "v2")) {
        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "data")) {
            request = ccxt.Add(ccxt.Add(ccxt.Add("data/", version), "/"), request)
        } else {
            request = ccxt.Add(ccxt.Add(version, "/"), request)
        }
    } else {
        url = ccxt.Add(url, ccxt.Add(version, "/"))
    }
    if ccxt.IsTrue(accountCategory) {
        url = ccxt.Add(url, this.ImplodeParams("{account-category}/", params))
    }
    params = this.Omit(params, "account-category")
    url = ccxt.Add(url, request)
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(version, "v1"))) && ccxt.IsTrue((ccxt.IsEqual(request, "cash/balance")))) || ccxt.IsTrue((ccxt.IsEqual(request, "margin/balance")))) {
        request = "balance"
    }
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(version, "v1"))) && ccxt.IsTrue((ccxt.IsEqual(request, "spot/fee")))) {
        request = "fee"
    }
    if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(request, "subuser"), 0)) {
        var parts interface{} = ccxt.Split(request, "/")
        request = ccxt.GetValue(parts, 2)
    }
    ...
    if ccxt.IsTrue(ccxt.IsEqual(access, "public")) {
        ...
        var payload interface{} = ccxt.Add(ccxt.Add(timestamp, "+"), request)
        var hmac interface{} = this.Hmac(this.Encode(payload), this.Encode(this.Secret), ccxt.Sha256, "base64")
    ...
    url = ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "rest"), url)
    return map[string]interface{} {
        "url": url,
        "method": method,
        "body": body,
...
func  (this *ascendex) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    var err interface{} = ccxt.IsTrue((!ccxt.IsEqual(code, nil))) && ccxt.IsTrue((!ccxt.IsEqual(code, "0")))
    if ccxt.IsTrue(ccxt.IsTrue(err) || ccxt.IsTrue((!ccxt.IsEqual(message, nil)))) {
