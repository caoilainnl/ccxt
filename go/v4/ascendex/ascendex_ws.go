...
func NewAscendexWsCore() ascendexWs {
   p := ascendexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *ascendexWs) Describe() interface{}  {
...
func  (this *ascendexWs) WatchPublic(messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *ascendexWs) WatchPublicMultiple(messageHashes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes7115 :=  (<-this.WatchMultiple(url, messageHashes, message, messageHashes, nil))
...
func  (this *ascendexWs) WatchPrivate(channel interface{}, messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *ascendexWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) HandleOHLCV(client interface{}, message interface{}) interface{}  {
    //
    // {
    //     "m": "bar",
    //     "s": "ASD/USDT",
 ...
 */
func  (this *ascendexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *ascendexWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) HandleTrades(client interface{}, message interface{})  {
    //
    // {
    //     "m": "trades",
    //     "symbol": "BTC/USDT",
 ...
 */
func  (this *ascendexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) WatchOrderBookSnapshot(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) FetchOrderBookSnapshot(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) HandleOrderBookSnapshot(client interface{}, message interface{})  {
    //
    // {
    //     "m": "depth",
    //     "symbol": "BTC/USDT",
...
func  (this *ascendexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //   {
    //       "m": "depth",
    //       "symbol": "BTC/USDT",
...
func  (this *ascendexWs) HandleDelta(bookside interface{}, delta interface{})  {
    //
    // ["40990.47","0.01619"],
    //
...
func  (this *ascendexWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *ascendexWs) HandleOrderBookMessage(client interface{}, message interface{}, orderbook interface{}) interface{}  {
    //
    // {
    //     "m":"depth",
    //     "symbol":"BTC/USDT",
 ...
 */
func  (this *ascendexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) HandleBalance(client interface{}, message interface{})  {
    //
    // cash account
    //
    // {
 ...
 */
func  (this *ascendexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *ascendexWs) HandleOrder(client interface{}, message interface{})  {
    //
    // spot order
    // {
    //   "m": "order",
...
func  (this *ascendexWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot order
    //    {
...
func  (this *ascendexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    // {
    //     "m": "disconnected",
    //     "code": 100005,
    ...
    {		ret__ := func(this *ascendexWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *ascendexWs) interface{} {
    					// catch block:
...
func  (this *ascendexWs) HandleAuthenticate(client interface{}, message interface{})  {
    //
...
func  (this *ascendexWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *ascendexWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //     { m: "sub", ch: "bar:BTC/USDT", code: 0 }
    //
    //     { m: 'sub', id: "1647515701", ch: "depth:BTC/USDT", code: 0 }
...
func  (this *ascendexWs) HandleOrderBookSubscription(client interface{}, message interface{})  {
    var channel interface{} = this.SafeString(message, "ch")
...
func  (this *ascendexWs) Pong(client interface{}, message interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                    
            {		 func(this *ascendexWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            				...
            				ret_ = func(this *ascendexWs) interface{} {
            					// catch block:
                                        err := ccxt.NetworkError(ccxt.Add(ccxt.Add(this.Id, " handlePing failed with error "), this.Json(e)))
...
func  (this *ascendexWs) HandlePing(client interface{}, message interface{})  {
    this.Spawn(this.Pong, client, message)
}
func  (this *ascendexWs) Authenticate(url interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func (this *ascendexWs) Init(userConfig map[string]interface{}) {
    this.ascendex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
