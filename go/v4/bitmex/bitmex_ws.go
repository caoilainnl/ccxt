...
func NewBitmexWsCore() bitmexWs {
   p := bitmexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bitmexWs) Describe() interface{}  {
 ...
 */
func  (this *bitmexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *bitmexWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ticker:= (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), rawSubscriptions, nil))
...
func  (this *bitmexWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "table": "instrument",
    //         "action": "partial",
 ...
 */
func  (this *bitmexWs) WatchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an array of [liquidation structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#liquidation-structure}
 */
func  (this *bitmexWs) WatchLiquidationsForSymbols(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            newLiquidations:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), subscriptionHashes, nil))
...
func  (this *bitmexWs) HandleLiquidation(client interface{}, message interface{})  {
    //
    //    {
    //        "table":"liquidation",
    //        "action":"partial",
 ...
 */
func  (this *bitmexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "margin",
    //         "action": "partial",
...
func  (this *bitmexWs) HandleTrades(client interface{}, message interface{})  {
    //
    // initial snapshot
    //
    //     {
 ...
 */
func  (this *bitmexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes71915 :=  <-future.(<-chan interface{})
...
func  (this *bitmexWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
 ...
 */
func  (this *bitmexWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) HandlePositions(client interface{}, message interface{})  {
    //
    // partial
    //    {
    //        table: 'position',
 ...
 */
func  (this *bitmexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) HandleOrders(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "order",
    //         "action": "partial",
 ...
 */
func  (this *bitmexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "table":"execution",
    //         "action":"insert",
 ...
 */
func  (this *bitmexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *bitmexWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            orderbook:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), topics, nil))
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *bitmexWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            trades:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), topics, nil))
            ccxt.PanicOnError(trades)
            if ccxt.IsTrue(this.NewUpdates) {
 ...
 */
func  (this *bitmexWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "table": "tradeBin1m",
    //         "action": "partial",
...
func  (this *bitmexWs) WatchHeartbeat(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitmexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // first snapshot
    //
    //     {
...
func  (this *bitmexWs) HandleSystemStatus(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *bitmexWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "success": true,
...
func  (this *bitmexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(err, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsGreaterThan(numArgs, 0)) {
            ...
            var broadKey interface{} = this.FindBroadlyMatchedKey(broad, err)
            var exception interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(broadKey, nil)) {
                exception = ccxt.ExchangeError(                err) // c# requirement for now
            } else {
                exception = ccxt.CallDynamically(ccxt.GetValue(broad, broadKey), err)
            }
...
func  (this *bitmexWs) HandleMessage(client interface{}, message interface{})  {
    //
    //     {
    //         "info": "Welcome to the BitMEX Realtime API.",
    //         "version": "2019-11-22T00:24:37.000Z",
...
func (this *bitmexWs) Init(userConfig map[string]interface{}) {
    this.bitmex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
