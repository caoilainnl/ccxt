...
func NewBithumbWs(userConfig map[string]interface{}) BithumbWs {
   p := &bithumbWs{}
   p.Init(userConfig)
   return BithumbWs{
       bithumbWs: p,
...
func (this *BithumbWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *BithumbWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *BithumbWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *BithumbWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
