...
type bithumbWs struct {
	bithumb
	base bithumb
}

func NewBithumbWsCore() bithumbWs {
   p := bithumbWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bithumbWs) Describe() interface{}  {
 ...
 */
func  (this *bithumbWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 */
func  (this *bithumbWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            newTicker:= (<-this.WatchMultiple(url, messageHashes, message, messageHashes, nil))
...
func  (this *bithumbWs) HandleTicker(client interface{}, message interface{})  {
    //
    //    {
    //        "type" : "ticker",
    //        "content" : {
...
func  (this *bithumbWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "symbol" : "BTC_KRW",           // 통화코드
    //        "tickType" : "24H",                 // 변동 기준시간- 30M, 1H, 12H, 24H, MID
 ...
 */
func  (this *bithumbWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bithumbWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //    {
    //        "type" : "orderbookdepth",
    //            "content" : {
...
func  (this *bithumbWs) HandleDelta(orderbook interface{}, delta interface{})  {
    //
    //    {
    //        symbol: "ETH_BTC",
    //        orderType: "bid",
...
func  (this *bithumbWs) HandleDeltas(orderbook interface{}, deltas interface{})  {
 ...
 */
func  (this *bithumbWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bithumbWs) HandleTrades(client interface{}, message interface{})  {
    //
    //    {
    //        "type" : "transaction",
    //        "content" : {
...
func  (this *bithumbWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "symbol" : "BTC_KRW",
    //        "buySellGb" : "1",
...
func  (this *bithumbWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "status" : "5100",
    ...
    {		ret__ := func(this *bithumbWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *bithumbWs) interface{} {
    					// catch block:
...
func  (this *bithumbWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *bithumbWs) Init(userConfig map[string]interface{}) {
    this.bithumb.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
