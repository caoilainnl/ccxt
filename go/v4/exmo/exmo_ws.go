...
func NewExmoWsCore() exmoWs {
   p := exmoWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *exmoWs) Describe() interface{}  {
...
func  (this *exmoWs) RequestId() interface{}  {
 ...
 */
func  (this *exmoWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *exmoWs) HandleBalance(client interface{}, message interface{})  {
    //
    //  spot
    //     {
    //         "ts": 1654208766007,
...
func  (this *exmoWs) ParseSpotBalance(message interface{})  {
    //
    //     {
    //         "balances": {
    //             "BTC": "3",
...
func  (this *exmoWs) ParseMarginBalance(message interface{})  {
    //
    //     {
    //         "RUB": {
    //             "balance": "1000000",
 ...
 */
func  (this *exmoWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *exmoWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *exmoWs) HandleTicker(client interface{}, message interface{})  {
    //
    //  spot
    //      {
    //          "ts": 1654205085473,
 ...
 */
func  (this *exmoWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *exmoWs) HandleTrades(client interface{}, message interface{})  {
    //
    //      {
    //          "ts": 1654206084001,
    //          "event": "update",
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *exmoWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *exmoWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //  spot
    //     {
    //         "ts": 1654210290219,
 ...
 */
func  (this *exmoWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *exmoWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "ts": 1574427585174,
    //         "event": "snapshot",
...
func  (this *exmoWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, 0, 1)
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *exmoWs) HandleDeltas(bookside interface{}, deltas interface{})  {
 ...
 */
func  (this *exmoWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *exmoWs) HandleOrders(client interface{}, message interface{})  {
    //
    //  spot
    // {
    //     "ts": 1574427585174,
...
func  (this *exmoWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // {
...
func  (this *exmoWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *exmoWs) HandleMessage(client interface{}, message interface{})  {
    //
    // {
    //     "ts": 1654206362552,
    //     "event": "info",
...
func  (this *exmoWs) HandleSubscribed(client interface{}, message interface{}) interface{}  {
    //
    // {
    //     "method": "subscribe",
    //     "id": 2,
...
func  (this *exmoWs) HandleInfo(client interface{}, message interface{}) interface{}  {
    //
    // {
    //     "ts": 1654215731659,
    //     "event": "info",
...
func  (this *exmoWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
    //
    //     {
    //         "method": "login",
    //         "id": 1,
...
func  (this *exmoWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(future, nil)) {
                ...
                var signData interface{} = ccxt.Add(this.ApiKey, ccxt.ToString(now))
...
func (this *exmoWs) Init(userConfig map[string]interface{}) {
    this.exmo.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
