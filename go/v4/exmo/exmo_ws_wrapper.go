...
func NewExmoWs(userConfig map[string]interface{}) ExmoWs {
   p := &exmoWs{}
   p.Init(userConfig)
   return ExmoWs{
       exmoWs: p,
...
func (this *ExmoWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
...
func (this *ExmoWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *ExmoWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
...
func (this *ExmoWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *ExmoWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *ExmoWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *ExmoWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
