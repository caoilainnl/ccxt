 ...
 */
func (this *Exmo) FetchCanceledOrders(options ...ccxt.FetchCanceledOrdersOptions) ([]map[string]interface{}, error) {
 ...
 * @returns {object} a [transaction structure]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Exmo) FetchWithdrawal(id string, options ...ccxt.FetchWithdrawalOptions) (ccxt.Transaction, error) {
 ...
 * @returns {object} a [transaction structure]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Exmo) FetchDeposit(id string, options ...ccxt.FetchDepositOptions) (ccxt.Transaction, error) {
