...
func  (this *zonda) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            ...
            "401": ccxt.InvalidOrder,
            "402": ccxt.InvalidOrder,
            "403": ccxt.InvalidOrder,
            "404": ccxt.InvalidOrder,
            "405": ccxt.InvalidOrder,
            "406": ccxt.InsufficientFunds,
            "408": ccxt.InvalidOrder,
            "501": ccxt.AuthenticationError,
            "502": ccxt.AuthenticationError,
            "503": ccxt.InvalidNonce,
            "504": ccxt.ExchangeError,
            "505": ccxt.AuthenticationError,
            "506": ccxt.AccountSuspended,
            "509": ccxt.ExchangeError,
            "510": ccxt.BadSymbol,
...
func  (this *zonda) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var markets interface{} = ccxt.ObjectValues(items)
...
func  (this *zonda) ParseMarket(item interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue(this.InArray(base, fiatCurrencies)) || ccxt.IsTrue(this.InArray(quote, fiatCurrencies))) {
...
func  (this *zonda) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(symbol) {
                ...
                ccxt.AddElementToObject(request, "markets", markets)
            }
...
func  (this *zonda) ParseBalance(response interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(balances, nil)) {
        panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " empty balance response "), this.Json(response))))
    }
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
        ...
        ccxt.AddElementToObject(account, "used", this.SafeString(balance, "lockedFunds"))
        ccxt.AddElementToObject(account, "free", this.SafeString(balance, "availableFunds"))
...
func  (this *zonda) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(fetchTickerMethod, method)) {
                response = (<-this.V1_01PublicGetTradingTickerSymbol(this.Extend(request, params)))
            } else if ccxt.IsTrue(ccxt.IsEqual(fetchTickerMethod, "v1_01PublicGetTradingStatsSymbol")) {
                response = (<-this.V1_01PublicGetTradingStatsSymbol(this.Extend(request, params)))
            } else {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchTicker params[\"method\"] must be \"v1_01PublicGetTradingTickerSymbol\" or \"v1_01PublicGetTradingStatsSymbol\"")))
            }
...
func  (this *zonda) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(fetchTickersMethod, method)) {
                response = (<-this.V1_01PublicGetTradingTicker(params))
            } else if ccxt.IsTrue(ccxt.IsEqual(fetchTickersMethod, "v1_01PublicGetTradingStats")) {
                response = (<-this.V1_01PublicGetTradingStats(params))
            } else {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchTickers params[\"method\"] must be \"v1_01PublicGetTradingTicker\" or \"v1_01PublicGetTradingStats\"")))
            }
...
func  (this *zonda) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                ...
                ccxt.AppendToArray(&balanceCurrencies, ccxt.GetValue(currency, "id"))
            }
            var request interface{} = map[string]interface{} {
                "balanceCurrencies": balanceCurrencies,
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "fromTime", since)
            }
            ...
            ccxt.PanicOnError(response)
            var items interface{} = ccxt.GetValue(response, "items")
...
func  (this *zonda) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes13008)
            var market interface{} = this.Market(symbol)
            var tradingSymbol interface{} = ccxt.Add(ccxt.Add(ccxt.GetValue(market, "baseId"), "-"), ccxt.GetValue(market, "quoteId"))
            var request interface{} = map[string]interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                ...
                limit = ccxt.MathMin(limit, 11000) // supports up to 11k candles diapason
            }
            var duration interface{} = this.ParseTimeframe(timeframe)
            var timerange interface{} = ccxt.Multiply(ccxt.Multiply(limit, duration), 1000)
            if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "to", this.Milliseconds())
                ccxt.AddElementToObject(request, "from", ccxt.Subtract(ccxt.GetValue(request, "to"), timerange))
            } else {
                ccxt.AddElementToObject(request, "from", since)
                ccxt.AddElementToObject(request, "to", this.Sum(ccxt.GetValue(request, "from"), timerange))
            }
...
func  (this *zonda) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(wasTaker, nil)) {
        takerOrMaker = ccxt.Ternary(ccxt.IsTrue(wasTaker), "taker", "maker")
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeCostString, nil)) {
        var feeCurrency interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), ccxt.GetValue(market, "base"), ccxt.GetValue(market, "quote"))
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(order, nil)) {
        typeVar = ccxt.Ternary(ccxt.IsTrue(order), "limit", "market")
    }
...
func  (this *zonda) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "fromTime", ccxt.Subtract(since, 1)) // result does not include exactly `since` time therefore decrease by 1
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default - 10, max - 300
            }
...
func  (this *zonda) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var tradingSymbol interface{} = ccxt.Add(ccxt.Add(ccxt.GetValue(market, "baseId"), "-"), ccxt.GetValue(market, "quoteId"))
            amount = ccxt.ParseFloat(this.AmountToPrecision(symbol, amount))
            var request interface{} = map[string]interface{} {
                "symbol": tradingSymbol,
                "offerType": ccxt.ToUpper(side),
                "amount": amount,
            }
            var stopLossPrice interface{} = this.SafeValue2(params, "stopPrice", "stopLossPrice")
            var isStopLossPrice interface{} = !ccxt.IsEqual(stopLossPrice, nil)
            var isLimitOrder interface{} = ccxt.IsEqual(typeVar, "limit")
            var isMarketOrder interface{} = ccxt.IsEqual(typeVar, "market")
            var isStopLimit interface{} = ccxt.IsTrue((ccxt.IsEqual(typeVar, "stop-limit"))) || ccxt.IsTrue((ccxt.IsTrue(isLimitOrder) && ccxt.IsTrue(isStopLossPrice)))
            var isStopMarket interface{} = ccxt.IsTrue(ccxt.IsEqual(typeVar, "stop-market")) || ccxt.IsTrue((ccxt.IsTrue(isMarketOrder) && ccxt.IsTrue(isStopLossPrice)))
            var isStopOrder interface{} = ccxt.IsTrue(isStopLimit) || ccxt.IsTrue(isStopMarket)
            if ccxt.IsTrue(ccxt.IsTrue(isLimitOrder) || ccxt.IsTrue(isStopLimit)) {
                ccxt.AddElementToObject(request, "rate", this.PriceToPrecision(symbol, price))
                ccxt.AddElementToObject(request, "mode", ccxt.Ternary(ccxt.IsTrue(isStopLimit), "stop-limit", "limit"))
            } else if ccxt.IsTrue(ccxt.IsTrue(isMarketOrder) || ccxt.IsTrue(isStopMarket)) {
                ccxt.AddElementToObject(request, "mode", ccxt.Ternary(ccxt.IsTrue(isStopMarket), "stop-market", "market"))
            } else {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " createOrder() invalid type")))
            }
            params = this.Omit(params, []interface{}{"stopPrice", "stopLossPrice"})
            var response interface{} = nil
            if ccxt.IsTrue(isStopOrder) {
                if !ccxt.IsTrue(isStopLossPrice) {
                    panic(ccxt.ExchangeError(ccxt.Add(this.Id, " createOrder() zonda requires `triggerPrice` parameter for stop-limit or stop-market orders")))
                }
                ccxt.AddElementToObject(request, "stopRate", this.PriceToPrecision(symbol, stopLossPrice))
            ...
            var status interface{} = ccxt.Ternary(ccxt.IsTrue(completed), "closed", "open")
...
func  (this *zonda) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(side, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " cancelOrder() requires a `side` parameter (\"buy\" or \"sell\")")))
            }
            var price interface{} = this.SafeValue(params, "price")
            if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                panic(ccxt.ExchangeError(ccxt.Add(this.Id, " cancelOrder() requires a `price` parameter (float or string)")))
            }
...
func  (this *zonda) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp37967 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp37967, 0)
            params = ccxt.GetValue(__tmp37967, 1)
            this.CheckAddress(address)
...
func  (this *zonda) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    var url interface{} = this.ImplodeHostname(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), api))
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        var query interface{} = this.Omit(params, this.ExtractParams(path))
        url = ccxt.Add(url, ccxt.Add(ccxt.Add("/", this.ImplodeParams(path, params)), ".json"))
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            url = ccxt.Add(url, ccxt.Add("?", this.Urlencode(query)))
        }
    } else if ccxt.IsTrue(ccxt.IsEqual(api, "v1_01Public")) {
        var query interface{} = this.Omit(params, this.ExtractParams(path))
        url = ccxt.Add(url, ccxt.Add("/", this.ImplodeParams(path, params)))
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            url = ccxt.Add(url, ccxt.Add("?", this.Urlencode(query)))
        }
    } else if ccxt.IsTrue(ccxt.IsEqual(api, "v1_01Private")) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(method, "POST")) {
            ...
            payload = ccxt.Add(this.ApiKey, nonce)
        } else if ccxt.IsTrue(ccxt.IsEqual(body, nil)) {
            body = this.Json(query)
            payload = ccxt.Add(ccxt.Add(this.ApiKey, nonce), body)
        }
        headers = map[string]interface{} {
            "Request-Timestamp": nonce,
            "Operation-Id": this.Uuid(),
            "API-Key": this.ApiKey,
            "API-ccxt.Hash": this.Hmac(this.Encode(payload), this.Encode(this.Secret), ccxt.Sha512),
        ...
        headers = map[string]interface{} {
            ...
            "API-Key": this.ApiKey,
            "API-ccxt.Hash": this.Hmac(this.Encode(body), this.Encode(this.Secret), ccxt.Sha512),
        }
    }
    return map[string]interface{} {
        "url": url,
...
func  (this *zonda) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(response, "code")) {
        ...
        //      404 ccxt.Error. Wrong transaction type
        //      405 ccxt.Order with this id doesn't exist
        ...
        //      506 ccxt.Account locked. Please contact with customer service
