...
func NewBitfinexWs(userConfig map[string]interface{}) BitfinexWs {
   p := &bitfinexWs{}
   p.Init(userConfig)
   return BitfinexWs{
       bitfinexWs: p,
...
func (this *BitfinexWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *BitfinexWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *BitfinexWs) WatchMyTrades(options ...ccxt.WatchMyTradesOptions) ([]ccxt.Trade, error) {
...
func (this *BitfinexWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *BitfinexWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *BitfinexWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
...
func (this *BitfinexWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
