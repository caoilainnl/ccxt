...
func  (this *bitfinex) IsFiat(code interface{}) interface{}  {
    return (ccxt.InOp(ccxt.GetValue(this.Options, "fiat"), code))
}
func  (this *bitfinex) GetCurrencyId(code interface{}) interface{}  {
    return ccxt.Add("f", code)
}
func  (this *bitfinex) GetCurrencyName(code interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(ccxt.GetValue(this.Options, "currencyNames"), code)) {
        return ccxt.GetValue(ccxt.GetValue(this.Options, "currencyNames"), code)
    }
    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), code), " not supported for withdrawal")))
}
...
func  (this *bitfinex) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            spotMarketsInfofuturesMarketsInfomarginIdsVariable := (<-ccxt.PromiseAll([]interface{}{spotMarketsInfoPromise, futuresMarketsInfoPromise, marginIdsPromise}));
            spotMarketsInfo := ccxt.GetValue(spotMarketsInfofuturesMarketsInfomarginIdsVariable,0);
            futuresMarketsInfo := ccxt.GetValue(spotMarketsInfofuturesMarketsInfomarginIdsVariable,1);
            marginIds := ccxt.GetValue(spotMarketsInfofuturesMarketsInfomarginIdsVariable,2)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                var pair interface{} = ccxt.GetValue(markets, i)
                ...
                if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(id, "F0"), 0)) {
                    spot = false
                }
                ...
                if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(id, ":"), 0)) {
                    ...
                    baseId = ccxt.GetValue(parts, 0)
                    quoteId = ccxt.GetValue(parts, 1)
                } else {
                    baseId = ccxt.Slice(id, 0, 3)
                    quoteId = ccxt.Slice(id, 3, 6)
                }
                var base interface{} = this.SafeCurrencyCode(baseId)
                var quote interface{} = this.SafeCurrencyCode(quoteId)
                var splitBase interface{} = ccxt.Split(base, "F0")
                var splitQuote interface{} = ccxt.Split(quote, "F0")
                ...
                if ccxt.IsTrue(ccxt.IsTrue(spot) && ccxt.IsTrue(this.InArray(id, marginIds))) {
                    margin = true
                }
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "quoteId": quoteId,
                    "settleId": settleId,
                    "type": ccxt.Ternary(ccxt.IsTrue(spot), "spot", "swap"),
                    "spot": spot,
                    "margin": margin,
                    "swap": swap,
                    "future": false,
                    ...
                    "active": true,
                    "contract": swap,
                    "linear": ccxt.Ternary(ccxt.IsTrue(swap), true, nil),
                    "inverse": ccxt.Ternary(ccxt.IsTrue(swap), false, nil),
                    "contractSize": ccxt.Ternary(ccxt.IsTrue(swap), this.ParseNumber("1"), nil),
                    "expiry": nil,
                    "expiryDatetime": nil,
                    "strike": nil,
                    "optionType": nil,
                    "precision": map[string]interface{} {
                        "amount": ccxt.ParseInt("8"),
                        "price": ccxt.ParseInt("5"),
                    },
...
func  (this *bitfinex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var config interface{} = ccxt.Join(labels, ",")
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ccxt.GetValue(indexed, "networks"))); i++ {
                var networkObj interface{} = ccxt.GetValue(ccxt.GetValue(indexed, "networks"), i)
                ...
                ccxt.AppendToArray(&networksList, networkId)
                ccxt.AddElementToObject(indexedNetworks, networkName, networksList)
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ...
                if ccxt.IsTrue(ccxt.EndsWith(id, "F0")) {
                    continue
                }
                var code interface{} = this.SafeCurrencyCode(id)
                var label interface{} = this.SafeList(ccxt.GetValue(indexed, "label"), id, []interface{}{})
                var name interface{} = this.SafeString(label, 1)
                var pool interface{} = this.SafeList(ccxt.GetValue(indexed, "pool"), id, []interface{}{})
                var rawType interface{} = this.SafeString(pool, 1)
                var isCryptoCoin interface{} = ccxt.IsTrue((!ccxt.IsEqual(rawType, nil))) || ccxt.IsTrue((ccxt.InOp(ccxt.GetValue(indexed, "explorer"), id))) // "hacky" solution
                var typeVar interface{} = nil
                if ccxt.IsTrue(isCryptoCoin) {
                    typeVar = "crypto"
                }
                var feeValues interface{} = this.SafeList(ccxt.GetValue(indexed, "fees"), id, []interface{}{})
                var fees interface{} = this.SafeList(feeValues, 1, []interface{}{})
                var fee interface{} = this.SafeNumber(fees, 1)
                var undl interface{} = this.SafeList(ccxt.GetValue(indexed, "undl"), id, []interface{}{})
                var precision interface{} = "8" // default precision, todo: fix "magic constants"
                var fid interface{} = ccxt.Add("f", id)
                var dwStatuses interface{} = this.SafeList(ccxt.GetValue(indexed, "statuses"), id, []interface{}{})
                var depositEnabled interface{} = ccxt.IsEqual(this.SafeInteger(dwStatuses, 1), 1)
                var withdrawEnabled interface{} = ccxt.IsEqual(this.SafeInteger(dwStatuses, 2), 1)
                var networks interface{} = map[string]interface{} {}
                var netwokIds interface{} = this.SafeList(indexedNetworks, id, []interface{}{})
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(netwokIds)); j++ {
                    var networkId interface{} = ccxt.GetValue(netwokIds, j)
                    var network interface{} = this.NetworkIdToCode(networkId)
                    ccxt.AddElementToObject(networks, network, map[string]interface{} {
            "info": networkId,
            "id": ccxt.ToLower(networkId),
            "network": networkId,
            "active": nil,
            "deposit": nil,
            "withdraw": nil,
            ...
            "fee": fee,
            "precision": ccxt.ParseInt(precision),
            "limits": map[string]interface{} {
                "amount": map[string]interface{} {
...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(accountType, nil)) {
                ...
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " fetchBalance() type parameter must be one of "), ccxt.Join(keys, ", "))))
            }
            var isDerivative interface{} = ccxt.IsEqual(requestedType, "derivatives")
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(interest, "0")) {
                    ccxt.AddElementToObject(account, "debt", interest)
                }
                var typeVar interface{} = this.SafeString(balance, 0)
                var currencyId interface{} = this.SafeStringLower(balance, 1, "")
                var start interface{} = ccxt.Subtract(ccxt.GetLength(currencyId), 2)
                var isDerivativeCode interface{} = ccxt.IsEqual(ccxt.Slice(currencyId, start, nil), "f0")
                // this will only filter the derivative codes if the requestedType is 'derivatives'
                var derivativeCondition interface{} =         (!ccxt.IsTrue(isDerivative) || ccxt.IsTrue(isDerivativeCode))
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(accountType, typeVar))) && ccxt.IsTrue(derivativeCondition)) {
                    var code interface{} = this.SafeCurrencyCode(currencyId)
                    ccxt.AddElementToObject(account, "total", this.SafeString(balance, 2))
                    ccxt.AddElementToObject(account, "free", this.SafeString(balance, 4))
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(fromId, nil)) {
                var keys interface{} = ccxt.ObjectKeys(accountsByType)
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(this.Id, " transfer() fromAccount must be one of "), ccxt.Join(keys, ", "))))
            }
            var toId interface{} = this.SafeString(accountsByType, toAccount)
            if ccxt.IsTrue(ccxt.IsEqual(toId, nil)) {
                var keys interface{} = ccxt.ObjectKeys(accountsByType)
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(this.Id, " transfer() toAccount must be one of "), ccxt.Join(keys, ", "))))
            }
            ...
            //         null,
            //         "SUCCESS",
            //         "1.0 Tether USDt transfered from ccxt.Exchange to Margin"
            //     ]
            //
            var err interface{} = this.SafeString(response, 0)
            if ccxt.IsTrue(ccxt.IsEqual(err, "error")) {
                ...
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " "), message)))
            }
...
func  (this *bitfinex) ConvertDerivativesId(currency interface{}, typeVar interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, "derivatives")) {
        currencyId = this.SafeString(underlying, 0, transferId)
        var start interface{} = ccxt.Subtract(ccxt.GetArrayLength(currencyId), 2)
        var isDerivativeCode interface{} = ccxt.IsEqual(ccxt.Slice(currencyId, start, nil), "F0")
        if !ccxt.IsTrue(isDerivativeCode) {
            currencyId = ccxt.Add(currencyId, "F0")
        }
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "len", limit)
            }
            ...
            var priceIndex interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(fullRequest, "precision"), "R0"))), 1, 0)
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orderbook)); i++ {
                var order interface{} = ccxt.GetValue(orderbook, i)
                var price interface{} = this.SafeNumber(order, priceIndex)
                var signedAmount interface{} = this.SafeString(order, 2)
                var amount interface{} = ccxt.Precise.StringAbs(signedAmount)
                var side interface{} = ccxt.Ternary(ccxt.IsTrue(ccxt.Precise.StringGt(signedAmount, "0")), "bids", "asks")
                var resultSide interface{} = ccxt.GetValue(result, side)
                ccxt.AppendToArray(&resultSide, []interface{}{price, this.ParseNumber(amount)})
            }
            ccxt.AddElementToObject(result, "bids", this.SortBy(ccxt.GetValue(result, "bids"), 0, true))
            ccxt.AddElementToObject(result, "asks", this.SortBy(ccxt.GetValue(result, "asks"), 0))
...
func  (this *bitfinex) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = market
    var length interface{} =     ccxt.GetArrayLength(ticker)
    var isFetchTicker interface{} = ccxt.IsTrue((ccxt.IsEqual(length, 10))) || ccxt.IsTrue((ccxt.IsEqual(length, 16)))
    var symbol interface{} = nil
    var minusIndex interface{} = 0
    var isFundingCurrency interface{} = false
    if ccxt.IsTrue(isFetchTicker) {
        minusIndex = 1
        isFundingCurrency = (ccxt.IsEqual(length, 16))
    } else {
        var marketId interface{} = this.SafeString(ticker, 0)
        market = this.SafeMarket(marketId, market)
        isFundingCurrency = (ccxt.IsEqual(length, 17))
    }
    ...
    if ccxt.IsTrue(isFundingCurrency) {
        // per api docs, they are different array type
        last = this.SafeString(ticker, ccxt.Subtract(10, minusIndex))
        bid = this.SafeString(ticker, ccxt.Subtract(2, minusIndex))
        ask = this.SafeString(ticker, ccxt.Subtract(5, minusIndex))
        change = this.SafeString(ticker, ccxt.Subtract(8, minusIndex))
        percentage = this.SafeString(ticker, ccxt.Subtract(9, minusIndex))
        volume = this.SafeString(ticker, ccxt.Subtract(11, minusIndex))
        high = this.SafeString(ticker, ccxt.Subtract(12, minusIndex))
        low = this.SafeString(ticker, ccxt.Subtract(13, minusIndex))
    } else {
        // on trading pairs (ex. tBTCUSD or tHMSTR:USD)
        last = this.SafeString(ticker, ccxt.Subtract(7, minusIndex))
        bid = this.SafeString(ticker, ccxt.Subtract(1, minusIndex))
        ask = this.SafeString(ticker, ccxt.Subtract(3, minusIndex))
        change = this.SafeString(ticker, ccxt.Subtract(5, minusIndex))
        percentage = this.SafeString(ticker, ccxt.Subtract(6, minusIndex))
        percentage = ccxt.Precise.StringMul(percentage, "100")
        volume = this.SafeString(ticker, ccxt.Subtract(8, minusIndex))
        high = this.SafeString(ticker, ccxt.Subtract(9, minusIndex))
        low = this.SafeString(ticker, ccxt.Subtract(10, minusIndex))
    }
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes12998)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                var ids interface{} = this.MarketIds(symbols)
                ccxt.AddElementToObject(request, "symbols", ccxt.Join(ids, ","))
            } else {
                ccxt.AddElementToObject(request, "symbols", "ALL")
            }
...
func  (this *bitfinex) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var tradeLength interface{} =     ccxt.GetArrayLength(tradeList)
    var isPrivate interface{} =     (ccxt.IsGreaterThan(tradeLength, 5))
    var id interface{} = this.SafeString(tradeList, 0)
    var amountIndex interface{} = ccxt.Ternary(ccxt.IsTrue(isPrivate), 4, 2)
    var side interface{} = nil
    var amountString interface{} = this.SafeString(tradeList, amountIndex)
    var priceIndex interface{} = ccxt.Ternary(ccxt.IsTrue(isPrivate), 5, 3)
    var priceString interface{} = this.SafeString(tradeList, priceIndex)
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(amountString, 0), "-")) {
        side = "sell"
    ...
    var timestampIndex interface{} = ccxt.Ternary(ccxt.IsTrue(isPrivate), 2, 1)
    var timestamp interface{} = this.SafeInteger(tradeList, timestampIndex)
    if ccxt.IsTrue(isPrivate) {
        var marketId interface{} = ccxt.GetValue(tradeList, 1)
        symbol = this.SafeSymbol(marketId)
        orderId = this.SafeString(tradeList, 3)
        var maker interface{} = this.SafeInteger(tradeList, 8)
        takerOrMaker = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(maker, 1))), "maker", "taker")
        ...
        var orderType interface{} = ccxt.GetValue(tradeList, 6)
        typeVar = this.SafeString(ccxt.GetValue(this.Options, "exchangeTypes"), orderType)
    }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes14688)
            var paginate interface{} = false
            __tmp538964 := this.HandleOptionAndParams(params, "fetchTrades", "paginate")
            paginate = ccxt.GetValue(__tmp538964, 0)
            params = ccxt.GetValue(__tmp538964, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes147219 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    ccxt.PanicOnError(retRes147219)
                    ch <- retRes147219
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", ccxt.MathMin(limit, 10000)) // default 120, max 10000
            }
            ccxt.AddElementToObject(request, "sort", sort)
            __tmp799454 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp799454, 0)
            params = ccxt.GetValue(__tmp799454, 1)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(trades)); i++ {
                ccxt.AppendToArray(&tradesList, map[string]interface{} {
                    "result": ccxt.GetValue(trades, i),
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes15228)
            var paginate interface{} = false
            __tmp660078 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate")
            paginate = ccxt.GetValue(__tmp660078, 0)
            params = ccxt.GetValue(__tmp660078, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes152619 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    ccxt.PanicOnError(retRes152619)
                    ch <- retRes152619
                    return nil
            }
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(ccxt.IsEqual(limit, nil)) {
                ...
                limit = ccxt.MathMin(limit, 10000)
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            ...
            __tmp353685 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp353685, 0)
            params = ccxt.GetValue(__tmp353685, 1)
...
func  (this *bitfinex) ParseOrderStatus(status interface{}) interface{}  {
    ...
    var parts interface{} = ccxt.Split(status, " ")
...
func  (this *bitfinex) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var remaining interface{} = ccxt.Precise.StringAbs(this.SafeString(orderList, 6))
    var signedAmount interface{} = this.SafeString(orderList, 7)
    var amount interface{} = ccxt.Precise.StringAbs(signedAmount)
    var side interface{} = ccxt.Ternary(ccxt.IsTrue(ccxt.Precise.StringLt(signedAmount, "0")), "sell", "buy")
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(flags, nil)) {
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(flags)); i++ {
            if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(flags, i), "postOnly")) {
                postOnly = true
            }
        }
    }
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(orderType, "EXCHANGE STOP"))) || ccxt.IsTrue((ccxt.IsEqual(orderType, "EXCHANGE STOP LIMIT")))) {
        price = nil
        triggerPrice = this.SafeString(orderList, 16)
        if ccxt.IsTrue(ccxt.IsEqual(orderType, "EXCHANGE STOP LIMIT")) {
            price = this.SafeString(orderList, 19)
        }
    }
    var status interface{} = nil
    var statusString interface{} = this.SafeString(orderList, 13)
    if ccxt.IsTrue(!ccxt.IsEqual(statusString, nil)) {
        var parts interface{} = ccxt.Split(statusString, " @ ")
...
func  (this *bitfinex) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    * @param {string} [params.price_aux_limit] ccxt.Order price for stop limit orders
    ...
    */
    ...
    amountString = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), amountString, ccxt.Precise.StringNeg(amountString))
    var request interface{} = map[string]interface{} {
        "symbol": ccxt.GetValue(market, "id"),
        "amount": amountString,
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(trailingAmount, nil)) {
        ...
        ccxt.AddElementToObject(request, "price_trailing", trailingAmount)
    } else if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
        // request['price'] is taken as triggerPrice for stop orders
        ccxt.AddElementToObject(request, "price", this.PriceToPrecision(symbol, triggerPrice))
        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) {
            orderType = "STOP LIMIT"
            ccxt.AddElementToObject(request, "price_aux_limit", this.PriceToPrecision(symbol, price))
        } else {
            orderType = "STOP"
        }
    }
    ...
    var postOnly interface{} =     (ccxt.IsTrue(postOnlyParam) || ccxt.IsTrue((ccxt.IsEqual(timeInForce, "PO"))))
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue(ioc) || ccxt.IsTrue(fok))) && ccxt.IsTrue((ccxt.IsEqual(price, nil)))) {
        panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createOrder() requires a price argument with IOC and FOK orders")))
    }
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsTrue(ioc) || ccxt.IsTrue(fok))) && ccxt.IsTrue((ccxt.IsEqual(typeVar, "market")))) {
        panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createOrder() does not allow market IOC and FOK orders")))
    }
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(typeVar, "market"))) && ccxt.IsTrue((ccxt.IsEqual(triggerPrice, nil)))) {
    ...
    __tmp632007 := this.HandleMarginModeAndParams("createOrder", params)
    marginMode = ccxt.GetValue(__tmp632007, 0)
    params = ccxt.GetValue(__tmp632007, 1)
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.GetValue(market, "spot")) && ccxt.IsTrue((ccxt.IsEqual(marginMode, nil)))) {
        // The EXCHANGE prefix is only required for non margin spot markets
        orderType = ccxt.Add("EXCHANGE ", orderType)
    }
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(flags, 0)) {
        ccxt.AddElementToObject(request, "flags", flags)
    }
    if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
        ccxt.AddElementToObject(request, "cid", clientOrderId)
    }
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            //              [
            //                  [
            //                      95412102131,            // ccxt.Order ID
            //                      null,                   // Group ID
            //                      1653325121798,          // ccxt.Client ccxt.Order ID
            //                      "tDOGE:UST",            // ccxt.Market ID
            ...
            //                      "ACTIVE",               // ccxt.Order Status, see parseOrderStatus()
            //                      null,                   // _PLACEHOLDER
            //                      null,                   // _PLACEHOLDER
            //                      0.071,                  // Price (Stop Price for stop-limit orders, ccxt.Limit Price for limit orders)
            //                      0,                      // Average Price
            //                      0,                      // Trailing Price
            //                      0,                      // Auxiliary ccxt.Limit price (for STOP LIMIT)
            //                      null,                   // _PLACEHOLDER
            //                      null,                   // _PLACEHOLDER
            //                      null,                   // _PLACEHOLDER
            ...
            //                      null,                   // _PLACEHOLDER
            //                      null,                   // _PLACEHOLDER
            //                      {"$F7":1}               // additional meta information about the order ( $F7 = IS_POST_ONLY (0 if false, 1 if true), $F33 = ccxt.Leverage (int))
            //                  ]
            //              ],
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(status, "SUCCESS")) {
                var errorCode interface{} = ccxt.GetValue(response, 5)
                var errorText interface{} = ccxt.GetValue(response, 7)
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), ccxt.GetValue(response, 6)), ": "), errorText), " (#"), errorCode), ")")))
            }
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                ccxt.AppendToArray(&ordersRequests, []interface{}{"on", orderRequest})
            }
            var request interface{} = map[string]interface{} {
                "ops": ordersRequests,
            }
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                var individualOrder interface{} = ccxt.GetValue(entry, 4)
                ccxt.AppendToArray(&results, map[string]interface{} {
                    "result": ccxt.GetValue(individualOrder, 0),
                })
            }
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ccxt.AppendToArray(&ordersList, map[string]interface{} {
                    "result": ccxt.GetValue(orders, i),
                })
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(cid, nil)) {
                var cidDate interface{} = this.SafeValue(params, "cidDate") // client order id date
                if ccxt.IsTrue(ccxt.IsEqual(cidDate, nil)) {
                    panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " canceling an order by clientOrderId (\\'cid\\') requires both \\'cid\\' and \\'cid_date\\' (\\'YYYY-MM-DD\\')")))
                }
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ccxt.AddElementToObject(ids, i, this.ParseToNumeric(ccxt.GetValue(ids, i)))
            }
            var request interface{} = map[string]interface{} {
                "id": ids,
            }
...
func  (this *bitfinex) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(order, nil)) {
                panic(ccxt.OrderNotFound(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " order "), id), " not found")))
            }
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            //      [
            //          [
            //              95408916206,            // ccxt.Order ID
            //              null,                   // Group ccxt.Order ID
            //              1653322349926,          // ccxt.Client ccxt.Order ID
            //              "tDOGE:UST",            // ccxt.Market ID
            ...
            //              -10,                    // Original amount
            //              "EXCHANGE LIMIT",       // ccxt.Order type
            //              null,                   // Previous ccxt.Order Type
            //              null,                   // _PLACEHOLDER
            //              null,                   // _PLACEHOLDER
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ccxt.AppendToArray(&ordersList, map[string]interface{} {
                    "result": ccxt.GetValue(response, i),
                })
            }
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp500749 := this.HandleOptionAndParams(params, "fetchClosedOrders", "paginate")
            paginate = ccxt.GetValue(__tmp500749, 0)
            params = ccxt.GetValue(__tmp500749, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes220619 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    ccxt.PanicOnError(retRes220619)
                    ch <- retRes220619
                    return nil
            }
            var request interface{} = map[string]interface{} {}
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default 25, max 2500
            }
            __tmp729232 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp729232, 0)
            params = ccxt.GetValue(__tmp729232, 1)
            var market interface{} = nil
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
            ...
            //              null,                   // _PLACEHOLDER
            //              "4096",                 // Flags, see parseOrderFlags()
            //              "POSTONLY CANCELED",    // ccxt.Order Status, see parseOrderStatus()
            //              null,                   // _PLACEHOLDER
            //              null,                   // _PLACEHOLDER
            //              0.071,                  // Price
            //              0,                      // Average Price
            ...
            //              null,                   // _PLACEHOLDER
            //              null,                   // _PLACEHOLDER
            //              {"_$F7":1}              // additional meta information about the order ( _$F7 = IS_POST_ONLY (0 if false, 1 if true), _$F33 = ccxt.Leverage (int))
            //          ]
            //      ]
            //
            var ordersList interface{} = []interface{}{}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var orderId interface{} = ccxt.ParseInt(id)
            var request interface{} = map[string]interface{} {
                "id": orderId,
                "symbol": ccxt.GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // default 25, max 1000
            }
            var response interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(networkId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchDepositAddress() could not find a network for \\'"), code), "\\'. You can specify it by providing the \\'network\\' value inside params")))
            }
            ...
            //             "BTC", // CURRENCY_CODE ccxt.Currency code of new address
            //             null, // PLACEHOLDER
            ...
            var address interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(poolAddress, nil))), this.SafeString(result, 4), poolAddress)
            var tag interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(poolAddress, nil))), nil, this.SafeString(result, 4))
...
func  (this *bitfinex) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //         null, // not documented
    //         [
    //             0, // WITHDRAWAL_ID ccxt.Unique Withdrawal ID
    //             null, // PLACEHOLDER
    ...
    //             null, // PLACEHOLDER
    //             null, // PLACEHOLDER
    //             0.0004, // WITHDRAWAL_FEE ccxt.Fee on withdrawal
    //         ],
    //         null, // CODE null or integer Work in progress
    ...
    currency := ccxt.GetArg(optionalArgs, 0, nil)
    _ = currency
    var transactionLength interface{} =     ccxt.GetArrayLength(transaction)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(transactionLength, 8)) {
        ...
        status = "ok"
        if ccxt.IsTrue(ccxt.IsEqual(id, 0)) {
            id = nil
            status = "failed"
        }
        ...
        network = this.NetworkIdToCode(ccxt.ToUpper(networkId)) // withdraw returns in lowercase
    } else if ccxt.IsTrue(ccxt.IsEqual(transactionLength, 22)) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(signedAmount, nil)) {
            if ccxt.IsTrue(ccxt.Precise.StringLt(signedAmount, "0")) {
                typeVar = "withdrawal"
            } else {
                typeVar = "deposit"
            }
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Symbols)); i++ {
                ...
                if ccxt.IsTrue(ccxt.InOp(fiat, ccxt.GetValue(market, "quote"))) {
                    ccxt.AddElementToObject(fee, "maker", makerFeeFiat)
                    ccxt.AddElementToObject(fee, "taker", takerFeeFiat)
                } else if ccxt.IsTrue(ccxt.GetValue(market, "contract")) {
                    ccxt.AddElementToObject(fee, "maker", makerFeeDeriv)
                    ccxt.AddElementToObject(fee, "taker", takerFeeDeriv)
                } else {
                    ccxt.AddElementToObject(fee, "maker", makerFee)
                    ccxt.AddElementToObject(fee, "taker", takerFee)
                }
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ccxt.AddElementToObject(request, "limit", limit) // max 1000
            }
            var response interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                currency = this.Currency(code)
                ccxt.AddElementToObject(request, "currency", ccxt.GetValue(currency, "uppercaseId"))
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var networkId interface{} = this.SafeString(currencyNetwork, "id")
            if ccxt.IsTrue(ccxt.IsEqual(networkId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " withdraw() could not find a network for \\'"), code), "\\'. You can specify it by providing the \\'network\\' value inside params")))
            }
            var wallet interface{} = this.SafeString(params, "wallet", "exchange") // 'exchange', 'margin', 'funding' and also old labels 'exchange', 'trading', 'deposit', respectively
            params = this.Omit(params, "network", "wallet")
            var request interface{} = map[string]interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(tag, nil)) {
                ccxt.AddElementToObject(request, "payment_id", tag)
            }
            ...
            if ccxt.IsTrue(includeFee) {
                ccxt.AddElementToObject(request, "fee_deduct", 1)
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(statusMessage, "error")) {
                var feedback interface{} = ccxt.Add(ccxt.Add(this.Id, " "), response)
                var message interface{} = this.SafeString(response, 2, "")
                // same message as in v1
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(text, "success")) {
                this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), text, text)
            }
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ccxt.AppendToArray(&positionsList, map[string]interface{} {
                    "result": ccxt.GetValue(response, i),
                })
            }
...
func  (this *bitfinex) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    return this.SafePosition(map[string]interface{} {
        ...
        "markPrice": nil,
        "lastPrice": nil,
        "side": ccxt.Ternary(ccxt.IsTrue(ccxt.Precise.StringGt(amount, "0")), "long", "short"),
        "hedged": nil,
        "timestamp": timestamp,
        "datetime": this.Iso8601(timestamp),
        ...
        "initialMargin": this.ParseNumber(ccxt.Precise.StringMul(tradeAmount, tradePrice)),
...
func  (this *bitfinex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "v1")) {
        request = ccxt.Add(api, request)
    } else {
        request = ccxt.Add(this.Version, request)
    }
    var url interface{} = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), api), "/"), request)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var auth interface{} = ccxt.Add(ccxt.Add(ccxt.Add("/api/", request), nonce), body)
        var signature interface{} = this.Hmac(this.Encode(auth), this.Encode(this.Secret), ccxt.Sha384)
...
func  (this *bitfinex) HandleErrors(statusCode interface{}, statusText interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    } else if ccxt.IsTrue(ccxt.IsEqual(response, "")) {
        panic(ccxt.ExchangeError(ccxt.Add(this.Id, " returned empty response")))
    }
    if ccxt.IsTrue(ccxt.IsEqual(statusCode, 429)) {
        panic(ccxt.RateLimitExceeded(ccxt.Add(ccxt.Add(this.Id, " "), body)))
    }
    if ccxt.IsTrue(ccxt.IsEqual(statusCode, 500)) {
        // See https://docs.bitfinex.com/docs/abbreviations-glossary#section-errorinfo-codes
        var errorCode interface{} = this.SafeString(response, 1, "")
        var errorText interface{} = this.SafeString(response, 2, "")
        var feedback interface{} = ccxt.Add(ccxt.Add(this.Id, " "), errorText)
        this.ThrowBroadlyMatchedException(ccxt.GetValue(this.Exceptions, "broad"), errorText, feedback)
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errorCode, feedback)
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), errorText, feedback)
        panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), errorText), " (#"), errorCode), ")")))
    }
    return response
}
func  (this *bitfinex) ParseLedgerEntryType(typeVar interface{}) interface{}  {
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, nil)) {
        return nil
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "fee"), 0)) || ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "charged"), 0))) {
        return "fee"
    } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "rebate"), 0)) {
        return "rebate"
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "deposit"), 0)) || ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "withdrawal"), 0))) {
        return "transaction"
    } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "transfer"), 0)) {
        return "transfer"
    } else if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "payment"), 0)) {
        return "payout"
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "exchange"), 0)) || ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(typeVar, "position"), 0))) {
        return "trade"
    } else {
        return typeVar
    }
...
func  (this *bitfinex) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(description, nil)) {
        var parts interface{} = ccxt.Split(description, " @ ")
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes31118)
            var paginate interface{} = false
            __tmp457714 := this.HandleOptionAndParams(params, "fetchLedger", "paginate")
            paginate = ccxt.GetValue(__tmp457714, 0)
            params = ccxt.GetValue(__tmp457714, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes311519 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    ccxt.PanicOnError(retRes311519)
                    ch <- retRes311519
                    return nil
            }
            var currency interface{} = nil
            ...
            __tmp669747 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp669747, 0)
            params = ccxt.GetValue(__tmp669747, 1)
            var response interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                currency = this.Currency(code)
                ccxt.AddElementToObject(request, "currency", ccxt.GetValue(currency, "uppercaseId"))
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                ccxt.AppendToArray(&ledgerObjects, map[string]interface{} {
                    "result": item,
                })
            }
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchFundingRates() requires a symbols argument")))
            }
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes32268)
            var paginate interface{} = false
            __tmp697022 := this.HandleOptionAndParams(params, "fetchFundingRateHistory", "paginate")
            paginate = ccxt.GetValue(__tmp697022, 0)
            params = ccxt.GetValue(__tmp697022, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes323019 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    ccxt.PanicOnError(retRes323019)
                    ch <- retRes323019
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            __tmp738010 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp738010, 0)
            params = ccxt.GetValue(__tmp738010, 1)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                var fr interface{} = ccxt.GetValue(response, i)
            ...
            var ratesLength interface{} =     ccxt.GetArrayLength(rawRates)
            for i := 0; ccxt.IsLessThan(i, ratesLength); i++ {
                var index interface{} = ccxt.Subtract(ccxt.Subtract(ratesLength, i), 1)
                var valueAtIndex interface{} = ccxt.GetValue(rawRates, index)
                ccxt.AppendToArray(&reversedArray, valueAtIndex)
            }
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes34568)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "keys": ccxt.GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes35118)
            var paginate interface{} = false
            __tmp182031 := this.HandleOptionAndParams(params, "fetchOpenInterestHistory", "paginate")
            paginate = ccxt.GetValue(__tmp182031, 0)
            params = ccxt.GetValue(__tmp182031, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes351519 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    ccxt.PanicOnError(retRes351519)
                    ch <- retRes351519
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            __tmp994486 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp994486, 0)
            params = ccxt.GetValue(__tmp994486, 1)
...
func  (this *bitfinex) ParseOpenInterest(interest interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var interestLength interface{} =     ccxt.GetArrayLength(interest)
    var openInterestIndex interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(interestLength, 23))), 17, 18)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var paginate interface{} = false
            __tmp991295 := this.HandleOptionAndParams(params, "fetchLiquidations", "paginate")
            paginate = ccxt.GetValue(__tmp991295, 0)
            params = ccxt.GetValue(__tmp991295, 1)
            if ccxt.IsTrue(paginate) {
        
                    retRes365219 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    ccxt.PanicOnError(retRes365219)
                    ch <- retRes365219
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            __tmp587977 := this.HandleUntilOption("end", request, params)
            request = ccxt.GetValue(__tmp587977, 0)
            params = ccxt.GetValue(__tmp587977, 1)
...
func  (this *bitfinex) ParseLiquidation(liquidation interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var entry interface{} = ccxt.GetValue(liquidation, 0)
    var timestamp interface{} = this.SafeInteger(entry, 2)
    var marketId interface{} = this.SafeString(entry, 4)
    var contracts interface{} = ccxt.Precise.StringAbs(this.SafeString(entry, 5))
    ...
    return this.SafeLiquidation(map[string]interface{} {
        ...
        "quoteValue": this.ParseNumber(ccxt.Precise.StringMul(baseValue, price)),
        "timestamp": timestamp,
        "datetime": this.Iso8601(timestamp),
    })
}
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes37378)
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " setMargin() only support swap markets")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
...
func  (this *bitfinex) ParseMarginModification(data interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var marginStatusRaw interface{} = ccxt.GetValue(data, 0)
    var marginStatus interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginStatusRaw, 1))), "ok", "failed")
    return map[string]interface{} {
        "info": data,
        "symbol": ccxt.GetValue(market, "symbol"),
        "type": nil,
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(amount, nil)) {
                var amountString interface{} = this.AmountToPrecision(symbol, amount)
                amountString = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), amountString, ccxt.Precise.StringNeg(amountString))
                ccxt.AddElementToObject(request, "amount", amountString)
            }
            var triggerPrice interface{} = this.SafeString2(params, "stopPrice", "triggerPrice")
            var trailingAmount interface{} = this.SafeString(params, "trailingAmount")
            var timeInForce interface{} = this.SafeString(params, "timeInForce")
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(leverage, nil)) {
                ccxt.AddElementToObject(request, "lev", leverage)
            }
