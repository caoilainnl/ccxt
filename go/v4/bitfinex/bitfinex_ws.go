...
func NewBitfinexWsCore() bitfinexWs {
   p := bitfinexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *bitfinexWs) Describe() interface{}  {
...
func  (this *bitfinexWs) Subscribe(channel interface{}, symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(checksum) && !ccxt.IsTrue(ccxt.GetValue(ccxt.GetValue(client.(ccxt.ClientInterface).GetSubscriptions(), messageHash), "checksum"))) && ccxt.IsTrue((ccxt.IsEqual(channel, "book")))) {
                ...
                retRes6312 := (<-client.(ccxt.ClientInterface).Send(map[string]interface{} {
                    "event": "conf",
                    "flags": 131072,
                }))
...
func  (this *bitfinexWs) SubscribePrivate(messageHash interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes738 := (<-this.Authenticate())
            ccxt.PanicOnError(retRes738)
            var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "private")
        
                retRes7515 :=  (<-this.Watch(url, messageHash, nil, 1))
 ...
 */
func  (this *bitfinexWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitfinexWs) HandleOHLCV(client interface{}, message interface{}, subscription interface{})  {
    //
    // initial snapshot
    //   [
    //       341527, // channel id
 ...
 */
func  (this *bitfinexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bitfinexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *bitfinexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes24515 :=  (<-this.Subscribe("ticker", symbol, params))
...
func  (this *bitfinexWs) HandleMyTrade(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    // trade execution
    // [
    //     0,
...
func  (this *bitfinexWs) HandleTrades(client interface{}, message interface{}, subscription interface{})  {
    //
    // initial snapshot
    //
    //    [
...
func  (this *bitfinexWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    [
    //        1128060969, // id
    //        1654702500098, // mts
...
func  (this *bitfinexWs) HandleTicker(client interface{}, message interface{}, subscription interface{})  {
    //
    // [
    //    340432, // channel ID
    //     [
...
func  (this *bitfinexWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     [
    //         236.62,        // 1 BID float Price of last highest bid
    //         9.0029,        // 2 BID_SIZE float Size of the last highest bid
 ...
 */
func  (this *bitfinexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitfinexWs) HandleOrderBook(client interface{}, message interface{}, subscription interface{})  {
    //
...
func  (this *bitfinexWs) HandleChecksum(client interface{}, message interface{}, subscription interface{})  {
    //
    // [ 173904, "cs", -890884919 ]
    //
    var marketId interface{} = this.SafeString(subscription, "symbol")
 ...
 */
func  (this *bitfinexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.Add("balance:", balanceType)
                ...
                retRes71815 :=  (<-this.SubscribePrivate(messageHash))
...
func  (this *bitfinexWs) HandleBalance(client interface{}, message interface{}, subscription interface{})  {
    //
...
func  (this *bitfinexWs) ParseWsBalance(balance interface{}) interface{}  {
    //
    //     [
    //         "exchange",
    //         "LTC",
...
func  (this *bitfinexWs) HandleSystemStatus(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "event": "info",
    //         "version": 2,
...
func  (this *bitfinexWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "event": "subscribed",
    //         "channel": "book",
...
func  (this *bitfinexWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes88515 :=  <-future.(<-chan interface{})
...
func  (this *bitfinexWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
    var messageHash interface{} = "authenticated"
 ...
 */
func  (this *bitfinexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *bitfinexWs) HandleOrders(client interface{}, message interface{}, subscription interface{})  {
    //
    // limit order
    //    [
    //        0,
...
func  (this *bitfinexWs) ParseWsOrderStatus(status interface{}) interface{}  {
...
func  (this *bitfinexWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //   [
    //       97084883506, // order id
    //       null,
...
func  (this *bitfinexWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *bitfinexWs) Init(userConfig map[string]interface{}) {
    this.bitfinex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
