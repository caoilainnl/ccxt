...
func NewUpbitWsCore() upbitWs {
   p := upbitWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *upbitWs) Describe() interface{}  {
...
func  (this *upbitWs) WatchPublic(symbol interface{}, channel interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *upbitWs) WatchPublicMultiple(symbols interface{}, channel interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            "codes": marketIds,
                ...
                retRes9115 :=  (<-this.WatchMultiple(url, messageHashes, request, messageHashes, nil))
 ...
 */
func  (this *upbitWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *upbitWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *upbitWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *upbitWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *upbitWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *upbitWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *upbitWs) HandleTicker(client interface{}, message interface{})  {
...
func  (this *upbitWs) HandleOrderBook(client interface{}, message interface{})  {
    // { type: "orderbook",
    //   "code": "BTC-ETH",
...
func  (this *upbitWs) HandleTrades(client interface{}, message interface{})  {
    // { type: "trade",
    //   "code": "KRW-BTC",
...
func  (this *upbitWs) HandleOHLCV(client interface{}, message interface{})  {
    // {
    //     type: 'candle.1s',
    //     code: 'KRW-USDT',
...
func  (this *upbitWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *upbitWs) WatchPrivate(symbol interface{}, channel interface{}, messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *upbitWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *upbitWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *upbitWs) ParseWsOrderStatus(status interface{}) interface{}  {
...
func  (this *upbitWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // {
    //     "type": "myOrder",
    //     "code": "SGD-XRP",
...
func  (this *upbitWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    // see: parseWsOrder
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *upbitWs) HandleMyOrder(client interface{}, message interface{})  {
    // see: parseWsOrder
...
func  (this *upbitWs) HandleMyTrade(client interface{}, message interface{})  {
    // see: parseWsOrder
...
func  (this *upbitWs) HandleOrder(client interface{}, message interface{})  {
 ...
 */
func  (this *upbitWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *upbitWs) HandleBalance(client interface{}, message interface{})  {
    //
    // {
    //     "type": "myAsset",
...
func  (this *upbitWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *upbitWs) Init(userConfig map[string]interface{}) {
    this.upbit.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
