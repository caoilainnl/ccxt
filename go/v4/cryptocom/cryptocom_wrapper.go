 ...
 */
func (this *Cryptocom) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) (map[string]interface{}, error) {
 ...
 */
func (this *Cryptocom) CancelOrders(ids interface{}, options ...ccxt.CancelOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Cryptocom) FetchSettlementHistory(options ...ccxt.FetchSettlementHistoryOptions) (map[string]interface{}, error) {
