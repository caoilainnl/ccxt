...
func NewCryptocomWsCore() cryptocomWs {
   p := cryptocomWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *cryptocomWs) Describe() interface{}  {
...
func  (this *cryptocomWs) Pong(client interface{}, message interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                    
            {		 func(this *cryptocomWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *cryptocomWs) interface{} {
            					// catch block:
 ...
 */
func  (this *cryptocomWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *cryptocomWs) UnWatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *cryptocomWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp105047 := this.HandleOptionAndParams(params, "watchOrderBook", "bookSubscriptionType", "SNAPSHOT_AND_UPDATE")
            bookSubscriptionType = ccxt.GetValue(__tmp105047, 0)
            params = ccxt.GetValue(__tmp105047, 1)
            __tmp123564 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "bookSubscriptionType", bookSubscriptionType)
            bookSubscriptionType2 = ccxt.GetValue(__tmp123564, 0)
            params = ccxt.GetValue(__tmp123564, 1)
            ...
            __tmp695863 := this.HandleOptionAndParams(params, "watchOrderBook", "bookUpdateFrequency")
            bookUpdateFrequency = ccxt.GetValue(__tmp695863, 0)
            params = ccxt.GetValue(__tmp695863, 1)
            __tmp495536 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "bookUpdateFrequency", bookUpdateFrequency)
            bookUpdateFrequency2 = ccxt.GetValue(__tmp495536, 0)
            params = ccxt.GetValue(__tmp495536, 1)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *cryptocomWs) UnWatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var bookSubscriptionType interface{} = nil
            var bookSubscriptionType2 interface{} = nil
            __tmp805644 := this.HandleOptionAndParams(params, "watchOrderBook", "bookSubscriptionType", "SNAPSHOT_AND_UPDATE")
            bookSubscriptionType = ccxt.GetValue(__tmp805644, 0)
            params = ccxt.GetValue(__tmp805644, 1)
            __tmp50058 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "bookSubscriptionType", bookSubscriptionType)
            bookSubscriptionType2 = ccxt.GetValue(__tmp50058, 0)
            params = ccxt.GetValue(__tmp50058, 1)
            ccxt.AddElementToObject(ccxt.GetValue(params, "params"), "bookSubscriptionType", bookSubscriptionType2)
            var bookUpdateFrequency interface{} = nil
            var bookUpdateFrequency2 interface{} = nil
            __tmp82799 := this.HandleOptionAndParams(params, "watchOrderBook", "bookUpdateFrequency")
            bookUpdateFrequency = ccxt.GetValue(__tmp82799, 0)
            params = ccxt.GetValue(__tmp82799, 1)
            __tmp203046 := this.HandleOptionAndParams(params, "watchOrderBookForSymbols", "bookUpdateFrequency", bookUpdateFrequency)
            bookUpdateFrequency2 = ccxt.GetValue(__tmp203046, 0)
            params = ccxt.GetValue(__tmp203046, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(bookUpdateFrequency2, nil)) {
                ccxt.AddElementToObject(ccxt.GetValue(params, "params"), "bookSubscriptionType", bookUpdateFrequency2)
            }
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
...
func  (this *cryptocomWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *cryptocomWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *cryptocomWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // snapshot
    //    {
 ...
 */
func  (this *cryptocomWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *cryptocomWs) UnWatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *cryptocomWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *cryptocomWs) UnWatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleTrades(client interface{}, message interface{})  {
    //
    // {
    //     "code": 0,
    //     "method": "subscribe",
 ...
 */
func  (this *cryptocomWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *cryptocomWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *cryptocomWs) UnWatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *cryptocomWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *cryptocomWs) UnWatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleTicker(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *cryptocomWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //       "h": "2400.20",
    //       "l": "2277.10",
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *cryptocomWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            newTickers:= (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, nil))
...
func  (this *cryptocomWs) HandleBidAsk(client interface{}, message interface{})  {
...
func  (this *cryptocomWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var marketId interface{} = this.SafeString(ticker, "i")
 ...
 */
func  (this *cryptocomWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *cryptocomWs) UnWatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //  {
    //       "instrument_name": "BTC_USDT",
 ...
 */
func  (this *cryptocomWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleOrders(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    //    {
    //        "method": "subscribe",
    //        "result": {
 ...
 */
func  (this *cryptocomWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) SetPositionsCache(client interface{}, typeVar interface{}, optionalArgs ...interface{})  {
    symbols := ccxt.GetArg(optionalArgs, 0, nil)
    _ = symbols
...
func  (this *cryptocomWs) LoadPositionsSnapshot(client interface{}, messageHash interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandlePositions(client interface{}, message interface{})  {
    //
    //    {
 ...
 */
func  (this *cryptocomWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleBalance(client interface{}, message interface{})  {
    //
    //     {
    //         "id": 1,
    //         "method": "subscribe",
 ...
 */
func  (this *cryptocomWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *cryptocomWs) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleOrder(client interface{}, message interface{})  {
    //
    //    {
    //        "id": 1,
    //        "method": "private/create-order",
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *cryptocomWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *cryptocomWs) CancelAllOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleCancelAllOrders(client interface{}, message interface{})  {
    //
    //    {
    //        "id": 1688914586647,
    //        "method": "private/cancel-all-orders",
...
func  (this *cryptocomWs) WatchPublic(messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) WatchPublicMultiple(messageHashes interface{}, topics interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.DeepExtend(request, params)
                ...
                retRes122715 :=  (<-this.WatchMultiple(url, messageHashes, message, messageHashes, nil))
...
func  (this *cryptocomWs) UnWatchPublicMultiple(topic interface{}, symbols interface{}, messageHashes interface{}, subMessageHashes interface{}, topics interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) WatchPrivateRequest(nonce interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) WatchPrivateSubscribe(messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *cryptocomWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        "id": 0,
    //        "code": 10004,
    ...
    {		ret__ := func(this *cryptocomWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
...
func  (this *cryptocomWs) HandleSubscribe(client interface{}, message interface{})  {
...
func  (this *cryptocomWs) HandleMessage(client interface{}, message interface{})  {
    //
    // ping
    //    {
    //        "id": 1587523073344,
...
func  (this *cryptocomWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes142015 :=  <-future.(<-chan interface{})
...
func  (this *cryptocomWs) HandlePing(client interface{}, message interface{})  {
    this.Spawn(this.Pong, client, message)
}
func  (this *cryptocomWs) HandleAuthenticate(client interface{}, message interface{})  {
    //
    //  { id: 1648132625434, method: "public/auth", code: 0 }
    //
...
func  (this *cryptocomWs) HandleUnsubscribe(client interface{}, message interface{})  {
    var id interface{} = this.SafeString(message, "id")
...
func (this *cryptocomWs) Init(userConfig map[string]interface{}) {
    this.cryptocom.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
