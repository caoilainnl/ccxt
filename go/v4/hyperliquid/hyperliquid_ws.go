...
func NewHyperliquidWsCore() hyperliquidWs {
   p := hyperliquidWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *hyperliquidWs) Describe() interface{}  {
 ...
 */
func  (this *hyperliquidWs) CreateOrdersWs(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *hyperliquidWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes1008 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes1008)
            ...
            var orderInfo interface{} = this.SafeDict(parsedOrder, "info")
            // handle potential error here
            this.HandleErrors(nil, nil, nil, nil, nil, this.Json(orderInfo), orderInfo, nil, nil)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *hyperliquidWs) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *hyperliquidWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *hyperliquidWs) UnWatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes20615 :=  (<-this.Watch(url, messageHash, message, messageHash))
...
func  (this *hyperliquidWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "l2Book",
    //         "data": {
 ...
 */
func  (this *hyperliquidWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *hyperliquidWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *hyperliquidWs) UnWatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes32315 :=  (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash))
                ccxt.PanicOnError(retRes32315)
                ch <- retRes32315
                return nil
 ...
 */
func  (this *hyperliquidWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp197627 := this.HandlePublicAddress("watchMyTrades", params)
            userAddress = ccxt.GetValue(__tmp197627, 0)
            params = ccxt.GetValue(__tmp197627, 1)
...
func  (this *hyperliquidWs) HandleWsTickers(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "webData2",
    //         "data": {
...
func  (this *hyperliquidWs) ParseWsTicker(rawTicker interface{}, optionalArgs ...interface{}) interface{}  {
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    return this.ParseTicker(rawTicker, market)
}
func  (this *hyperliquidWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "userFills",
    //         "data": {
...
func  (this *hyperliquidWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
 */
func  (this *hyperliquidWs) UnWatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes55715 :=  (<-this.Watch(url, messageHash, message, messageHash))
...
func  (this *hyperliquidWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     {
    //         "channel": "trades",
    //         "data": [
...
func  (this *hyperliquidWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchMyTrades
    //
    //     {
 ...
 */
func  (this *hyperliquidWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *hyperliquidWs) UnWatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var message interface{} = this.Extend(request, params)
                ...
                retRes72215 :=  (<-this.Watch(url, messagehash, message, messagehash))
...
func  (this *hyperliquidWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         channel: 'candle',
    //         data: {
...
func  (this *hyperliquidWs) HandleWsPost(client interface{}, message interface{})  {
    //    {
    //         channel: "post",
    //         data: {
    //             id: <number>,
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *hyperliquidWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var userAddress interface{} = nil
            __tmp761382 := this.HandlePublicAddress("watchOrders", params)
            userAddress = ccxt.GetValue(__tmp761382, 0)
            params = ccxt.GetValue(__tmp761382, 1)
...
func  (this *hyperliquidWs) HandleOrder(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *hyperliquidWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "channel": "error",
...
func  (this *hyperliquidWs) HandleOrderBookUnsubscription(client interface{}, subscription interface{})  {
    //
    //        "subscription":{
    //           "type":"l2Book",
    //           "coin":"BTC",
...
func  (this *hyperliquidWs) HandleTradesUnsubscription(client interface{}, subscription interface{})  {
    //
    var coin interface{} = this.SafeString(subscription, "coin")
    var marketId interface{} = this.CoinToMarketId(coin)
    var symbol interface{} = this.SafeSymbol(marketId)
...
func  (this *hyperliquidWs) HandleTickersUnsubscription(client interface{}, subscription interface{})  {
    //
    var subMessageHash interface{} = "tickers"
    var messageHash interface{} = ccxt.Add("unsubscribe:", subMessageHash)
    this.CleanUnsubscription(client.(*ccxt.Client), subMessageHash, messageHash)
...
func  (this *hyperliquidWs) HandleOHLCVUnsubscription(client interface{}, subscription interface{})  {
    var coin interface{} = this.SafeString(subscription, "coin")
    var marketId interface{} = this.CoinToMarketId(coin)
    var symbol interface{} = this.SafeSymbol(marketId)
...
func  (this *hyperliquidWs) HandleSubscriptionResponse(client interface{}, message interface{})  {
    // {
...
func  (this *hyperliquidWs) HandleMessage(client interface{}, message interface{})  {
    //
    // {
    //     "channel":"subscriptionResponse",
    //     "data":{
...
func  (this *hyperliquidWs) Ping(client interface{}) interface{}  {
    return map[string]interface{} {
        "method": "ping",
    }
}
func  (this *hyperliquidWs) HandlePong(client interface{}, message interface{}) interface{}  {
    //
    //   {
    //       "channel": "pong"
    //   }
...
func  (this *hyperliquidWs) RequestId() interface{}  {
...
func  (this *hyperliquidWs) WrapAsPostAction(request interface{}) interface{}  {
...
func (this *hyperliquidWs) Init(userConfig map[string]interface{}) {
    this.hyperliquid.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
