 ...
 */
func (this *Paradex) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) (map[string]interface{}, error) {
 ...
 * @returns {object} response from the exchange
 */
func (this *Paradex) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (map[string]interface{}, error) {
