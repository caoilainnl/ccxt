...
func NewParadexWsCore() paradexWs {
   p := paradexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *paradexWs) Describe() interface{}  {
 ...
 */
func  (this *paradexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *paradexWs) HandleTrade(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
 ...
 */
func  (this *paradexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *paradexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(inserts)); i++ {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(side, "BUY")) {
                ...
                value := ccxt.GetValue(orderbookData, "bids")
                ccxt.AppendToArray(&value, []interface{}{price, size})
            
        } else {
            
                value := ccxt.GetValue(orderbookData, "asks")
                ccxt.AppendToArray(&value, []interface{}{price, size})
 ...
 */
func  (this *paradexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *paradexWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            newTickers:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(request, params), messageHashes, nil))
...
func  (this *paradexWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "method": "subscription",
...
func  (this *paradexWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "jsonrpc": "2.0",
    //         "id": 0,
    ...
    //     }
    //
    var err interface{} = this.SafeDict(message, "error")
    if ccxt.IsTrue(ccxt.IsEqual(err, nil)) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(errorCode, nil)) {
            var feedback interface{} = ccxt.Add(ccxt.Add(this.Id, " "), this.Json(err))
            this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), "-32600", feedback)
            var messageString interface{} = this.SafeValue(err, "message")
...
func  (this *paradexWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *paradexWs) Init(userConfig map[string]interface{}) {
    this.paradex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
