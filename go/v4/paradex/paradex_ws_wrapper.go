...
func NewParadexWs(userConfig map[string]interface{}) ParadexWs {
   p := &paradexWs{}
   p.Init(userConfig)
   return ParadexWs{
       paradexWs: p,
...
func (this *ParadexWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *ParadexWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *ParadexWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *ParadexWs) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
