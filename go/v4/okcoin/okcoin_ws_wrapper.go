...
func NewOkcoinWs(userConfig map[string]interface{}) OkcoinWs {
   p := &okcoinWs{}
   p.Init(userConfig)
   return OkcoinWs{
       okcoinWs: p,
...
func (this *OkcoinWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *OkcoinWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *OkcoinWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *OkcoinWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *OkcoinWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
...
func (this *OkcoinWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
