...
func NewOkcoinWsCore() okcoinWs {
   p := okcoinWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *okcoinWs) Describe() interface{}  {
...
func  (this *okcoinWs) Subscribe(channel interface{}, symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
 ...
 */
func  (this *okcoinWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *okcoinWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *okcoinWs) HandleOrders(client interface{}, message interface{}, optionalArgs ...interface{})  {
    //
    // {
    //     "table": "spot/order",
    //     "data": [
 ...
 */
func  (this *okcoinWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *okcoinWs) HandleTrade(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "table": "spot/trade",
    //         "data": [
...
func  (this *okcoinWs) HandleTicker(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "table": "spot/ticker",
    //         "data": [
 ...
 */
func  (this *okcoinWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *okcoinWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
 ...
 */
func  (this *okcoinWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *okcoinWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *okcoinWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *okcoinWs) HandleOrderBookMessage(client interface{}, message interface{}, orderbook interface{}) interface{}  {
    //
    //     {
    //         "instrument_id": "BTC-USDT",
    //         "asks": [
...
func  (this *okcoinWs) HandleOrderBook(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *okcoinWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(future, nil)) {
                ...
                retRes50015 :=  <-future.(<-chan interface{})
 ...
 */
func  (this *okcoinWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *okcoinWs) SubscribeToUserAccount(negotiation interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *okcoinWs) HandleBalance(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
...
func  (this *okcoinWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *okcoinWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    //
...
func  (this *okcoinWs) Ping(client interface{}) interface{}  {
    // okex does not support built-in ws protocol-level ping-pong
    // instead it requires custom text-based ping-pong
    return "ping"
}
func  (this *okcoinWs) HandlePong(client interface{}, message interface{}) interface{}  {
    client.(*ccxt.Client).LastPong = this.Milliseconds()
    return message
}
func  (this *okcoinWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    ...
    {		ret__ := func(this *okcoinWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *okcoinWs) interface{} {
    					// catch block:
...
func  (this *okcoinWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *okcoinWs) Init(userConfig map[string]interface{}) {
    this.okcoin.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
