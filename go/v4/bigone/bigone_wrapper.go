 ...
 */
func (this *Bigone) FetchCurrencies(params ...interface{}) (ccxt.Currencies, error) {
 ...
 */
func (this *Bigone) FetchMarkets(params ...interface{}) ([]ccxt.MarketInterface, error) {
 ...
 */
func (this *Bigone) FetchTicker(symbol string, options ...ccxt.FetchTickerOptions) (ccxt.Ticker, error) {
 ...
 */
func (this *Bigone) FetchTickers(options ...ccxt.FetchTickersOptions) (ccxt.Tickers, error) {
 ...
 */
func (this *Bigone) FetchOrderBook(symbol string, options ...ccxt.FetchOrderBookOptions) (ccxt.OrderBook, error) {
 ...
 */
func (this *Bigone) FetchTrades(symbol string, options ...ccxt.FetchTradesOptions) ([]ccxt.Trade, error) {
 ...
 */
func (this *Bigone) FetchOHLCV(symbol string, options ...ccxt.FetchOHLCVOptions) ([]ccxt.OHLCV, error) {
 ...
 */
func (this *Bigone) FetchBalance(params ...interface{}) (ccxt.Balances, error) {
 ...
 */
func (this *Bigone) CreateMarketBuyOrderWithCost(symbol string, cost float64, options ...ccxt.CreateMarketBuyOrderWithCostOptions) (ccxt.Order, error) {
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bigone) CreateOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bigone) CancelOrder(id string, options ...ccxt.CancelOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Bigone) CancelAllOrders(options ...ccxt.CancelAllOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bigone) FetchOrder(id string, options ...ccxt.FetchOrderOptions) (ccxt.Order, error) {
 ...
 */
func (this *Bigone) FetchOrders(options ...ccxt.FetchOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Bigone) FetchMyTrades(options ...ccxt.FetchMyTradesOptions) ([]ccxt.Trade, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bigone) FetchOpenOrders(options ...ccxt.FetchOpenOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Bigone) FetchClosedOrders(options ...ccxt.FetchClosedOrdersOptions) ([]ccxt.Order, error) {
 ...
 */
func (this *Bigone) FetchDepositAddress(code string, options ...ccxt.FetchDepositAddressOptions) (ccxt.DepositAddress, error) {
 ...
 */
func (this *Bigone) FetchDeposits(options ...ccxt.FetchDepositsOptions) ([]ccxt.Transaction, error) {
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Bigone) FetchWithdrawals(options ...ccxt.FetchWithdrawalsOptions) ([]ccxt.Transaction, error) {
 ...
 */
func (this *Bigone) Transfer(code string, amount float64, fromAccount string, toAccount string, options ...ccxt.TransferOptions) (ccxt.TransferEntry, error) {
 ...
 */
func (this *Bigone) Withdraw(code string, amount float64, address string, options ...ccxt.WithdrawOptions) (ccxt.Transaction, error) {
