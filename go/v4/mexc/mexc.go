...
func  (this *mexc) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "options": map[string]interface{} {
            ...
            "maxTimeTillEnd": ccxt.Subtract(ccxt.Multiply(ccxt.Multiply(90, 86400), 1000), 1),
            "broker": "CCXT",
        },
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "400": ccxt.BadRequest,
                "600": ccxt.BadRequest,
                "70011": ccxt.PermissionDenied,
                "88004": ccxt.InsufficientFunds,
                "88009": ccxt.ExchangeError,
                "88013": ccxt.InvalidOrder,
                "88015": ccxt.InsufficientFunds,
                "700003": ccxt.InvalidNonce,
                "26": ccxt.ExchangeError,
                "602": ccxt.AuthenticationError,
                "10001": ccxt.AuthenticationError,
                "10007": ccxt.BadSymbol,
                "10015": ccxt.BadRequest,
                "10072": ccxt.BadRequest,
                "10073": ccxt.BadRequest,
                "10095": ccxt.InvalidOrder,
                "10096": ccxt.InvalidOrder,
                "10097": ccxt.InvalidOrder,
                "10098": ccxt.InvalidOrder,
                "10099": ccxt.BadRequest,
                "10100": ccxt.BadRequest,
                "10102": ccxt.InvalidOrder,
                "10103": ccxt.ExchangeError,
                "10200": ccxt.BadRequest,
                "10201": ccxt.BadRequest,
                "10202": ccxt.BadRequest,
                "10206": ccxt.BadRequest,
                "10211": ccxt.BadRequest,
                "10212": ccxt.BadRequest,
                "10216": ccxt.ExchangeError,
                "10219": ccxt.ExchangeError,
                "10222": ccxt.BadRequest,
                "10232": ccxt.BadRequest,
                "10259": ccxt.ExchangeError,
                "10265": ccxt.ExchangeError,
                "10268": ccxt.BadRequest,
                "20001": ccxt.ExchangeError,
                "20002": ccxt.ExchangeError,
                "22222": ccxt.BadRequest,
                "30000": ccxt.ExchangeError,
                "30001": ccxt.InvalidOrder,
                "30002": ccxt.InvalidOrder,
                "30003": ccxt.InvalidOrder,
                "30010": ccxt.InvalidOrder,
                "30014": ccxt.InvalidOrder,
                "30016": ccxt.InvalidOrder,
                "30018": ccxt.AccountSuspended,
                "30020": ccxt.AuthenticationError,
                "30021": ccxt.BadRequest,
                "30025": ccxt.InvalidOrder,
                "30026": ccxt.BadRequest,
                "30027": ccxt.InvalidOrder,
                "30028": ccxt.InvalidOrder,
                "30029": ccxt.InvalidOrder,
                "30032": ccxt.InvalidOrder,
                "30041": ccxt.InvalidOrder,
                "60005": ccxt.ExchangeError,
                "700001": ccxt.AuthenticationError,
                "700002": ccxt.AuthenticationError,
                "700004": ccxt.BadRequest,
                "700005": ccxt.InvalidNonce,
                "700006": ccxt.BadRequest,
                "700007": ccxt.AuthenticationError,
                "700008": ccxt.BadRequest,
                "700013": ccxt.AuthenticationError,
                "730001": ccxt.BadRequest,
                "730002": ccxt.BadRequest,
                "730000": ccxt.ExchangeError,
                "730003": ccxt.ExchangeError,
                "730100": ccxt.ExchangeError,
                "730600": ccxt.BadRequest,
                "730601": ccxt.BadRequest,
                "730602": ccxt.BadRequest,
                "730700": ccxt.BadRequest,
                "730701": ccxt.BadRequest,
                "730702": ccxt.BadRequest,
                "730703": ccxt.BadRequest,
                "730704": ccxt.BadRequest,
                "730705": ccxt.BadRequest,
                "730706": ccxt.BadRequest,
                "730707": ccxt.BadRequest,
                "730101": ccxt.BadRequest,
                "140001": ccxt.BadRequest,
                "140002": ccxt.AuthenticationError,
            },
            "broad": map[string]interface{} {
                "ccxt.Order quantity error, please try to modify.": ccxt.BadRequest,
                "Combination of optional parameters invalid": ccxt.BadRequest,
                "api market order is disabled": ccxt.BadRequest,
                "Contract not allow place order!": ccxt.InvalidOrder,
                "Oversold": ccxt.InsufficientFunds,
                "Insufficient position": ccxt.InsufficientFunds,
                "Insufficient balance!": ccxt.InsufficientFunds,
                "Bid price is great than max allow price": ccxt.InvalidOrder,
                "Invalid symbol.": ccxt.BadSymbol,
                "Param error!": ccxt.BadRequest,
...
func  (this *mexc) FetchStatus(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                status = ccxt.Ternary(ccxt.IsTrue(length), this.Json(response), "ok")
            } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
                response = (<-this.ContractPublicGetPing(query))
                //
                //     {"success":true,"code":"0","data":"1648124374985"}
                //
                status = ccxt.Ternary(ccxt.IsTrue(this.SafeValue(response, "success")), "ok", this.Json(response))
...
func  (this *mexc) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                ccxt.PanicOnError(retRes115112)
            }
            var spotMarketPromise interface{} = this.FetchSpotMarkets(params)
            var swapMarketPromise interface{} = this.FetchSwapMarkets(params)
            spotMarketswapMarketVariable := (<-ccxt.PromiseAll([]interface{}{spotMarketPromise, swapMarketPromise}));
            spotMarket := ccxt.GetValue(spotMarketswapMarketVariable,0);
            swapMarket := ccxt.GetValue(spotMarketswapMarketVariable,1)
...
func  (this *mexc) FetchSpotMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(status, "1"))) && ccxt.IsTrue((isSpotTradingAllowed))) {
                    active = true
                }
...
func  (this *mexc) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(response, "lastUpdateId"))
                ...
                ccxt.AddElementToObject(orderbook, "nonce", this.SafeInteger(data, "version"))
            }
...
func  (this *mexc) ParseBidAsk(bidask interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(count, nil)) {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(until, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchTrades() requires an until parameter when since is provided")))
                    }
                }
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchTrades() requires a since parameter when until is provided")))
                    }
                ...
                if ccxt.IsTrue(ccxt.IsEqual(method, "spotPublicGetAggTrades")) {
                    trades = (<-this.SpotPublicGetAggTrades(this.Extend(request, params)))
                } else if ccxt.IsTrue(ccxt.IsEqual(method, "spotPublicGetHistoricalTrades")) {
                    trades = (<-this.SpotPublicGetHistoricalTrades(this.Extend(request, params)))
                } else if ccxt.IsTrue(ccxt.IsEqual(method, "spotPublicGetTrades")) {
                    trades = (<-this.SpotPublicGetTrades(this.Extend(request, params)))
                } else {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchTrades() not support this method")))
                }
            } else if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
...
func  (this *mexc) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    // if swap
    if ccxt.IsTrue(ccxt.InOp(trade, "v")) {
        //
        // swap: fetchTrades
        //
        //     {
        ...
        // if swap
        if ccxt.IsTrue(ccxt.InOp(trade, "positionMode")) {
            ...
            takerOrMaker = ccxt.Ternary(ccxt.IsTrue(this.SafeValue(trade, "taker")), "taker", "maker")
        } else {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(buyerMaker, nil)) {
                side = ccxt.Ternary(ccxt.IsTrue(buyerMaker), "sell", "buy")
                takerOrMaker = "taker"
            }
            var feeAsset interface{} = this.SafeString(trade, "commissionAsset")
            if ccxt.IsTrue(!ccxt.IsEqual(feeAsset, nil)) {
                fee = map[string]interface{} {
...
func  (this *mexc) SyntheticTradeId(optionalArgs ...interface{}) interface{}  {
    ...
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    timestamp := ccxt.GetArg(optionalArgs, 1, nil)
    _ = timestamp
    side := ccxt.GetArg(optionalArgs, 2, nil)
    _ = side
    amount := ccxt.GetArg(optionalArgs, 3, nil)
    _ = amount
    price := ccxt.GetArg(optionalArgs, 4, nil)
    _ = price
    orderType := ccxt.GetArg(optionalArgs, 5, nil)
    _ = orderType
    takerOrMaker := ccxt.GetArg(optionalArgs, 6, nil)
    _ = takerOrMaker
    var id interface{} = ""
    if ccxt.IsTrue(!ccxt.IsEqual(timestamp, nil)) {
        id = ccxt.Add(ccxt.Add(this.NumberToString(timestamp), "-"), this.SafeString(market, "id", "_"))
        if ccxt.IsTrue(!ccxt.IsEqual(side, nil)) {
            id = ccxt.Add(id, ccxt.Add("-", side))
        }
        if ccxt.IsTrue(!ccxt.IsEqual(amount, nil)) {
            id = ccxt.Add(id, ccxt.Add("-", this.NumberToString(amount)))
        }
        if ccxt.IsTrue(!ccxt.IsEqual(price, nil)) {
            id = ccxt.Add(id, ccxt.Add("-", this.NumberToString(price)))
        }
        if ccxt.IsTrue(!ccxt.IsEqual(takerOrMaker, nil)) {
            id = ccxt.Add(id, ccxt.Add("-", takerOrMaker))
        }
        if ccxt.IsTrue(!ccxt.IsEqual(orderType, nil)) {
            id = ccxt.Add(id, ccxt.Add("-", orderType))
        }
    }
    return id
}
...
func  (this *mexc) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var maxLimit interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.GetValue(market, "spot"))), 1000, 2000)
            var paginate interface{} = false
            __tmp238265 := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate", false)
            paginate = ccxt.GetValue(__tmp238265, 0)
            params = ccxt.GetValue(__tmp238265, 1)
            if ccxt.IsTrue(paginate) {
                    ...
                    ccxt.PanicOnError(retRes178519)
                    ch <- retRes178519
                    return nil
            }
            var options interface{} = this.SafeValue(this.Options, "timeframes", map[string]interface{} {})
            var timeframes interface{} = this.SafeValue(options, ccxt.GetValue(market, "type"), map[string]interface{} {})
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(until, nil)) {
                        ...
                        var end interface{} = this.Sum(since, ccxt.Multiply(maxLimit, duration))
                        var now interface{} = this.Milliseconds()
                        ccxt.AddElementToObject(request, "endTime", ccxt.MathMin(end, now))
                    }
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "limit", limit)
                ...
                var response interface{} = nil
                if ccxt.IsTrue(ccxt.IsEqual(priceType, "default")) {
                ...
                } else if ccxt.IsTrue(ccxt.IsEqual(priceType, "mark")) {
                    response = (<-this.ContractPublicGetKlineFairPriceSymbol(this.Extend(request, params)))
                } else {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchOHLCV() not support this price type, [default, index, mark]")))
                }
                //
                //     {
                //         "success":true,
...
func  (this *mexc) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                isSingularMarket = ccxt.IsEqual(length, 1)
            ...
            if ccxt.IsTrue(isSingularMarket) {
...
func  (this *mexc) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    // if swap
    if ccxt.IsTrue(ccxt.IsTrue(isSwap) || ccxt.IsTrue((ccxt.InOp(ticker, "timestamp")))) {
        //
        //     {
        //         "symbol": "ETH_USDT",
        //         "lastPrice": 3581.3,
        ...
        changePcnt = ccxt.Precise.StringMul(changePcnt, "100")
    } else {
        //
        //     {
        //         "symbol": "BTCUSDT",
        ...
        if ccxt.IsTrue(ccxt.Precise.StringEq(bidVolume, "0")) {
            bidVolume = nil
        }
        if ccxt.IsTrue(ccxt.Precise.StringEq(askVolume, "0")) {
            askVolume = nil
        }
...
func  (this *mexc) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchBidsAsks() is not available for "), marketType), " markets")))
            }
            // when it's single symbol request, the returned structure is different (singular object) for both spot & swap, thus we need to wrap inside array
            if ccxt.IsTrue(isSingularMarket) {
                tickers = []interface{}{tickers}
...
func  (this *mexc) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes222715)
                ch <- retRes222715
                return nil
...
func  (this *mexc) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                ccxt.PanicOnError(retRes224915)
                ch <- retRes224915
                return nil
...
func  (this *mexc) CreateSpotOrderRequest(market interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
            amount = cost
            ccxt.AddElementToObject(request, "quoteOrderQty", this.CostToPrecision(symbol, amount))
        } else {
            if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
        if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated")) {
            panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() does not support marginMode "), marginMode), " for spot-margin trading")))
        }
    }
    var postOnly interface{} = nil
    __tmp410926 := this.HandlePostOnly(ccxt.IsEqual(typeVar, "market"), ccxt.IsEqual(typeVar, "LIMIT_MAKER"), params)
    postOnly = ccxt.GetValue(__tmp410926, 0)
    params = ccxt.GetValue(__tmp410926, 1)
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(tif, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(tif, "IOC")) {
            ccxt.AddElementToObject(request, "type", "IMMEDIATE_OR_CANCEL")
        } else if ccxt.IsTrue(ccxt.IsEqual(tif, "FOK")) {
            ccxt.AddElementToObject(request, "type", "FILL_OR_KILL")
        }
    }
...
func  (this *mexc) CreateSpotOrder(market interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(this.SafeString(order, "price"), nil)) {
                ccxt.AddElementToObject(order, "price", price)
            }
            if ccxt.IsTrue(ccxt.IsEqual(this.SafeString(order, "amount"), nil)) {
...
func  (this *mexc) CreateSwapOrder(market interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(isContractUnavaiable) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(this.Id, " createSwapOrder() does not support yet this symbol:"), symbol)))
            }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                if ccxt.IsTrue(ccxt.IsEqual(marginMode, "cross")) {
                    ...
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createSwapOrder() marginMode parameter should be either \"cross\" or \"isolated\"")))
                }
            } else {
                openType = this.SafeInteger(params, "openType", 2) // defaulting to cross margin
            }
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(typeVar, "limit"))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, "market")))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 1)))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 2)))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 3)))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 4)))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 5)))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 6)))) {
                panic(ccxt.InvalidOrder(ccxt.Add(this.Id, " createSwapOrder() order type must either limit, market, or 1 for limit orders, 2 for post-only orders, 3 for IOC orders, 4 for FOK orders, 5 for market orders or 6 to convert market price to current price")))
            }
            var postOnly interface{} = nil
            __tmp653274 := this.HandlePostOnly(ccxt.IsEqual(typeVar, "market"), ccxt.IsEqual(typeVar, 2), params)
            postOnly = ccxt.GetValue(__tmp653274, 0)
            params = ccxt.GetValue(__tmp653274, 1)
            if ccxt.IsTrue(postOnly) {
                typeVar = 2
            ...
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
                "vol": ccxt.ParseFloat(this.AmountToPrecision(symbol, amount)),
                "type": typeVar,
                "openType": openType,
            }
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(typeVar, 5))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, 6)))) && ccxt.IsTrue((!ccxt.IsEqual(typeVar, "market")))) {
                ccxt.AddElementToObject(request, "price", ccxt.ParseFloat(this.PriceToPrecision(symbol, price)))
            }
            if ccxt.IsTrue(ccxt.IsEqual(openType, 1)) {
                var leverage interface{} = this.SafeInteger(params, "leverage")
                if ccxt.IsTrue(ccxt.IsEqual(leverage, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createSwapOrder() requires a leverage parameter for isolated margin orders")))
                }
            }
            ...
            if ccxt.IsTrue(hedged) {
                ...
                sideInteger = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), 1, 3)
                ccxt.AddElementToObject(request, "positionMode", 1)
            } else {
                if ccxt.IsTrue(reduceOnly) {
                    sideInteger = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), 2, 4)
                } else {
                    sideInteger = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(side, "buy"))), 1, 3)
                }
            }
            ccxt.AddElementToObject(request, "side", sideInteger)
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "externalOid")
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                ccxt.AddElementToObject(request, "externalOid", clientOrderId)
            }
            ...
            if ccxt.IsTrue(triggerPrice) {
                ...
                ccxt.AddElementToObject(request, "triggerType", this.SafeInteger(params, "triggerType", 1))
                ccxt.AddElementToObject(request, "executeCycle", this.SafeInteger(params, "executeCycle", 1))
                ccxt.AddElementToObject(request, "trend", this.SafeInteger(params, "trend", 1))
                ccxt.AddElementToObject(request, "orderType", this.SafeInteger(params, "orderType", 1))
...
func  (this *mexc) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                if !ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrders() is only supported for spot markets")))
                }
                ...
                __tmp612399 := this.HandleMarginModeAndParams("createOrder", params)
                marginMode = ccxt.GetValue(__tmp612399, 0)
                params = ccxt.GetValue(__tmp612399, 1)
...
func  (this *mexc) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated")) {
                        panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOrder() does not support marginMode "), marginMode), " for spot-margin trading")))
                    }
...
func  (this *mexc) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOrders() requires a symbol argument for spot market")))
                }
                marginModequeryInnerVariable := this.HandleMarginModeAndParams("fetchOrders", params);
                marginMode := ccxt.GetValue(marginModequeryInnerVariable,0);
                queryInner := ccxt.GetValue(marginModequeryInnerVariable,1)
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(request, "startTime", since)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated")) {
                        panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOrders() does not support marginMode "), marginMode), " for spot-margin trading")))
                    }
        ...
        ch <- this.ParseOrders(response, market, since, limit)
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(end, nil)) {
                        ccxt.AddElementToObject(request, "end_time", this.Sum(since, ccxt.GetValue(this.Options, "maxTimeTillEnd")))
                    } else {
                        if ccxt.IsTrue(ccxt.IsGreaterThan((ccxt.Subtract(end, since)), ccxt.GetValue(this.Options, "maxTimeTillEnd"))) {
                            panic(ccxt.BadRequest(ccxt.Add(this.Id, " end is invalid, i.e. exceeds allowed 90 days.")))
                        } else {
                            ccxt.AddElementToObject(request, "end_time", until)
                        }
                    }
                } else if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ccxt.AddElementToObject(request, "start_time", this.Sum(until, ccxt.Multiply(ccxt.GetValue(this.Options, "maxTimeTillEnd"), ccxt.OpNeg(1))))
                    ccxt.AddElementToObject(request, "end_time", until)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(method, "contractPrivateGetOrderListHistoryOrders")) {
...
func  (this *mexc) FetchOrdersByIds(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            query := ccxt.GetValue(marketTypequeryVariable,1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(this.Id, " fetchOrdersByIds() is not supported for "), marketType)))
            } else {
                ccxt.AddElementToObject(request, "order_ids", ccxt.Join(ids, ","))
...
func  (this *mexc) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp721481 := this.HandleMarketTypeAndParams("fetchOpenOrders", market, params)
            marketType = ccxt.GetValue(__tmp721481, 0)
            params = ccxt.GetValue(__tmp721481, 1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchOpenOrders() requires a symbol argument for spot market")))
                }
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated")) {
                        panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchOpenOrders() does not support marginMode "), marginMode), " for spot-margin trading")))
                    }
        ...
        ch <- this.ParseOrders(response, market, since, limit)
                return nil
                    ...
                    ccxt.PanicOnError(retRes307019)
...
func  (this *mexc) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes308815)
                ch <- retRes308815
                return nil
...
func  (this *mexc) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes310515)
                ch <- retRes310515
                return nil
...
func  (this *mexc) FetchOrdersByState(state interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            marketType := ccxt.GetValue(marketTypeVariable,0)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(this.Id, " fetchOrdersByState() is not supported for "), marketType)))
            } else {
                ccxt.AddElementToObject(request, "states", state)
        
                    retRes312019 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                    ccxt.PanicOnError(retRes312019)
                    ch <- retRes312019
                    return nil
            }
                return nil
...
func  (this *mexc) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketType interface{} = nil
            __tmp767309 := this.HandleMarketTypeAndParams("cancelOrder", market, params)
            marketType = ccxt.GetValue(__tmp767309, 0)
            params = ccxt.GetValue(__tmp767309, 1)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                    ...
                    ccxt.AddElementToObject(requestInner, "origClientOrderId", clientOrderId)
                } else {
                    ccxt.AddElementToObject(requestInner, "orderId", id)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated")) {
                        panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelOrder() does not support marginMode "), marginMode), " for spot-margin trading")))
                    }
                ...
                method = this.SafeString(query, "method", method)
                var response interface{} = nil
                if ccxt.IsTrue(ccxt.IsEqual(method, "contractPrivatePostOrderCancel")) {
                    response = (<-this.ContractPrivatePostOrderCancel([]interface{}{id})) // the request cannot be changed or extended. This is the only way to send.
                } else if ccxt.IsTrue(ccxt.IsEqual(method, "contractPrivatePostPlanorderCancel")) {
                    response = (<-this.ContractPrivatePostPlanorderCancel([]interface{}{id})) // the request cannot be changed or extended. This is the only way to send.
                } else {
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " cancelOrder() not support this method")))
                }
                //
                //     {
                //         "success": true,
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(errorMsg, "success")) {
                    panic(ccxt.InvalidOrder(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelOrder() the order with id "), id), " cannot be cancelled: "), errorMsg)))
                }
            }
...
func  (this *mexc) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            marketType := ccxt.GetValue(marketTypeVariable,0)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(this.Id, " cancelOrders() is not supported for "), marketType)))
            } else {
        
                response:= (<-this.ContractPrivatePostOrderCancel(ids))
                ccxt.PanicOnError(response) // the request cannot be changed or extended. The only way to send.
                //
                //     {
                //         "success": true,
                //         "code": "0",
...
func  (this *mexc) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes32898)
            var market interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(symbol, nil))), this.Market(symbol), nil)
            var request interface{} = map[string]interface{} {}
            var marketType interface{} = nil
            __tmp359154 := this.HandleMarketTypeAndParams("cancelAllOrders", market, params)
            marketType = ccxt.GetValue(__tmp359154, 0)
            params = ccxt.GetValue(__tmp359154, 1)
            marginModequeryVariable := this.HandleMarginModeAndParams("cancelAllOrders", params);
            marginMode := ccxt.GetValue(marginModequeryVariable,0);
            query := ccxt.GetValue(marginModequeryVariable,1)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " cancelAllOrders() requires a symbol argument on spot")))
                }
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                var response interface{} = nil
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    if ccxt.IsTrue(!ccxt.IsEqual(marginMode, "isolated")) {
                        panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " cancelAllOrders() does not support marginMode "), marginMode), " for spot-margin trading")))
                    }
        ...
        ch <- this.ParseOrders(response, market)
                ...
                method = this.SafeString(query, "method", method)
                var response interface{} = nil
                if ccxt.IsTrue(ccxt.IsEqual(method, "contractPrivatePostOrderCancelAll")) {
                    response = (<-this.ContractPrivatePostOrderCancelAll(this.Extend(request, query)))
                } else if ccxt.IsTrue(ccxt.IsEqual(method, "contractPrivatePostPlanorderCancelAll")) {
...
func  (this *mexc) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(feeCurrency, nil)) {
        ...
        var feeSum interface{} = ccxt.Precise.StringAdd(takerFee, makerFee)
        fee = map[string]interface{} {
...
func  (this *mexc) GetTifFromRawOrderType(optionalArgs ...interface{}) interface{}  {
    orderType := ccxt.GetArg(optionalArgs, 0, nil)
    _ = orderType
    var statuses interface{} = map[string]interface{} {
        "LIMIT": "GTC",
...
func  (this *mexc) FetchAccountHelper(typeVar interface{}, params interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                ...
                defer ccxt.ReturnPanicError(ch)
                    ...
                    ccxt.PanicOnError(retRes366219)
                    ch <- retRes366219
                    return nil
...
func  (this *mexc) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes37568)
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchTradingFee() supports spot markets only")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            }
...
func  (this *mexc) CustomParseBalance(response interface{}, marketType interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(marketType, "margin")) {
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(wallet)); i++ {
            ...
            ccxt.AddElementToObject(account, "free", this.SafeString(entry, "availableBalance"))
            ccxt.AddElementToObject(account, "used", this.SafeString(entry, "frozenBalance"))
...
func  (this *mexc) ParseBalanceHelper(entry interface{}) interface{}  {
    ...
    ccxt.AddElementToObject(account, "used", this.SafeString(entry, "locked"))
    ccxt.AddElementToObject(account, "free", this.SafeString(entry, "free"))
    ccxt.AddElementToObject(account, "total", this.SafeString(entry, "totalAsset"))
...
func  (this *mexc) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes39208)
            var marketType interface{} = nil
            var request interface{} = map[string]interface{} {}
            __tmp288449 := this.HandleMarketTypeAndParams("fetchBalance", nil, params)
            marketType = ccxt.GetValue(__tmp288449, 0)
            params = ccxt.GetValue(__tmp288449, 1)
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(marginMode, nil))) || ccxt.IsTrue((isMargin))) || ccxt.IsTrue((ccxt.IsEqual(marketType, "margin")))) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                        parsedSymbols = ccxt.Join(this.MarketIds(symbols), ",")
                    }
                } else {
                    var market interface{} = this.Market(symbol)
                    parsedSymbols = ccxt.GetValue(market, "id")
                }
                this.CheckRequiredArgument("fetchBalance", parsedSymbols, "symbol or symbols")
                marketType = "margin"
                ccxt.AddElementToObject(request, "symbols", parsedSymbols)
                ...
                panic(ccxt.NotSupported(ccxt.Add(this.Id, " fetchBalance() not support this method")))
            }
...
func  (this *mexc) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes40568)
            var market interface{} = this.Market(symbol)
            var marketType interface{} = nil
            __tmp112062 := this.HandleMarketTypeAndParams("fetchMyTrades", market, params)
            marketType = ccxt.GetValue(__tmp112062, 0)
            params = ccxt.GetValue(__tmp112062, 1)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
            }
            var trades interface{} = nil
...
func  (this *mexc) ModifyMarginHelper(symbol interface{}, amount interface{}, addOrReduce interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(positionId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " modifyMarginHelper() requires a positionId parameter")))
            }
        
            retRes42248 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes42248)
            var request interface{} = map[string]interface{} {
...
func  (this *mexc) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes425015)
                ch <- retRes425015
                return nil
...
func  (this *mexc) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes426415)
                ch <- retRes426415
                return nil
...
func  (this *mexc) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(positionId, nil)) {
                ...
                var market interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(symbol, nil))), this.Market(symbol), nil)
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(openType, nil))) || ccxt.IsTrue((ccxt.IsEqual(positionType, nil)))) || ccxt.IsTrue((ccxt.IsEqual(market, nil)))) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " setLeverage() requires a positionId parameter or a symbol argument with openType and positionType parameters, use openType 1 or 2 for isolated or cross margin respectively, use positionType 1 or 2 for long or short positions")))
                } else {
                    ccxt.AddElementToObject(request, "openType", openType)
                    ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                    ccxt.AddElementToObject(request, "positionType", positionType)
                }
            } else {
                ccxt.AddElementToObject(request, "positionId", positionId)
            }
        
                retRes429715 :=  (<-this.ContractPrivatePostPositionChangeLeverage(this.Extend(request, params)))
                ccxt.PanicOnError(retRes429715)
                ch <- retRes429715
                return nil
...
func  (this *mexc) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes443315)
                ch <- retRes443315
                return nil
...
func  (this *mexc) ParseMarketLeverageTiers(info interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(riskIncrVol, "0")) {
    ...
    for ccxt.Precise.StringLt(floor, maxVol) {
        var cap interface{} = ccxt.Precise.StringAdd(floor, riskIncrVol)
        ccxt.AppendToArray(&tiers, map[string]interface{} {
            "tier": this.ParseNumber(ccxt.Precise.StringDiv(cap, riskIncrVol)),
            "symbol": this.SafeSymbol(marketId, market, nil, "contract"),
            "currency": this.SafeCurrencyCode(quoteId),
        ...
        initialMarginRate = ccxt.Precise.StringAdd(initialMarginRate, riskIncrImr)
        maintenanceMarginRate = ccxt.Precise.StringAdd(maintenanceMarginRate, riskIncrMmr)
        floor = cap
    }
    return tiers
}
...
func  (this *mexc) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
                ...
                if ccxt.IsTrue(ccxt.InOp(networks, networkUnified)) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(networkId, nil)) {
                ccxt.AddElementToObject(request, "network", networkId)
            }
...
func  (this *mexc) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var networkCode interface{} = this.SafeString(params, "network")
            if ccxt.IsTrue(ccxt.IsEqual(networkCode, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createDepositAddress requires a `network` parameter")))
            }
            // createDepositAddress and fetchDepositAddress use a different network-id compared to withdraw
            var networkId interface{} = nil
            var networkUnified interface{} = this.NetworkIdToCode(networkCode, code)
...
func  (this *mexc) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(result, nil)) {
                panic(ccxt.InvalidAddress(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchDepositAddress() cannot find a deposit address for "), code), ", and network"), network), "consider creating one using .createDepositAddress() method or in MEXC website")))
            }
...
func  (this *mexc) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(rawNetwork, nil)) {
                    params = this.Omit(params, "network")
                    ccxt.AddElementToObject(request, "coin", ccxt.Add(ccxt.Add(ccxt.GetValue(request, "coin"), "-"), rawNetwork))
                }
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "startTime", since)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                if ccxt.IsTrue(ccxt.IsGreaterThan(limit, 1000)) {
                    panic(ccxt.ExchangeError("This exchange supports a maximum limit of 1000"))
                }
                ccxt.AddElementToObject(request, "limit", limit)
            }
...
func  (this *mexc) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(id, nil))), "deposit", "withdrawal")
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(currencyWithNetwork, nil)) {
        currencyId = ccxt.GetValue(ccxt.Split(currencyWithNetwork, "-"), 0)
    }
...
func  (this *mexc) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var side interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(rawSide, "1"))), "long", "short")
    var openType interface{} = this.SafeString(position, "margin_mode")
    var marginType interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(openType, "1"))), "isolated", "cross")
...
func  (this *mexc) FetchTransfer(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(this.Id, " fetchTransfer() is not supported for "), marketType)))
            }
...
func  (this *mexc) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    if ccxt.IsTrue(ccxt.IsGreaterThan(limit, 50)) {
                        panic(ccxt.ExchangeError("This exchange supports a maximum limit of 50"))
                    }
                    ccxt.AddElementToObject(request, "page-size", limit)
                }
...
func  (this *mexc) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(fromId, nil)) {
                var keys interface{} = ccxt.ObjectKeys(accounts)
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " fromAccount must be one of "), ccxt.Join(keys, ", "))))
            }
            if ccxt.IsTrue(ccxt.IsEqual(toId, nil)) {
                var keys interface{} = ccxt.ObjectKeys(accounts)
                panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, " toAccount must be one of "), ccxt.Join(keys, ", "))))
            }
            var request interface{} = map[string]interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(fromId, "ISOLATED_MARGIN"))) || ccxt.IsTrue((ccxt.IsEqual(toId, "ISOLATED_MARGIN")))) {
                var symbol interface{} = this.SafeString(params, "symbol")
                params = this.Omit(params, "symbol")
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " transfer() requires a symbol argument for isolated margin")))
                }
                var market interface{} = this.Market(symbol)
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
            }
...
func  (this *mexc) ParseTransfer(transfer interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var datetime interface{} = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(timestamp, nil))), this.Iso8601(timestamp), nil)
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(direction, nil)) {
        accountFrom = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(direction, "IN"))), "MAIN", "CONTRACT")
        accountTo = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(direction, "IN"))), "CONTRACT", "MAIN")
    } else {
...
func  (this *mexc) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes55218)
            var currency interface{} = this.Currency(code)
            __tmp733628 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp733628, 0)
            params = ccxt.GetValue(__tmp733628, 1)
            ...
            network = this.NetworkCodeToId(network, ccxt.GetValue(currency, "code"))
            this.CheckAddress(address)
            var request interface{} = map[string]interface{} {
                "coin": ccxt.GetValue(currency, "id"),
                "address": address,
...
func  (this *mexc) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            var request interface{} = map[string]interface{} {
                "positionMode": ccxt.Ternary(ccxt.IsTrue(hedged), 1, 2),
            }
...
func  (this *mexc) FetchPositionMode(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- map[string]interface{} {
                "info": response,
                "hedged": (ccxt.IsEqual(positionMode, 1)),
            }
            return nil
...
func  (this *mexc) ParseTransactionFees(response interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
        ...
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(codes, nil))) || ccxt.IsTrue((this.InArray(code, codes)))) {
            ccxt.AddElementToObject(withdrawFees, code, this.ParseTransactionFee(entry, currency))
        }
    }
    return map[string]interface{} {
...
func  (this *mexc) ParseTransactionFee(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(networkList)); j++ {
        ...
        var networkCode interface{} = this.SafeString(ccxt.GetValue(this.Options, "networks"), networkId, networkId)
        var fee interface{} = this.SafeNumber(networkEntry, "withdrawFee")
        ccxt.AddElementToObject(result, networkCode, fee)
    }
    return result
}
/**
...
func  (this *mexc) ParseLeverage(leverage interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(leverage)); i++ {
        ...
        if ccxt.IsTrue(ccxt.IsEqual(positionType, 1)) {
            longLeverage = this.SafeInteger(entry, "leverage")
        } else if ccxt.IsTrue(ccxt.IsEqual(positionType, 2)) {
            shortLeverage = this.SafeInteger(entry, "leverage")
        }
        marginMode = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(openType, 1))), "isolated", "cross")
    }
    return map[string]interface{} {
        "info": leverage,
        "symbol": ccxt.GetValue(market, "symbol"),
...
func  (this *mexc) HandleMarginModeAndParams(methodName interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    var isMargin interface{} = this.SafeBool(params, "margin", false)
    var marginMode interface{} = nil
    __tmp25100 := this.Exchange.HandleMarginModeAndParams(methodName, params, defaultValue)
    marginMode = ccxt.GetValue(__tmp25100, 0)
    params = ccxt.GetValue(__tmp25100, 1)
...
func  (this *mexc) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "leverage": leverage,
                "openType": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(marginMode, "isolated"))), 1, 2),
            }
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(direction, nil)) {
                ccxt.AddElementToObject(request, "positionType", ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(direction, "short"))), 2, 1))
            }
...
func  (this *mexc) Nonce() interface{}  {
    return ccxt.Subtract(this.Milliseconds(), this.SafeInteger(this.Options, "timeDifference", 0))
}
func  (this *mexc) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    __tmp926146 := this.ResolvePath(path, params)
    path = ccxt.GetValue(__tmp926146, 0)
    params = ccxt.GetValue(__tmp926146, 1)
    var url interface{} = nil
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(section, "spot")) || ccxt.IsTrue(ccxt.IsEqual(section, "broker"))) {
        if ccxt.IsTrue(ccxt.IsEqual(section, "broker")) {
            url = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), section), access), "/"), path)
        } else {
            url = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), section), access), "/api/"), this.Version), "/"), path)
        }
        var urlParams interface{} = params
        if ccxt.IsTrue(ccxt.IsEqual(access, "private")) {
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(section, "broker")) && ccxt.IsTrue((ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(method, "POST"))) || ccxt.IsTrue((ccxt.IsEqual(method, "PUT")))) || ccxt.IsTrue((ccxt.IsEqual(method, "DELETE")))))) {
                ...
                ccxt.AddElementToObject(urlParams, "timestamp", this.Nonce())
                ccxt.AddElementToObject(urlParams, "recvWindow", this.SafeInteger(this.Options, "recvWindow", 5000))
            }
        }
        var paramsEncoded interface{} = ""
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(urlParams))) {
            paramsEncoded = this.Urlencode(urlParams)
            url = ccxt.Add(url, ccxt.Add("?", paramsEncoded))
        }
        if ccxt.IsTrue(ccxt.IsEqual(access, "private")) {
            this.CheckRequiredCredentials()
            var signature interface{} = this.Hmac(this.Encode(paramsEncoded), this.Encode(this.Secret), ccxt.Sha256)
            url = ccxt.Add(url, ccxt.Add(ccxt.Add("&", "signature="), signature))
    ...
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(section, "contract")) || ccxt.IsTrue(ccxt.IsEqual(section, "spot2"))) {
        url = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), section), access), "/"), this.ImplodeParams(path, params))
        ...
        if ccxt.IsTrue(ccxt.IsEqual(access, "public")) {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(method, "POST")) {
                ...
                if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(params))) {
                    auth = ccxt.Add(auth, this.Urlencode(params))
                    url = ccxt.Add(url, ccxt.Add("?", auth))
                }
            }
            auth = ccxt.Add(ccxt.Add(this.ApiKey, timestamp), auth)
            var signature interface{} = this.Hmac(this.Encode(auth), this.Encode(this.Secret), ccxt.Sha256)
            ccxt.AddElementToObject(headers, "Signature", signature)
        }
    }
    return map[string]interface{} {
        "url": url,
...
func  (this *mexc) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    //     {"success":false,"code":123456,"message":"ccxt.Order quantity error...."}
    //
    // contract
    //
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(responseCode, nil))) && ccxt.IsTrue((!ccxt.IsEqual(responseCode, "200")))) && ccxt.IsTrue((!ccxt.IsEqual(responseCode, "0")))) {
