...
func NewKrakenfuturesWsCore() krakenfuturesWs {
   p := krakenfuturesWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *krakenfuturesWs) Describe() interface{}  {
 ...
 */
func  (this *krakenfuturesWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
                ...
                retRes9115 :=  <-future.(<-chan interface{})
 ...
 */
func  (this *krakenfuturesWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *krakenfuturesWs) SubscribePublic(name interface{}, symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} data from the websocket stream
 */
func  (this *krakenfuturesWs) SubscribePrivate(name interface{}, messageHash interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *krakenfuturesWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *krakenfuturesWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *krakenfuturesWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *krakenfuturesWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *krakenfuturesWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *krakenfuturesWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *krakenfuturesWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *krakenfuturesWs) HandlePositions(client interface{}, message interface{})  {
    //
    //    {
    //        feed: 'open_positions',
...
func  (this *krakenfuturesWs) ParseWsPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //        {
    //            instrument: 'PF_LTCUSD',
    //            balance: 0.5,
 ...
 */
func  (this *krakenfuturesWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *krakenfuturesWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *krakenfuturesWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp994680 := this.HandleOptionAndParams(params, "watchBalance", "account")
            account = ccxt.GetValue(__tmp994680, 0)
            params = ccxt.GetValue(__tmp994680, 1)
...
func  (this *krakenfuturesWs) HandleTrade(client interface{}, message interface{})  {
    //
    // snapshot
    //
    //    {
...
func  (this *krakenfuturesWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "feed": "trade",
    //        "product_id": "PI_XBTUSD",
...
func  (this *krakenfuturesWs) ParseWsOrderTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "symbol": "BTC_USDT",
    //        "type": "LIMIT",
...
func  (this *krakenfuturesWs) HandleOrder(client interface{}, message interface{}) interface{}  {
    //
    //  update (verbose)
    //
    //    {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(order, nil)) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(previousOrder, nil))) || ccxt.IsTrue((ccxt.IsEqual(reason, "edited_by_user")))) {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(previousOrder, "trades"), nil)) {
                ...
                value := ccxt.GetValue(previousOrder, "trades")
                ccxt.AppendToArray(&value, trade)
...
func  (this *krakenfuturesWs) HandleOrderSnapshot(client interface{}, message interface{})  {
    //
    // verbose
    //
    //    {
...
func  (this *krakenfuturesWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // update
    //
    //    {
...
func  (this *krakenfuturesWs) HandleTicker(client interface{}, message interface{})  {
    //
    //    {
    //        "time": 1680811086487,
    //        "product_id": "PI_XBTUSD",
...
func  (this *krakenfuturesWs) HandleBidAsk(client interface{}, message interface{})  {
    //
    //    {
    //        "feed": "ticker_lite",
...
func  (this *krakenfuturesWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "time": 1680811086487,
    //        "product_id": "PI_XBTUSD",
...
func  (this *krakenfuturesWs) HandleOrderBookSnapshot(client interface{}, message interface{})  {
    //
    //    {
    //        "feed": "book_snapshot",
    //        "product_id": "PI_XBTUSD",
...
func  (this *krakenfuturesWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //    {
    //        "feed": "book",
    //        "product_id": "PI_XBTUSD",
...
func  (this *krakenfuturesWs) HandleBalance(client interface{}, message interface{})  {
    //
    // snapshot
    //
    //    {
...
func  (this *krakenfuturesWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //    {
    //        "feed": "fills_snapshot",
    //        "account": "DemoUser",
...
func  (this *krakenfuturesWs) ParseWsMyTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "instrument": "FI_XBTUSD_200925",
    //        "time": 1600256910739,
...
func  (this *krakenfuturesWs) WatchMultiHelper(unifiedName interface{}, channelName interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *krakenfuturesWs) GetMessageHash(unifiedElementName interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *krakenfuturesWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //        event: 'alert',
    ...
    {		ret__ := func(this *krakenfuturesWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *krakenfuturesWs) interface{} {
    					// catch block:
...
func  (this *krakenfuturesWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *krakenfuturesWs) HandleAuthenticate(client interface{}, message interface{}) interface{}  {
    /**
     * @ignore
     * @method
...
func (this *krakenfuturesWs) Init(userConfig map[string]interface{}) {
    this.krakenfutures.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
