...
func  (this *indodax) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                ...
                ccxt.AppendToArray(&result, map[string]interface{} {
                    ...
                    "future": false,
                    "option": false,
                    "active": ccxt.Ternary(ccxt.IsTrue(isMaintenance), false, true),
                    "contract": false,
                    "linear": nil,
                    "inverse": nil,
...
func  (this *indodax) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                "pair": ccxt.Add(ccxt.GetValue(market, "base"), ccxt.GetValue(market, "quote")),
            }
        
            orderbook:= (<-this.PublicGetApiDepthPair(this.Extend(request, params)))
            ccxt.PanicOnError(orderbook)
        
            ch <- this.ParseOrderBook(orderbook, ccxt.GetValue(market, "symbol"), nil, "buy", "sell")
            return nil
...
func  (this *indodax) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var baseVolume interface{} = ccxt.Add("vol_", ccxt.ToLower(ccxt.GetValue(market, "baseId")))
    var quoteVolume interface{} = ccxt.Add("vol_", ccxt.ToLower(ccxt.GetValue(market, "quoteId")))
...
func  (this *indodax) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var market interface{} = this.Market(symbol)
            var timeframes interface{} = ccxt.GetValue(this.Options, "timeframes")
            ...
            var request interface{} = map[string]interface{} {
                ...
                "symbol": ccxt.Add(ccxt.GetValue(market, "base"), ccxt.GetValue(market, "quote")),
            }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ...
                ccxt.AddElementToObject(request, "from", ccxt.Subtract(ccxt.Subtract(now, ccxt.Multiply(limit, duration)), 1))
            }
...
func  (this *indodax) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(market, nil)) {
        ...
        var quoteId interface{} = ccxt.GetValue(market, "quoteId")
        var baseId interface{} = ccxt.GetValue(market, "baseId")
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(market, "quoteId"), "idr"))) && ccxt.IsTrue((ccxt.InOp(order, "order_rp")))) {
            quoteId = "rp"
        }
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(ccxt.GetValue(market, "baseId"), "idr"))) && ccxt.IsTrue((ccxt.InOp(order, "remain_rp")))) {
            baseId = "rp"
        }
        cost = this.SafeString(order, ccxt.Add("order_", quoteId))
        if !ccxt.IsTrue(cost) {
            amount = this.SafeString(order, ccxt.Add("order_", baseId))
            remaining = this.SafeString(order, ccxt.Add("remain_", baseId))
        }
    }
...
func  (this *indodax) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(response)
            var orders interface{} = ccxt.GetValue(response, "return")
            var order interface{} = this.ParseOrder(this.Extend(map[string]interface{} {
                "id": id,
            }, ccxt.GetValue(orders, "order")), market)
...
func  (this *indodax) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(response)
            var rawOrders interface{} = ccxt.GetValue(ccxt.GetValue(response, "return"), "orders")
            // { success: 1, return: { orders: null }} if no orders
            if !ccxt.IsTrue(rawOrders) {
            ...
            var marketIds interface{} = ccxt.ObjectKeys(rawOrders)
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketIds)); i++ {
                ...
                var marketOrders interface{} = ccxt.GetValue(rawOrders, marketId)
...
func  (this *indodax) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(response)
            var orders interface{} = this.ParseOrders(ccxt.GetValue(ccxt.GetValue(response, "return"), "orders"), market)
...
func  (this *indodax) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
                if ccxt.IsTrue(ccxt.IsEqual(side, "buy")) {
                    ...
                    ccxt.AddElementToObject(request, ccxt.GetValue(market, "quoteId"), quoteAmount)
                } else {
                ...
                quantityIsRequired = true
                if ccxt.IsTrue(ccxt.IsEqual(side, "buy")) {
                    ccxt.AddElementToObject(request, ccxt.GetValue(market, "quoteId"), this.ParseToNumeric(ccxt.Precise.StringMul(this.NumberToString(amount), this.NumberToString(price))))
                }
            }
            ...
            if ccxt.IsTrue(quantityIsRequired) {
                ccxt.AddElementToObject(request, ccxt.GetValue(market, "baseId"), this.AmountToPrecision(symbol, amount))
            }
...
func  (this *indodax) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(side, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " cancelOrder() requires an extra \"side\" param")))
            }
...
func  (this *indodax) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                var startTime interface{} = ccxt.Slice(this.Iso8601(since), 0, 10)
                ccxt.AddElementToObject(request, "start", startTime)
                ccxt.AddElementToObject(request, "end", ccxt.Slice(this.Iso8601(this.Milliseconds()), 0, 10))
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                var keys interface{} = ccxt.ObjectKeys(withdraw)
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                    var key interface{} = ccxt.GetValue(keys, i)
                    transactions = this.ArrayConcat(transactions, ccxt.GetValue(withdraw, key))
                }
                keys = ccxt.ObjectKeys(deposit)
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
                    var key interface{} = ccxt.GetValue(keys, i)
                    transactions = this.ArrayConcat(transactions, ccxt.GetValue(deposit, key))
                }
            } else {
                currency = this.Currency(code)
                var withdraws interface{} = this.SafeValue(withdraw, ccxt.GetValue(currency, "id"), []interface{}{})
                var deposits interface{} = this.SafeValue(deposit, ccxt.GetValue(currency, "id"), []interface{}{})
...
func  (this *indodax) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp424715 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp424715, 0)
            params = ccxt.GetValue(__tmp424715, 1)
            ...
            var request interface{} = map[string]interface{} {
                ...
                "request_id": ccxt.ToString(requestId),
            }
            if ccxt.IsTrue(tag) {
                ccxt.AddElementToObject(request, "withdraw_memo", tag)
            }
...
func  (this *indodax) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    return map[string]interface{} {
        ...
        "type": ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(depositId, nil))), "withdraw", "deposit"),
        "currency": this.SafeCurrencyCode(nil, currency),
...
func  (this *indodax) FetchDepositAddresses(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var addressKeys interface{} = ccxt.ObjectKeys(addresses)
            var result interface{} = map[string]interface{} {
                "info": data,
            }
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(addressKeys)); i++ {
                var marketId interface{} = ccxt.GetValue(addressKeys, i)
                var code interface{} = this.SafeCurrencyCode(marketId)
                var address interface{} = this.SafeString(addresses, marketId)
                if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(address, nil))) && ccxt.IsTrue((ccxt.IsTrue((ccxt.IsEqual(codes, nil))) || ccxt.IsTrue((this.InArray(code, codes)))))) {
                    this.CheckAddress(address)
                    var network interface{} = nil
                    if ccxt.IsTrue(ccxt.InOp(networks, marketId)) {
                        var networkId interface{} = this.SafeString(networks, marketId)
                        if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(networkId, ","), 0)) {
                            network = []interface{}{}
                            var networkIds interface{} = ccxt.Split(networkId, ",")
                            for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(networkIds)); j++ {
                                ccxt.AppendToArray(&network, ccxt.ToUpper(this.NetworkIdToCode(ccxt.GetValue(networkIds, j))))
                            }
                        } else {
                            network = ccxt.ToUpper(this.NetworkIdToCode(networkId))
                        }
                    }
...
func  (this *indodax) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        url = ccxt.Add(url, requestPath)
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            url = ccxt.Add(url, ccxt.Add("?", this.UrlencodeWithArrayRepeat(query)))
        }
    } else {
        ...
        body = this.Urlencode(this.Extend(map[string]interface{} {
            ...
            "recvWindow": ccxt.GetValue(this.Options, "recvWindow"),
        }, params))
...
func  (this *indodax) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsTrue((ccxt.InOp(response, "success"))) && ccxt.IsTrue(ccxt.IsEqual(err, ""))) {
        return nil  // no 'success' property on public responses
    }
    var status interface{} = this.SafeString(response, "success")
    if ccxt.IsTrue(ccxt.IsEqual(status, "approved")) {
        return nil
    }
    if ccxt.IsTrue(ccxt.IsEqual(this.SafeInteger(response, "success", 0), 1)) {
        // { success: 1, return: { orders: [] }}
        if !ccxt.IsTrue((ccxt.InOp(response, "return"))) {
            panic(ccxt.ExchangeError(ccxt.Add(ccxt.Add(this.Id, ": malformed response: "), this.Json(response))))
        } else {
            return nil
        }
    }
