...
func NewCoincheckWsCore() coincheckWs {
   p := coincheckWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *coincheckWs) Describe() interface{}  {
 ...
 */
func  (this *coincheckWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *coincheckWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     [
    //         "btc_jpy",
    //         {
 ...
 */
func  (this *coincheckWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coincheckWs) HandleTrades(client interface{}, message interface{})  {
    //
    //     [
    //         [
...
func  (this *coincheckWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     [
    //         "1663318663", // transaction timestamp (unix time)
    //         "2357062", // transaction ID
...
func  (this *coincheckWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *coincheckWs) Init(userConfig map[string]interface{}) {
    this.coincheck.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
