    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "disabled API Key": ccxt.AuthenticationError,
                "invalid authentication": ccxt.AuthenticationError,
            },
...
func  (this *coincheck) ParseBalance(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(codes)); i++ {
        ...
        if ccxt.IsTrue(ccxt.InOp(response, currencyId)) {
            var account interface{} = this.Account()
            var reserved interface{} = ccxt.Add(currencyId, "_reserved")
            ccxt.AddElementToObject(account, "free", this.SafeString(response, currencyId))
            ccxt.AddElementToObject(account, "used", this.SafeString(response, reserved))
...
func  (this *coincheck) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(parsedOrders)); i++ {
                ccxt.AppendToArray(&result, this.Extend(ccxt.GetValue(parsedOrders, i), map[string]interface{} {
                    "status": "open",
                }))
            }
...
func  (this *coincheck) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                ...
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
            _ = params
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, "BTC/JPY")) {
                panic(ccxt.BadSymbol(ccxt.Add(this.Id, " fetchTicker() supports BTC/JPY only")))
            }
...
func  (this *coincheck) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.InOp(trade, "liquidity")) {
        if ccxt.IsTrue(ccxt.IsEqual(this.SafeString(trade, "liquidity"), "T")) {
            takerOrMaker = "taker"
        } else if ccxt.IsTrue(ccxt.IsEqual(this.SafeString(trade, "liquidity"), "M")) {
            takerOrMaker = "maker"
        }
...
func  (this *coincheck) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(this.Symbols)); i++ {
                ...
                var market interface{} = this.Market(symbol)
                var fee interface{} = this.SafeValue(fees, ccxt.GetValue(market, "id"), map[string]interface{} {})
...
func  (this *coincheck) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "market")) {
                ccxt.AddElementToObject(request, "order_type", ccxt.Add(ccxt.Add(typeVar, "_"), side))
                if ccxt.IsTrue(ccxt.IsEqual(side, "sell")) {
                    ...
                    if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() : you should use \"cost\" parameter instead of \"amount\" argument to create market buy orders")))
                    }
                    ccxt.AddElementToObject(request, "market_buy_amount", cost)
                }
            } else {
                ccxt.AddElementToObject(request, "order_type", side)
                ccxt.AddElementToObject(request, "rate", price)
                ccxt.AddElementToObject(request, "amount", amount)
            }
...
func  (this *coincheck) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(api, "public")) {
        ...
        var auth interface{} = ccxt.Add(ccxt.Add(nonce, url), queryString)
        headers = map[string]interface{} {
            "Content-Type": "application/x-www-form-urlencoded",
            "ACCESS-KEY": this.ApiKey,
            "ACCESS-NONCE": nonce,
            "ACCESS-SIGNATURE": this.Hmac(this.Encode(auth), this.Encode(this.Secret), ccxt.Sha256),
        }
    }
    return map[string]interface{} {
        "url": url,
