...
type coinbaseinternationalWs struct {
	...
	base coinbaseinternational
}

func NewCoinbaseinternationalWsCore() coinbaseinternationalWs {
   p := coinbaseinternationalWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *coinbaseinternationalWs) Describe() interface{}  {
 ...
 */
func  (this *coinbaseinternationalWs) Subscribe(name interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsGreaterThan(symbolsLength, 1)) {
                    ...
                    retRes12519 :=  (<-this.WatchMultiple(url, messageHashes, this.Extend(subscribe, params), messageHashes, nil))
 ...
 * @returns {object} subscription to a websocket channel
 */
func  (this *coinbaseinternationalWs) SubscribeMultiple(name interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var subscribe interface{} = map[string]interface{} {
                ...
                retRes17215 :=  (<-this.WatchMultiple(url, messageHashes, this.Extend(subscribe, params), messageHashes, nil))
 ...
 */
func  (this *coinbaseinternationalWs) WatchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *coinbaseinternationalWs) WatchFundingRates(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *coinbaseinternationalWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp866976 := this.HandleOptionAndParams(params, "watchTicker", "channel", "LEVEL1")
            channel = ccxt.GetValue(__tmp866976, 0)
            params = ccxt.GetValue(__tmp866976, 1)
...
func  (this *coinbaseinternationalWs) GetActiveSymbols() interface{}  {
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *coinbaseinternationalWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var channel interface{} = nil
            __tmp42629 := this.HandleOptionAndParams(params, "watchTickers", "channel", "LEVEL1")
            channel = ccxt.GetValue(__tmp42629, 0)
            params = ccxt.GetValue(__tmp42629, 1)
...
func  (this *coinbaseinternationalWs) HandleInstrument(client interface{}, message interface{})  {
    //
    //    {
    //        "sequence": 1,
    //        "product_id": "ETH-PERP",
...
func  (this *coinbaseinternationalWs) ParseWsInstrument(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "sequence": 1,
    //        "product_id": "ETH-PERP",
...
func  (this *coinbaseinternationalWs) HandleTicker(client interface{}, message interface{})  {
    //
    // snapshot
    //    {
    //        "sequence": 0,
...
func  (this *coinbaseinternationalWs) ParseWsTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //       "sequence": 1,
    //       "product_id": "BTC-PERP",
 ...
 */
func  (this *coinbaseinternationalWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinbaseinternationalWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    // {
    //     "sequence": 0,
    //     "product_id": "BTC-PERP",
 ...
 */
func  (this *coinbaseinternationalWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *coinbaseinternationalWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinbaseinternationalWs) HandleTrade(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //       "sequence": 0,
    //       "product_id": "BTC-PERP",
...
func  (this *coinbaseinternationalWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //       "sequence": 0,
    //       "product_id": "BTC-PERP",
 ...
 */
func  (this *coinbaseinternationalWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *coinbaseinternationalWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinbaseinternationalWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    // snapshot
    //    {
    //       "sequence": 0,
...
func  (this *coinbaseinternationalWs) HandleDelta(orderbook interface{}, delta interface{})  {
...
func  (this *coinbaseinternationalWs) HandleDeltas(orderbook interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(orderbook, ccxt.GetValue(deltas, i))
    }
}
func  (this *coinbaseinternationalWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //    {
    //       "channels": [
    //           {
...
func  (this *coinbaseinternationalWs) HandleFundingRate(client interface{}, message interface{})  {
    //
    // snapshot
    //    {
    //       "sequence": 0,
...
func  (this *coinbaseinternationalWs) HandleErrorMessage(client interface{}, message interface{}) interface{}  {
    //
    //    {
    ...
    {		ret__ := func(this *coinbaseinternationalWs) (ret_ interface{}) {
    		defer func() {
    			if e := recover(); e != nil {
                    if e == "break" {
    				    return
    			    }
    				ret_ = func(this *coinbaseinternationalWs) interface{} {
    					// catch block:
...
func  (this *coinbaseinternationalWs) HandleMessage(client interface{}, message interface{})  {
...
func (this *coinbaseinternationalWs) Init(userConfig map[string]interface{}) {
    this.coinbaseinternational.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
