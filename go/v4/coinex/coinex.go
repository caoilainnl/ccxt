    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                "23": ccxt.PermissionDenied,
                "24": ccxt.AuthenticationError,
                "25": ccxt.AuthenticationError,
                "34": ccxt.AuthenticationError,
                "35": ccxt.ExchangeNotAvailable,
                "36": ccxt.RequestTimeout,
                "213": ccxt.RateLimitExceeded,
                "107": ccxt.InsufficientFunds,
                "158": ccxt.PermissionDenied,
                "600": ccxt.OrderNotFound,
                "601": ccxt.InvalidOrder,
                "602": ccxt.InvalidOrder,
                "606": ccxt.InvalidOrder,
                "3008": ccxt.RequestTimeout,
                "3109": ccxt.InsufficientFunds,
                "3127": ccxt.InvalidOrder,
                "3600": ccxt.OrderNotFound,
                "3606": ccxt.InvalidOrder,
                "3610": ccxt.ExchangeError,
                "3612": ccxt.InvalidOrder,
                "3613": ccxt.InvalidOrder,
                "3614": ccxt.InvalidOrder,
                "3615": ccxt.InvalidOrder,
                "3616": ccxt.InvalidOrder,
                "3617": ccxt.InvalidOrder,
                "3618": ccxt.InvalidOrder,
                "3619": ccxt.InvalidOrder,
                "3620": ccxt.InvalidOrder,
                "3621": ccxt.InvalidOrder,
                "3622": ccxt.InvalidOrder,
                "3627": ccxt.InvalidOrder,
                "3628": ccxt.InvalidOrder,
                "3629": ccxt.InvalidOrder,
                "3632": ccxt.InvalidOrder,
                "3633": ccxt.InvalidOrder,
                "3634": ccxt.InvalidOrder,
                "3635": ccxt.InvalidOrder,
                "4001": ccxt.ExchangeNotAvailable,
                "4002": ccxt.RequestTimeout,
                "4003": ccxt.ExchangeError,
                "4004": ccxt.BadRequest,
                "4005": ccxt.AuthenticationError,
                "4006": ccxt.AuthenticationError,
                "4007": ccxt.PermissionDenied,
                "4008": ccxt.AuthenticationError,
                "4009": ccxt.ExchangeError,
                "4010": ccxt.ExchangeError,
                "4011": ccxt.PermissionDenied,
                "4017": ccxt.ExchangeError,
                "4115": ccxt.AccountSuspended,
                "4117": ccxt.BadSymbol,
                "4123": ccxt.RateLimitExceeded,
                "4130": ccxt.ExchangeError,
                "4158": ccxt.ExchangeError,
                "4213": ccxt.RateLimitExceeded,
                "4512": ccxt.PermissionDenied,
            },
...
func  (this *coinex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                var coin interface{} = ccxt.GetValue(data, i)
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(chains)); j++ {
                    ...
                    var network interface{} = map[string]interface{} {
                        ...
                        "network": networkId,
                        "name": nil,
                        "active": ccxt.IsTrue(canDepositChain) && ccxt.IsTrue(canWithdrawChain),
                    ...
                    ccxt.AddElementToObject(networks, networkId, network)
                }
                ccxt.AddElementToObject(result, code, this.SafeCurrencyStructure(map[string]interface{} {
            "id": currencyId,
            "code": code,
            "name": nil,
            "active": ccxt.IsTrue(canDeposit) && ccxt.IsTrue(canWithdraw),
            "deposit": canDeposit,
...
func  (this *coinex) FetchContractMarkets(params interface{}) <- chan interface{} {
            ...
            var result interface{} = []interface{}{}
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(markets)); i++ {
                var entry interface{} = ccxt.GetValue(markets, i)
                ...
                var base interface{} = this.SafeCurrencyCode(baseId)
                var quote interface{} = this.SafeCurrencyCode(quoteId)
                var settleId interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(subType, "linear"))), "USDT", baseId)
                var settle interface{} = this.SafeCurrencyCode(settleId)
                var symbol interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(base, "/"), quote), ":"), settle)
                var leveragesLength interface{} =         ccxt.GetArrayLength(leverages)
                ccxt.AppendToArray(&result, map[string]interface{} {
                    "id": id,
                    "symbol": symbol,
                    "base": base,
                    ...
                    "limits": map[string]interface{} {
                        "leverage": map[string]interface{} {
                            ...
                            "max": this.SafeNumber(leverages, ccxt.Subtract(leveragesLength, 1)),
                        },
                        "amount": map[string]interface{} {
...
func  (this *coinex) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = market
    var marketType interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.InOp(ticker, "mark_price"))), "swap", "spot")
...
func  (this *coinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
                    limit := ccxt.GetArg(optionalArgs, 0, 20)
            _ = limit
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
...
func  (this *coinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            //     }
            //
        ch <- this.ParseTrades(ccxt.GetValue(response, "data"), market, since, limit)
            return nil
...
func  (this *coinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp600942 := this.HandleMarketTypeAndParams("fetchTradingFees", nil, params)
            typeVar = ccxt.GetValue(__tmp600942, 0)
            params = ccxt.GetValue(__tmp600942, 1)
            var response interface{} = nil
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                ccxt.AddElementToObject(result, symbol, this.ParseTradingFee(entry, market))
            }
...
func  (this *coinex) FetchMarginBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
                ...
                ccxt.AddElementToObject(baseAccount, "free", this.SafeString(free, "base_ccy"))
                ccxt.AddElementToObject(baseAccount, "used", this.SafeString(used, "base_ccy"))
                var baseDebt interface{} = this.SafeString(loan, "base_ccy")
                var baseInterest interface{} = this.SafeString(interest, "base_ccy")
                ccxt.AddElementToObject(baseAccount, "debt", ccxt.Precise.StringAdd(baseDebt, baseInterest))
                ccxt.AddElementToObject(result, baseCurrencyCode, baseAccount)
            }
...
func  (this *coinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp965577 := this.HandleMarketTypeAndParams("fetchBalance", nil, params)
            marketType = ccxt.GetValue(__tmp965577, 0)
            params = ccxt.GetValue(__tmp965577, 1)
            var marginMode interface{} = nil
            __tmp712898 := this.HandleMarginModeAndParams("fetchBalance", params)
            marginMode = ccxt.GetValue(__tmp712898, 0)
            params = ccxt.GetValue(__tmp712898, 1)
            var isMargin interface{} = ccxt.IsTrue((!ccxt.IsEqual(marginMode, nil))) || ccxt.IsTrue((ccxt.IsEqual(marketType, "margin")))
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
        
                    retRes184319 :=  (<-this.FetchSwapBalance(params))
                    ccxt.PanicOnError(retRes184319)
                    ch <- retRes184319
                    return nil
            } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "financial")) {
        
                    retRes184519 :=  (<-this.FetchFinancialBalance(params))
                    ccxt.PanicOnError(retRes184519)
                    ch <- retRes184519
                    return nil
            } else if ccxt.IsTrue(isMargin) {
                    ...
                    ccxt.PanicOnError(retRes184919)
                    ch <- retRes184919
                    return nil
            }
                return nil
...
func  (this *coinex) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(updatedTimestamp, 0)) {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(orderType, "futures")) {
        orderType = "swap"
    }
    var marketType interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(orderType, "swap"))), "swap", "spot")
    ...
    if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, "")) {
        clientOrderId = nil
    }
...
func  (this *coinex) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = params
    var market interface{} = this.Market(symbol)
    var swap interface{} = ccxt.GetValue(market, "swap")
    ...
    var postOnly interface{} = this.IsPostOnly(isMarketOrder, ccxt.IsEqual(option, "maker_only"), params)
    ...
    if ccxt.IsTrue(reduceOnly) {
        if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
            panic(ccxt.InvalidOrder(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrder() does not support reduceOnly for "), ccxt.GetValue(market, "type")), " orders, reduceOnly orders are supported for swap markets only")))
        }
    }
    var request interface{} = map[string]interface{} {
        "market": ccxt.GetValue(market, "id"),
    ...
    if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
        ...
        ccxt.AddElementToObject(request, "client_id", ccxt.Add(ccxt.Add(brokerId, "-"), this.Uuid16()))
    } else {
        ccxt.AddElementToObject(request, "client_id", clientOrderId)
    }
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(stopLossPrice, nil))) && ccxt.IsTrue((ccxt.IsEqual(takeProfitPrice, nil)))) {
        if !ccxt.IsTrue(reduceOnly) {
        ...
        } else if ccxt.IsTrue(!ccxt.IsEqual(timeInForceRaw, nil)) {
            if ccxt.IsTrue(ccxt.IsEqual(timeInForceRaw, "IOC")) {
                requestType = "ioc"
            } else if ccxt.IsTrue(ccxt.IsEqual(timeInForceRaw, "FOK")) {
                requestType = "fok"
            }
        }
    ...
    if ccxt.IsTrue(swap) {
        ccxt.AddElementToObject(request, "market_type", "FUTURES")
        if ccxt.IsTrue(ccxt.IsTrue(stopLossPrice) || ccxt.IsTrue(takeProfitPrice)) {
            if ccxt.IsTrue(stopLossPrice) {
                ccxt.AddElementToObject(request, "stop_loss_price", this.PriceToPrecision(symbol, stopLossPrice))
                ccxt.AddElementToObject(request, "stop_loss_type", this.SafeString(params, "stop_type", "latest_price"))
            } else if ccxt.IsTrue(takeProfitPrice) {
                ccxt.AddElementToObject(request, "take_profit_price", this.PriceToPrecision(symbol, takeProfitPrice))
                ccxt.AddElementToObject(request, "take_profit_type", this.SafeString(params, "stop_type", "latest_price"))
            }
        } else {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
                ...
                ccxt.AddElementToObject(request, "trigger_price_type", this.SafeString(params, "stop_type", "latest_price"))
            }
        }
    } else {
        var marginMode interface{} = nil
        __tmp914882 := this.HandleMarginModeAndParams("createOrder", params)
        marginMode = ccxt.GetValue(__tmp914882, 0)
        params = ccxt.GetValue(__tmp914882, 1)
        if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
            ccxt.AddElementToObject(request, "market_type", "MARGIN")
        } else {
            ccxt.AddElementToObject(request, "market_type", "SPOT")
        }
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "market"))) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))) {
            var createMarketBuyOrderRequiresPrice interface{} = true
            __tmp999195 := this.HandleOptionAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", true)
            createMarketBuyOrderRequiresPrice = ccxt.GetValue(__tmp999195, 0)
            params = ccxt.GetValue(__tmp999195, 1)
...
func  (this *coinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(typeVar, "limit")) {
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " createOrders() does not support "), typeVar), " orders, only limit orders are accepted")))
                }
                ...
                isTriggerOrder = !ccxt.IsEqual(triggerPrice, nil)
                var isStopLossTriggerOrder interface{} = !ccxt.IsEqual(stopLossTriggerPrice, nil)
                var isTakeProfitTriggerOrder interface{} = !ccxt.IsEqual(takeProfitTriggerPrice, nil)
                isStopLossOrTakeProfitTrigger = ccxt.IsTrue(isStopLossTriggerOrder) || ccxt.IsTrue(isTakeProfitTriggerOrder)
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                if ccxt.IsTrue(isTriggerOrder) {
                    ...
                    panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrders() does not support stopLossPrice or takeProfitPrice orders")))
                } else {
                    if ccxt.IsTrue(reduceOnly) {
                        panic(ccxt.NotSupported(ccxt.Add(this.Id, " createOrders() does not support reduceOnly orders")))
                    } else {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                ...
                if ccxt.IsTrue(ccxt.IsTrue(ccxt.GetValue(market, "spot")) && !ccxt.IsTrue(isTriggerOrder)) {
                    ccxt.AddElementToObject(entry, "status", status)
                    order = this.ParseOrder(entry, market)
                } else {
                    ccxt.AddElementToObject(innerData, "status", status)
                    order = this.ParseOrder(innerData, market)
                }
                ccxt.AppendToArray(&results, order)
            }
...
func  (this *coinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(ids)); i++ {
                ccxt.AppendToArray(&requestIds, ccxt.ParseInt(ccxt.GetValue(ids, i)))
            }
            if ccxt.IsTrue(trigger) {
                ccxt.AddElementToObject(request, "stop_ids", requestIds)
            } else {
                ccxt.AddElementToObject(request, "order_ids", requestIds)
            }
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                if ccxt.IsTrue(trigger) {
...
func  (this *coinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(isTriggerOrder) {
                ccxt.AddElementToObject(request, "trigger_price", this.PriceToPrecision(symbol, triggerPrice))
                ccxt.AddElementToObject(request, "stop_id", this.ParseToNumeric(id))
            } else {
                ccxt.AddElementToObject(request, "order_id", this.ParseToNumeric(id))
            }
            var marginMode interface{} = nil
            __tmp301590 := this.HandleMarginModeAndParams("editOrder", params)
            marginMode = ccxt.GetValue(__tmp301590, 0)
            params = ccxt.GetValue(__tmp301590, 1)
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    ccxt.AddElementToObject(request, "market_type", "MARGIN")
                } else {
...
func  (this *coinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marginMode interface{} = nil
            __tmp505130 := this.HandleMarginModeAndParams("cancelOrder", params)
            marginMode = ccxt.GetValue(__tmp505130, 0)
            params = ccxt.GetValue(__tmp505130, 1)
            if ccxt.IsTrue(swap) {
                ccxt.AddElementToObject(request, "market_type", "FUTURES")
            } else {
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                ...
                data = this.SafeDict(ccxt.GetValue(rows, 0), "data", map[string]interface{} {})
            } else {
...
func  (this *coinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ...
                var marginMode interface{} = nil
                __tmp402782 := this.HandleMarginModeAndParams("cancelAllOrders", params)
                marginMode = ccxt.GetValue(__tmp402782, 0)
                params = ccxt.GetValue(__tmp402782, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    ccxt.AddElementToObject(request, "market_type", "MARGIN")
                } else {
                    ccxt.AddElementToObject(request, "market_type", "SPOT")
...
func  (this *coinex) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"stop", "trigger"})
            var marketType interface{} = nil
            __tmp754002 := this.HandleMarketTypeAndParams("fetchOrdersByStatus", market, params)
            marketType = ccxt.GetValue(__tmp754002, 0)
            params = ccxt.GetValue(__tmp754002, 1)
            var response interface{} = nil
            var isClosed interface{} = ccxt.IsTrue((ccxt.IsEqual(status, "finished"))) || ccxt.IsTrue((ccxt.IsEqual(status, "closed")))
            var isOpen interface{} = ccxt.IsTrue((ccxt.IsEqual(status, "pending"))) || ccxt.IsTrue((ccxt.IsEqual(status, "open")))
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
                ccxt.AddElementToObject(request, "market_type", "FUTURES")
                if ccxt.IsTrue(isClosed) {
                    if ccxt.IsTrue(trigger) {
                ...
                var marginMode interface{} = nil
                __tmp819527 := this.HandleMarginModeAndParams("fetchOrdersByStatus", params)
                marginMode = ccxt.GetValue(__tmp819527, 0)
                params = ccxt.GetValue(__tmp819527, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    ccxt.AddElementToObject(request, "market_type", "MARGIN")
                } else {
                    ccxt.AddElementToObject(request, "market_type", "SPOT")
                ...
                } else if ccxt.IsTrue(ccxt.IsEqual(status, "pending")) {
                    if ccxt.IsTrue(trigger) {
...
func  (this *coinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(openOrders)
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(openOrders)); i++ {
                ccxt.AddElementToObject(ccxt.GetValue(openOrders, i), "status", "open")
            }
...
func  (this *coinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes381415)
                ch <- retRes381415
                return nil
...
func  (this *coinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                "chain": this.NetworkCodeToId(network, ccxt.GetValue(currency, "code")),
            }
...
func  (this *coinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp902944 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp902944, 0)
            params = ccxt.GetValue(__tmp902944, 1)
            ...
            ccxt.AddElementToObject(request, "chain", this.NetworkCodeToId(networkCode)) // required for on-chain, not required for inter-user transfer
...
func  (this *coinex) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var parts interface{} = ccxt.Split(coinAddress, ":")
    var address interface{} = nil
    var tag interface{} = nil
    var partsLength interface{} =     ccxt.GetArrayLength(parts)
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsGreaterThan(partsLength, 1)) && ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(parts, 0), "cfx"))) {
        address = ccxt.GetValue(parts, 0)
        tag = ccxt.GetValue(parts, 1)
    } else {
        address = coinAddress
    }
    return map[string]interface{} {
...
func  (this *coinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp60500 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp60500, 0)
            params = ccxt.GetValue(__tmp60500, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                ccxt.AddElementToObject(request, "market_type", "FUTURES")
                ...
                var marginMode interface{} = nil
                __tmp993123 := this.HandleMarginModeAndParams("fetchMyTrades", params)
                marginMode = ccxt.GetValue(__tmp993123, 0)
                params = ccxt.GetValue(__tmp993123, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                    ccxt.AddElementToObject(request, "market_type", "MARGIN")
                } else {
                    ccxt.AddElementToObject(request, "market_type", "SPOT")
...
func  (this *coinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes40198)
            var defaultMethod interface{} = nil
            __tmp326052 := this.HandleOptionAndParams(params, "fetchPositions", "method", "v2PrivateGetFuturesPendingPosition")
            defaultMethod = ccxt.GetValue(__tmp326052, 0)
            params = ccxt.GetValue(__tmp326052, 1)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {
                "market_type": "FUTURES",
            }
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(defaultMethod, "v2PrivateGetFuturesPendingPosition")) {
...
func  (this *coinex) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParsePosition(ccxt.GetValue(data, 0), market)
            return nil
...
func  (this *coinex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var maxLeverage interface{} = this.SafeInteger(ccxt.GetValue(ccxt.GetValue(market, "limits"), "leverage"), "max", 100)
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsLessThan(leverage, 1))) || ccxt.IsTrue((ccxt.IsGreaterThan(leverage, maxLeverage)))) {
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " setMarginMode() leverage should be between 1 and "), ccxt.ToString(maxLeverage)), " for "), symbol)))
            }
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
                "market_type": "FUTURES",
                ...
                ccxt.PanicOnError(retRes427015)
                ch <- retRes427015
                return nil
...
func  (this *coinex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes42988)
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                panic(ccxt.BadSymbol(ccxt.Add(this.Id, " setLeverage() supports swap contracts only")))
            }
            var marginMode interface{} = nil
            __tmp517210 := this.HandleMarginModeAndParams("setLeverage", params, "cross")
            marginMode = ccxt.GetValue(__tmp517210, 0)
            params = ccxt.GetValue(__tmp517210, 1)
            var minLeverage interface{} = this.SafeInteger(ccxt.GetValue(ccxt.GetValue(market, "limits"), "leverage"), "min", 1)
            var maxLeverage interface{} = this.SafeInteger(ccxt.GetValue(ccxt.GetValue(market, "limits"), "leverage"), "max", 100)
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsLessThan(leverage, minLeverage))) || ccxt.IsTrue((ccxt.IsGreaterThan(leverage, maxLeverage)))) {
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " setLeverage() leverage should be between "), ccxt.ToString(minLeverage)), " and "), ccxt.ToString(maxLeverage)), " for "), symbol)))
            }
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
                "market_type": "FUTURES",
                ...
                ccxt.PanicOnError(retRes431615)
                ch <- retRes431615
                return nil
...
func  (this *coinex) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes43398)
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                var marketIds interface{} = this.MarketIds(symbols)
                ccxt.AddElementToObject(request, "market", ccxt.Join(marketIds, ","))
            }
...
func  (this *coinex) ParseMarketLeverageTiers(info interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(brackets)); i++ {
        ...
        ccxt.AppendToArray(&tiers, map[string]interface{} {
            ...
            "currency": ccxt.Ternary(ccxt.IsTrue(ccxt.GetValue(market, "linear")), ccxt.GetValue(market, "base"), ccxt.GetValue(market, "quote")),
...
func  (this *coinex) ModifyMarginHelper(symbol interface{}, amount interface{}, addOrReduce interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(addOrReduce, "reduce"))), "reduce", "add")
...
func  (this *coinex) ParseMarginModification(data interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    return map[string]interface{} {
        ...
        "type": nil,
        "marginMode": "isolated",
        "amount": this.ParseNumber(ccxt.Precise.StringAbs(change)),
...
func  (this *coinex) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes454315)
                ch <- retRes454315
                return nil
...
func  (this *coinex) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes455715)
                ch <- retRes455715
                return nil
...
func  (this *coinex) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes45758)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
                "market_type": "FUTURES",
            }
            __tmp332021 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp332021, 0)
            params = ccxt.GetValue(__tmp332021, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_time", since)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
...
func  (this *coinex) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                ccxt.PanicOnError(retRes468215)
                ch <- retRes468215
                return nil
...
func  (this *coinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                market = this.Market(symbol)
                if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                    panic(ccxt.BadSymbol(ccxt.Add(this.Id, " fetchFundingRates() supports swap contracts only")))
                }
                var marketIds interface{} = this.MarketIds(symbols)
                ccxt.AddElementToObject(request, "market", ccxt.Join(marketIds, ","))
            }
...
func  (this *coinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp644725 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp644725, 0)
            params = ccxt.GetValue(__tmp644725, 1)
            this.CheckAddress(address)
        
            retRes48018 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes48018)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "ccy": ccxt.GetValue(currency, "id"),
                "to_address": address,
            ...
            var networkCode interface{} = nil
            __tmp775894 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp775894, 0)
            params = ccxt.GetValue(__tmp775894, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
                ccxt.AddElementToObject(request, "chain", this.NetworkCodeToId(networkCode)) // required for on-chain, not required for inter-user transfer
            }
...
func  (this *coinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes48808)
            var paginate interface{} = false
            __tmp459613 := this.HandleOptionAndParams(params, "fetchFundingRateHistory", "paginate")
            paginate = ccxt.GetValue(__tmp459613, 0)
            params = ccxt.GetValue(__tmp459613, 1)
            if ccxt.IsTrue(paginate) {
                    ...
                    ccxt.PanicOnError(retRes488419)
                    ch <- retRes488419
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            __tmp424196 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp424196, 0)
            params = ccxt.GetValue(__tmp424196, 1)
...
func  (this *coinex) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(remark, nil)) {
        if ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetLength(remark), 1)) {
            remark = nil
        }
    }
    var txid interface{} = this.SafeString(transaction, "tx_id")
    if ccxt.IsTrue(!ccxt.IsEqual(txid, nil)) {
        if ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetLength(txid), 1)) {
            txid = nil
        }
    }
    ...
    var typeVar interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.InOp(transaction, "withdraw_id"))), "withdrawal", "deposit")
    ...
    var internal interface{} = ccxt.IsEqual(transferMethod, "local")
...
func  (this *coinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(fromAccount, "margin"))) || ccxt.IsTrue((ccxt.IsEqual(toAccount, "margin")))) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " transfer() the symbol parameter must be defined for a margin account")))
                }
                params = this.Omit(params, "symbol")
                ccxt.AddElementToObject(request, "market", this.MarketId(symbol))
            }
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(fromAccount, "spot"))) && ccxt.IsTrue((!ccxt.IsEqual(toAccount, "spot")))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " transfer() can only be between spot and swap, or spot and margin, either the fromAccount or toAccount must be spot")))
            }
...
func  (this *coinex) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marginMode interface{} = nil
            __tmp797654 := this.HandleMarginModeAndParams("fetchTransfers", params)
            marginMode = ccxt.GetValue(__tmp797654, 0)
            params = ccxt.GetValue(__tmp797654, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(marginMode, nil)) {
                ccxt.AddElementToObject(request, "transfer_type", "MARGIN")
            } else {
                ccxt.AddElementToObject(request, "transfer_type", "FUTURES")
            }
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_time", since)
            }
            ...
            __tmp985388 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp985388, 0)
            params = ccxt.GetValue(__tmp985388, 1)
...
func  (this *coinex) ParseIsolatedBorrowRate(info interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(currency, ccxt.GetValue(market, "baseId"))) {
        baseRate = rate
    } else if ccxt.IsTrue(ccxt.IsEqual(currency, ccxt.GetValue(market, "quoteId"))) {
        quoteRate = rate
    }
    return map[string]interface{} {
        "symbol": ccxt.GetValue(market, "symbol"),
        "base": ccxt.GetValue(market, "base"),
        "baseRate": baseRate,
        "quote": ccxt.GetValue(market, "quote"),
        "quoteRate": quoteRate,
        "period": 86400000,
        "timestamp": nil,
        "datetime": nil,
...
func  (this *coinex) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes53448)
            var code interface{} = this.SafeString(params, "code")
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchIsolatedBorrowRate() requires a code parameter")))
            }
...
func  (this *coinex) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(chains)); i++ {
        var entry interface{} = ccxt.GetValue(chains, i)
        var isWithdrawEnabled interface{} = this.SafeBool(entry, "withdraw_enabled")
        if ccxt.IsTrue(isWithdrawEnabled) {
            ccxt.AddElementToObject(ccxt.GetValue(result, "withdraw"), "fee", this.SafeNumber(entry, "withdrawal_fee"))
...
func  (this *coinex) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes57058)
            var code interface{} = this.SafeString(params, "code")
            if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchLeverage() requires a code parameter")))
            }
            params = this.Omit(params, "code")
            var currency interface{} = this.Currency(code)
            var market interface{} = this.Market(symbol)
...
func  (this *coinex) FetchPositionHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp285742 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp285742, 0)
            params = ccxt.GetValue(__tmp285742, 1)
...
func  (this *coinex) HandleMarginModeAndParams(methodName interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    var marginMode interface{} = nil
    __tmp468799 := this.Exchange.HandleMarginModeAndParams(methodName, params, defaultValue)
    marginMode = ccxt.GetValue(__tmp468799, 0)
    params = ccxt.GetValue(__tmp468799, 1)
    if ccxt.IsTrue(ccxt.IsEqual(marginMode, nil)) {
...
func  (this *coinex) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var requestUrl interface{} = ccxt.GetValue(api, 1)
    var url interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), requestUrl), "/"), version), "/"), path)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(method, "POST")) {
        ...
        var lastPart interface{} = this.SafeString(parts, ccxt.Subtract(numParts, 1), "")
        var lastWords interface{} = ccxt.Split(lastPart, "_")
        var numWords interface{} =         ccxt.GetArrayLength(lastWords)
        var lastWord interface{} = this.SafeString(lastWords, ccxt.Subtract(numWords, 1), "")
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(firstPart, "order"))) && ccxt.IsTrue((ccxt.IsTrue(ccxt.IsEqual(lastWord, "limit")) || ccxt.IsTrue(ccxt.IsEqual(lastWord, "market"))))) {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(clientOrderId, nil)) {
                ...
                ccxt.AddElementToObject(query, "client_id", ccxt.Add(ccxt.Add(brokerId, "_"), this.Uuid16()))
            }
        }
    }
    if ccxt.IsTrue(ccxt.IsEqual(requestUrl, "perpetualPrivate")) {
        ...
        var signature interface{} = this.Hash(this.Encode(ccxt.Add(ccxt.Add(urlencoded, "&secret_key="), this.Secret)), ccxt.Sha256)
        headers = map[string]interface{} {
            "Authorization": ccxt.ToLower(signature),
            "AccessId": this.ApiKey,
        }
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(method, "GET"))) || ccxt.IsTrue((ccxt.IsEqual(method, "PUT")))) {
            url = ccxt.Add(url, ccxt.Add("?", urlencoded))
        } else {
            ccxt.AddElementToObject(headers, "Content-Type", "application/x-www-form-urlencoded")
            body = urlencoded
        }
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(requestUrl, "public")) || ccxt.IsTrue(ccxt.IsEqual(requestUrl, "perpetualPublic"))) {
        if ccxt.IsTrue(ccxt.GetArrayLength(ccxt.ObjectKeys(query))) {
            url = ccxt.Add(url, ccxt.Add("?", this.Urlencode(query)))
        }
    } else {
        if ccxt.IsTrue(ccxt.IsEqual(version, "v1")) {
            this.CheckRequiredCredentials()
            query = this.Extend(map[string]interface{} {
                "access_id": this.ApiKey,
                "tonce": nonce,
            ...
            query = this.Keysort(query)
            var urlencoded interface{} = this.Rawencode(query)
            var signature interface{} = this.Hash(this.Encode(ccxt.Add(ccxt.Add(urlencoded, "&secret_key="), this.Secret)), ccxt.Md5)
            headers = map[string]interface{} {
                "Authorization": ccxt.ToUpper(signature),
                "Content-Type": "application/json",
            }
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(method, "GET"))) || ccxt.IsTrue((ccxt.IsEqual(method, "DELETE")))) || ccxt.IsTrue((ccxt.IsEqual(method, "PUT")))) {
                url = ccxt.Add(url, ccxt.Add("?", urlencoded))
            } else {
                body = this.Json(query)
            }
        } else if ccxt.IsTrue(ccxt.IsEqual(version, "v2")) {
            this.CheckRequiredCredentials()
            query = this.Keysort(query)
            var urlencoded interface{} = this.Rawencode(query)
            var preparedString interface{} = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(method, "/"), version), "/"), path)
            if ccxt.IsTrue(ccxt.IsEqual(method, "POST")) {
                body = this.Json(query)
                preparedString = ccxt.Add(preparedString, body)
            } else if ccxt.IsTrue(urlencoded) {
                preparedString = ccxt.Add(preparedString, ccxt.Add("?", urlencoded))
            }
            preparedString = ccxt.Add(preparedString, ccxt.Add(nonce, this.Secret))
            var signature interface{} = this.Hash(this.Encode(preparedString), ccxt.Sha256)
            headers = map[string]interface{} {
                "Content-Type": "application/json",
...
func  (this *coinex) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(code, "0"))) || ccxt.IsTrue((ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(message, "Success"))) && ccxt.IsTrue((!ccxt.IsEqual(message, "Succeeded")))) && ccxt.IsTrue((!ccxt.IsEqual(ccxt.ToLower(message), "ok")))) && !ccxt.IsTrue(data)))) {
...
func  (this *coinex) FetchMarginAdjustmentHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(positionId, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchMarginAdjustmentHistory() requires a positionId parameter")))
            }
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": ccxt.GetValue(market, "id"),
            ...
            __tmp423116 := this.HandleUntilOption("end_time", request, params)
            request = ccxt.GetValue(__tmp423116, 0)
            params = ccxt.GetValue(__tmp423116, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                ccxt.AddElementToObject(request, "start_time", since)
            }
            if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
