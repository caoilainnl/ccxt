...
type coinexWs struct {
	coinex
	base coinex
}

func NewCoinexWsCore() coinexWs {
   p := coinexWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *coinexWs) Describe() interface{}  {
...
func  (this *coinexWs) RequestId() interface{}  {
...
func  (this *coinexWs) HandleTicker(client interface{}, message interface{})  {
    //
    //  spot
    //
    //     {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(rawTickers)); i++ {
        ...
        ccxt.AppendToArray(&newTickers, parsedTicker)
    }
...
func  (this *coinexWs) ParseWSTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //  spot
    //
    //     {
 ...
 */
func  (this *coinexWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp569268 := this.HandleMarketTypeAndParams("watchBalance", nil, params, "spot")
            typeVar = ccxt.GetValue(__tmp569268, 0)
            params = ccxt.GetValue(__tmp569268, 1)
...
func  (this *coinexWs) HandleBalance(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
...
func  (this *coinexWs) ParseWsBalance(balance interface{}, optionalArgs ...interface{})  {
    //
    // spot
    //
    //     {
 ...
 */
func  (this *coinexWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp181129 := this.HandleMarketTypeAndParams("watchMyTrades", market, params, "spot")
            typeVar = ccxt.GetValue(__tmp181129, 0)
            params = ccxt.GetValue(__tmp181129, 1)
...
func  (this *coinexWs) HandleMyTrades(client interface{}, message interface{})  {
    //
    //     {
...
func  (this *coinexWs) HandleTrades(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
...
func  (this *coinexWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot watchTrades
    //
    //     {
 ...
 */
func  (this *coinexWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *coinexWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp178546 := this.HandleMarketTypeAndParams("watchTickers", market, params)
            typeVar = ccxt.GetValue(__tmp178546, 0)
            params = ccxt.GetValue(__tmp178546, 1)
            var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), typeVar)
            ...
            result:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(subscribe, params), subscriptionHashes, nil))
 ...
 */
func  (this *coinexWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.AddElementToObject(params, "callerMethodName", "watchTrades")
                ...
                retRes70015 :=  (<-this.WatchTradesForSymbols([]interface{}{symbol}, since, limit, params))
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *coinexWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp180274 := this.HandleParamString(params, "callerMethodName", "watchTradesForSymbols")
            callerMethodName = ccxt.GetValue(__tmp180274, 0)
            params = ccxt.GetValue(__tmp180274, 1)
            var symbolsDefined interface{} =     (!ccxt.IsEqual(symbols, nil))
            if ccxt.IsTrue(symbolsDefined) {
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
                    var symbol interface{} = ccxt.GetValue(symbols, i)
            ...
            var typeVar interface{} = nil
            __tmp235878 := this.HandleMarketTypeAndParams(callerMethodName, market, params)
            typeVar = ccxt.GetValue(__tmp235878, 0)
            params = ccxt.GetValue(__tmp235878, 1)
            var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), typeVar)
            var subscriptionHashes interface{} = []interface{}{"trades"}
            var subscribe interface{} = map[string]interface{} {
            ...
            trades:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(subscribe, params), subscriptionHashes, nil))
            ccxt.PanicOnError(trades)
            if ccxt.IsTrue(this.NewUpdates) {
 ...
 */
func  (this *coinexWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            var callerMethodName interface{} = nil
            __tmp110978 := this.HandleParamString(params, "callerMethodName", "watchOrderBookForSymbols")
            callerMethodName = ccxt.GetValue(__tmp110978, 0)
            params = ccxt.GetValue(__tmp110978, 1)
            __tmp961919 := this.HandleMarketTypeAndParams(callerMethodName, nil, params)
            typeVar = ccxt.GetValue(__tmp961919, 0)
            params = ccxt.GetValue(__tmp961919, 1)
            ...
            if ccxt.IsTrue(symbolsDefined) {
                ...
                ccxt.AppendToArray(&messageHashes, "orderbook")
            }
            ...
            var subscriptionHashes interface{} = this.Hash(this.Encode(this.Json(watchOrderBookSubscriptions)), ccxt.Sha256)
            var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), typeVar)
        
            orderbooks:= (<-this.WatchMultiple(url, messageHashes, this.DeepExtend(subscribe, params), subscriptionHashes, nil))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *coinexWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coinexWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bidAsk interface{} = this.ParseBidAsk(delta, 0, 1)
    bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func  (this *coinexWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *coinexWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //     {
    //         "method": "depth.update",
    //         "data": {
 ...
 */
func  (this *coinexWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp783681 := this.HandleMarketTypeAndParams("watchOrders", market, params, "spot")
            typeVar = ccxt.GetValue(__tmp783681, 0)
            params = ccxt.GetValue(__tmp783681, 1)
        
            retRes9248 := (<-this.Authenticate(typeVar))
...
func  (this *coinexWs) HandleOrders(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
...
func  (this *coinexWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //
    //     {
...
func  (this *coinexWs) ParseWsOrderStatus(status interface{}) interface{}  {
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *coinexWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp259581 := this.HandleMarketTypeAndParams("watchBidsAsks", market, params)
            typeVar = ccxt.GetValue(__tmp259581, 0)
            params = ccxt.GetValue(__tmp259581, 1)
            var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), typeVar)
...
func  (this *coinexWs) HandleBidAsk(client interface{}, message interface{})  {
    //
    //     {
    //         "method": "bbo.update",
    //         "data": {
...
func  (this *coinexWs) ParseWsBidAsk(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "market": "BTCUSDT",
    //         "updated_at": 1656660154,
...
func  (this *coinexWs) HandleMessage(client interface{}, message interface{})  {
    var method interface{} = this.SafeString(message, "method")
    var err interface{} = this.SafeString(message, "message")
    if ccxt.IsTrue(!ccxt.IsEqual(err, nil)) {
        this.HandleErrors(nil, nil, client.(*ccxt.Client).Url, method, nil, this.Json(err), message, nil, nil)
    }
...
func  (this *coinexWs) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
...
func  (this *coinexWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
    //
    // success
    //
    //     {
...
func  (this *coinexWs) HandleSubscriptionStatus(client interface{}, message interface{})  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(subscription, nil)) {
        ...
        var future interface{} = this.SafeValue(client.(*ccxt.Client).Futures, futureIndex)
...
func  (this *coinexWs) Authenticate(typeVar interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var timestamp interface{} = ccxt.ToString(now)
            var messageHash interface{} = "authenticated"
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(authenticated, nil)) {
                    ...
                    retRes142219 :=  <-future.(<-chan interface{})
                    ccxt.PanicOnError(retRes142219)
                    ch <- retRes142219
                    return nil
            }
            ...
            ccxt.AddElementToObject(client.(ccxt.ClientInterface).GetSubscriptions(), messageHash, true)
                ...
                retRes144115 :=  <-future.(<-chan interface{})
...
func (this *coinexWs) Init(userConfig map[string]interface{}) {
    this.coinex.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
