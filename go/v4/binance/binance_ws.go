...
func NewBinanceWsCore() binanceWs {
   p := binanceWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *binanceWs) Describe() interface{}  {
    var superDescribe interface{} = this.base.Describe()
    return this.DeepExtend(superDescribe, this.DescribeData())
}
func  (this *binanceWs) DescribeData() interface{}  {
...
func  (this *binanceWs) RequestId(url interface{}) interface{}  {
...
func  (this *binanceWs) Stream(typeVar interface{}, subscriptionHash interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *binanceWs) WatchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes22115 :=  (<-this.WatchLiquidationsForSymbols([]interface{}{symbol}, since, limit, params))
 ...
 * @returns {object} an array of [liquidation structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#liquidation-structure}
 */
func  (this *binanceWs) WatchLiquidationsForSymbols(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp651499 := this.HandleMarketTypeAndParams("watchLiquidationsForSymbols", firstMarket, params)
            typeVar = ccxt.GetValue(__tmp651499, 0)
            params = ccxt.GetValue(__tmp651499, 1)
            ...
            __tmp847957 := this.HandleSubTypeAndParams("watchLiquidationsForSymbols", firstMarket, params)
            subType = ccxt.GetValue(__tmp847957, 0)
            params = ccxt.GetValue(__tmp847957, 1)
...
func  (this *binanceWs) HandleLiquidation(client interface{}, message interface{})  {
    //
    // future
    //    {
    //        "e":"forceOrder",
...
func  (this *binanceWs) ParseWsLiquidation(liquidation interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // future
    //    {
    //        "s":"BTCUSDT",
 ...
 * @returns {object} an array of [liquidation structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#liquidation-structure}
 */
func  (this *binanceWs) WatchMyLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an array of [liquidation structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#liquidation-structure}
 */
func  (this *binanceWs) WatchMyLiquidationsForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes4608 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes4608)
            ...
            var typeVar interface{} = nil
            __tmp693137 := this.HandleMarketTypeAndParams("watchMyLiquidationsForSymbols", market, params)
            typeVar = ccxt.GetValue(__tmp693137, 0)
            params = ccxt.GetValue(__tmp693137, 1)
            var subType interface{} = nil
            __tmp302770 := this.HandleSubTypeAndParams("watchMyLiquidationsForSymbols", market, params)
            subType = ccxt.GetValue(__tmp302770, 0)
            params = ccxt.GetValue(__tmp302770, 1)
            if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
                typeVar = "future"
            } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
                typeVar = "delivery"
            ...
            retRes4798 := (<-this.Authenticate(params))
            ...
            newLiquidations:= (<-this.WatchMultiple(url, messageHashes, message, []interface{}{typeVar}, nil))
            ccxt.PanicOnError(newLiquidations)
            if ccxt.IsTrue(this.NewUpdates) {
...
func  (this *binanceWs) HandleMyLiquidation(client interface{}, message interface{})  {
    //
    //    {
    //        "s":"BTCUSDT",              // Symbol
    //        "c":"TEST",                 // ccxt.Client ccxt.Order Id
 ...
 */
func  (this *binanceWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes60615 :=  (<-this.WatchOrderBookForSymbols([]interface{}{symbol}, limit, params))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *binanceWs) WatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *binanceWs) UnWatchOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes72915 :=  (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, subscription))
                ccxt.PanicOnError(retRes72915)
                ch <- retRes72915
                return nil
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *binanceWs) UnWatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes74715 :=  (<-this.UnWatchOrderBookForSymbols([]interface{}{symbol}, params))
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
 */
func  (this *binanceWs) FetchOrderBookWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp348522 := this.HandleOptionAndParams(params, "createOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp348522, 0)
            params = ccxt.GetValue(__tmp348522, 1)
...
func  (this *binanceWs) HandleFetchOrderBook(client interface{}, message interface{})  {
    //
    //    {
...
func  (this *binanceWs) FetchOrderBookSnapshot(client interface{}, message interface{}, subscription interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            {		 func(this *binanceWs) (ret_ interface{}) {
            		defer func() {
            			if e := recover(); e != nil {
                            if e == "break" {
            				    return
            			    }
            				ret_ = func(this *binanceWs) interface{} {
            					// catch block:
...
func  (this *binanceWs) HandleDelta(bookside interface{}, delta interface{})  {
...
func  (this *binanceWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *binanceWs) HandleOrderBookMessage(client interface{}, message interface{}, orderbook interface{}) interface{}  {
...
func  (this *binanceWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    ...
    //     }
    //
    var isSpot interface{} =     (ccxt.IsGreaterThan(ccxt.GetIndexOf(client.(*ccxt.Client).Url, "/stream"), ccxt.OpNeg(1)))
...
func  (this *binanceWs) HandleOrderBookSubscription(client interface{}, message interface{}, subscription interface{})  {
    var defaultLimit interface{} = this.SafeInteger(this.Options, "watchOrderBookLimit", 1000)
...
func  (this *binanceWs) HandleSubscriptionStatus(client interface{}, message interface{}) interface{}  {
    //
    //     {
    //         "result": null,
    //         "id": 1574649734450
...
func  (this *binanceWs) HandleUnSubscription(client interface{}, subscription interface{})  {
 ...
 */
func  (this *binanceWs) WatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp414357 := this.HandleOptionAndParams(params, "watchTradesForSymbols", "name", "trade")
            name = ccxt.GetValue(__tmp414357, 0)
            params = ccxt.GetValue(__tmp414357, 1)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *binanceWs) UnWatchTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var name interface{} = nil
            __tmp189288 := this.HandleOptionAndParams(params, "watchTradesForSymbols", "name", "trade")
            name = ccxt.GetValue(__tmp189288, 0)
            params = ccxt.GetValue(__tmp189288, 1)
            params = this.Omit(params, "callerMethodName")
            var firstMarket interface{} = this.Market(ccxt.GetValue(symbols, 0))
            var typeVar interface{} = ccxt.GetValue(firstMarket, "type")
            if ccxt.IsTrue(ccxt.GetValue(firstMarket, "contract")) {
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes117815 :=  (<-this.WatchMultiple(url, messageHashes, this.Extend(request, query), messageHashes, subscription))
                ccxt.PanicOnError(retRes117815)
                ch <- retRes117815
                return nil
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *binanceWs) UnWatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(retRes11958)
                ...
                retRes119615 :=  (<-this.UnWatchTradesForSymbols([]interface{}{symbol}, params))
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
 */
func  (this *binanceWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.AddElementToObject(params, "callerMethodName", "watchTrades")
                ...
                retRes121615 :=  (<-this.WatchTradesForSymbols([]interface{}{symbol}, since, limit, params))
                ccxt.PanicOnError(retRes121615)
                ch <- retRes121615
                return nil
...
func  (this *binanceWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // public watchTrades
    //
    //     {
...
func  (this *binanceWs) HandleTrade(client interface{}, message interface{})  {
 ...
 */
func  (this *binanceWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *binanceWs) WatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp777128 := this.HandleParamString2(params, "channel", "name", "kline")
            klineType = ccxt.GetValue(__tmp777128, 0)
            params = ccxt.GetValue(__tmp777128, 1)
            ...
            __tmp302316 := this.HandleParamString(params, "timezone", nil)
            timezone = ccxt.GetValue(__tmp302316, 0)
            params = ccxt.GetValue(__tmp302316, 1)
            ...
            params = this.Omit(params, "callerMethodName")
            symboltimeframecandlesVariable := (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, subscribe))
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *binanceWs) UnWatchOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var klineType interface{} = nil
            __tmp817010 := this.HandleParamString2(params, "channel", "name", "kline")
            klineType = ccxt.GetValue(__tmp817010, 0)
            params = ccxt.GetValue(__tmp817010, 1)
            var symbols interface{} = this.GetListFromObjectValues(symbolsAndTimeframes, 0)
            var marketSymbols interface{} = this.MarketSymbols(symbols, nil, false, false, true)
            var firstMarket interface{} = this.Market(ccxt.GetValue(marketSymbols, 0))
            var typeVar interface{} = ccxt.GetValue(firstMarket, "type")
            ...
            var isSpot interface{} =     (ccxt.IsEqual(typeVar, "spot"))
            var timezone interface{} = nil
            __tmp222898 := this.HandleParamString(params, "timezone", nil)
            timezone = ccxt.GetValue(__tmp222898, 0)
            params = ccxt.GetValue(__tmp222898, 1)
            var isUtc8 interface{} = ccxt.IsTrue((!ccxt.IsEqual(timezone, nil))) && ccxt.IsTrue((ccxt.IsTrue((ccxt.IsEqual(timezone, "+08:00"))) || ccxt.IsTrue(ccxt.Precise.StringEq(timezone, "8"))))
            var rawHashes interface{} = []interface{}{}
            var subMessageHashes interface{} = []interface{}{}
            var messageHashes interface{} = []interface{}{}
            ...
            params = this.Omit(params, "callerMethodName")
                ...
                retRes155815 :=  (<-this.WatchMultiple(url, messageHashes, this.Extend(request, params), messageHashes, subscribe))
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *binanceWs) UnWatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.AddElementToObject(params, "callerMethodName", "watchOHLCV")
                ...
                retRes157915 :=  (<-this.UnWatchOHLCVForSymbols([]interface{}{[]interface{}{symbol, timeframe}}, params))
...
func  (this *binanceWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //     {
    //         "e": "kline",
    //         "E": 1579482921215,
 ...
 */
func  (this *binanceWs) FetchTickerWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var returnRateLimits interface{} = false
            __tmp645759 := this.HandleOptionAndParams(params, "fetchTickerWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp645759, 0)
            params = ccxt.GetValue(__tmp645759, 1)
            ccxt.AddElementToObject(payload, "returnRateLimits", returnRateLimits)
            params = this.Omit(params, "test")
            var method interface{} = nil
            __tmp349019 := this.HandleOptionAndParams(params, "fetchTickerWs", "method", "ticker.book")
            method = ccxt.GetValue(__tmp349019, 0)
            params = ccxt.GetValue(__tmp349019, 1)
            var message interface{} = map[string]interface{} {
                "id": messageHash,
                "method": method,
                "params": this.SignParams(this.Extend(payload, params)),
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *binanceWs) FetchOHLCVWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp983012 := this.HandleOptionAndParams(params, "fetchOHLCVWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp983012, 0)
            params = ccxt.GetValue(__tmp983012, 1)
            var payload interface{} = map[string]interface{} {
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes174115 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes174115)
                ch <- retRes174115
                return nil
...
func  (this *binanceWs) HandleFetchOHLCV(client interface{}, message interface{})  {
    //
    //    {
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) WatchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) WatchMarkPrices(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp642956 := this.HandleOptionAndParams(params, "watchMarkPrices", "name", "markPrice")
            channelName = ccxt.GetValue(__tmp642956, 0)
            params = ccxt.GetValue(__tmp642956, 1)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) WatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
            var channelName interface{} = nil
            __tmp205062 := this.HandleOptionAndParams(params, "watchTickers", "name", "ticker")
            channelName = ccxt.GetValue(__tmp205062, 0)
            params = ccxt.GetValue(__tmp205062, 1)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) UnWatchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
            var channelName interface{} = nil
            __tmp531355 := this.HandleOptionAndParams(params, "watchTickers", "name", "ticker")
            channelName = ccxt.GetValue(__tmp531355, 0)
            params = ccxt.GetValue(__tmp531355, 1)
            if ccxt.IsTrue(ccxt.IsEqual(channelName, "bookTicker")) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " deprecation notice - to subscribe for bids-asks, use watch_bids_asks() method instead")))
            }
            ...
            __tmp293349 := this.HandleMarketTypeAndParams(methodName, firstMarket, params)
            marketType = ccxt.GetValue(__tmp293349, 0)
            params = ccxt.GetValue(__tmp293349, 1)
            var subType interface{} = nil
            __tmp515187 := this.HandleSubTypeAndParams(methodName, firstMarket, params)
            subType = ccxt.GetValue(__tmp515187, 0)
            params = ccxt.GetValue(__tmp515187, 1)
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes195715 :=  (<-this.WatchMultiple(url, subMessageHashes, this.Extend(request, params), subMessageHashes, subscription))
                ccxt.PanicOnError(retRes195715)
                ch <- retRes195715
                return nil
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) UnWatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes197515 :=  (<-this.UnWatchTickers([]interface{}{symbol}, params))
                ccxt.PanicOnError(retRes197515)
                ch <- retRes197515
                return nil
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
 */
func  (this *binanceWs) WatchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *binanceWs) WatchMultiTickerHelper(methodName interface{}, channelName interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp962575 := this.HandleMarketTypeAndParams(methodName, firstMarket, params, defaultMarket)
            marketType = ccxt.GetValue(__tmp962575, 0)
            params = ccxt.GetValue(__tmp962575, 1)
            var subType interface{} = nil
            __tmp239259 := this.HandleSubTypeAndParams(methodName, firstMarket, params)
            subType = ccxt.GetValue(__tmp239259, 0)
            params = ccxt.GetValue(__tmp239259, 1)
            var rawMarketType interface{} = nil
            if ccxt.IsTrue(this.IsLinear(marketType, subType)) {
                rawMarketType = "future"
            } else if ccxt.IsTrue(this.IsInverse(marketType, subType)) {
...
func  (this *binanceWs) ParseWsTicker(message interface{}, marketType interface{}) interface{}  {
    // markPrice
    //   {
...
func  (this *binanceWs) HandleTickerWs(client interface{}, message interface{})  {
    //
    // ticker.price
    //    {
    //        "id":"1",
...
func  (this *binanceWs) HandleBidsAsks(client interface{}, message interface{})  {
    //
...
func  (this *binanceWs) HandleTickers(client interface{}, message interface{})  {
    //
    // arrives one symbol dict or array of symbol dicts
    //
    //     {
...
func  (this *binanceWs) HandleTickersAndBidsAsks(client interface{}, message interface{}, methodType interface{})  {
    var isSpot interface{} =     (ccxt.IsGreaterThan(ccxt.GetIndexOf(client.(*ccxt.Client).Url, "/stream"), ccxt.OpNeg(1)))
    var marketType interface{} = ccxt.Ternary(ccxt.IsTrue((isSpot)), "spot", "contract")
...
func  (this *binanceWs) GetMessageHash(channelName interface{}, symbol interface{}, isBidAsk interface{}) interface{}  {
...
func  (this *binanceWs) SignParams(optionalArgs ...interface{}) interface{}  {
    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
    _ = params
...
func  (this *binanceWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp350431 := this.HandleMarketTypeAndParams("authenticate", nil, params)
            typeVar = ccxt.GetValue(__tmp350431, 0)
            params = ccxt.GetValue(__tmp350431, 1)
            var subType interface{} = nil
            __tmp116196 := this.HandleSubTypeAndParams("authenticate", nil, params)
            subType = ccxt.GetValue(__tmp116196, 0)
            params = ccxt.GetValue(__tmp116196, 1)
            var isPortfolioMargin interface{} = nil
            __tmp668608 := this.HandleOptionAndParams2(params, "authenticate", "papi", "portfolioMargin", false)
            isPortfolioMargin = ccxt.GetValue(__tmp668608, 0)
            params = ccxt.GetValue(__tmp668608, 1)
            if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
                typeVar = "future"
            } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
                typeVar = "delivery"
            ...
            __tmp328263 := this.HandleMarginModeAndParams("authenticate", params)
            marginMode = ccxt.GetValue(__tmp328263, 0)
            params = ccxt.GetValue(__tmp328263, 1)
            ...
            if ccxt.IsTrue(ccxt.IsGreaterThan(ccxt.Subtract(now, lastAuthenticatedTime), delay)) {
...
func  (this *binanceWs) KeepAliveListenKey(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var isPortfolioMargin interface{} = nil
            __tmp416320 := this.HandleOptionAndParams2(params, "keepAliveListenKey", "papi", "portfolioMargin", false)
            isPortfolioMargin = ccxt.GetValue(__tmp416320, 0)
            params = ccxt.GetValue(__tmp416320, 1)
            ...
            {		 func(this *binanceWs) (ret_ interface{}) {
                ...
                "lastAuthenticatedTime": 0,
            		...
            		// try block:
                        ...
                        retRes243816 := (<-this.PapiPutListenKey(this.Extend(request, params)))
                        ccxt.PanicOnError(retRes243816)
                        params = this.Extend(params, map[string]interface{} {
                            "portfolioMargin": true,
                        })
                    } else if ccxt.IsTrue(ccxt.IsEqual(typeVar, "future")) {
            
                        retRes244116 := (<-this.FapiPrivatePutListenKey(this.Extend(request, params)))
                        ccxt.PanicOnError(retRes244116)
                    } else if ccxt.IsTrue(ccxt.IsEqual(typeVar, "delivery")) {
            
                        retRes244316 := (<-this.DapiPrivatePutListenKey(this.Extend(request, params)))
                        ccxt.PanicOnError(retRes244316)
                    } else {
                        ...
                        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "margin")) {
                            ...
                            retRes244820 := (<-this.SapiPutUserDataStream(this.Extend(request, params)))
                            ccxt.PanicOnError(retRes244820)
                        } else {
            
                            retRes245020 := (<-this.PublicPutUserDataStream(this.Extend(request, params)))
                            ccxt.PanicOnError(retRes245020)
                        }
                    }
            		return nil
            	}(this)
...
func  (this *binanceWs) SetBalanceCache(client interface{}, typeVar interface{}, optionalArgs ...interface{})  {
    isPortfolioMargin := ccxt.GetArg(optionalArgs, 0, false)
    _ = isPortfolioMargin
    if ccxt.IsTrue(ccxt.InOp(client.(ccxt.ClientInterface).GetSubscriptions(), typeVar)) {
        return
    }
...
func  (this *binanceWs) LoadBalanceSnapshot(client interface{}, messageHash interface{}, typeVar interface{}, isPortfolioMargin interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *binanceWs) FetchBalanceWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp493353 := this.HandleOptionAndParams(params, "fetchBalanceWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp493353, 0)
            params = ccxt.GetValue(__tmp493353, 1)
            var payload interface{} = map[string]interface{} {
                "returnRateLimits": returnRateLimits,
            }
            var method interface{} = nil
            __tmp520806 := this.HandleOptionAndParams(params, "fetchBalanceWs", "method", "account.status")
            method = ccxt.GetValue(__tmp520806, 0)
            params = ccxt.GetValue(__tmp520806, 1)
            var message interface{} = map[string]interface{} {
                "id": messageHash,
                "method": method,
                "params": this.SignParams(this.Extend(payload, params)),
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes256115 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes256115)
                ch <- retRes256115
                return nil
...
func  (this *binanceWs) HandleBalanceWs(client interface{}, message interface{})  {
    //
    //
    var messageHash interface{} = this.SafeString(message, "id")
...
func  (this *binanceWs) HandleAccountStatusWs(client interface{}, message interface{})  {
    //
    // spot
    //    {
 ...
 */
func  (this *binanceWs) FetchPositionWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes264415 :=  (<-this.FetchPositionsWs([]interface{}{symbol}, params))
                ccxt.PanicOnError(retRes264415)
                ch <- retRes264415
                return nil
 ...
 */
func  (this *binanceWs) FetchPositionsWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp289877 := this.HandleOptionAndParams(params, "fetchPositionsWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp289877, 0)
            params = ccxt.GetValue(__tmp289877, 1)
            ccxt.AddElementToObject(payload, "returnRateLimits", returnRateLimits)
            var method interface{} = nil
            __tmp946612 := this.HandleOptionAndParams(params, "fetchPositionsWs", "method", "account.position")
            method = ccxt.GetValue(__tmp946612, 0)
            params = ccxt.GetValue(__tmp946612, 1)
            var message interface{} = map[string]interface{} {
                "id": messageHash,
                "method": method,
                "params": this.SignParams(this.Extend(payload, params)),
...
func  (this *binanceWs) HandlePositionsWs(client interface{}, message interface{})  {
    //
    //    {
    //        id: '1',
    //        status: 200,
 ...
 * @returns {object} a [balance structure]{@link https://docs.ccxt.com/#/?id=balance-structure}
 */
func  (this *binanceWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes27498 := (<-this.Authenticate(params))
            ...
            var subType interface{} = nil
            __tmp481749 := this.HandleSubTypeAndParams("watchBalance", nil, params)
            subType = ccxt.GetValue(__tmp481749, 0)
            params = ccxt.GetValue(__tmp481749, 1)
            var isPortfolioMargin interface{} = nil
            __tmp212424 := this.HandleOptionAndParams2(params, "watchBalance", "papi", "portfolioMargin", false)
            isPortfolioMargin = ccxt.GetValue(__tmp212424, 0)
            params = ccxt.GetValue(__tmp212424, 1)
            if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
                typeVar = "future"
            } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
                typeVar = "delivery"
            ...
            if ccxt.IsTrue(ccxt.IsTrue(fetchBalanceSnapshot) && ccxt.IsTrue(awaitBalanceSnapshot)) {
                ...
                retRes277312 := (<-client.(ccxt.ClientInterface).Future(ccxt.Add(typeVar, ":fetchBalanceSnapshot")))
                ccxt.PanicOnError(retRes277312)
            }
            var messageHash interface{} = ccxt.Add(typeVar, ":balance")
            var message interface{} = nil
        
                retRes277715 :=  (<-this.Watch(url, messageHash, message, typeVar))
                ccxt.PanicOnError(retRes277715)
                ch <- retRes277715
                return nil
...
func  (this *binanceWs) HandleBalance(client interface{}, message interface{})  {
    //
    ...
    if ccxt.IsTrue(ccxt.IsEqual(event, "balanceUpdate")) {
        ...
        var deltaFree interface{} = this.SafeString(message, "d")
        if ccxt.IsTrue(ccxt.InOp(ccxt.GetValue(this.Balance, accountType), code)) {
            ...
            ccxt.AddElementToObject(account, "free", ccxt.Precise.StringAdd(previousValue, deltaFree))
        } else {
            ccxt.AddElementToObject(account, "free", deltaFree)
        }
...
func  (this *binanceWs) GetMarketType(method interface{}, market interface{}, optionalArgs ...interface{}) interface{}  {
    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
    _ = params
    var typeVar interface{} = nil
    __tmp399162 := this.HandleMarketTypeAndParams(method, market, params)
    typeVar = ccxt.GetValue(__tmp399162, 0)
    params = ccxt.GetValue(__tmp399162, 1)
    var subType interface{} = nil
    __tmp184050 := this.HandleSubTypeAndParams(method, market, params)
    subType = ccxt.GetValue(__tmp184050, 0)
    params = ccxt.GetValue(__tmp184050, 1)
    if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
        typeVar = "future"
    } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
        typeVar = "delivery"
 ...
 */
func  (this *binanceWs) CreateOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes29168 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes29168)
            var market interface{} = this.Market(symbol)
            ...
            var returnRateLimits interface{} = false
            __tmp488669 := this.HandleOptionAndParams(params, "createOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp488669, 0)
            params = ccxt.GetValue(__tmp488669, 1)
            ccxt.AddElementToObject(payload, "returnRateLimits", returnRateLimits)
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes294815 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes294815)
                ch <- retRes294815
                return nil
...
func  (this *binanceWs) HandleOrderWs(client interface{}, message interface{})  {
    //
    //    {
    //        "id": 1,
    //        "status": 200,
...
func  (this *binanceWs) HandleOrdersWs(client interface{}, message interface{})  {
    //
    //    {
    //        "id": 1,
    //        "status": 200,
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *binanceWs) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var returnRateLimits interface{} = false
            __tmp194964 := this.HandleOptionAndParams(params, "editOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp194964, 0)
            params = ccxt.GetValue(__tmp194964, 1)
            ccxt.AddElementToObject(payload, "returnRateLimits", returnRateLimits)
            var message interface{} = map[string]interface{} {
                "id": messageHash,
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes309315 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes309315)
                ch <- retRes309315
                return nil
...
func  (this *binanceWs) HandleEditOrderWs(client interface{}, message interface{})  {
    //
    // spot
    //    {
    //        "id": 1,
 ...
 */
func  (this *binanceWs) CancelOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp106125 := this.HandleOptionAndParams(params, "cancelOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp106125, 0)
            params = ccxt.GetValue(__tmp106125, 1)
            var payload interface{} = map[string]interface{} {
                "symbol": this.MarketId(symbol),
                "returnRateLimits": returnRateLimits,
            }
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes325115 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes325115)
                ch <- retRes325115
                return nil
 ...
 */
func  (this *binanceWs) CancelAllOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(typeVar, "spot")) && ccxt.IsTrue(!ccxt.IsEqual(typeVar, "future"))) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " cancelAllOrdersWs only supports spot or swap markets")))
            }
            var url interface{} = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "ws-api"), typeVar)
            var requestId interface{} = this.RequestId(url)
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp422141 := this.HandleOptionAndParams(params, "cancelAllOrdersWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp422141, 0)
            params = ccxt.GetValue(__tmp422141, 1)
            var payload interface{} = map[string]interface{} {
                "symbol": this.MarketId(symbol),
                "returnRateLimits": returnRateLimits,
            }
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes328715 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes328715)
                ch <- retRes328715
                return nil
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *binanceWs) FetchOrderWs(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp64780 := this.HandleOptionAndParams(params, "fetchOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp64780, 0)
            params = ccxt.GetValue(__tmp64780, 1)
            var payload interface{} = map[string]interface{} {
                "symbol": this.MarketId(symbol),
                "returnRateLimits": returnRateLimits,
            }
            ...
            var subscription interface{} = map[string]interface{} {
                ...
                retRes333515 :=  (<-this.Watch(url, messageHash, message, messageHash, subscription))
                ccxt.PanicOnError(retRes333515)
                ch <- retRes333515
                return nil
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *binanceWs) FetchOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp869120 := this.HandleOptionAndParams(params, "fetchOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp869120, 0)
            params = ccxt.GetValue(__tmp869120, 1)
            var payload interface{} = map[string]interface{} {
                "symbol": this.MarketId(symbol),
                "returnRateLimits": returnRateLimits,
            }
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *binanceWs) FetchClosedOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *binanceWs) FetchOpenOrdersWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes34198 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes34198)
            var market interface{} = this.Market(symbol)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp338866 := this.HandleOptionAndParams(params, "fetchOrderWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp338866, 0)
            params = ccxt.GetValue(__tmp338866, 1)
            var payload interface{} = map[string]interface{} {
                "returnRateLimits": returnRateLimits,
            }
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func  (this *binanceWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp406344 := this.HandleMarketTypeAndParams("watchOrders", market, params)
            typeVar = ccxt.GetValue(__tmp406344, 0)
            params = ccxt.GetValue(__tmp406344, 1)
            var subType interface{} = nil
            __tmp110101 := this.HandleSubTypeAndParams("watchOrders", market, params)
            subType = ccxt.GetValue(__tmp110101, 0)
            params = ccxt.GetValue(__tmp110101, 1)
            if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
                typeVar = "future"
            } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
                typeVar = "delivery"
            ...
            retRes34828 := (<-this.Authenticate(params))
            ccxt.PanicOnError(retRes34828)
            var marginMode interface{} = nil
            __tmp806139 := this.HandleMarginModeAndParams("watchOrders", params)
            marginMode = ccxt.GetValue(__tmp806139, 0)
            params = ccxt.GetValue(__tmp806139, 1)
            var urlType interface{} = typeVar
            ...
            var isPortfolioMargin interface{} = nil
            __tmp593052 := this.HandleOptionAndParams2(params, "watchOrders", "papi", "portfolioMargin", false)
            isPortfolioMargin = ccxt.GetValue(__tmp593052, 0)
            params = ccxt.GetValue(__tmp593052, 1)
            if ccxt.IsTrue(isPortfolioMargin) {
                urlType = "papi"
            }
            var url interface{} = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), urlType), "/"), ccxt.GetValue(ccxt.GetValue(this.Options, typeVar), "listenKey"))
...
func  (this *binanceWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //
    //     {
...
func  (this *binanceWs) HandleOrderUpdate(client interface{}, message interface{})  {
    //
    // spot
    //
    //     {
 ...
 */
func  (this *binanceWs) WatchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var typeVar interface{} = nil
            __tmp162905 := this.HandleMarketTypeAndParams("watchPositions", market, params)
            typeVar = ccxt.GetValue(__tmp162905, 0)
            params = ccxt.GetValue(__tmp162905, 1)
            if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(typeVar, "spot")) || ccxt.IsTrue(ccxt.IsEqual(typeVar, "margin"))) {
                typeVar = "future"
            }
            var subType interface{} = nil
            __tmp468038 := this.HandleSubTypeAndParams("watchPositions", market, params)
            subType = ccxt.GetValue(__tmp468038, 0)
            params = ccxt.GetValue(__tmp468038, 1)
            if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
                typeVar = "future"
            } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
                typeVar = "delivery"
            ...
            retRes37838 := (<-this.Authenticate(this.Extend(marketTypeObject, params)))
            ccxt.PanicOnError(retRes37838)
            messageHash = ccxt.Add(ccxt.Add(typeVar, ":positions"), messageHash)
            var isPortfolioMargin interface{} = nil
            __tmp123750 := this.HandleOptionAndParams2(params, "watchPositions", "papi", "portfolioMargin", false)
            isPortfolioMargin = ccxt.GetValue(__tmp123750, 0)
            params = ccxt.GetValue(__tmp123750, 1)
            var urlType interface{} = typeVar
            if ccxt.IsTrue(isPortfolioMargin) {
                urlType = "papi"
            }
...
func  (this *binanceWs) SetPositionsCache(client interface{}, typeVar interface{}, optionalArgs ...interface{})  {
    symbols := ccxt.GetArg(optionalArgs, 0, nil)
    _ = symbols
...
func  (this *binanceWs) LoadPositionsSnapshot(client interface{}, messageHash interface{}, typeVar interface{}, isPortfolioMargin interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *binanceWs) HandlePositions(client interface{}, message interface{})  {
    //
    //     {
    //         e: 'ACCOUNT_UPDATE',
    //         T: 1667881353112,
...
func  (this *binanceWs) ParseWsPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "s": "BTCUSDT", // Symbol
    //         "pa": "0", // ccxt.Position Amount
 ...
 */
func  (this *binanceWs) FetchMyTradesWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp926332 := this.HandleOptionAndParams(params, "fetchMyTradesWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp926332, 0)
            params = ccxt.GetValue(__tmp926332, 1)
            var payload interface{} = map[string]interface{} {
                "symbol": this.MarketId(symbol),
                "returnRateLimits": returnRateLimits,
            }
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
 */
func  (this *binanceWs) FetchTradesWs(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.PanicOnError(retRes40438)
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " fetchTradesWs () requires a symbol argument")))
            }
            var market interface{} = this.Market(symbol)
            ...
            var messageHash interface{} = ccxt.ToString(requestId)
            var returnRateLimits interface{} = false
            __tmp555810 := this.HandleOptionAndParams(params, "fetchTradesWs", "returnRateLimits", false)
            returnRateLimits = ccxt.GetValue(__tmp555810, 0)
            params = ccxt.GetValue(__tmp555810, 1)
            var payload interface{} = map[string]interface{} {
                "symbol": this.MarketId(symbol),
                "returnRateLimits": returnRateLimits,
            }
...
func  (this *binanceWs) HandleTradesWs(client interface{}, message interface{})  {
    //
    // fetchMyTradesWs
    //
    //    {
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
 */
func  (this *binanceWs) WatchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            __tmp773545 := this.HandleMarketTypeAndParams("watchMyTrades", market, params)
            typeVar = ccxt.GetValue(__tmp773545, 0)
            params = ccxt.GetValue(__tmp773545, 1)
            var subType interface{} = nil
            __tmp187218 := this.HandleSubTypeAndParams("watchMyTrades", market, params)
            subType = ccxt.GetValue(__tmp187218, 0)
            params = ccxt.GetValue(__tmp187218, 1)
            if ccxt.IsTrue(this.IsLinear(typeVar, subType)) {
                typeVar = "future"
            } else if ccxt.IsTrue(this.IsInverse(typeVar, subType)) {
                typeVar = "delivery"
            ...
            retRes41618 := (<-this.Authenticate(params))
            ccxt.PanicOnError(retRes41618)
            var urlType interface{} = typeVar // we don't change type because the listening key is different
            if ccxt.IsTrue(ccxt.IsEqual(typeVar, "margin")) {
                urlType = "spot" // spot-margin shares the same stream as regular spot
            }
            var isPortfolioMargin interface{} = nil
            __tmp224076 := this.HandleOptionAndParams2(params, "watchMyTrades", "papi", "portfolioMargin", false)
            isPortfolioMargin = ccxt.GetValue(__tmp224076, 0)
            params = ccxt.GetValue(__tmp224076, 1)
            if ccxt.IsTrue(isPortfolioMargin) {
                urlType = "papi"
            }
            var url interface{} = ccxt.Add(ccxt.Add(ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), urlType), "/"), ccxt.GetValue(ccxt.GetValue(this.Options, typeVar), "listenKey"))
...
func  (this *binanceWs) HandleMyTrade(client interface{}, message interface{})  {
    var messageHash interface{} = "myTrades"
    ...
    if ccxt.IsTrue(ccxt.IsEqual(executionType, "TRADE")) {
        ...
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(!ccxt.IsEqual(orderId, nil)) && ccxt.IsTrue(!ccxt.IsEqual(tradeFee, nil))) && ccxt.IsTrue(!ccxt.IsEqual(symbol, nil))) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(cachedOrders, nil)) {
                ...
                value := ccxt.GetValue(order, "fees")
                ccxt.AppendToArray(&value, tradeFee)
...
func  (this *binanceWs) HandleOrder(client interface{}, message interface{})  {
...
func  (this *binanceWs) HandleAcountUpdate(client interface{}, message interface{})  {
    this.HandleBalance(client, message)
    this.HandlePositions(client, message)
}
func  (this *binanceWs) HandleWsError(client interface{}, message interface{})  {
    //
    //    {
    //        "error": {
    //            "code": 2,
    ...
    var err interface{} = this.SafeDict(message, "error", map[string]interface{} {})
    var code interface{} = this.SafeInteger(err, "code")
    var msg interface{} = this.SafeString(err, "msg")
    ...
    {		 func(this *binanceWs) (ret_ interface{}) {
    		...
    		// try block:
                    this.HandleErrors(code, msg, client.(*ccxt.Client).Url, nil, nil, this.Json(err), err, nil, nil)
    		return nil
    	}(this)
    ...
    var codeString interface{} = this.SafeString(err, "code")
...
func  (this *binanceWs) HandleMessage(client interface{}, message interface{})  {
    // handle WebSocketAPI
    var status interface{} = this.SafeString(message, "status")
    var err interface{} = this.SafeValue(message, "error")
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(err, nil))) || ccxt.IsTrue((ccxt.IsTrue(!ccxt.IsEqual(status, nil)) && ccxt.IsTrue(!ccxt.IsEqual(status, "200"))))) {
...
func (this *binanceWs) Init(userConfig map[string]interface{}) {
