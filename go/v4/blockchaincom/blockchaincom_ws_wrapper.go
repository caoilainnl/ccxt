...
type BlockchaincomWs struct {
   *blockchaincomWs
   Core *blockchaincomWs
}

func NewBlockchaincomWs(userConfig map[string]interface{}) BlockchaincomWs {
   p := &blockchaincomWs{}
   p.Init(userConfig)
   return BlockchaincomWs{
       blockchaincomWs: p,
       Core:  p,
   }
}
...
func (this *BlockchaincomWs) WatchBalance(params ...interface{}) (ccxt.Balances, error) {
...
func (this *BlockchaincomWs) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
...
func (this *BlockchaincomWs) WatchTicker(symbol string, options ...ccxt.WatchTickerOptions) (ccxt.Ticker, error) {
...
func (this *BlockchaincomWs) WatchTrades(symbol string, options ...ccxt.WatchTradesOptions) ([]ccxt.Trade, error) {
...
func (this *BlockchaincomWs) WatchOrders(options ...ccxt.WatchOrdersOptions) ([]ccxt.Order, error) {
...
func (this *BlockchaincomWs) WatchOrderBook(symbol string, options ...ccxt.WatchOrderBookOptions) (ccxt.IOrderBook, error) {
