...
type blockchaincomWs struct {
	blockchaincom
	base blockchaincom
}

func NewBlockchaincomWsCore() blockchaincomWs {
   p := blockchaincomWs{}
   ccxt.SetDefaults(&p)
   return p
}

func  (this *blockchaincomWs) Describe() interface{}  {
 ...
 */
func  (this *blockchaincomWs) WatchBalance(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *blockchaincomWs) HandleBalance(client interface{}, message interface{})  {
    //
    //  subscribed
    //     {
    //         "seqnum": 1,
 ...
 */
func  (this *blockchaincomWs) WatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blockchaincomWs) HandleOHLCV(client interface{}, message interface{})  {
    //
    //  subscribed
    //     {
    //         "seqnum": 0,
 ...
 */
func  (this *blockchaincomWs) WatchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blockchaincomWs) HandleTicker(client interface{}, message interface{})  {
    //
    //  subscribed
    //     {
    //         "seqnum": 0,
...
func  (this *blockchaincomWs) ParseWsUpdatedTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "seqnum": 2,
    //         "event": "updated",
 ...
 */
func  (this *blockchaincomWs) WatchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blockchaincomWs) HandleTrades(client interface{}, message interface{})  {
    //
    //  subscribed
    //     {
    //         "seqnum": 0,
...
func  (this *blockchaincomWs) ParseWsTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "seqnum": 1,
    //         "event": "updated",
 ...
 */
func  (this *blockchaincomWs) WatchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blockchaincomWs) HandleOrders(client interface{}, message interface{})  {
    //
    //     {
    //         "seqnum": 1,
    //         "event": "rejected",
...
func  (this *blockchaincomWs) ParseWsOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "seqnum": 3,
    //         "event": "updated",
...
func  (this *blockchaincomWs) ParseWsOrderStatus(status interface{}) interface{}  {
 ...
 */
func  (this *blockchaincomWs) WatchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *blockchaincomWs) HandleOrderBook(client interface{}, message interface{})  {
    //
    //  subscribe
    //     {
    //         "seqnum": 0,
...
func  (this *blockchaincomWs) HandleDelta(bookside interface{}, delta interface{})  {
    var bookArray interface{} = this.ParseBidAsk(delta, "px", "qty", "num")
    bookside.(ccxt.IOrderBookSide).StoreArray(bookArray)
}
func  (this *blockchaincomWs) HandleDeltas(bookside interface{}, deltas interface{})  {
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
        this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
    }
}
func  (this *blockchaincomWs) HandleMessage(client interface{}, message interface{})  {
...
func  (this *blockchaincomWs) HandleAuthenticationMessage(client interface{}, message interface{})  {
    //
    //     {
    //         "seqnum": 0,
    //         "event": "subscribed",
...
func  (this *blockchaincomWs) Authenticate(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(isAuthenticated, nil)) {
                ...
                retRes78715 :=  <-future.(<-chan interface{})
...
func (this *blockchaincomWs) Init(userConfig map[string]interface{}) {
    this.blockchaincom.Init(this.DeepExtend(this.Describe(), userConfig))
    this.Itf = this
