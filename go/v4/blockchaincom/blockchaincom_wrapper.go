 ...
 */
func (this *Blockchaincom) FetchL3OrderBook(symbol string, options ...ccxt.FetchL3OrderBookOptions) (ccxt.OrderBook, error) {

    opts := ccxt.FetchL3OrderBookOptionsStruct{}
...
func (this *Blockchaincom) FetchL2OrderBook(symbol string, options ...ccxt.FetchL2OrderBookOptions) (ccxt.OrderBook, error) {

    opts := ccxt.FetchL2OrderBookOptionsStruct{}
 ...
 */
func (this *Blockchaincom) FetchCanceledOrders(options ...ccxt.FetchCanceledOrdersOptions) ([]ccxt.Order, error) {
...
func (this *Blockchaincom) FetchOrdersByState(state interface{}, options ...ccxt.FetchOrdersByStateOptions) ([]ccxt.Order, error) {
 ...
 * @returns {object} a [transaction structure]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Blockchaincom) FetchWithdrawal(id string, options ...ccxt.FetchWithdrawalOptions) (ccxt.Transaction, error) {
 ...
 * @returns {object} a [transaction structure]{@link https://docs.ccxt.com/#/?id=transaction-structure}
 */
func (this *Blockchaincom) FetchDeposit(id string, options ...ccxt.FetchDepositOptions) (ccxt.Transaction, error) {
