    ...
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "api": map[string]interface{} {
            "public": map[string]interface{} {
                "get": map[string]interface{} {
                    ...
                    "api/spot/v1/public/currencies": ccxt.Divide(20, 3),
        ...
        "exceptions": map[string]interface{} {
            "exact": map[string]interface{} {
                ...
                "40020": ccxt.BadRequest,
                "40034": ccxt.BadRequest,
                "400172": ccxt.BadRequest,
                "40912": ccxt.BadRequest,
                "40913": ccxt.BadRequest,
                "40102": ccxt.BadRequest,
                "40200": ccxt.OnMaintenance,
                "40305": ccxt.BadRequest,
                "40409": ccxt.ExchangeError,
                "40704": ccxt.ExchangeError,
                "40724": ccxt.BadRequest,
                "40725": ccxt.ExchangeError,
                "40762": ccxt.InsufficientFunds,
                "40774": ccxt.BadRequest,
                "40808": ccxt.BadRequest,
                "43001": ccxt.OrderNotFound,
                "43002": ccxt.InvalidOrder,
                "43004": ccxt.OrderNotFound,
                "43005": ccxt.RateLimitExceeded,
                "43006": ccxt.BadRequest,
                "43007": ccxt.BadRequest,
                "43008": ccxt.BadRequest,
                "43009": ccxt.BadRequest,
                "43010": ccxt.BadRequest,
                "43011": ccxt.BadRequest,
                "43012": ccxt.InsufficientFunds,
                "43117": ccxt.InsufficientFunds,
                "43118": ccxt.BadRequest,
                "43122": ccxt.BadRequest,
                "45006": ccxt.InsufficientFunds,
                "45110": ccxt.BadRequest,
            },
...
func  (this *coincatch) CalculateRateLimiterCost(api interface{}, method interface{}, path interface{}, params interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(step, nil))) && ccxt.IsTrue((ccxt.IsGreaterThan(ordersLength, step)))) {
        var numberOfSteps interface{} = ccxt.MathCeil(ccxt.Divide(ordersLength, step))
        return ccxt.Multiply(cost, numberOfSteps)
    } else {
        return cost
    }
}
...
func  (this *coincatch) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
                var currecy interface{} = ccxt.GetValue(data, i)
                var currencyId interface{} = this.SafeString(currecy, "coinName")
                ccxt.AppendToArray(&currenciesIds, currencyId)
                ...
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(networks)); j++ {
                    ...
                    ccxt.AddElementToObject(parsedNetworks, networkId, map[string]interface{} {
            "id": networkId,
            "network": networkCode,
            ...
            "active": nil,
            "deposit": ccxt.IsEqual(this.SafeString(network, "rechargeable"), "true"),
            "withdraw": ccxt.IsEqual(this.SafeString(network, "withdrawable"), "true"),
            ...
            if ccxt.IsTrue(ccxt.IsEqual(this.SafeList(this.Options, "currencyIdsListForParseMarket"), nil)) {
                ccxt.AddElementToObject(this.Options, "currencyIdsListForParseMarket", currenciesIds)
            }
 ...
 */
func  (this *coincatch) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *coincatch) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // {
    //     "coinId":"1",
    //     "coinName":"BTC",
...
func  (this *coincatch) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(this.SafeList(this.Options, "currencyIdsListForParseMarket"), nil)) {
                ...
                retRes77512 := (<-this.FetchCurrencies())
            ...
            __tmp791778 := this.HandleOptionAndParams(params, "fetchMarkets", "productType", productType)
            productType = ccxt.GetValue(__tmp791778, 0)
            params = ccxt.GetValue(__tmp791778, 1)
            var swapMarkets interface{} = []interface{}{}
            ccxt.AddElementToObject(request, "productType", "umcbl")
            ...
            ccxt.AddElementToObject(request, "productType", "dmcbl")
            response = (<-this.PublicGetApiMixV1MarketContracts(this.Extend(request, params)))
            //
            //     {
            //         "code":"00000",
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(swapDMCBL)); i++ {
                var market interface{} = ccxt.GetValue(swapDMCBL, i)
                var supportMarginCoins interface{} = this.SafeList(market, "supportMarginCoins", []interface{}{})
                for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(supportMarginCoins)); j++ {
                    var settle interface{} = ccxt.GetValue(supportMarginCoins, j)
                    var obj interface{} = map[string]interface{} {
                        "supportMarginCoins": []interface{}{settle},
                    }
                    ccxt.AppendToArray(&swapDMCBLExtended, this.Extend(market, obj))
                }
            }
...
func  (this *coincatch) ParseMarket(market interface{}) interface{}  {
    ...
    var isSpot interface{} = ccxt.IsEqual(baseId, nil) // for now spot markets have no properties baseCoin and quoteCoin
    if ccxt.IsTrue(isSpot) {
        ...
        marketId = ccxt.Add(marketId, "_SPBL") // spot markets should have current suffix
    } else {
        typeVar = "swap"
        ccxt.AddElementToObject(fees, "taker", this.SafeNumber(market, "takerFeeRate"))
        ccxt.AddElementToObject(fees, "maker", this.SafeNumber(market, "makerFeeRate"))
        var supportMarginCoins interface{} = this.SafeList(market, "supportMarginCoins", []interface{}{})
        settleId = this.SafeString(supportMarginCoins, 0)
        settle = this.SafeCurrencyCode(settleId)
        suffix = ccxt.Add(":", settle)
        isLinear = ccxt.IsEqual(quoteId, settleId) // todo check
        isInverse = ccxt.IsEqual(baseId, settleId) // todo check
    ...
    var active interface{} = ccxt.Ternary(ccxt.IsTrue(symbolStatus), (ccxt.IsEqual(symbolStatus, "normal")), nil)
    ...
    var pricePrecisionString interface{} = ccxt.Precise.StringMul(this.ParsePrecision(pricePlace), priceEndStep)
    return this.SafeMarketStructure(map[string]interface{} {
        ...
        "subType": subType,
        "spot": isSpot,
        "margin": ccxt.Ternary(ccxt.IsTrue(isSpot), false, nil),
...
func  (this *coincatch) ParseSpotMarketId(marketId interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(currencyIds)); i++ {
        ...
        if ccxt.IsTrue(ccxt.IsGreaterThan(entryIndex, ccxt.OpNeg(1))) {
...
func  (this *coincatch) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), "fetchTicker() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
            }
...
func  (this *coincatch) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp598254 := this.HandleMarketTypeAndParams(methodName, market, params, marketType)
            marketType = ccxt.GetValue(__tmp598254, 0)
            params = ccxt.GetValue(__tmp598254, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                __tmp962170 := this.HandleOptionAndParams(params, methodName, "productType", productType)
                productType = ccxt.GetValue(__tmp962170, 0)
                params = ccxt.GetValue(__tmp962170, 1)
                var request interface{} = map[string]interface{} {
...
func  (this *coincatch) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsLessThan(ccxt.GetIndexOf(marketId, "_"), 0)) {
        marketId = ccxt.Add(marketId, "_SPBL") // spot markets from tickers endpoints have no suffix specific for market id
    }
    ...
    return this.SafeTicker(map[string]interface{} {
        ...
        "previousClose": nil,
        "change": nil,
        "percentage": ccxt.Precise.StringMul(this.SafeString2(ticker, "changeUtc", "chgUtc"), "100"),
        "average": nil,
...
func  (this *coincatch) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp609140 := this.HandleOptionAndParams(params, methodName, "precision")
            precision = ccxt.GetValue(__tmp609140, 0)
            params = ccxt.GetValue(__tmp609140, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(precision, nil)) {
                ccxt.AddElementToObject(request, "precision", precision)
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
...
func  (this *coincatch) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp702234 := this.HandleOptionAndParams(params, methodName, "until")
            until = ccxt.GetValue(__tmp702234, 0)
            params = ccxt.GetValue(__tmp702234, 1)
            var marketType interface{} = ccxt.GetValue(market, "type")
            ...
            if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(since, nil))) || ccxt.IsTrue((!ccxt.IsEqual(until, nil)))) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(requestedLimit, nil)) {
                ccxt.AddElementToObject(request, "limit", requestedLimit)
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                ccxt.AddElementToObject(request, "period", encodedTimeframe)
                ...
                ccxt.AddElementToObject(request, "granularity", encodedTimeframe)
                if ccxt.IsTrue(ccxt.IsEqual(until, nil)) {
                    until = this.Milliseconds()
                }
                if ccxt.IsTrue(ccxt.IsEqual(since, nil)) {
                    var duration interface{} = this.ParseTimeframe(timeframe)
                    since = ccxt.Subtract(until, (ccxt.Multiply(ccxt.Multiply(duration, maxLimit), 1000)))
                }
                ccxt.AddElementToObject(request, "startTime", since) // since and until are mandatory for swap
                ccxt.AddElementToObject(request, "endTime", until)
                var priceType interface{} = nil
                __tmp751379 := this.HandleOptionAndParams(params, methodName, "price")
                priceType = ccxt.GetValue(__tmp751379, 0)
                params = ccxt.GetValue(__tmp751379, 1)
                if ccxt.IsTrue(ccxt.IsEqual(priceType, "mark")) {
                    ccxt.AddElementToObject(request, "kLineType", "market mark index")
                }
...
func  (this *coincatch) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var until interface{} = nil
            __tmp963751 := this.HandleOptionAndParams(params, methodName, "until")
            until = ccxt.GetValue(__tmp963751, 0)
            params = ccxt.GetValue(__tmp963751, 1)
            var maxLimit interface{} = 1000
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(requestLimit, nil)) {
                ccxt.AddElementToObject(request, "limit", requestLimit)
            }
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
...
func  (this *coincatch) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(fees, nil)) {
        feeCost = ccxt.Precise.StringAbs(fees)
    }
    var feeCurrency interface{} = this.SafeString(trade, "feeCcy")
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(feeCurrency, nil))) && ccxt.IsTrue((!ccxt.IsEqual(ccxt.GetValue(market, "settle"), nil)))) {
        feeCurrency = ccxt.GetValue(market, "settle")
    }
...
func  (this *coincatch) HandleOptionParamsAndRequest(params interface{}, methodName interface{}, optionName interface{}, request interface{}, requestProperty interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    option := ccxt.GetValue(optionparamsOmitedVariable,0);
    paramsOmited := ccxt.GetValue(optionparamsOmitedVariable,1)
    if ccxt.IsTrue(!ccxt.IsEqual(option, nil)) {
        ccxt.AddElementToObject(request, requestProperty, option)
    }
...
func  (this *coincatch) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(requestedLimit, nil)) {
                ccxt.AddElementToObject(request, "pageSize", requestedLimit)
            }
...
func  (this *coincatch) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes17938)
            var methodName interface{} = "fetchBalance"
            var marketType interface{} = nil
            __tmp993020 := this.HandleMarketTypeAndParams(methodName, nil, params)
            marketType = ccxt.GetValue(__tmp993020, 0)
            params = ccxt.GetValue(__tmp993020, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                //
                //     {
                ...
                var productType interface{} = "umcbl"
                __tmp176135 := this.HandleOptionAndParams(params, methodName, "productType", productType)
                productType = ccxt.GetValue(__tmp176135, 0)
                params = ccxt.GetValue(__tmp176135, 1)
                var request interface{} = map[string]interface{} {
                    "productType": productType,
                }
                //
...
func  (this *coincatch) ParseBalance(balances interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
        ...
        ccxt.AddElementToObject(account, "used", ccxt.Precise.StringAdd(locked, frozen))
        ccxt.AddElementToObject(account, "total", this.SafeString(balanceEntry, "equity"))
...
func  (this *coincatch) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes19228)
            var currency interface{} = this.Currency(code)
            if ccxt.IsTrue(ccxt.IsEqual(fromAccount, "swap")) {
                if ccxt.IsTrue(ccxt.IsEqual(code, "USDT")) {
                    fromAccount = "mix_usdt"
                } else {
                    fromAccount = "mix_usd"
                }
            }
            if ccxt.IsTrue(ccxt.IsEqual(toAccount, "swap")) {
                if ccxt.IsTrue(ccxt.IsEqual(code, "USDT")) {
                    toAccount = "mix_usdt"
                } else {
                    toAccount = "mix_usd"
            ...
            __tmp779754 := this.HandleOptionAndParams(params, "transfer", "clientOrderId")
            clientOrderId = ccxt.GetValue(__tmp779754, 0)
            params = ccxt.GetValue(__tmp779754, 1)
...
func  (this *coincatch) ParseTransfer(transfer interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.IsEqual(msg, "success")) {
        status = "ok"
    }
...
func  (this *coincatch) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp741080 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp741080, 0)
            params = ccxt.GetValue(__tmp741080, 1)
            if ccxt.IsTrue(ccxt.IsEqual(networkCode, nil)) {
                networkCode = this.DefaultNetworkCode(code)
            }
            if ccxt.IsTrue(ccxt.IsEqual(networkCode, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchDepositAddress() requires a network parameter or a default network code")))
            }
...
func  (this *coincatch) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var network interface{} = this.SafeString(ccxt.GetValue(this.Options, "networksById"), networkId, networkId)
...
func  (this *coincatch) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var until interface{} = nil
            __tmp751663 := this.HandleOptionAndParams(params, methodName, "until")
            until = ccxt.GetValue(__tmp751663, 0)
            params = ccxt.GetValue(__tmp751663, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "endTime", until)
            }
...
func  (this *coincatch) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var until interface{} = nil
            __tmp659325 := this.HandleOptionAndParams(params, methodName, "until")
            until = ccxt.GetValue(__tmp659325, 0)
            params = ccxt.GetValue(__tmp659325, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                ccxt.AddElementToObject(request, "endTime", until)
            }
...
func  (this *coincatch) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            __tmp790357 := this.HandleWithdrawTagAndParams(tag, params)
            tag = ccxt.GetValue(__tmp790357, 0)
            params = ccxt.GetValue(__tmp790357, 1)
            ...
            var networkCode interface{} = nil
            __tmp771986 := this.HandleNetworkCodeAndParams(params)
            networkCode = ccxt.GetValue(__tmp771986, 0)
            params = ccxt.GetValue(__tmp771986, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(networkCode, nil)) {
...
func  (this *coincatch) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes22978)
            var methodName interface{} = "createMarketBuyOrderWithCost"
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() supports spot orders only")))
            }
            ccxt.AddElementToObject(params, "methodName", methodName)
            ccxt.AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
        
                retRes230515 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                ccxt.PanicOnError(retRes230515)
                ch <- retRes230515
                return nil
...
func  (this *coincatch) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes23308)
            ccxt.AddElementToObject(params, "methodName", this.SafeString(params, "methodName", "createOrder"))
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
        
                    retRes233419 :=  (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
                    ccxt.PanicOnError(retRes233419)
                    ch <- retRes233419
                    return nil
            } else if ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
        
                    retRes233619 :=  (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
                    ccxt.PanicOnError(retRes233619)
                    ch <- retRes233619
                    return nil
            } else {
...
func  (this *coincatch) CreateSpotOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.AddElementToObject(params, "methodName", this.SafeString(params, "methodName", "createSpotOrder"))
            var request interface{} = this.CreateSpotOrderRequest(symbol, typeVar, side, amount, price, params)
            var isPlanOrer interface{} = !ccxt.IsEqual(this.SafeString(request, "triggerPrice"), nil)
            var response interface{} = nil
            if ccxt.IsTrue(isPlanOrer) {
...
func  (this *coincatch) CreateSpotOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    __tmp101458 := this.HandleParamString(params, "methodName", methodName)
    methodName = ccxt.GetValue(__tmp101458, 0)
    params = ccxt.GetValue(__tmp101458, 1)
    var market interface{} = this.Market(symbol)
    var request interface{} = map[string]interface{} {
        "symbol": ccxt.GetValue(market, "id"),
        "side": side,
    ...
    params = ccxt.GetValue(timeInForceAndParams, "params")
    var timeInForce interface{} = ccxt.GetValue(timeInForceAndParams, "timeInForce")
    var cost interface{} = nil
    __tmp728292 := this.HandleParamString(params, "cost")
    cost = ccxt.GetValue(__tmp728292, 0)
    params = ccxt.GetValue(__tmp728292, 1)
    var triggerPrice interface{} = nil
    __tmp902763 := this.HandleParamString(params, "triggerPrice")
    triggerPrice = ccxt.GetValue(__tmp902763, 0)
    params = ccxt.GetValue(__tmp902763, 1)
    var isMarketBuy interface{} = ccxt.IsTrue(isMarketOrder) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))
    if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsTrue(isMarketBuy))) && ccxt.IsTrue((!ccxt.IsEqual(cost, nil)))) {
        panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " supports cost parameter for market buy orders only")))
    }
    if ccxt.IsTrue(isMarketBuy) {
        var costAndParams interface{} = this.HandleRequiresPriceAndCost(methodName, params, price, amount, cost)
        cost = ccxt.GetValue(costAndParams, "cost")
        params = ccxt.GetValue(costAndParams, "params")
    }
    if ccxt.IsTrue(ccxt.IsEqual(triggerPrice, nil)) {
        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) {
            ccxt.AddElementToObject(request, "price", price) // spot markets have no precision
        }
        ccxt.AddElementToObject(request, "quantity", ccxt.Ternary(ccxt.IsTrue(isMarketBuy), cost, this.NumberToString(amount))) // spot markets have no precision
        ccxt.AddElementToObject(request, "force", ccxt.Ternary(ccxt.IsTrue(timeInForce), timeInForce, "normal")) // the exchange requres force but accepts any value
    } else {
        ccxt.AddElementToObject(request, "triggerPrice", triggerPrice) // spot markets have no precision
        if ccxt.IsTrue(!ccxt.IsEqual(timeInForce, nil)) {
            ccxt.AddElementToObject(request, "timeInForceValue", timeInForce)
        }
        var clientOrderId interface{} = nil
        __tmp890681 := this.HandleParamString(params, "clientOrderId")
        clientOrderId = ccxt.GetValue(__tmp890681, 0)
        params = ccxt.GetValue(__tmp890681, 1)
        if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
            ccxt.AddElementToObject(request, "clientOid", clientOrderId)
        }
        if ccxt.IsTrue(ccxt.IsEqual(typeVar, "limit")) {
            ccxt.AddElementToObject(request, "executePrice", price) // spot markets have no precision
        }
        ...
        ccxt.AddElementToObject(request, "triggerType", triggerType)
        // tood check placeType
        ccxt.AddElementToObject(request, "size", ccxt.Ternary(ccxt.IsTrue(isMarketOrder), cost, this.NumberToString(amount))) // spot markets have no precision
    }
...
func  (this *coincatch) HandleRequiresPriceAndCost(methodName interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = price
    amount := ccxt.GetArg(optionalArgs, 2, nil)
    _ = amount
    cost := ccxt.GetArg(optionalArgs, 3, nil)
    _ = cost
    side := ccxt.GetArg(optionalArgs, 4, "buy")
    _ = side
    var optionName interface{} = ccxt.Add(ccxt.Add("createMarket", this.Capitalize(side)), "OrderRequiresPrice")
    var requiresPrice interface{} = true
    __tmp990227 := this.HandleOptionAndParams(params, methodName, optionName, true)
    requiresPrice = ccxt.GetValue(__tmp990227, 0)
    params = ccxt.GetValue(__tmp990227, 1)
    ...
    if ccxt.IsTrue(requiresPrice) {
        if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(price, nil))) && ccxt.IsTrue((ccxt.IsEqual(cost, nil)))) {
            panic(ccxt.InvalidOrder(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires the price argument for market "), side), " orders to calculate the total cost to spend (amount * price), alternatively set the "), optionName), " option or param to false and pass the cost to spend in the amount argument")))
        } else if ccxt.IsTrue(ccxt.IsEqual(cost, nil)) {
            cost = ccxt.Precise.StringMul(amountString, priceString)
        }
    } else {
        cost = ccxt.Ternary(ccxt.IsTrue(cost), cost, amountString)
    }
    var result interface{} = map[string]interface{} {
        "cost": cost,
        "params": params,
...
func  (this *coincatch) HandleTimeInForceAndPostOnly(methodName interface{}, optionalArgs ...interface{}) interface{}  {
    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
    _ = params
    isMarketOrder := ccxt.GetArg(optionalArgs, 1, false)
    _ = isMarketOrder
    var timeInForce interface{} = nil
    __tmp78608 := this.HandleOptionAndParams(params, methodName, "timeInForce")
    timeInForce = ccxt.GetValue(__tmp78608, 0)
    params = ccxt.GetValue(__tmp78608, 1)
    var postOnly interface{} = false
    __tmp657160 := this.HandlePostOnly(isMarketOrder, ccxt.IsEqual(timeInForce, "post_only"), params)
    postOnly = ccxt.GetValue(__tmp657160, 0)
    params = ccxt.GetValue(__tmp657160, 1)
...
func  (this *coincatch) CreateSwapOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
            _ = params
            ccxt.AddElementToObject(params, "methodName", this.SafeString(params, "methodName", "createSwapOrder"))
        
            retRes25378 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes25378)
            var market interface{} = this.Market(symbol)
            ...
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(endpointType, "trigger")) {
                response = (<-this.PrivatePostApiMixV1PlanPlacePlan(request))
            } else if ccxt.IsTrue(ccxt.IsEqual(endpointType, "tpsl")) {
...
func  (this *coincatch) CreateSwapOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    */
    ...
    __tmp183127 := this.HandleParamString(params, "methodName", methodName)
    methodName = ccxt.GetValue(__tmp183127, 0)
    params = ccxt.GetValue(__tmp183127, 1)
    var market interface{} = this.Market(symbol)
    var request interface{} = map[string]interface{} {
        "symbol": ccxt.GetValue(market, "id"),
    ...
    __tmp109120 := this.HandleOptionParamsAndRequest(params, methodName, "clientOrderId", request, "clientOid")
    request = ccxt.GetValue(__tmp109120, 0)
    params = ccxt.GetValue(__tmp109120, 1)
    var isMarketOrder interface{} =     (ccxt.IsEqual(typeVar, "market"))
    ...
    if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(endpointType, nil))) || ccxt.IsTrue((ccxt.IsEqual(endpointType, "standard")))) {
    ...
    if ccxt.IsTrue((!ccxt.IsEqual(endpointType, "tpsl"))) {
        ccxt.AddElementToObject(request, "orderType", typeVar)
        var hedged interface{} = false
        __tmp855038 := this.HandleOptionAndParams(params, methodName, "hedged", hedged)
        hedged = ccxt.GetValue(__tmp855038, 0)
        params = ccxt.GetValue(__tmp855038, 1)
        // hedged and non-hedged orders have different side values and reduceOnly handling
        var reduceOnly interface{} = false
        __tmp205862 := this.HandleParamBool(params, "reduceOnly", reduceOnly)
        reduceOnly = ccxt.GetValue(__tmp205862, 0)
        params = ccxt.GetValue(__tmp205862, 1)
        if ccxt.IsTrue(hedged) {
            ...
            side = ccxt.Add(ccxt.ToLower(side), "_single")
        }
...
func  (this *coincatch) HandleTriggerStopLossAndTakeProfit(symbol interface{}, side interface{}, typeVar interface{}, price interface{}, optionalArgs ...interface{}) interface{}  {
    methodName := ccxt.GetArg(optionalArgs, 0, "createOrder")
    _ = methodName
    params := ccxt.GetArg(optionalArgs, 1, map[string]interface{} {})
    _ = params
    var request interface{} = map[string]interface{} {}
    ...
    var hasTPPrice interface{} =     (!ccxt.IsEqual(takeProfitPrice, nil))
    var hasSLPrice interface{} =     (!ccxt.IsEqual(stopLossPrice, nil))
    var hasTPParams interface{} =     (!ccxt.IsEqual(takeProfitParams, nil))
    if ccxt.IsTrue(ccxt.IsTrue(hasTPParams) && !ccxt.IsTrue(hasTPPrice)) {
        takeProfitPrice = this.SafeString(takeProfitParams, "triggerPrice")
        hasTPPrice = (!ccxt.IsEqual(takeProfitPrice, nil))
    }
    var hasSLParams interface{} =     (!ccxt.IsEqual(stopLossParams, nil))
    if ccxt.IsTrue(ccxt.IsTrue(hasSLParams) && !ccxt.IsTrue(hasSLPrice)) {
        stopLossPrice = this.SafeString(stopLossParams, "triggerPrice")
        hasSLPrice = (!ccxt.IsEqual(stopLossPrice, nil))
    }
    var hasBothTPAndSL interface{} = ccxt.IsTrue(hasTPPrice) && ccxt.IsTrue(hasSLPrice)
    ...
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(hasBothTPAndSL) || ccxt.IsTrue(isTrigger)) || ccxt.IsTrue((ccxt.IsEqual(methodName, "createOrderWithTakeProfitAndStopLoss")))) {
        if ccxt.IsTrue(isTrigger) {
            if ccxt.IsTrue(isMarketOrder) {
                ccxt.AddElementToObject(request, "triggerType", "market_price")
            } else {
                ccxt.AddElementToObject(request, "triggerType", "fill_price")
        ...
        if ccxt.IsTrue(ccxt.IsEqual(methodName, "createOrders")) {
            endpointType = nil // we do not provide endpointType for createOrders
        }
        if ccxt.IsTrue(hasTPPrice) {
            ccxt.AddElementToObject(request, "presetTakeProfitPrice", takeProfitPrice)
        }
        if ccxt.IsTrue(hasSLPrice) {
            ccxt.AddElementToObject(request, "presetStopLossPrice", stopLossPrice)
        }
    } else if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue(hasTPPrice) || ccxt.IsTrue(hasSLPrice)) || ccxt.IsTrue(isTrailingPercentOrder)) {
        if !ccxt.IsTrue(isMarketOrder) {
            panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() supports does not support "), typeVar), " type of stop loss and take profit orders (only market type is supported for stop loss and take profit orders). To create a market order with stop loss or take profit attached use createOrderWithTakeProfitAndStopLoss()")))
        }
        ...
        ccxt.AddElementToObject(request, "holdSide", holdSide)
        if ccxt.IsTrue(isTrailingPercentOrder) {
            if ccxt.IsTrue(ccxt.IsEqual(trailingTriggerPrice, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires the trailingTriggerPrice parameter for trailing stop orders")))
            }
            requestTriggerPrice = trailingTriggerPrice
            ccxt.AddElementToObject(request, "rangeRate", trailingPercent)
            ccxt.AddElementToObject(request, "planType", "moving_plan")
        } else if ccxt.IsTrue(hasTPPrice) {
            requestTriggerPrice = takeProfitPrice
            ccxt.AddElementToObject(request, "planType", "profit_plan")
        } else {
            requestTriggerPrice = stopLossPrice
            ccxt.AddElementToObject(request, "planType", "loss_plan")
        }
        ccxt.AddElementToObject(request, "triggerPrice", this.PriceToPrecision(symbol, requestTriggerPrice))
    }
    if ccxt.IsTrue(!ccxt.IsEqual(endpointType, nil)) {
        ccxt.AddElementToObject(request, "endpointType", endpointType)
    }
...
func  (this *coincatch) CreateOrderWithTakeProfitAndStopLoss(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                ...
                defer ccxt.ReturnPanicError(ch)
                    price := ccxt.GetArg(optionalArgs, 0, nil)
            _ = price
            takeProfit := ccxt.GetArg(optionalArgs, 1, nil)
            _ = takeProfit
            stopLoss := ccxt.GetArg(optionalArgs, 2, nil)
            _ = stopLoss
            params := ccxt.GetArg(optionalArgs, 3, map[string]interface{} {})
            _ = params
            ...
            ccxt.PanicOnError(retRes27418)
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() is supported for swap markets only")))
            }
            ccxt.AddElementToObject(params, "methodName", methodName)
...
func  (this *coincatch) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(triggerPrice, nil)) {
                    panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() does not support trigger orders")))
                }
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbolsLength, 1)) {
                panic(ccxt.BadRequest(ccxt.Add(this.Id, " createOrders() requires all orders to be of the same symbol")))
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ccxt.AddElementToObject(request, "orderList", ordersRequests)
                ...
                ccxt.AddElementToObject(request, "orderDataList", ordersRequests)
...
func  (this *coincatch) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes29118 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes29118)
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
        
                    retRes291419 :=  (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
                    ccxt.PanicOnError(retRes291419)
                    ch <- retRes291419
                    return nil
            } else {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
...
func  (this *coincatch) EditSpotOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes29408)
            var methodName interface{} = "editSpotOrder"
            __tmp105222 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp105222, 0)
            params = ccxt.GetValue(__tmp105222, 1)
            var market interface{} = this.Market(symbol)
            if !ccxt.IsTrue(ccxt.GetValue(market, "spot")) {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                ccxt.AddElementToObject(request, "clientOid", clientOrderId)
            } else if ccxt.IsTrue(ccxt.IsEqual(id, nil)) {
                panic(ccxt.BadRequest(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires id or clientOrderId")))
            } else {
                ccxt.AddElementToObject(request, "orderId", id)
            }
            var cost interface{} = nil
            __tmp606433 := this.HandleParamString(params, "cost")
            cost = ccxt.GetValue(__tmp606433, 0)
            params = ccxt.GetValue(__tmp606433, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(amount, nil)) {
                if ccxt.IsTrue(isMarketBuy) {
                    ...
                    ccxt.AddElementToObject(request, "size", this.NumberToString(amount)) // spot markets have no precision
                }
            }
            if ccxt.IsTrue(!ccxt.IsEqual(cost, nil)) {
                ccxt.AddElementToObject(request, "size", cost) // spot markets have no precision
            }
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(typeVar, "limit"))) && ccxt.IsTrue((!ccxt.IsEqual(price, nil)))) {
                ccxt.AddElementToObject(request, "price", price) // spot markets have no precision
            }
...
func  (this *coincatch) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketType interface{} = "spot"
            __tmp307324 := this.HandleMarketTypeAndParams(methodName, market, params, marketType)
            marketType = ccxt.GetValue(__tmp307324, 0)
            params = ccxt.GetValue(__tmp307324, 1)
            var response interface{} = nil
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(ccxt.IsEqual(data, nil)) {
                    response = ccxt.JsonParse(response) // the response from closed orders is not a standard JSON
                ...
                if ccxt.IsTrue(ccxt.IsEqual(market, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires a symbol argument for "), marketType), " type of markets")))
                }
...
func  (this *coincatch) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var marketType interface{} = "spot"
            __tmp998799 := this.HandleMarketTypeAndParams(methodName, market, params, marketType)
            marketType = ccxt.GetValue(__tmp998799, 0)
            params = ccxt.GetValue(__tmp998799, 1)
            ccxt.AddElementToObject(params, "methodName", methodName)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
        
                    retRes315719 :=  (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes315719)
                    ch <- retRes315719
                    return nil
            } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
        
                    retRes315919 :=  (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes315919)
                    ch <- retRes315919
                    return nil
            } else {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() is not supported for "), marketType), " type of markets")))
...
func  (this *coincatch) FetchOpenSpotOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp293289 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp293289, 0)
            params = ccxt.GetValue(__tmp293289, 1)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            ...
            __tmp572841 := this.HandleOptionAndParams2(params, methodName, "trigger", "stop", isTrigger)
            isTrigger = ccxt.GetValue(__tmp572841, 0)
            params = ccxt.GetValue(__tmp572841, 1)
            var result interface{} = nil
            if ccxt.IsTrue(isTrigger) {
                if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires a symbol argument for trigger orders")))
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
...
func  (this *coincatch) FetchOpenSwapOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes32868)
            var methodName interface{} = "fetchOpenSwapOrders"
            __tmp579690 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp579690, 0)
            params = ccxt.GetValue(__tmp579690, 1)
            var isTrigger interface{} = false
            __tmp605673 := this.HandleOptionAndParams2(params, methodName, "trigger", "stop", isTrigger)
            isTrigger = ccxt.GetValue(__tmp605673, 0)
            params = ccxt.GetValue(__tmp605673, 1)
            var plan interface{} = nil
            __tmp994568 := this.HandleOptionAndParams(params, methodName, "isPlan", plan)
            plan = ccxt.GetValue(__tmp994568, 0)
            params = ccxt.GetValue(__tmp994568, 1)
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                if ccxt.IsTrue(ccxt.IsTrue((isTrigger)) || ccxt.IsTrue((!ccxt.IsEqual(plan, nil)))) {
                    if ccxt.IsTrue(!ccxt.IsEqual(productType, nil)) {
                        ccxt.AddElementToObject(request, "productType", productType)
                    }
                    if ccxt.IsTrue(!ccxt.IsEqual(plan, nil)) {
                        ccxt.AddElementToObject(request, "isPlan", plan) // current param is used to define the type of the orders to fetch (trigger or stop-loss/take-profit)
                    }
                    //
                    //     {
                    //         "code": "00000",
                ...
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires a symbol argument for swap trigger orders")))
            } else {
                if ccxt.IsTrue(ccxt.IsEqual(productType, nil)) {
                    productType = "umcbl"
                }
...
func  (this *coincatch) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes34218)
            var market interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            var marketType interface{} = "spot"
            __tmp248786 := this.HandleMarketTypeAndParams(methodName, market, params, marketType)
            marketType = ccxt.GetValue(__tmp248786, 0)
            params = ccxt.GetValue(__tmp248786, 1)
            ccxt.AddElementToObject(params, "methodName", methodName)
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
        
                    retRes343019 :=  (<-this.FetchCanceledAndClosedSpotOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes343019)
                    ch <- retRes343019
                    return nil
            } else if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
        
                    retRes343219 :=  (<-this.FetchCanceledAndClosedSwapOrders(symbol, since, limit, params))
                    ccxt.PanicOnError(retRes343219)
                    ch <- retRes343219
                    return nil
            } else {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() is not supported for "), marketType), " type of markets")))
...
func  (this *coincatch) FetchCanceledAndClosedSpotOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp377607 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp377607, 0)
            params = ccxt.GetValue(__tmp377607, 1)
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " () requires a symbol argument for spot markets")))
            }
            ...
            var requestLimit interface{} = limit
            var isTrigger interface{} = false
            __tmp714591 := this.HandleOptionAndParams2(params, methodName, "trigger", "stop", isTrigger)
            isTrigger = ccxt.GetValue(__tmp714591, 0)
            params = ccxt.GetValue(__tmp714591, 1)
            var result interface{} = nil
            if ccxt.IsTrue(isTrigger) {
                var until interface{} = nil
                __tmp933289 := this.HandleOptionAndParams(params, methodName, "until", until)
                until = ccxt.GetValue(__tmp933289, 0)
                params = ccxt.GetValue(__tmp933289, 1)
                // const now = this.milliseconds ();
                var requestSince interface{} = since
                var interval interface{} = ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(90, 24), 60), 60), 1000) // startTime and endTime interval cannot be greater than 90 days
                var now interface{} = this.Milliseconds()
                // both since and until are required for trigger orders
                if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(until, nil))) && ccxt.IsTrue((ccxt.IsEqual(requestSince, nil)))) {
                    requestSince = ccxt.Subtract(now, interval)
                    until = now
                } else if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    requestSince = ccxt.Subtract(until, interval)
                } else {
                    until = ccxt.Add(since, interval)
                }
                ccxt.AddElementToObject(request, "startTime", requestSince)
                ccxt.AddElementToObject(request, "endTime", until)
                if ccxt.IsTrue(ccxt.IsEqual(requestLimit, nil)) {
                    requestLimit = maxLimit
                }
                ccxt.AddElementToObject(request, "pageSize", requestLimit)
                ...
                //     }
                //
                var parsedResponse interface{} = ccxt.JsonParse(response) // the response is not a standard JSON
...
func  (this *coincatch) FetchCanceledAndClosedSwapOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp908775 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp908775, 0)
            params = ccxt.GetValue(__tmp908775, 1)
            var requestSince interface{} = since
            var until interface{} = nil
            __tmp137856 := this.HandleOptionAndParams(params, methodName, "until", until)
            until = ccxt.GetValue(__tmp137856, 0)
            params = ccxt.GetValue(__tmp137856, 1)
            var now interface{} = this.Milliseconds()
            // since and until are mandatory
            // they should be within 90 days interval
            var interval interface{} = ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(ccxt.Multiply(90, 24), 60), 60), 1000)
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(until, nil))) && ccxt.IsTrue((ccxt.IsEqual(requestSince, nil)))) {
                requestSince = ccxt.Subtract(now, interval)
                until = now
            } else if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
            ...
            var productType interface{} = this.HandleOption(methodName, "productType")
            var isTrigger interface{} = false
            __tmp869080 := this.HandleOptionAndParams2(params, methodName, "trigger", "stop", isTrigger)
            isTrigger = ccxt.GetValue(__tmp869080, 0)
            params = ccxt.GetValue(__tmp869080, 1)
            var plan interface{} = nil
            __tmp489013 := this.HandleOptionAndParams(params, methodName, "isPlan", plan)
            plan = ccxt.GetValue(__tmp489013, 0)
            params = ccxt.GetValue(__tmp489013, 1)
            var response interface{} = nil
            var result interface{} = nil
            if ccxt.IsTrue(ccxt.IsTrue((isTrigger)) || ccxt.IsTrue((!ccxt.IsEqual(plan, nil)))) {
                if ccxt.IsTrue(!ccxt.IsEqual(plan, nil)) {
                    ccxt.AddElementToObject(request, "isPlan", plan)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(productType, nil)) {
                    ccxt.AddElementToObject(request, "productType", productType)
                }
...
func  (this *coincatch) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes37618)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = nil
            __tmp704651 := this.HandleParamString(params, "clientOrderId")
            clientOrderId = ccxt.GetValue(__tmp704651, 0)
            params = ccxt.GetValue(__tmp704651, 1)
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(id, nil))) && ccxt.IsTrue((ccxt.IsEqual(clientOrderId, nil)))) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " () requires an id argument or clientOrderId parameter")))
            }
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderId, nil)) {
                ccxt.AddElementToObject(request, "clientOid", clientOrderId)
            } else {
            ...
            __tmp211225 := this.HandleOptionAndParams2(params, methodName, "trigger", "stop", trigger)
            trigger = ccxt.GetValue(__tmp211225, 0)
            params = ccxt.GetValue(__tmp211225, 1)
            var response interface{} = nil
            if ccxt.IsTrue(!ccxt.IsTrue(trigger) || ccxt.IsTrue((!ccxt.IsEqual(marketType, "spot")))) {
                ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
            }
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                __tmp726478 := this.HandleOptionAndParams(params, methodName, "planType", planType)
                planType = ccxt.GetValue(__tmp726478, 0)
                params = ccxt.GetValue(__tmp726478, 1)
                ccxt.AddElementToObject(request, "marginCoin", ccxt.GetValue(market, "settleId"))
                if ccxt.IsTrue(ccxt.IsTrue((trigger)) || ccxt.IsTrue((!ccxt.IsEqual(planType, nil)))) {
                    if ccxt.IsTrue(ccxt.IsEqual(planType, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " () requires a planType parameter for swap trigger orders (\"profit_plan\" - profit order, \"loss_plan\" - loss order, \"normal_plan\" - plan order, \"pos_profit\" - position profit, \"pos_loss\" - position loss, \"moving_plan\" - Trailing TP/SL, \"track_plan\" - Trailing Stop)")))
                    }
...
func  (this *coincatch) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            var marketType interface{} = "spot"
            __tmp620247 := this.HandleMarketTypeAndParams(methodName, market, params, marketType)
            marketType = ccxt.GetValue(__tmp620247, 0)
            params = ccxt.GetValue(__tmp620247, 1)
            var trigger interface{} = false
            __tmp235225 := this.HandleOptionAndParams2(params, methodName, "trigger", "stop", trigger)
            trigger = ccxt.GetValue(__tmp235225, 0)
            params = ccxt.GetValue(__tmp235225, 1)
            var response interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(trigger) {
                    if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                    ...
                    if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " () requires a symbol argument for spot non-trigger orders")))
                    }
                    ccxt.AddElementToObject(request, "symbol", ccxt.GetValue(market, "id"))
                    //
                    //     {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                    ...
                    ccxt.AddElementToObject(request, "productType", productType) // we need either symbol or productType
                }
                var planType interface{} = nil
                __tmp856834 := this.HandleOptionAndParams(params, methodName, "planType", planType)
                planType = ccxt.GetValue(__tmp856834, 0)
                params = ccxt.GetValue(__tmp856834, 1)
                if ccxt.IsTrue(ccxt.IsTrue((trigger)) || ccxt.IsTrue((!ccxt.IsEqual(planType, nil)))) {
                    if ccxt.IsTrue(ccxt.IsEqual(planType, nil)) {
                        panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " () requires a planType parameter for swap trigger orders (\"profit_plan\" - profit order, \"loss_plan\" - loss order, \"normal_plan\" - plan order, \"pos_profit\" - position profit, \"pos_loss\" - position loss, \"moving_plan\" - Trailing TP/SL, \"track_plan\" - Trailing Stop)")))
                    }
                    ...
                    var marginCoin interface{} = nil
                    if ccxt.IsTrue(ccxt.IsEqual(productType, "umcbl")) {
                        marginCoin = "USDT"
                    } else {
                        __tmp336493 := this.HandleOptionAndParams(params, methodName, "marginCoin", marginCoin)
                        marginCoin = ccxt.GetValue(__tmp336493, 0)
                        params = ccxt.GetValue(__tmp336493, 1)
                        if ccxt.IsTrue(ccxt.IsEqual(marginCoin, nil)) {
                            panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), " () requires a marginCoin parameter for dmcbl product type")))
                        }
                    }
                    ccxt.AddElementToObject(request, "marginCoin", marginCoin)
...
func  (this *coincatch) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(clientOrderIds, nil)) {
                ccxt.AddElementToObject(request, "clientOids", clientOrderIds)
                params = this.Omit(params, "clientOrderIds")
            } else if ccxt.IsTrue(ccxt.IsEqual(ids, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires either ids argument or clientOrderIds parameter")))
            } else {
                ccxt.AddElementToObject(request, "orderIds", ids)
            }
            var response interface{} = nil
            var result interface{} = nil
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
...
func  (this *coincatch) GetResultFromBatchCancelingSwapOrders(response interface{}) interface{}  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orderIds)); i++ {
        var orderId interface{} = ccxt.GetValue(orderIds, i)
        var resultItem interface{} = map[string]interface{} {
            "orderId": orderId,
        }
        ccxt.AppendToArray(&result, resultItem)
    }
    return result
}
func  (this *coincatch) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var isTrigger interface{} = !ccxt.IsEqual(this.SafeString(order, "triggerType"), nil)
    var isMarketBuy interface{} = ccxt.IsTrue((ccxt.IsEqual(typeVar, "market"))) && ccxt.IsTrue((ccxt.IsEqual(side, "buy")))
    if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.GetValue(market, "spot"))) && ccxt.IsTrue((isMarketBuy))) && ccxt.IsTrue((!ccxt.IsTrue(isTrigger)))) {
    ...
    var feeCost interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(feeDetailString, nil)) {
        fees = this.ParseFeeDetailString(feeDetailString)
    } else {
        feeCurrency = ccxt.Ternary(ccxt.IsTrue(marginCoin), this.SafeCurrencyCode(marginCoin), nil)
        feeCost = ccxt.Precise.StringAbs(this.SafeString(order, "fee"))
    }
    var timeInForce interface{} = this.ParseOrderTimeInForce(this.SafeStringLower(order, "timeInForce"))
    var postOnly interface{} = nil
    if ccxt.IsTrue(!ccxt.IsEqual(timeInForce, nil)) {
        postOnly = ccxt.IsEqual(timeInForce, "PO")
    }
    ...
    if ccxt.IsTrue(ccxt.IsEqual(planType, "loss_plan")) {
        stopLossPrice = triggerPrice
    } else if ccxt.IsTrue(ccxt.IsEqual(planType, "profit_plan")) {
    ...
    return this.SafeOrder(map[string]interface{} {
        ...
        "side": side,
        "price": price,
        "average": ccxt.Ternary(ccxt.IsTrue(priceAvg), priceAvg, this.SafeString(order, "fillPrice")),
        "amount": amount,
...
func  (this *coincatch) ParseFeeDetailString(feeDetailString interface{}) interface{}  {
    ...
    if ccxt.IsTrue(feeDetail) {
        var keys interface{} = ccxt.ObjectKeys(feeDetail)
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
            var currencyId interface{} = this.SafeString(keys, i)
            if ccxt.IsTrue(ccxt.InOp(this.Currencies_by_id, currencyId)) {
                ...
                var amount interface{} = ccxt.Precise.StringAbs(this.SafeString(feeEntry, "totalFee"))
...
func  (this *coincatch) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp751378 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp751378, 0)
            params = ccxt.GetValue(__tmp751378, 1)
        
            retRes43358 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes43358)
            var market interface{} = nil
            var marketType interface{} = "spot"
            var request interface{} = map[string]interface{} {}
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                ...
                __tmp844208 := this.HandleMarketTypeAndParams(methodName, market, params, marketType)
                marketType = ccxt.GetValue(__tmp844208, 0)
                params = ccxt.GetValue(__tmp844208, 1)
                if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires a symbol argument for spot markets")))
                }
            }
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ccxt.AddElementToObject(params, "startTime", since)
                } else {
                    ccxt.AddElementToObject(params, "startTime", 0) // mandatory
                }
                var until interface{} = nil
                __tmp912955 := this.HandleOptionAndParams(params, methodName, "until")
                until = ccxt.GetValue(__tmp912955, 0)
                params = ccxt.GetValue(__tmp912955, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ccxt.AddElementToObject(request, "endTime", until)
                } else {
                    ccxt.AddElementToObject(request, "endTime", this.Milliseconds()) // mandatory
                }
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                    //
                    //     {
...
func  (this *coincatch) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes448515 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                ccxt.PanicOnError(retRes448515)
                ch <- retRes448515
                return nil
...
func  (this *coincatch) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes45698)
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(market, "type"), "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " setMarginMode() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
                "marginCoin": ccxt.GetValue(market, "settleId"),
...
func  (this *coincatch) FetchPositionMode(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " fetchPositionMode() requires a symbol argument")))
            }
        
            retRes46198 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes46198)
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(market, "type"), "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchPositionMode() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
                "marginCoin": ccxt.GetValue(market, "settleId"),
            ...
            response:= (<-this.PrivateGetApiMixV1AccountAccount(this.Extend(request, params)))
            ccxt.PanicOnError(response) // same endpoint as fetchMarginMode
            var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
            var holdMode interface{} = this.SafeString(data, "holdMode")
        
            ch <- map[string]interface{} {
                "info": response,
                "hedged": ccxt.IsEqual(holdMode, "double_hold"),
            }
            return nil
...
func  (this *coincatch) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46518 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes46518)
            var productType interface{} = this.SafeString(params, "productType")
            if ccxt.IsTrue(ccxt.IsEqual(productType, nil)) {
                if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                    var market interface{} = this.Market(symbol)
                    if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(market, "type"), "swap")) {
                        panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " setPositionMode() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
                    }
                    var marketId interface{} = ccxt.GetValue(market, "id")
                    var parts interface{} = ccxt.Split(marketId, "_")
            ...
            var request interface{} = map[string]interface{} {
                "productType": productType,
                "holdMode": ccxt.Ternary(ccxt.IsTrue(hedged), "double_hold", "single_hold"),
            }
        
                retRes468115 :=  (<-this.PrivatePostApiMixV1AccountSetPositionMode(this.Extend(request, params)))
                ccxt.PanicOnError(retRes468115)
                    //
            //     {
            //         "code": "00000",
            //         "msg": "success",
...
func  (this *coincatch) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes46948)
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(market, "type"), "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " fetchLeverage() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
            }
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
                "marginCoin": ccxt.GetValue(market, "settleId"),
...
func  (this *coincatch) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp953241 := this.HandleOptionAndParams(params, methodName, "side")
            side = ccxt.GetValue(__tmp953241, 0)
            params = ccxt.GetValue(__tmp953241, 1)
...
func  (this *coincatch) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp426554 := this.HandleParamString(params, "methodName", methodName)
            methodName = ccxt.GetValue(__tmp426554, 0)
            params = ccxt.GetValue(__tmp426554, 1)
        
            retRes48168 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes48168)
            var market interface{} = this.Market(symbol)
            if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetValue(market, "type"), "swap")) {
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() is not supported for "), ccxt.GetValue(market, "type")), " type of markets")))
            }
            ...
            var side interface{} = nil
            __tmp58163 := this.HandleOptionAndParams(params, methodName, "side")
            side = ccxt.GetValue(__tmp58163, 0)
            params = ccxt.GetValue(__tmp58163, 1)
            if ccxt.IsTrue(!ccxt.IsEqual(side, nil)) {
                ccxt.AddElementToObject(request, "holdSide", side)
            }
...
func  (this *coincatch) ParseMarginModification(data interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var status interface{} = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(msg, "success"))), "ok", "failed")
    return map[string]interface{} {
        "info": data,
        "symbol": ccxt.GetValue(market, "symbol"),
        "type": nil,
...
func  (this *coincatch) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                ...
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
            _ = params
            ccxt.AddElementToObject(params, "methodName", "reduceMargin")
        
                retRes487815 :=  (<-this.ModifyMarginHelper(symbol, ccxt.OpNeg(amount), "reduce", params))
                ccxt.PanicOnError(retRes487815)
                ch <- retRes487815
                return nil
...
func  (this *coincatch) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                ...
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]interface{} {})
            _ = params
            ccxt.AddElementToObject(params, "methodName", "addMargin")
        
                retRes489415 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                ccxt.PanicOnError(retRes489415)
                ch <- retRes489415
                return nil
...
func  (this *coincatch) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            __tmp753183 := this.HandleOptionAndParams(params, methodName, "side")
            side = ccxt.GetValue(__tmp753183, 0)
            params = ccxt.GetValue(__tmp753183, 1)
        
            positions:= (<-this.FetchPositionsForSymbol(symbol, params))
            ccxt.PanicOnError(positions)
            var arrayLength interface{} =     ccxt.GetArrayLength(positions)
            if ccxt.IsTrue(ccxt.IsGreaterThan(arrayLength, 1)) {
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(positions)); i++ {
                    var position interface{} = ccxt.GetValue(positions, i)
                    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(position, "side"), side)) {
...
func  (this *coincatch) FetchPositionsForSymbol(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49358 := (<-this.LoadMarkets())
            ccxt.PanicOnError(retRes49358)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": ccxt.GetValue(market, "id"),
                "marginCoin": ccxt.GetValue(market, "settleId"),
...
func  (this *coincatch) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if ccxt.IsTrue(!ccxt.IsEqual(symbols, nil)) {
                ...
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketIds)); i++ {
                    ...
                    ccxt.AppendToArray(&productTypes, marketProductType)
                }
                productTypes = this.Unique(productTypes)
                var arrayLength interface{} =         ccxt.GetArrayLength(productTypes)
                if ccxt.IsTrue(ccxt.IsGreaterThan(arrayLength, 1)) {
                    panic(ccxt.BadSymbol(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() requires all symbols to belong to the same product type (umcbl or dmcbl)")))
                } else {
                    productType = ccxt.GetValue(productTypes, 0)
                }
            } else {
                __tmp406775 := this.HandleOptionAndParams(params, methodName, "productType", productType)
                productType = ccxt.GetValue(__tmp406775, 0)
                params = ccxt.GetValue(__tmp406775, 1)
            }
            var request interface{} = map[string]interface{} {
                "productType": productType,
            }
            if ccxt.IsTrue(ccxt.IsEqual(productType, "dmcbl")) {
                var marginCoin interface{} = nil
                __tmp688750 := this.HandleOptionAndParams(params, methodName, "marginCoin")
                marginCoin = ccxt.GetValue(__tmp688750, 0)
                params = ccxt.GetValue(__tmp688750, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(marginCoin, nil)) {
                    var currency interface{} = this.Currency(marginCoin)
                    ccxt.AddElementToObject(request, "marginCoin", ccxt.GetValue(currency, "id"))
                }
            }
...
func  (this *coincatch) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    return this.SafePosition(map[string]interface{} {
        ...
        "maintenanceMarginPercentage": this.ParseNumber(ccxt.Precise.StringMul(keepMarginRate, "100")),
...
func  (this *coincatch) SafeMarketCustom(marketId interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    settleId := ccxt.GetArg(optionalArgs, 1, nil)
    _ = settleId
    ...
    {		ret__ := func(this *coincatch) (ret_ interface{}) {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(settleId, nil)) {
                market = ccxt.GetValue(marketsWithCurrentId, 0) // if settleId is not provided, return the first market with the current id
            } else {
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketsWithCurrentId)); i++ {
                    var marketWithCurrentId interface{} = ccxt.GetValue(marketsWithCurrentId, i)
                    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(marketWithCurrentId, "settleId"), settleId)) {
...
func  (this *coincatch) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ccxt.PanicOnError(retRes51778)
            var request interface{} = map[string]interface{} {}
            var marketType interface{} = "spot"
            __tmp956882 := this.HandleMarketTypeAndParams(methodName, nil, params, marketType)
            marketType = ccxt.GetValue(__tmp956882, 0)
            params = ccxt.GetValue(__tmp956882, 1)
            var result interface{} = nil
            var currency interface{} = nil
            if ccxt.IsTrue(!ccxt.IsEqual(code, nil)) {
                currency = this.Currency(code)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(marketType, "spot")) {
                if ccxt.IsTrue(!ccxt.IsEqual(currency, nil)) {
                    ...
                    ccxt.AddElementToObject(request, "coinId", numericId)
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "limit", limit)
                }
                ...
                if ccxt.IsTrue(!ccxt.IsEqual(since, nil)) {
                    ...
                    ccxt.AddElementToObject(request, "startTime", 0) // is mandatory
                }
                var until interface{} = nil
                __tmp380858 := this.HandleOptionAndParams(params, methodName, "until")
                until = ccxt.GetValue(__tmp380858, 0)
                params = ccxt.GetValue(__tmp380858, 1)
                if ccxt.IsTrue(!ccxt.IsEqual(until, nil)) {
                    ccxt.AddElementToObject(request, "endTime", until)
                } else {
                    ccxt.AddElementToObject(request, "endTime", this.Milliseconds()) // is mandatory
                }
                if ccxt.IsTrue(!ccxt.IsEqual(limit, nil)) {
                    ccxt.AddElementToObject(request, "pageSize", limit)
                }
                ...
                if ccxt.IsTrue(ccxt.IsEqual(code, nil)) {
                    productType = this.HandleOption(methodName, "productType", productType)
                } else if ccxt.IsTrue(ccxt.IsEqual(code, "USDT")) {
                    productType = "umcbl"
                } else {
                    productType = "dmcbl"
                }
                __tmp794386 := this.HandleParamString(params, "productType", productType)
                productType = ccxt.GetValue(__tmp794386, 0)
                params = ccxt.GetValue(__tmp794386, 1)
                ccxt.AddElementToObject(request, "productType", productType)
                ...
                panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() does not support market type "), marketType)))
            }
...
func  (this *coincatch) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if ccxt.IsTrue(ccxt.Precise.StringLt(amountString, "0")) {
        direction = "out"
        amountString = ccxt.Precise.StringMul(amountString, "-1")
    }
    var fee interface{} = map[string]interface{} {
        "cost": ccxt.Precise.StringAbs(this.SafeString2(item, "fee", "fees")),
...
func  (this *coincatch) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    var success interface{} = ccxt.IsTrue((ccxt.IsEqual(message, "success"))) || ccxt.IsTrue((ccxt.IsEqual(message, nil)))
    if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(url, "batch"), 0)) {
        var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
        var failure interface{} = this.SafeList2(data, "failure", "fail_infos", []interface{}{})
        if !ccxt.IsTrue(this.IsEmpty(failure)) {
            success = false
    ...
    if !ccxt.IsTrue(success) {
        this.ThrowExactlyMatchedException(ccxt.GetValue(this.Exceptions, "exact"), messageCode, feedback)
...
func  (this *coincatch) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    var endpoint interface{} = ccxt.Add("/", path)
    if ccxt.IsTrue(ccxt.IsEqual(method, "GET")) {
        var query interface{} = this.Urlencode(params)
        if ccxt.IsTrue(!ccxt.IsEqual(ccxt.GetArrayLength(query), 0)) {
            endpoint = ccxt.Add(endpoint, ccxt.Add("?", query))
        }
    }
    if ccxt.IsTrue(ccxt.IsEqual(api, "private")) {
        ...
        var payload interface{} = ccxt.Add(ccxt.Add(ccxt.Add(timestamp, method), endpoint), suffix)
