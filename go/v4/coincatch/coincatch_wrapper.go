...
func (this *Coincatch) CreateOrderWithTakeProfitAndStopLoss(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWithTakeProfitAndStopLossOptions) (ccxt.Order, error) {
    ...
    opts := ccxt.CreateOrderWithTakeProfitAndStopLossOptionsStruct{}
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coincatch) EditSpotOrder(id string, symbol string, typeVar string, side string, amount float64, options ...ccxt.EditSpotOrderOptions) (ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coincatch) FetchOpenSpotOrders(options ...ccxt.FetchOpenSpotOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coincatch) FetchOpenSwapOrders(options ...ccxt.FetchOpenSwapOrdersOptions) ([]ccxt.Order, error) {
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coincatch) FetchCanceledAndClosedSpotOrders(options ...ccxt.FetchCanceledAndClosedSpotOrdersOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchCanceledAndClosedSpotOrdersOptionsStruct{}
 ...
 * @returns {ccxt.Order[]} a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Coincatch) FetchCanceledAndClosedSwapOrders(options ...ccxt.FetchCanceledAndClosedSwapOrdersOptions) ([]ccxt.Order, error) {

    opts := ccxt.FetchCanceledAndClosedSwapOrdersOptionsStruct{}
 ...
 * @returns {object} response from the exchange
 */
func (this *Coincatch) SetLeverage(leverage int64, options ...ccxt.SetLeverageOptions) (ccxt.Leverage, error) {
